...
dv_has_:
  name_:
    ...
    uk: нормальні умови
    ur: معیاری حالات
    vi: nhiệt độ và áp suất tiêu chuẩn
    wuu: 标准状况
    yue: 標準狀況
    zh: 标准状况
    zh_cn: 标准状况
...
#is_/same_as :: [[_Standards/WikiData/WD~Standard_temperature_and_pressure,102145|WD~Standard_temperature_and_pressure,102145]] 
