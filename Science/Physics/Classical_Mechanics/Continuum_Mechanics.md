...
- Тасралтгүй механик
- Татти-сыпписĕр талккăшсен механики
...
is_the_study_of: '[[_Standards/WikiData/WD~continuum,1704572|WD~continuum,1704572]]'
instance_of: '[[_Standards/WikiData/WD~branch_of_physics,4162444|WD~branch_of_physics,4162444]]'
topic_has_template: '[[_Standards/WikiData/WD~Template_Continuum_mechanics,5616464|WD~Template_Continuum_mechanics,5616464]]'
part_of:
...
dv_has_:
  name_:
    ...
    ca: mecànica dels medis continus
    cs: mechanika kontinua
    cv: Татти-сыпписĕр талккăшсен механики
    da: Kontinuummekanik
    ...
    eu: Medio jarraituen mekanika
    fa: مکانیک محیطهای پیوسته
    fi: jatkuvan aineen mekaniikka
    fr: mécanique des milieux continus
    gl: mecánica de medios continuos
    he: מכניקת הרצף
    hi: सातत्यक यांत्रिकी
    hr: Mehanika kontinuuma
    hu: kontinuummechanika
    id: Mekanika kontinuum
    io: Kontinuo mekaniko
    ...
    sl: mehanika kontinuov
    sr: Mehanika kontinuuma
    sv: kontinuummekanik
    ta: தொடர்ம விசையியல்
    th: กลศาสตร์ภาวะต่อเนื่อง
    tr: Sürekli ortamlar mekaniği
    tt: Тоташ тирәлекләр механикасы
    uk: механіка суцільних середовищ
    ur: مسلسلہ آلاتیات
    uz: tutash muhitlar mexanikasi
