---
has_id_wikidata: Q272035
dv_has_:
  name_:
    ar: الدقة والضبط
    az: Dəqiqlik
    be: дакладнасць і ўзгодненасць
    bn: সঠিকতা ও সূক্ষ্মতা
    ca: exactitud i precisió
    cs: přesnost
    cv: Тĕллĕх
    da: præcision
    de: Genauigkeit
    en: accuracy and precision
    eo: ekzakteco kaj precizeco
    es: precisión y exactitud
    et: Täpsus ja kordustäpsus
    fa: صحت و دقت
    fi: Tarkkuus
    fr: justesse et fidélité
    ga: cruinneas agus beachtas
    he: דיוק ונכונות
    ...
    lv: pareizāk
    lzh: 精準度
    nan: Chún-khak kah cheng-bi̍t
    nb: nøyaktighet og presisjon
    nl: nauwkeurigheid
    nn: nøyaktigheit og presisjon
    pl: dokładność i precyzja metody pomiaru
    pt: exatidão
    ro: exactitate și precizie
    ru: точность
    sh: Tačnost
    sk: Presnosť merania
    sl: točnost in natančnost
    so: Talantaal
    sq: Saktësia dhe përpikëria
    sr: Прецизност и тачност
    su: Akurasi jeung présisi
    sv: precision
    ta: துல்லியம் மற்றும் வழுவாத நுண்ணியம்
    tr: Doğruluk ve kesinlik
...
> A **combination of both precision and trueness**, 
> accounting for both types of observational error (**both random and systematic**), 
> so that high accuracy requires both high precision and high trueness. 
...
> - [[Accuracy]] is how close a given set of measurements is to the true value and 
...
>
> More commonly, a description of systematic errors 
> (a measure of statistical bias of a given measure of central tendency, such as the mean). 
> In this definition of "accuracy", the concept is independent of "precision", 
> so a particular set of data can be said to be accurate, precise, both, or neither. 
