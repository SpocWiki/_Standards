...
dv_has_:
  name_:
    ...
    bn: কম্পটন ক্রিয়া
    ca: efecte Compton
    ckb: دیاردەی پەرشبوونەوەی کۆمپتن
    cs: Comptonův jev
    da: Comptonspredning
    de: Compton-Effekt
    el: Σκέδαση Κόμπτον
    ...
    hu: Compton-szórás
    hy: Քոմփթոնի էֆեկտ
    id: Penyebaran Compton
    it: scattering Compton
    ja: コンプトン効果
    ka: კომპტონის ეფექტი
    ...
    lv: Komptona efekts
    mk: Комптонов ефект
    ml: കോംപ്റ്റൺ പ്രതിഭാസം
    nb: Compton-spredning
    nl: compton-effect
    nn: Comptoneffekt
    pl: zjawisko Comptona
    pms: Efet Compton
    pnb: اثر کومپٹن
    pt: Efeito Compton
    ro: Împrăștiere Compton
    ru: Эффект Комптона
    sh: Komptonov efekat
    sk: Comptonov jav
    skr: کومپٹن ایفیکٹ
