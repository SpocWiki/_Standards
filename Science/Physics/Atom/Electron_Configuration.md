...
dv_has_:
  name_:
    ...
    km: រូបសណ្ឋានអេឡិចត្រុង
    kn: ಎಲೆಕ್ಟ್ರಾನ್ ವಿನ್ಯಾಸ
    ko: 전자 배열
    lt: elektronų konfigūracija
    lv: elektronu konfigurācija
    mk: Електронска конфигурација
    ml: ഇലക്ട്രോൺ വിന്യാസം
    mn: Электрон байгуулалт
    ms: Konfigurasi elektron
    nb: elektronkonfigurasjon
    nds: Elektronenkonfiguratschoon
    nl: elektronenconfiguratie
    nn: elektronkonfigurasjon
    oc: Configuracion electronica
    pa: ਇਲੈਕਟ੍ਰਾਨ ਤਰਤੀਬ
