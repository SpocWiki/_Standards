...
dv_has_:
  name_:
    ...
    he: קליפת אלקטרונים
    hi: इलैक्ट्रॉन आवरण
    hr: elektronska ljuska
    hu: elektronhéj
    id: kelopak elektron
    io: Elektronala shelo
    ja: 電子殻
    kk: Химиялық элементтердің периодтық жүйесін атом құрылысы тұрғысынан сипаттау
    ko: 전자 껍질
    la: Tegimen electronicum
    lb: Elektronecouche
    lzh: 電子層
    mk: електронска обвивка
    mn: Электрон бүрхүүл
    ms: Petala elektron
    nb: elektronskall
    nds: Valenzschaal
    ...
    rue: Електронный обал
    sh: Elektronska ljuska
    si: ඉලෙක්ට්රෝන කවච
    sk: Elektrónový obal
    sl: elektronska lupina
    smn: elektronkorrâ
