...
Stack_Exchange_tag: https://physics.stackexchange.com/tags/electromagnetism
IEV_number: 121-11-74
GitHub_topic: electromagnetism
Commons_category: Electromagnetism
IPTC_NewsCode: mediatopic/20000732
dv_has_:
  name_:
    af: elektromagnetisme
    an: electromagnetismo
    anp: विद्युत्चुम्बकत्व
    ar: كهرطيسية
    as: বিদ্যুত চুম্বকত্ব
    ast: lletromagnetismu
    az: elektromaqnetizm
    azb: الکترومغناطیس
    be: электрамагнетызм
    ...
    bxr: сахилгаан суранзан
    ca: electromagnetisme
    ckb: کارۆموگناتیسی
    crh: electromagnetizm
    ...
    et: elektromagnetism
    eu: elektromagnetismo
    fa: الکترومغناطیس
    fi: sähkömagnetismi
    fr: électromagnétisme
    fy: Elektromagnetisme
    ga: leictreamaighnéadas
    gcr: Élektomagnétism
    gl: electromagnetismo
    gor: Elektromagnetisme
    he: אלקטרומגנטיות
    hi: विद्युतचुम्बकत्व
    hif: electromagnetism
    hr: elektromagnetizam
    hsb: elektromagnetizm
    ht: Elektwomayetis
    hu: elektromágnesség
    hy: էլեկտրամագնիսականություն
    ...
    ja: 電磁気学
    jam: Ilekchomagnetizim
    ka: ელექტრომაგნეტიზმი
    kaa: elektromagnetizm
    kk: электромагниттік өзара әсерлесу
    km: អេឡិចត្រូម៉ាញ៉េទិច
    kn: ವಿದ್ಯುತ್ಕಾಂತತೆ
    ko: 전자기학
    ky: электромагнитизм
    ...
    my: လျှပ်စစ်သံလိုက်
    nan: tiān-chû-la̍t
    nb: elektromagnetisme
    new: विद्युतचुम्बकत्व
    nl: elektromagnetisme
    nn: elektromagnetisme
    oc: electromagnetisme
    om: elektiroomaagneetiizimii
    or: ବିଦ୍ୟୁତ୍-ଚୁମ୍ବକତ୍ଵ
    os: электромагнетизм
    pa: ਬਿਜਲਈ ਚੁੰਬਕਤਾ
    pl: elektromagnetyzm
    pnb: الیکٹرومیگنیٹزم
    ...
    scn: elettrumagnatìsimu
    sd: برقناطيسيت
    se: elektromagnetisma
    sh: elektromagnetizam
    shi: taliktṛamaɣniṭit
...
> In physics, **Electromagnetism** is an interaction that occurs 
> between particles with electric charge via electromagnetic fields. 
> 
...
> Electromagnetism can be thought of as a combination of electrostatics and magnetism, 
> which are distinct but closely intertwined phenomena. 
> 
> Electromagnetic forces occur between any two charged particles. 
> Electric forces cause an attraction between particles with opposite charges 
> and repulsion between particles with the same charge, 
> while magnetism is an interaction that occurs between charged particles in relative motion. 
> These two forces are described in terms of electromagnetic fields. 
> Macroscopic charged objects are described in terms of Coulomb's law for electricity 
> and Ampère's force law for magnetism; 
> the Lorentz force describes microscopic charged particles.
>
