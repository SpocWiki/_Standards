...
research_site: '[[_Standards/WikiData/WD~European_Southern_Observatory,151991|WD~European_Southern_Observatory,151991]]'
instance_of:
- '[[_Standards/WikiData/WD~galaxy_filament,1133705|WD~galaxy_filament,1133705]]'
- '[[_Standards/WikiData/WD~gravity_anomaly,1413914|WD~gravity_anomaly,1413914]]'
- '[[_Standards/WikiData/WD~supercluster,27521|WD~supercluster,27521]]'
has_effect: '[[_Standards/WikiData/WD~peculiar_velocity,1253791|WD~peculiar_velocity,1253791]]'
different_from: '[[_Standards/WikiData/WD~dark_flow,1266091|WD~dark_flow,1266091]]'
part_of:
- '[[_Standards/WikiData/WD~Zone_of_Avoidance,2081504|WD~Zone_of_Avoidance,2081504]]'
- '[[_Standards/WikiData/WD~Laniakea_Supercluster,17863945|WD~Laniakea_Supercluster,17863945]]'
theorized_by: '[[_Standards/WikiData/WD~Alan_Dressler,4706535|WD~Alan_Dressler,4706535]]'
constellation: '[[_Standards/WikiData/WD~Norma,10582|WD~Norma,10582]]'
named_after: '[[_Standards/WikiData/WD~gravity,11412|WD~gravity,11412]]'
declination: -46
speed: 0
...
dv_has_:
  name_:
    ...
    id: Penarik Besar
    is: Miklidragi
    it: Grande Attrattore
    ja: グレート・アトラクター
    ko: 거대 인력체
    lb: Groussen Attrakter
    lv: Lielais Atraktors
    mk: Голем Привлекувач
    nl: Grote Aantrekker
    oc: Grand Atractor
    pl: Wielki Atraktor
    pt: Grande Atrator
    ro: Marele Magnet
    ru: Великий аттрактор
    sk: Veľký atraktor
    sl: Veliki Atraktor
    sr: Велики атрактор
    sv: Stora attraktorn
    tr: Büyük Çekici
    uk: Великий аттрактор
    ur: عظیم کششگر
    vi: Điểm Hút Lớn
    wuu: 巨引源
    yue: 巨引源
