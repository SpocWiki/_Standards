...
dv_has_:
  name_:
    ...
    eo: magnetomova forto
    es: fuerza magnetomotriz
    eu: indar magnetoeragile
    fa: نیروی محرک مغناطیسی
    fi: magnetomotorinen voima
    fr: force magnétomotrice
    gl: forza magnetomotriz
    he: כוח מגנטו־מניע
    hu: magnetomotoros erő
    hy: Մագնիսաշարժ ուժ
    id: Gaya gerak magnet
    it: Tensione magnetica
    ja: 起磁力
    ko: 기자력
    mk: Магнетомоторна сила
    nl: magnetomotorische kracht
    nn: Magnetomotorisk spenning
    om: Humna maagneetoomootiivii
...
#is_/same_as :: [[_Standards/WikiData/WD~Magnetomotive_force,1266982|WD~Magnetomotive_force,1266982]] 
