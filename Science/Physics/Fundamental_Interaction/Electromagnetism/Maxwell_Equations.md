...
dv_has_:
  name_:
    ...
    ga: cothromóidí Maxwell
    gl: ecuacións de Maxwell
    gsw: Maxwell-Gleichungen
    he: משוואות מקסוול
    hi: मैक्सवेल के समीकरण
    hr: Maxwellove jednadžbe
    ht: Équations de Maxwell
    hu: Maxwell-egyenletek
    hy: Մաքսվելի հավասարումներ
    ia: equationes de Maxwell
    id: persamaan Maxwell
    io: Equacioni di Maxwell
    is: jöfnur Maxwells
    it: equazioni di Maxwell
    ja: マクスウェルの方程式
    ka: მაქსველის განტოლებები
    kk: Максвелл теңдеуі
    kn: ಮ್ಯಾಕ್ಸ್ವೆಲ್ನ ಸಮೀಕರಣಗಳು
    ko: 맥스웰 방정식
    ko-kp: 막스웰방정식
    la: aequationes Maxwellianae
    lfn: egalis de Maxwell
    li: wètte van Maxwell
    lt: Maksvelo lygtys
    lv: Maksvela vienādojumi
    mag: मैक्सवेलके समीकरण
    mk: Максвелови равенки
    mr: मॅक्सवेलची समीकरणे
    ms: persamaan Maxwell
    my: မက်စ်ဝဲလ်၏ ညီမျှခြင်းများ
    nb: Maxwells likninger
    ne: माक्सवेल समीकरण
    ...
    ta: மாக்சுவெல்லின் சமன்பாடுகள்
    te: మాక్స్వెల్ సమీకరణాలు
    th: สมการของแมกซ์เวลล์
    tl: mga ekwasyon ni Maxwell
    tr: Maxwell denklemleri
    tt: Makswell tigezlämäläre
    uk: рівняння Максвелла
    ur: میکس ویل کی مساواتیں
    uz: Maksvell tenglamalari
