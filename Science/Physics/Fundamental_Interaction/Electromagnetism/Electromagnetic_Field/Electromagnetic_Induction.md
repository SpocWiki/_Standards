...
- šleđgâmagneetlâš induktio
- Ηλεκτρομαγνητική επαγωγή
- електромагнітна індукція
- Електромагнетна индукција
- Електромагнитна индукция
- электрамагнітная індукцыя
- Электромагнитла индукци
...
- http://commons.wikimedia.org/wiki/Special:FilePath/%E9%9B%BB%E7%A3%81%E8%AA%98%E5%B0%8E%E3%81%AE%E3%81%97%E3%81%8F%E3%81%BF.svg
- http://commons.wikimedia.org/wiki/Special:FilePath/Faraday%27s%20disc.PNG
- http://commons.wikimedia.org/wiki/Special:FilePath/Sentidodacorrenteinduzida.jpg
time_of_discovery_or_invention: 1831-01-01T00:00:00Z
Commons_category: Electromagnetic induction
image:
- http://commons.wikimedia.org/wiki/Special:FilePath/Catalonia%20Terrassa%20mNATEC%20Dinamo.JPG
- http://commons.wikimedia.org/wiki/Special:FilePath/Experiencia%20de%20Faraday.gif
video: http://commons.wikimedia.org/wiki/Special:FilePath/Electric-generator-animation.gif
IEV_number: 121-11-30
dv_has_:
  name_:
    ar: حث كهرطيسي
    ...
    br: Red induktet
    bs: Elektromagnetna indukcija
    ca: inducció electromagnètica
    ckb: کارۆموگنەکاری
    cs: elektromagnetická indukce
    cv: Электромагнитла индукци
    cy: Anwythiant electromagnetig
    da: Elektromagnetisk induktion
    de: elektromagnetische Induktion
    el: Ηλεκτρομαγνητική επαγωγή
    en: electromagnetic induction
    eo: elektromagneta indukto
    es: inducción electromagnética
    et: elektromagnetiline induktsioon
    eu: Indukzio elektromagnetiko
    fa: القای الکترومغناطیسی
    fi: sähkömagneettinen induktio
    fr: induction électromagnétique
    frr: elektromagneetisk induksion
    ga: ionduchtú leictreamaighnéadach
    gl: Indución electromagnética
    gu: વિદ્યુતચુંબકીય પ્રેરણ
    he: השראה אלקטרומגנטית
    hi: विद्युत्-चुम्बकीय प्रेरण
    hr: Elektromagnetska indukcija
    ht: Endiksyon elektwomayetik
    hu: elektromágneses indukció
    hy: Էլեկտրամագնիսական մակածում
    id: Induksi elektromagnetik
    is: Lögmál Faradays
    it: Induzione elettromagnetica
    ja: 電磁誘導
    kk: Электромагниттік индукция
    kn: ವಿದ್ಯುತ್ಕಾಂತೀಯ ಪ್ರೇರಣೆ
    ko: 전자기 유도
    lt: elektromagnetinė indukcija
    lv: elektromagnētiskā indukcija
    mag: विद्युच्चुम्बकीय प्रेरण
    mk: Електромагнетна индукција
    ml: ഇലക്ട്രോമാഗ്നറ്റിക് ഇൻഡക്ഷൻ
    ms: Aruhan elektromagnet
    nb: elektromagnetisk induksjon
    ne: विद्युत चुम्बकीय उपपादन
    nl: inductie
    nn: elektromagnetisk induksjon
    oc: Induccion electromagnetica
    pa: ਇਲੈਕਟ੍ਰੋਮੈਗਨੈਟਿਕ ਇੰਡਕਸ਼ਨ
    pl: indukcja elektromagnetyczna
    pms: Andussion eletromagnética
    pt: indução eletromagnética
    ro: inducție electromagnetică
    ru: электромагнитная индукция
    sco: electromagnetic induction
    se: Indukšuvdna
    sh: Elektromagnetska indukcija
    sk: Elektromagnetická indukcia
    sl: elektromagnetna indukcija
    ...
    tr: Elektromanyetik Ürünlenim
    uk: електромагнітна індукція
    ur: برقناطیسی تحریض
    uz: Elektromagnit induksiya
    vi: Cảm ứng điện
    wo: Xiirtalug mbëjbijjaakon
    wuu: 电磁感应
    yue: 電磁感應
    zh: 电磁感应
    zh_hans: 电磁感应
...
> Electromagnetic or magnetic induction is the production of an electromotive force (emf) 
...
> one of the four Maxwell equations in his theory of electromagnetism.
>
