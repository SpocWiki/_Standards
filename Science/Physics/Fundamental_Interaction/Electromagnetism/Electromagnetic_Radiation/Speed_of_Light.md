...
dv_has_:
  name_:
    ...
    fj: totolo ni rarama
    fr: vitesse de la lumière dans le vide
    ...
    gn: tesape pya'ekue
    gsw: Liechtgschwindigkeit
    gu: પ્રકાશનો વેગ
    he: מהירות האור
    hi: प्रकाश का वेग
    hif: parkaas ke raftaar
    hr: brzina svjetlosti
    ht: vitès limyè
    hu: fénysebesség vákuumban
    hy: լույսի արագություն
    ia: velocitate de lumine
    id: laju cahaya
    io: Rapideso di lumo
    is: ljóshraði
    ...
    scn: vilucitati dâ luci
    sco: speed o licht
    sgs: švėisas grētoms
    sh: brzina svjetlosti
    si: ආලෝකයේ වේගය
    sk: rýchlosť svetla
    sl: hitrost svetlobe v vakuumu
    smn: čuovâliähtu
    so: xawaaraha ileyska
...
> is a universal physical constant that is exactly equal to 299,792,458 metres per second 
> (approximately 300,000 kilometres per second; 186,000 miles per second; 671 million miles per hour). 
> It is exact because, by a 1983 international agreement, a metre is defined as 
