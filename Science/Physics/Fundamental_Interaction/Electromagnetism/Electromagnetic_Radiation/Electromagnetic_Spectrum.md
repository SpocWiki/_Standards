...
- spettro elettromagnettico
- spèttro elèttromagnetich
...
- Электромагнитла спектр
- электромагнитный спектр
- הספקטרום האלקטרומגנטי
- برېښنايي مقناطيسي طيف
- سڤيکتروم ايليکترومݢنيت
...
dv_has_:
  name_:
    ...
    ckb: شەبەنگی کارۆموگناتیسی
    cs: elektromagnetické spektrum
    cv: Электромагнитла спектр
    cy: sbectrwm electromagnetig
    da: elektromagnetiske spektrum
    de: elektromagnetisches Spektrum
    el: ηλεκτρομαγνητικό φάσμα
    ...
    ga: speictream leictreamaighnéadach
    gl: espectro electromagnético
    he: הספקטרום האלקטרומגנטי
    hi: विद्युतचुंबकीय वर्णक्रम
    hr: elektromagnetski spektar
    ht: espèk elektwomayetik
    hu: elektromágneses spektrum
    ia: spectro electromagnetic
    id: spektrum elektromagnetik
    io: Elektromagnetika spektro
    ...
    kw: an spektrum elektromagnetek
    lb: elektromagnéitesche Spektrum
    lij: spettro elettromagnettico
    lmo: spèttro elèttromagnetich
    lt: elektromagnetinis spektras
    lv: elektromagnētisko viļņu skala
    mk: електромагнетен спектар
    ...
    ps: برېښنايي مقناطيسي طيف
    pt: espectro eletromagnético
    ro: spectru electromagnetic
    ru: электромагнитный спектр
    rue: електромаґнетічне спектрум
    sc: ispetru eletromagnèticu
    sh: elektromagnetni spektar
    si: විද්යුත් චුම්බක වර්ණාවලිය
    ...
    te: విద్యుదయస్కాంత వర్ణపటం
    th: สเปกตรัมแม่เหล็กไฟฟ้า
    tr: elektromanyetik tayf
    uk: електромагнітний спектр
    uz: Elektromagnit spektr
    vec: spetro ełetromagnètego
    vi: phổ điện từ
    war: espektro elektromagnetiko
    wuu: 电磁波谱
    yue: 電磁波譜
    zh: 電磁波譜
    zh_cn: 电磁波谱
