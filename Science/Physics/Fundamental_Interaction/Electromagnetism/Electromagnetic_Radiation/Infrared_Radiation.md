...
followed_by: '[[_Standards/WikiData/WD~radio_wave,4262|WD~radio_wave,4262]]'
...
> with wavelengths longer than that of visible light but shorter than microwaves. 
> 
> The infrared spectral band begins with the waves that are 
> just longer than those of red light (the longest waves in the visible spectrum), 
> so IR is invisible to the human eye. 
> 
> IR is generally (according to ISO, CIE) understood to include 
> wavelengths from around 780 nm (380 THz) to 1 mm (300 GHz). 
> 
> IR is commonly divided between longer-wavelength thermal IR, 
> emitted from terrestrial sources, and shorter-wavelength IR or near-IR, part of the solar spectrum. 
> 
...
> 
> As a form of EMR, IR carries energy and momentum, exerts radiation pressure, 
> and has properties corresponding to both those of a wave and of a particle, the photon.
>
