...
- rede de distribución d'enerxía llétrico
- Rede de distribución de enerxía eléctrica
...
- разьмеркаваньне электраэнэргіі
...
dv_has_:
  name_:
    ...
    cs: distribuční soustava
    cy: dosbarthu trydan
    de: Elektrizitätsverteilung
    en: electric power distribution
    es: distribución de energía eléctrica
    et: elektrienergia jaotamine
    eu: Energia elektrikoaren banaketa
    fa: توزیع انرژی الکتریکی
    fi: Sähkönjakelu
    fr: réseau de distribution électrique
    gl: Rede de distribución de enerxía eléctrica
    he: חלוקת חשמל
    hi: विद्युतशक्ति का वितरण
    hu: elosztóhálózat
    id: Distribusi tenaga listrik
    it: distribuzione di energia elettrica
    ja: 配電
    ko: 배전
    lt: elektros paskirstymas
    lv: elektroenerģijas sadale
    ml: വൈദ്യുതിവിതരണം
    mr: विद्युत वितरण
    ms: Pengagihan kuasa elektrik
    my: လျှပ်စစ်ဓာတ်အား ဖြန့်ဖြူးခြင်း
    nb: distribusjonsnett
    nl: elektriciteitsdistributie
    pl: sieć elektroenergetyczna rozdzielcza
    pms: Distribussion d'energia elétrica
    pt: distribuição de energia elétrica
    ro: distribuția energiei electrice
    ru: распределение электроэнергии
