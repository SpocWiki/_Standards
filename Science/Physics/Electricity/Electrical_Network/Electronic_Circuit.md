...
- circuitu elittrònicu
- circuitus electronicus
...
dv_has_:
  name_:
    ...
    eu: zirkuitu elektroniko
    fa: مدار الکترونیکی
    fi: elektroninen piiri
    fr: circuit électronique
    gl: circuíto electrónico
    he: מעגל אלקטרוני
    hi: इलेक्ट्रानिक परिपथ
    ht: Sikui
    hu: elektronikus áramkör
    hy: Էլեկտրոնային միացում
    id: Sirkuit elektronik
    io: Elektronikala cirkuito
    is: Rafrás
    it: circuito elettronico
    ja: 電子回路
    ko: 전자 회로
    la: circuitus electronicus
    mg: Olik'aratra
    mk: електронско коло
    ms: Litar elektronik
    my: အီလက်ထရွန်းနစ် ဆားကစ် ပတ်လမ်း
    nb: elektronisk krets
    nl: schakeling
    nn: elektronisk krins
