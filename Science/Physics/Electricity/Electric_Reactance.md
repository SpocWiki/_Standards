...
- Blindwiderstand
- electric reactance
- električna reaktanca
- Električna reaktancija
- Električna reaktansa
- erreaktantzia elektriko
- freasaitheacht
- Launviðnám
- meddő ellenállás
- reactancia
...
opposite_of: '[[_Standards/WikiData/WD~susceptance,509598|WD~susceptance,509598]]'
...
dv_has_:
  name_:
    ...
    de: Blindwiderstand
    el: Άεργη αντίσταση
    en: electric reactance
    eo: reaktanco
    es: reactancia
    et: reaktiivtakistus
    eu: erreaktantzia elektriko
    fa: راکتانس الکتریکی
    fi: reaktanssi
    fr: réactance électrique
    ga: freasaitheacht
    gl: reactancia
    he: היגב
    hi: वैद्युत प्रतिघात
    hr: Električna reaktancija
    hu: meddő ellenállás
    hy: Ռեակտիվ դիմադրություն
    id: Reaktansi listrik
    is: Launviðnám
    it: reattanza
    ja: リアクタンス
    ko: 리액턴스
    lt: Reaktyvioji varža
    lv: Reaktīvā pretestība
    mk: реактанса
    nan: Tiān-khòng
    nb: reaktans
    new: रियाक्ट्यान्स
    ...
    pl: Reaktancja
    pt: reatância
    ro: Reactanță electrică
    ru: Реактивное сопротивление
    se: reaktánsa
    sh: Električna reaktansa
    sk: Reaktancia
    sl: električna reaktanca
    smn: reaktans
    sms: reaktanss
    sr: Električna reaktansa
    su: Réaktansi
    sv: reaktans
    ta: மின்மறுப்பு
    tl: Reaktansiya
