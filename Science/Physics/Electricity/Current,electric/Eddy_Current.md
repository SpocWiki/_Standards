...
dv_has_:
  name_:
    ...
    et: Pöörisvool
    eu: Foucaulten korronte
    fa: جریان گردابی
    fi: Pyörrevirta
    fr: courants de Foucault
    ga: sruthanna guairneáin
    gl: Corrente de Foucault
    he: זרם פוקו
    hi: भँवर धारा
    hr: Foucaultove struje
    ht: Kouran-toubiyon
    hu: örvényáram
    hy: Մրրկային հոսանքներ
    io: Vortica flui
    it: corrente parassita
    ja: 渦電流
    ko: 맴돌이 전류
    lv: virpuļstrāva
    mk: вителни струи
