...
dv_has_:
  name_:
    ...
    et: vahelduvvool
    eu: Korronte aldizkatzaile
    fa: جریان متناوب
    fi: vaihtovirta
    fr: courant alternatif
    frr: wakselstruum
    ga: sruth ailtéarnach
    gl: corrente alterna
    gor: Arus bolak-balik
    gsw: Wechselstrom
    he: זרם חילופין
    ...
    nl: wisselstroom
    nn: vekselspenning
    oc: Corrent alternatiu
    pa: ਬਿਜਲੀ ਦੀ ਬਦਲਵੀਂ ਧਾਰਾ
    pl: prąd przemienny
    pms: Corent auternà
    pnb: آلٹرنیٹنگ کرنٹ
    ...
    te: ద్విముఖ విద్యుత్ ప్రవాహం
    th: ไฟฟ้ากระแสสลับ
    tl: Alternating current
    tr: Alternatif akım
    udm: вошъяськись ток
    uk: змінний струм
    ur: متبادل رو
