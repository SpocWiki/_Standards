...
- 987007535943605171
- 987007535946705171
Commons_category: Direct current
dv_has_:
  name_:
    af: Gelykstroom
    am: ቀጥተኛ ጅረት
    ...
    la: currens directus
    li: Gelieksjtroum
    lmo: Corrent continua
    lt: nuolatinė elektros srovė
    lv: līdzstrāva
    mk: еднонасочна струја
    ml: നേർധാരാ വൈദ്യുതി
    mn: Тогтмол гүйдэл
    ms: Arus terus
    my: တည်ငြိမ်လျှပ်စစ်
    ...
    nn: Likestraum
    oc: Corrent continú
    pa: ਬਿਜਲੀ ਦੀ ਸਿੱਧੀ ਪ੍ਰਵਾਹਿਤ ਧਾਰਾ
    pl: prąd stały
    pms: Corent continua
    pnb: ڈریکٹ کرنٹ
    ...
    sv: likström
    ta: நேர் மின்னோட்டம்
    te: ఏకముఖ విద్యుత్ ప్రవాహం
    th: ไฟฟ้ากระแสตรง
    tl: Direct Current machines
    tr: Doğru akım
    tt: даими агым
    uk: постійний струм
    ur: راست رو
