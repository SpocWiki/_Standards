...
> A Fresnel lens ( FRAY-nel, -⁠nəl;  FREN-el, -⁠əl; or  fray-NEL) 
> is a type of composite compact lens 
> which reduces the amount of material required compared to a conventional lens 
> by dividing the lens into a set of concentric annular sections.
>
...
> that use total internal reflection as well as refraction 
> to capture more oblique light from the light source 
> and add it to the beam, making it visible at greater distances.
>
