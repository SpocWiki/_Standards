...
- 620.28
- 534.55
audio: http://commons.wikimedia.org/wiki/Special:FilePath/15000Hz%20hugh%20pitch%20ultrasound.oga
image: http://commons.wikimedia.org/wiki/Special:FilePath/CRL%20Crown%20rump%20length%2012%20weeks%20ecografia%20Dr.%20Wolfgang%20Moroder.jpg
video: http://commons.wikimedia.org/wiki/Special:FilePath/How%20Ultrasound%20Imaging%20Works%20%28Sonography%29.webm
IEV_number: 801-21-04
MeSH_tree_code: G01.750.770.776.891
Krugosvet_article_archived_: nauka_i_tehnika/fizika/ULTRAZVUK.html
dv_has_:
  name_:
    af: Ultraklank
    ar: موجات فوق صوتية
    ...
    bs: Ultrazvuk
    ca: ultrasò
    ckb: شەپۆلی سەرووی دەنگ
    cs: ultrazvuk
    cy: uwchsain
    da: ultralyd
    de: Ultraschall
    dv: އަލްޓްރާ ސައުންޑް
    el: Υπέρηχος
    en: ultrasound
    eo: ultrasono
    es: ultrasonido
    ...
    ta: மீயொலி
    te: అతిధ్వనులు
    th: การบันทึกด้วยคลื่นเสียงความถี่สูง
    tr: Ultrason
    uk: ультразвук
    ur: بالاصوت
    uz: Ultratovush
...
> This frequency is the approximate upper audible limit of human hearing 
