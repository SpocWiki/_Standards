...
- erlatibitate berezi
- espesyal na teoriya ng relatibidad
- Kerelatifan khas
- mahsus nisbiyet nazariyesi
- Maxsus nisbiylik nazariyasi
- Maxsus çağıştırmalılıq teoriäse
- mba'ekuaarã joguerahaviárava ijapýva
- perthnasedd arbennig
- Pinaurog nga teyorya han relatividad
- Posebna teorija relativnosti
- relativelezh ispisial
- relatividad especial
- relatividade especial
- relatividade restrita
- Relatividat especial
- Relativitas khusus
...
- Specēliuojė relētīvoma teuorėjė
- spesiale relatiwiteit
- Spetschale Relativitätstheorie
...
- Харисангы байдалай тусхай онол
...
described_by_source:
- '[[_Standards/WikiData/WD~On_the_Electrodynamics_of_Moving_Bodies,3020388|WD~On_the_Electrodynamics_of_Moving_Bodies,3020388]]'
...
has_characteristic: '[[_Standards/WikiData/WD~mass_in_special_relativity,719048|WD~mass_in_special_relativity,719048]]'
...
is_invariant_under: '[[_Standards/WikiData/WD~Lorentz_transformation,217255|WD~Lorentz_transformation,217255]]'
Krugosvet_article: nauka_i_tehnika/fizika/OTNOSITELNOSTI_TEORIYA_SPETSIALNAYA_–.html
part_of: '[[_Standards/WikiData/WD~theory_of_relativity,43514|WD~theory_of_relativity,43514]]'
permanent_duplicated_item: '[[_Standards/WikiData/WD~Formulations_of_special_relativity,7574858|WD~Formulations_of_special_relativity,7574858]]'
...
dv_has_:
  name_:
    ...
    ar: النسبية الخاصة
    arz: نسبيه خاصه
    as: বিশেষ আপেক্ষিকতাবাদ তত্ত্ব
    ast: Teoría de la relatividá especial
    az: Xüsusi nisbilik nəzəriyyəsi
    azb: اؤزل نیسبیت
    ba: Махсус сағыштырмалыҡ теорияһы
    ...
    bho: बिशेस सापेक्षता
    bn: বিশেষ আপেক্ষিকতা
    br: relativelezh ispisial
    bs: Posebna teorija relativnosti
    bxr: Харисангы байдалай тусхай онол
    ca: relativitat especial
    ckb: ڕێژەییی تایبەت
    crh: mahsus nisbiyet nazariyesi
    cs: speciální teorie relativity
    cv: Танлаштарулăхăн ятарлă теорийĕ
    cy: perthnasedd arbennig
    ...
    gd: teòirig shònraichte na dàimheachd
    gl: relatividade especial
    gn: mba'ekuaarã joguerahaviárava ijapýva
    gsw: Spezielle Relativitätstheorie
    gu: વિશિષ્ટ સાપેક્ષવાદ
    he: תורת היחסות הפרטית
    hi: विशिष्ट आपेक्षिकता
    hif: special relativity
    ...
    sco: special relativity
    sd: اسپيشل رليٽوٽي جو نظريو
    sgs: Specēliuojė relētīvoma teuorėjė
    sh: Posebna teorija relativnosti
    si: විශේෂ සාපේක්ෂතාවාදය
