...
- Termodïnamïkanıñ ekinşi bastaması
...
- තාපගති විද්යාවේ දෙවන නියමය - හැඳින්වීම
...
dv_has_:
  name_:
    af: Tweede wet van termodinamika
    ar: قانون الديناميكا الحراري الثاني
    ...
    cv: Термодинамикăн иккĕмĕш пуçламăшĕ
    da: Termodynamikkens 2. lov
    de: zweiter Hauptsatz der Thermodynamik
    el: Δεύτερος θερμοδυναμικός νόμος
    en: second law of thermodynamics
    eo: dua leĝo de termodinamiko
    es: segundo principio de la termodinámica
    et: Termodünaamika teine seadus
    eu: Termodinamikaren bigarren legea
    fa: قانون دوم ترمودینامیک
    fi: termodynamiikan toinen pääsääntö
    ...
    ht: Dezyèm lwa tèmodinamik
    hu: a termodinamika második főtétele
    hy: Ջերմադինամիկայի երկրորդ օրենք
    ...
    lt: antrasis termodinamikos dėsnis
    lv: otrais termodinamikas likums
    lzh: 熱力學第二定律
    ms: Hukum termodinamik kedua
    nb: Termodynamikkens andre hovedsetning
    nl: tweede wet van de thermodynamica
    oc: Segond principi de la termodinamica
    pa: ਥਰਮੋਡਾਇਨਾਮਿਕਸ ਦਾ ਦੂਜਾ ਨਿਯਮ
    ...
    sh: Drugi zakon termodinamike
    si: තාපගති විද්යාවේ දෙවන නියමය - හැඳින්වීම
    ...
    tr: Termodinamiğin ikinci yasası
    uk: другий закон термодинаміки
    ur: حرحرکیات کا دوسرا قانون
    uz: Termodinamikaning ikkinchi qonuni
...
#is_/same_as :: [[_Standards/WikiData/WD~Second_law_of_thermodynamics,177045|WD~Second_law_of_thermodynamics,177045]] 

## #has_/text_of_/abstract 

> The second law of thermodynamics is a physical law 
> based on universal empirical observation concerning heat and energy interconversions. 
> 
> A simple statement of the law is that 
> heat always flows spontaneously from hotter to colder regions of matter 
> (or 'downhill' in terms of the temperature gradient). 
> 
> Another statement is: "Not all heat can be converted into work in a cyclic process." 
> These are informal definitions, however; more formal definitions appear below.
>
> The second law of thermodynamics 
> establishes the concept of **entropy** as a physical property of a thermodynamic system. 
> 
> It predicts whether processes are forbidden, 
> despite obeying the requirement of conservation of energy 
> as expressed in the first law of thermodynamics 
> and provides necessary criteria for spontaneous processes. 
> 
> For example, the first law allows the process of 
> a cup falling off a table and breaking on the floor, 
> as well as allowing the reverse process of the cup fragments coming back together 
> and 'jumping' back onto the table, 
> while the second law allows the former and denies the latter. 
> 
> The second law may be formulated by the observation 
> that the entropy of isolated systems left to spontaneous evolution cannot decrease, 
> as they always tend toward a state of thermodynamic equilibrium 
> where the entropy is highest at the given internal energy. 
> An increase in the combined entropy of system and surroundings 
> accounts for the irreversibility of natural processes, often referred to in the concept of 
> **the arrow of time**.
>
