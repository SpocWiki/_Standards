...
- Νόμος του Μπόιλ
- Бојл-Мариотов закон
- Бойль — Мариотт саккунĕ
- Бойль-Мариотт мыйзамы
- Бойль–Мариотт заңы
- Бойля-Мариотлэн законэз
- закон Бойла—Марыёта
...
dv_has_:
  name_:
    ...
    hy: Բոյլ-Մարիոտի օրենք
    id: Hukum Boyle
    is: Lögmál Boyles
    it: legge di Boyle-Mariotte
    ja: ボイルの法則
    jv: Hukum Boyle
    kk: Бойль–Мариотт заңы
    ko: 보일의 법칙
    ky: Бойль-Мариотт мыйзамы
    lij: Lezze de Boyle
    lt: Boilio ir Marioto dėsnis
    lv: Boila—Mariota likums
    mk: Бојл-Мариотов закон
    ml: ബോയിൽ നിയമം
    ms: Hukum Boyle
    my: ဘွိုင်းလ်၏ နိယာမ
    nan: Boyle hoat-chek
    nb: Boyle-Mariottes lov
    nl: Wet van Boyle
    nn: Boyle-Mariotte-lova
    pa: ਬੋਏਲ ਦਾ ਕਾਨੂੰਨ
    ...
    sh: Boyle-Mariotteov zakon
    si: බොයිල් නියමය
    sk: Boylov-Mariottov zákon
    sl: Boylov zakon
    ...
    tl: Batas ni Boyle
    tr: Boyle Yasası
    udm: Бойля-Мариотлэн законэз
    uk: Закон Бойля — Маріотта
    ur: قانون بوائل
    uz: Boyl-mariott qonuni
