...
dv_has_:
  name_:
    ...
    el: Κίνηση Μπράουν
    en: Brownian motion
    en-us: Brownian motion
    eo: Brown-a movado
    es: Movimiento browniano
    et: Browni liikumine
    eu: Mugimendu browndar
    fa: حرکت براونی
    fi: Brownin liike
    fr: Mouvement brownien
    ga: gluaisne de Brún
    gl: Movemento browniano
    gu: બ્રાઉનીયનગતિ
    he: תנועה בראונית
    hi: ब्राउनी गति
    hr: Brownovo gibanje
    ht: Mouvman bwonyen
    hu: Brown-mozgás
    hy: Բրոունյան շարժում
    id: Gerak Brown
    io: Browniana movemento
    it: moto browniano
    ja: ブラウン運動
    kk: Броундық қозғалыс
    kn: ಬ್ರೌನಿಯನ್ ಚಲನೆ
    ko: 브라운 운동
    ky: Броун кыймылы
    lt: Brauno judėjimas
