...
- Llei de caltenimientu de la materia
...
- Масса сыхланнин саккунĕ
- Массанын сакталуу мыйзамы
- Массаның сақталу заңы
- тырметлэсь массазэ утись закон
...
- قانون حفظ الكتلة
- پایستگی جرم
- द्रब्य की अविनाशिता का नियम
- ਪੁੰਜ ਸੁਰੱਖਿਅਣ ਦਾ ਨਿਯਮ
- દળ-સંચયનો નિયમ
- திணிவுக் காப்பு விதி
- ద్రవ్య నిశ్చత్వ నియమము
...
dv_has_:
  name_:
    ...
    cv: Масса сыхланнин саккунĕ
    da: massens bevarelse
    de: Massenerhaltungssatz
    el: Αρχή διατήρησης της μάζας
    en: conservation of mass
    eo: konservado de maso
    es: Ley de conservación de la materia
    et: Aine massi jäävuse seadus
    eu: masaren kontserbazioaren legea
    fa: پایستگی جرم
    fi: Aineen häviämättömyyden laki
    fr: conservation de la masse
    ga: imchoimeád na maise
    gl: Lei da conservación da masa
    gu: દળ-સંચયનો નિયમ
    he: חוק שימור החומר
    hi: द्रब्य की अविनाशिता का नियम
    hr: Zakon očuvanja mase
    ht: Lwa konsèvasyon mas
    hu: tömegmegmaradás
    hy: Զանգվածի պահպանման օրենք
    id: Hukum kekekalan massa
    it: legge della conservazione della massa
    ja: 質量保存の法則
    ka: მასის შენახვის კანონი
    kk: Массаның сақталу заңы
    ko: 질량 보존의 법칙
    ky: Массанын сакталуу мыйзамы
    lt: Masių tvermės dėsnis
    lv: masas saglabāšanās
    mk: Закон за зачувување на масата
    ml: ദ്രവ്യ സംരക്ഷണ നിയമം
    ms: Hukum keabadian jisim
    my: ဒြပ်ထု တည်မြဲမှု နိယာမ
    nan: Chit-liōng pó-siú
    nb: Massens bevarelse
    nl: wet van behoud van massa
    nn: bevaring av masse
    oc: Lei de conservacion de la massa
    pa: ਪੁੰਜ ਸੁਰੱਖਿਅਣ ਦਾ ਨਿਯਮ
    pl: Prawo zachowania masy
    pnb: قانون بقائے مادہ
    pt: conservação da massa
    rki: ဒြပ်ထု တည်မြဲမှု နိယာမ
    ro: Legea conservării masei substanțelor
    ru: закон сохранения массы
    sh: Zakon održanja mase
    ...
    udm: тырметлэсь массазэ утись закон
    uk: закон збереження маси речовини
    ur: قانون بقائے مادہ
    uz: Massalar saqlanish qonuni
...
>
> In general, mass is not conserved. The conservation of mass is a law that holds only in the classical limit. For example, the overlap of the electron and positron wave functions, where the interacting particles are nearly at rest, will proceed to annihilate via electromagnetic interaction. This process creates two photons and is the mechanism for PET scans.
>
