...
- pachapi tiyaq chimpaykuna
- relatiivsusteooria
- relativitehtateoriija
- Relativiteitsteory
...
- teorija tar-relattività
- Teorio di relativeso
- teoriya relativita
- teoría da relatividade
- teoría de la relatividad
- teoría de la relatividá
- Teyori relativite
- teyorya han relatibidad
- teória relativity
...
- тэорыя адноснасці
- тэорыя рэлятыўнасьці
- харьцангуйн онол
- чагыштырмалылык теориясе
- համարժեքության տեսություն
...
- सापेक्षिकता का सिद्धान्त
- सापेक्षिकता केरऽ सिद्धांत
- আপেক্ষিকতা তত্ত্ব
...
is_the_study_of: '[[_Standards/WikiData/WD~spacetime,133327|WD~spacetime,133327]]'
has_characteristic:
- '[[_Standards/WikiData/WD~spacetime,133327|WD~spacetime,133327]]'
- '[[_Standards/WikiData/WD~time_dilation,185918|WD~time_dilation,185918]]'
- '[[_Standards/WikiData/WD~length_contraction,836595|WD~length_contraction,836595]]'
- '[[_Standards/WikiData/WD~relativity,983751|WD~relativity,983751]]'
...
different_from: '[[_Standards/WikiData/WD~relativity,983751|WD~relativity,983751]]'
history_of_topic: '[[_Standards/WikiData/WD~history_of_special_relativity,1095704|WD~history_of_special_relativity,1095704]]'
subclass_of: '[[_Standards/WikiData/WD~scientific_theory,3239681|WD~scientific_theory,3239681]]'
instance_of:
...
topic_has_template: '[[_Standards/WikiData/WD~Template_Relativity,14839046|WD~Template_Relativity,14839046]]'
union_of: '[[_Standards/WikiData/WD~list_of_values_as_qualifiers,23766486|WD~list_of_values_as_qualifiers,23766486]]'
practiced_by: '[[_Standards/WikiData/WD~relativity_theorist,109096773|WD~relativity_theorist,109096773]]'
permanent_duplicated_item: '[[_Standards/WikiData/WD~Q110314677,110314677|WD~Q110314677,110314677]]'
...
Library_of_Congress_Classification: QC173.5-QC173.65
image: http://commons.wikimedia.org/wiki/Special:FilePath/World%20line.svg
Dewey_Decimal_Classification: 530.11
spoken_text_audio: http://commons.wikimedia.org/wiki/Special:FilePath/Nl-Relativiteitstheorie-article.ogg
WordLift_URL: http://data.thenextweb.com/tnw/entity/theory_of_relativity
Stack_Exchange_tag: https://hsm.stackexchange.com/tags/relativity-theory
Iconclass_notation: 49E2111
Krugosvet_article_archived_: nauka_i_tehnika/fizika/OTNOSITELNOST.html
Commons_category: Theory of relativity
dv_has_:
  name_:
    af: Relatiwiteitsteorie
    anp: सापेक्षिकता केरऽ सिद्धांत
    ar: نظرية النسبية
    ary: نظرية النسبية
    arz: نظرية النسبيه
    as: আপেক্ষিকতাবাদ তত্ত্ব
    ast: teoría de la relatividá
    az: nisbilik nəzəriyyəsi
    azb: نیسبیلیک نظریهسی
    ...
    bo: ལྟོས་བཅས་སྨྲ་བ་
    br: damkan ar relativelezh
    bs: teorija relativnosti
    ca: teoria de la relativitat
    ckb: تیۆریی ڕێژەیی
    cs: teorie relativity
    cv: танлаштарулăх теорийĕ
    cy: damcaniaeth perthnasedd
    ...
    frr: relatiwiteetsteorii
    fy: Relativiteitsteory
    ga: teoiric choibhneasachta Einstein
    gcr: téyori di rélativité
    gl: teoría da relatividade
    gsw: Relativitätstheorie
    ha: Ka'idar Dangantaka
    he: תורת היחסות
    hi: सापेक्षिकता का सिद्धान्त
    hr: teorija relativnosti
    ht: Teyori relativite
    hu: relativitáselmélet
    hy: համարժեքության տեսություն
    id: teori relativitas
    io: Teorio di relativeso
    is: afstæðiskenningin
    it: teoria della relatività
    ja: 相対性理論
    jam: tiori a relitiviti
    jv: teori relativitas
    ka: ფარდობითობის თეორია
    kbp: ɖama tʋʋzɩnaʋ tɛ lɩmaɣzɩyɛ
    ...
    la: Theoria relativitatis
    lb: Relativitéitstheorie
    lfn: teoria de relativia
    lo: ທິດສະດີສົມທຽບ
    lt: reliatyvumo teorija
    lv: relativitātes teorija
    mag: आपेक्षिकता सिद्धान्त
    mk: теорија за релативноста
    ml: ആപേക്ഷികത സിദ്ധാന്തം
    mn: харьцангуйн онол
    mr: सापेक्षतावादाचा सिद्धान्त
    ms: teori kerelatifan
    mt: teorija tar-relattività
    my: နှိုင်းရသီအိုရီ
    nan: siong-tùi-lūn
    nb: relativitetsteorien
    ne: सापेक्षता सिद्धान्त
    nl: relativiteitstheorie
    nn: relativitetsteorien
    nov: teorie de relativitate
    nqo: ߢߐ߲߯ߘߐߦߊ ߦߟߌߦߊ
    oc: teoria de la relativitat
    pa: ਸਾਪੇਖਤਾ ਸਿਧਾਂਤ
    ...
    sco: theory o relativity
    sd: آئنسٽائين جو نظریو اضافیت
    se: relativitehtateoriija
    ...
    te: సాపేక్ష సిద్ధాంతం
    th: ทฤษฎีสัมพัทธภาพ
    tk: Otnositellik teoriýasy
    tok: sona pi sama lon
    tr: izafiyet teorisi
    tt: чагыштырмалылык теориясе
    uk: теорія відносності
    ur: نظریۂ اضافیت
    uz: nisbiylik nazariyasi
    vec: teoria de la relatività
    vi: thuyết tương đối
    war: teyorya han relatibidad
    wuu: 相对论
    yi: טעאריע פון רעלאטיוויטעט
    yue: 相對論
    zgh: ⵜⵉⵥⵕⵉ ⵏ ⵜⵎⵎⴰⵙⵖⵜ
    zh: 相對論
    zh_cn: 相对论
