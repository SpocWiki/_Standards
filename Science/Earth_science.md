...
- Cirne öyränüçe fännär
- ciències de la Terra
- Ciéncia de la Tierra
- ciências da terra
- Dowan-oaylleeaght
- Dê-giù Kuŏ-hŏk
- Earth science
...
- Scientia tellurica
- scientias del terra
- Scienzas da la Terra
- scienze della Terra
- Scienze di a Terra
- scienzi dâ terra
- sciéncias de la Tèrra
- Shikpɔŋ jeŋ shi kpamɔ
- shkencë e Tokës
- Siencis de tiere
- siense de ła tera
- Siyensya han Kalibutan
- Skiantoù an douar
- sáyẹ́nsì àgbáyé
- tedyske
- Teral sienties
...
Wikimedia_outline: '[[_Standards/WikiData/WD~outline_of_earth_science,715140|WD~outline_of_earth_science,715140]]'
instance_of:
...
main_subject:
- '[[_Standards/WikiData/WD~Earth_analog,2670101|WD~Earth_analog,2670101]]'
- '[[_Standards/WikiData/WD~Earth,2|WD~Earth,2]]'
topic_has_template: '[[_Standards/WikiData/WD~Template_Earth_science,6580824|WD~Template_Earth_science,6580824]]'
topic_s_main_Wikimedia_portal: '[[_Standards/WikiData/WD~Portal_Earth_sciences,8207058|WD~Portal_Earth_sciences,8207058]]'
practiced_by: '[[_Standards/WikiData/WD~earth_scientist,11424604|WD~earth_scientist,11424604]]'
studied_by: '[[_Standards/WikiData/WD~earth_science_studies,106387954|WD~earth_science_studies,106387954]]'
history_of_topic: '[[_Standards/WikiData/WD~history_of_Earth_science,113192690|WD~history_of_Earth_science,113192690]]'
...
is_the_study_of: '[[_Standards/WikiData/WD~Earth,2|WD~Earth,2]]'
...
Stack_Exchange_site_URL: https://earthscience.stackexchange.com
described_at_URL:
- https://geology.com/articles/what-is-earth-science.shtml
- https://www.nsf.gov/geo/ear/about.jsp
- https://www.usnews.com/education/best-graduate-schools/articles/what-earth-science-is-and-reasons-to-study-it
UMLS_CUI: C2717821
subreddit: EarthScience
GitHub_topic: geoscience
MeSH_tree_code: H01.277
dv_has_:
  name_:
    af: aardwetenskap
    ...
    et: maateadus
    eu: Lurraren zientziak
    fa: علوم زمین
    fi: geotieteet
    fr: sciences de la Terre
    frp: Sciences de la Tèrra
    fur: Siencis de tiere
    fy: Ierdwittenskip
    ga: eolaíocht an domhain
    gaa: Shikpɔŋ jeŋ shi kpamɔ
    gl: ciencias da Terra
    gv: Dowan-oaylleeaght
    ha: Earth science
    hak: Thi-khiù Khô-ho̍k
    he: מדעי כדור הארץ
    hr: geoznanosti
    hu: földtudomány
    hy: Երկրագիտություն
    ...
    kk: Жер туралы ғылымдар
    kn: ಭೂಶಾಸ್ತ್ರ
    ko: 지구과학
    kw: godhonieth an nor
    la: Scientia tellurica
    lb: Geowëssenschaften
    li: Aerdweitesjappe
    lt: Žemės mokslai
    lv: Zemes zinātne
    mag: पृथ्वी विज्ञान
    ...
    nn: geofag
    nov: Teral sienties
    nqo: ߘߎ߱ ߟߐ߲ߞߏ ߘߏ߫ ߟߎ߬
    oc: sciéncias de la Tèrra
    or: ଭୂବିଜ୍ଞାନ
    os: Зæххы тыххæй зонæдтæ
    pa: ਧਰਤੀ ਵਿਗਿਆਨ
    pl: nauki o Ziemi
    ps: ځمکپوهنې
    ...
    sa: भूगर्भशास्त्रम्
    sah: Сир үөрэхтэрэ
    sc: Iscièntzias de sa Terra
    scn: scienzi dâ terra
    sco: Yird science
    sd: ڌرتي سائنس
    se: geodiehtagat
    sgs: Muokslos api Žemė
    sh: Nauke o Zemlji
    shi: Timassanin n wakal
    sk: vedy o Zemi
    sl: veda o Zemlji
    smn: geotiettuuh
    sms: geotiõđ
    sq: shkencë e Tokës
    sr: науке о Земљи
    stq: Äidkunde af Geowietenskuppe
    su: Élmu bumi
    sv: geovetenskap
    sw: Sayansi za dunia
    ta: புவி அறிவியல்
    ...
    war: Siyensya han Kalibutan
    wo: Xam-xamu suuf si ak jawwu ji
    wuu: 地球科學
    xmf: დიხაუჩაშ მენცარობეფი
    yi: ערד וויסנשאפט
    yo: sáyẹ́nsì àgbáyé
    yue: 地球科學
    zh: 地球科學
