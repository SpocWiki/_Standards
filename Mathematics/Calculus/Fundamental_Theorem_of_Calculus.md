...
dv_has_:
  name_:
    ...
    ga: bunteoirim an chalcalais
    gl: teorema fundamental do cálculo
    ...
    kn: ಕಲನಶಾಸ್ತ್ರದ ಮೂಲಭೂತ ಪ್ರಮೇಯ
    ko: 미적분학의 기본 정리
    la: theorema fundamentale calculi
    lmo: teurema fundamentaal dal càlcül
    lzh: 微積分基本定理
    mag: कलनके मूलभूत प्रमेय
    mk: основна теорема на анализата
    ms: teorem asas kalkulus
    nan: Bî-chek-hun ê ki-pún tēng-lí
    nb: analysens fundamentalteorem
    ...
    sl: osnovni izrek infinitezimalnega računa
    sr: fundamentalna teorema računa
    sv: analysens fundamentalsats
    th: ทฤษฎีบทมูลฐานของแคลคูลัส
    tr: hesabın temel teoremi
    tt: Ньютон-Лейбниц формуласы
    uk: формула Ньютона — Лейбніца
    ur: حسابان کا بنیادی قضیہ
    vi: Định lý cơ bản của giải tích
    yue: 微積分基本定理
    zh: 微积分基本定理
---
