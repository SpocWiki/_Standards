...
- teorie dai insiemis
- teorie množin
- teorienn an teskadoù
- teorija množic
- teorija skupova
- teorija tas-settijiet
- teoriya ng hanay
- teorya nin set
- teorìa dj'ansem
...
dv_has_:
  name_:
    ...
    anp: समुच्चय सिद्धान्त
    ar: نظرية المجموعات
    ary: نظرية د لمجموعات
    as: সংহতি তত্ত্ব
    ast: teoría de conxuntos
    ...
    ce: дукхаллин теори
    ckb: تیۆریی کۆمەڵە
    crh: coqluqlar nazariyesi
    cs: teorie množin
    cv: нумайлăх теорийĕ
    cy: damcaniaeth setiau
    da: mængdelære
    de: Mengenlehre
    el: θεωρία συνόλων
    en: set theory
    ...
    kbp: kegbeɣlasi lɩmaɣzɩyɛ
    ki: thiori ya seti
    kk: жиындар теориясы
    kn: ಗಣ ಸಿದ್ಧಾಂತ
    ko: 집합론
    kw: damkanieth settys
    ky: көптүктөр теориясы
    la: theoria copiarum
    lb: Theorie vun den Ensemblen
    ...
    sk: teória množín
    sl: teorija množic
    sq: teoria e vendosur
    sr: теорија скупова
    sv: mängdteori
    sw: nadharia seti
    ta: கணக் கோட்பாடு
    tg: назарияи маҷмӯъаҳо
    th: ทฤษฎีเซต
    tk: köplükler we san köplükleri
    tl: teoriya ng hanay
    tr: kümeler kuramı
    tt: күплек теориясе
    udm: унолыко теори
    uk: теорія множин
    ur: نظریۂ طاقم
    uz: toʻplamlar nazariyasi
    vep: äjüziden teorii
    vi: lý thuyết tập hợp
    vls: verzoameliengeleer
    vo: konletateor
    vro: hulgateooria
    war: teyorya set
    wuu: 集合论
    xmf: მიარეეფიშ თეორია
    yi: סכומען טעאריע
    yue: 集合論
    zh: 集合论
    zh_hans: 集合论
