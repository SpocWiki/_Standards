...
> In mathematics, the gamma function (represented by Γ, capital Greek letter gamma) is the most common extension of the factorial function to complex numbers. Derived by Daniel Bernoulli, the gamma function Γ(z) is defined for all complex numbers z
...
>
> The gamma function has no zeros, so the reciprocal gamma function ⁠1/Γ(z)⁠ is an entire function. 
> In fact, the gamma function corresponds to 
> the Mellin transform of the negative exponential function:
