...
schematic: http://commons.wikimedia.org/wiki/Special:FilePath/Example%20for%20a%20composition%20of%20two%20functions.svg
Commons_category: Composition (mappings)
dv_has_:
  name_:
    am: ቅብብል
    ar: تركيب الدوال
    ast: función compuesta
    ...
    de: Komposition
    el: σύνθεση συνάρτησης
    en: function composition
    eo: funkcia komponaĵo
    es: composición de funciones
    et: liitfunktsioon
    eu: funtzio konposatu
    fa: ترکیب تابع
    fi: yhdistetty funktio
    fr: composition de fonctions
    gl: composición de funcións
    he: הרכבת פונקציות
    hi: फलनों का संयुक्तीकरण
    hr: kompozicija funkcija
    hu: függvénykompozíció
    hy: Ֆունկցիայի կոմպոզիցիա
    id: komposisi fungsi
    is: samsetning falla
    ...
    ko: 합성함수
    la: Compositio
    lb: Kompositioun (Mathematik)
    nb: funksjonskomposisjon
    nl: functiecompositie
    nn: funksjonssamansetjing
    pl: złożenie funkcji
    pt: composição de funções
    ro: compunerea funcțiilor
