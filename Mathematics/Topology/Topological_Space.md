...
dv_has_:
  name_:
    ...
    eu: espazio topologiko
    fa: فضای توپولوژیک
    fi: topologinen avaruus
    fr: espace topologique
    ga: spás toipeolaíoch
    gl: espazo topolóxico
    he: מרחב טופולוגי
    hr: topološki prostor
    hu: topologikus tér
    ia: spatio topologic
    id: ruang topologi
    io: Topologiala spaco
    it: spazio topologico
    ja: 位相空間
    ...
    lb: Topologesche Raum
    lt: topologinė erdvė
    lv: topoloģiska telpa
    lzh: 拓撲空間
