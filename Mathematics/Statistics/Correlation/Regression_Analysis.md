---
aliases:
- anailís ar chúlchéimniú
- analisi della regressione
- Analisis regresi
- Analisis régrèsi
- Analisis régrési
- analiza de regresie
- Analís de la regresión
...
Stack_Exchange_tag:
- https://stackoverflow.com/tags/regression
- https://stats.stackexchange.com/tags/regression
UNSPSC_Code: 81131503
UMLS_CUI: C0034980
MeSH_tree_code:
- E05.318.740.750
- N05.715.360.750.695
- N06.850.520.830.750
Commons_category: Regression analysis
dv_has_:
  name_:
    ar: تحليل الانحدار
    ...
    et: regressioonanalüüs
    eu: Erregresio-analisi
    fa: تحلیل رگرسیون
    fi: regressioanalyysi
    fr: régression
    ga: anailís ar chúlchéimniú
    gl: análise da regresión
    he: רגרסיה (סטטיסטיקה)
    hi: समाश्रयण विश्लेषण
    hu: regressziószámítás
    hy: ռեեգրեսիոն վերլուծություն
    id: Analisis regresi
    io: Regresal analizo
    is: Aðhvarfsgreining
    it: analisi della regressione
    ja: 回帰分析
    jv: Analisis régrèsi
    ko: 회귀 분석
    lt: regresinė analizė
    lv: Lineārās regresijas analīze
    mn: Регрессийн шинжилгээ
    nan: Hôe-kui hun-sek
    nb: regresjonsanalyse
    ...
    sl: regresijska analiza
    smn: regressioanalyys
    sms: regressioanalyys
    sr: регресиона анализа
    su: Analisis régrési
    sv: regressionsanalys
    tg: Таҳлили регрессия
    th: การวิเคราะห์การถดถอย
    tl: Regresyong analisis
...
#is_/same_as :: [[_Standards/WikiData/WD~Regression_analysis,208042|WD~Regression_analysis,208042]] 

## #has_/text_of_/abstract 

> In statistical modeling, regression analysis is a statistical method 
> for estimating the relationship between a dependent variable 
> (often called the outcome or response variable, or a label in machine learning parlance) 
> and one or more independent variables 
> (often called regressors, predictors, covariates, explanatory variables or features).
>
