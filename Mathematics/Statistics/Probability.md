...
Stack_Exchange_tag:
- https://stackoverflow.com/tags/probability
- https://math.stackexchange.com/tags/probability
- https://stats.stackexchange.com/tags/probability
...
dv_has_:
  name_:
    ...
    fr: probabilité
    frr: Woorskiinelkhaid
    ga: dóchúlacht
    gan: 機率
    gcr: Probabilité
    gl: probabilidade
    gsw: Woorschiinligkäit
    ha: Yiwuwar abu (Lissafi)
    he: הסתברות
    hi: प्रायिकता
    hif: anumaan
    hr: vjerojatnost
    ...
    tr: olasılık
    tt: ихтималлылык
    tum: Kusanda vya Mwaŵi
    udm: луонолыкъя теори
    uk: імовірність
    ur: احتمال
    uz: Ehtimollik
    vec: Probabiłità
