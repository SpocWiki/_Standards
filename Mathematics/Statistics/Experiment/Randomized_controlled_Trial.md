...
different_from:
- '[[_Standards/WikiData/WD~blind_experiment,608510|WD~blind_experiment,608510]]'
- '[[_Standards/WikiData/WD~randomized_controlled_trial,130616270|WD~randomized_controlled_trial,130616270]]'
partially_coincident_with:
- '[[_Standards/WikiData/WD~blind_experiment,608510|WD~blind_experiment,608510]]'
- '[[_Standards/WikiData/WD~single_blind_clinical_trial,108482620|WD~single_blind_clinical_trial,108482620]]'
- '[[_Standards/WikiData/WD~double_blind_clinical_trial,108483352|WD~double_blind_clinical_trial,108483352]]'
- '[[_Standards/WikiData/WD~triple_blind_clinical_trial,108483576|WD~triple_blind_clinical_trial,108483576]]'
- '[[_Standards/WikiData/WD~quadruple_blind_clinical_trial,108510128|WD~quadruple_blind_clinical_trial,108510128]]'
subclass_of:
- '[[_Standards/WikiData/WD~randomized_experiment,1231081|WD~randomized_experiment,1231081]]'
- '[[_Standards/WikiData/WD~scholarly_article,13442814|WD~scholarly_article,13442814]]'
- '[[_Standards/WikiData/WD~study_type,78088984|WD~study_type,78088984]]'
- '[[_Standards/WikiData/WD~controlled_trial,106489573|WD~controlled_trial,106489573]]'
- '[[_Standards/WikiData/WD~clinical_trial,30612|WD~clinical_trial,30612]]'
uses:
- '[[_Standards/WikiData/WD~control_group,2148398|WD~control_group,2148398]]'
- '[[_Standards/WikiData/WD~group_in_an_experiment,7836899|WD~group_in_an_experiment,7836899]]'
- '[[_Standards/WikiData/WD~treatment_group,106486532|WD~treatment_group,106486532]]'
MeSH_tree_code:
...
dv_has_:
  name_:
    ...
    cs: randomizovaná kontrolovaná studie
    da: randomiseret kontrolleret forsøg
    de: randomisierte kontrollierte Studie
    el: Τυχαιοποιημένη ελεγχόμενη δοκιμή
    en: randomized controlled trial
    eo: stokastigita kontrola studo
    es: prueba controlada aleatoria
    eu: Kontrolatutako saiakuntza ausazkotu
    fa: آزمایش تصادفی کنترلشده
    fi: satunnaistettu vertailukoe
    fr: essai randomisé contrôlé
    ga: triail rialaithe randamaithe
    gl: Estudo aleatorizado controlado
    he: ניסוי מבוקר בהקצאה אקראית
    hi: यादृच्छिक नियंत्रण परीक्षण
    hu: randomizált kontrollált vizsgálat
    id: uji acak terkendali
    it: studio controllato randomizzato
    ja: ランダム化比較試験
    kab: Arram amesguceṛ unɣid
    ko: 무작위 대조 시험
    lt: eksperimentiniai tyrimai
    nb: Randomisert kontrollert studie
    nl: gerandomiseerd onderzoek met controlegroep
    ...
    sv: Randomiserad kontrollerad studie
    th: การทดลองแบบสุ่มและมีกลุ่มควบคุม
    uk: рандомізоване контрольоване дослідження
    yue: 隨機對照試驗
    zh: 随机对照试验
---
