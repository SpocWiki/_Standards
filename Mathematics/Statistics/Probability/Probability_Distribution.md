...
- ихтималлылык бүленеше
- Пулаяслăхсен валеçĕвĕ
...
- N05.715.360.750.750
- N06.850.520.830.994
Commons_gallery: Probability distribution
Commons_category: Probability distributions
dv_has_:
  name_:
    ar: توزع احتمالي
    ...
    cv: Пулаяслăхсен валеçĕвĕ
    cy: dosbarthiad tebygolrwydd
    da: sandsynlighedsfordeling
    ...
    ga: dáileadh dóchúlachta
    gl: distribución de probabilidade
    he: התפלגות הסתברות
    hi: प्रायिकता बंटन
    hu: valószínűség-eloszlás
    hy: Հավանականության բաշխում
    id: Sebaran probabilitas
    io: Distributo di probableso
    ...
    tl: Distribusyong probabilidad
    tr: olasılık dağılımı
    tt: ихтималлылык бүленеше
