...
dv_has_:
  name_:
    ...
    kn: ಆಧುನಿಕ ಬೀಜಗಣಿತ
    ko: 추상대수학
    la: Algebra abstracta
    lt: abstrakčioji algebra
    lv: abstraktā algebra
    ml: അമൂർത്തബീജഗണിതം
    mn: Хийсвэр алгебр
    ms: algebra abstrak
    mt: alġebra astratta
    my: ခေတ်သစ်အက္ခရာသင်္ချာ
    nb: abstrakt algebra
    ...
    sco: abstract algebra
    se: abstrákta algebra
    sh: Apstraktna algebra
    si: වියුක්ත වීජ ගණිතය
    sk: abstraktná algebra
    sl: abstraktna algebra
    smn: abstraktlâš algebra
