...
Stack_Exchange_tag:
- https://math.stackexchange.com/tags/vector-spaces
- https://mathoverflow.net/tags/vector-spaces
IEV_number: 102-03-01
Commons_category: Vector spaces
dv_has_:
  name_:
    af: wektorruimte
    ar: فضاء متجهي
    ...
    ko: 벡터 공간
    ko-kp: 벡토르공간
    ky: вектордук мейкиндик
    la: spatium vectoriale
