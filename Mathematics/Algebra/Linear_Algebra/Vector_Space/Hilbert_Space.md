...
- https://mathoverflow.net/tags/hilbert-spaces
- https://physics.stackexchange.com/tags/hilbert-space
- https://quantumcomputing.stackexchange.com/tags/hilbert-space
Wolfram_Language_entity_code: Entity["Concept", "HilbertSpace::sd8xf"]
Commons_category: Hilbert space
dv_has_:
  name_:
    af: Hilbert-ruimte
    ar: فضاء هيلبرت
    ...
    et: Hilberti ruum
    eu: Hilberten espazio
    fa: فضای هیلبرت
    fi: Hilbertin avaruus
    fr: espace de Hilbert
    ga: spás Hilbert
    gl: espazo de Hilbert
    he: מרחב הילברט
    hu: Hilbert-tér
    hy: Հիլբերտյան տարածություն
    id: ruang Hilbert
    io: Spaco di Hilbert
    is: Hilbert-rúm
    ...
    ja: ヒルベルト空間
    ko: 힐베르트 공간
    ky: Гильберт мейкиндиги
    la: spatium hilbertianum
    lt: Hilberto erdvė
    lzh: 希爾伯特空間
    mk: Хилбертов простор
    mn: Хилбертийн орон зай
    ms: ruang Hilbert
    nb: Hilbertrom
    nl: Hilbertruimte
    nn: hilbertrom
...
#is_/same_as :: [[_Standards/WikiData/WD~Hilbert_space,190056|WD~Hilbert_space,190056]] 
...
> The inner product, which is the analog of the dot product from vector calculus, 
> allows lengths and angles to be defined. 
> Furthermore, completeness means that there are enough limits in the space 
> to allow the techniques of calculus to be used. 
> A Hilbert space is a special case of a [[Banach_Space]]. 
>
