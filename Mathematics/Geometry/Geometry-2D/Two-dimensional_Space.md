...
- 2次元
- 2차원
- ale pi nasin ante tu
- bidimensional
- bidimensionalità
- bidimentsional
- du-dimensia spaco
- Du-dimensionala spaco
...
- 二維
- 二维空间
has_id_wikidata: Q222032
has_part_s_: '[[_Standards/WikiData/WD~one_dimensional_space,208920|WD~one_dimensional_space,208920]]'
follows: '[[_Standards/WikiData/WD~one_dimensional_space,208920|WD~one_dimensional_space,208920]]'
subclass_of:
- '[[_Standards/WikiData/WD~space,472971|WD~space,472971]]'
- '[[_Standards/WikiData/WD~two_dimensional_object,118870638|WD~two_dimensional_object,118870638]]'
has_characteristic: '[[_Standards/WikiData/WD~dimension,4440864|WD~dimension,4440864]]'
partially_coincident_with:
- '[[_Standards/WikiData/WD~real_plane,105525603|WD~real_plane,105525603]]'
- '[[_Standards/WikiData/WD~plane,17285|WD~plane,17285]]'
different_from: '[[_Standards/WikiData/WD~2D,29023|WD~2D,29023]]'
part_of: '[[_Standards/WikiData/WD~three_dimensional_space,34929|WD~three_dimensional_space,34929]]'
followed_by: '[[_Standards/WikiData/WD~three_dimensional_space,34929|WD~three_dimensional_space,34929]]'
image: http://commons.wikimedia.org/wiki/Special:FilePath/2D%20Cartesian.svg
dv_has_:
  name_:
    ...
    cs: dvourozměrný prostor
    cv: икĕ виçеллĕ уçлăх
    cy: gofod dau ddimensiwn
    da: 2-D
    de: zweidimensionaler Raum
    el: δισδιάστατος χώρος
    en: two-dimensional space
    eo: du-dimensia spaco
    es: espacio bidimensional
    eu: bidimentsional
    fa: فضای دوبعدی
    fi: kaksiulotteisuus
    fr: espace à deux dimensions
    ga: spás déthoiseach
    gl: espazo bidimensional
    gsw: Zweidimensional
    he: מרחב דו-ממדי
    hi: द्वि-विम समष्टि
    hr: dvodimenzionalni prostor
    hu: kétdimenziós tér
    hy: երկչափ տարածություն
    id: ruang dua dimensi
    io: Du-dimensionala spaco
    it: bidimensionalità
    ja: 2次元
    kk: жазықтық
    ko: 2차원
    ...
    sco: twa-dimensional space
    sk: 2D
    sl: dvorazsežni prostor
    sq: plani
    sr: dvodimenzionalni prostor
    sv: 2D
    ta: ஈரளவு வெளி
    th: ปริภูมิสองมิติ
    tok: ale pi nasin ante tu
    tr: İki boyutlu uzay
    uk: двовимірний простір
    vec: 2D
    vi: không gian hai chiều
    xh: I-2D
    yue: 二維
    zh: 二维空间
---
...
> A two-dimensional space is a mathematical space with two dimensions, 
> meaning points have two degrees of freedom: 
> their locations can be locally described with two coordinates 
> or they can move in two independent directions. 
> 
