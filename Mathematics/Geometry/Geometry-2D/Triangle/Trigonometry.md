...
has_part_s_: '[[_Standards/WikiData/WD~trigonometric_table,787322|WD~trigonometric_table,787322]]'
has_use: '[[_Standards/WikiData/WD~uses_of_trigonometry,2858853|WD~uses_of_trigonometry,2858853]]'
history_of_topic: '[[_Standards/WikiData/WD~history_of_trigonometry,2344515|WD~history_of_trigonometry,2344515]]'
...
is_the_study_of:
- '[[_Standards/WikiData/WD~trigonometric_function,93344|WD~trigonometric_function,93344]]'
- '[[_Standards/WikiData/WD~unit_circle,203425|WD~unit_circle,203425]]'
Krugosvet_article: matematika/trigonometriya
maintained_by_WikiProject: '[[_Standards/WikiData/WD~WikiProject_Mathematics,8487137|WD~WikiProject_Mathematics,8487137]]'
OmegaWiki_Defined_Meaning: 351429
partially_coincident_with: '[[_Standards/WikiData/WD~triangle_geometry,1257470|WD~triangle_geometry,1257470]]'
Stack_Exchange_tag:
...
Wikimedia_outline: '[[_Standards/WikiData/WD~outline_of_trigonometry,7112803|WD~outline_of_trigonometry,7112803]]'
dv_has_:
  name_:
    af: driehoeksmeting
    am: ትሪጎኖሜትሪ
    ...
    ka: ტრიგონომეტრია
    kaa: trigonometriya
    kbp: kɔlɔmɩŋ naadozo tʊ pilinzi mazʊʊ
    kk: тригонометрия
    km: ត្រីកោណមាត្រ
    ko: 삼각법
    ku: sêgoşezanî
...
> **Trigonometry** (Ancient Greek  τρίγωνον (trígōnon) 'triangle' and  μέτρον (métron) 'measure') 
> is a branch of mathematics concerned with 
> relationships between angles and side lengths of triangles. 
> 
> In particular, the trigonometric functions relate the angles of a right triangle 
> with ratios of its side lengths. 
...
> while mathematicians in India created the earliest-known tables of values for trigonometric ratios 
...
> These trigonometric identities are commonly used 
