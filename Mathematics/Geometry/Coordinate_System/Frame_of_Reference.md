...
dv_has_:
  name_:
    ...
    bho: परसंग परनाली
    bn: প্রসঙ্গ কাঠামো
    ca: sistema de referència
    ckb: چوارچێوەی ئاماژەپێدان
    cs: vztažná soustava
    cv: Пуçлав тытăмĕ
    cy: ffrâm gyfeirio
    da: henførelsessystem
    de: Bezugssystem
    ...
    fa: چارچوب مرجع
    fi: vertausjärjestelmä
    fr: référentiel
    ga: fráma tagartha
    gl: sistema de referencia
    gsw: Bezugssystem
    gu: નિર્દેશ ફ્રેમ
    he: מערכת ייחוס
    hi: निर्देश तंत्र
    hr: Referentni sustav
    hu: vonatkoztatási rendszer
    hy: Հաշվարկման համակարգ
    hyw: Համակարգ (բնագիտութիւն)
    id: Kerangka acuan
    io: Referosistemo
    ...
    nl: referentiekader
    nn: referansesystem
    pl: układ odniesienia
    pt: referencial
    ro: sistem de referință
    ru: система отсчёта
    scn: sistema di rifirimentu
    sh: Referentni okvir
    sk: Vzťažná sústava
    sl: opazovalni sistem
    sq: Sistemi i referimit
    sr: референтни систем
    sv: referenssystem
    th: กรอบอ้างอิง
    tr: gözlemci çerçevesi
    uk: система відліку
    vi: hệ quy chiếu
    wuu: 参考系
    yue: 參考系
