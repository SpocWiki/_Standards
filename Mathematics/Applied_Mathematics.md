...
- applee'd mathematics
- Applied Mathematics
- Applied_Mathematics
- bruksmatematikk
- heimfærð stærðfræði
- heivehuvvon matematihkka
- heiviittum matematiik
- lietišķā matemātika
...
- '[[_Standards/WikiData/WD~actuarial_science,1128453|WD~actuarial_science,1128453]]'
- '[[_Standards/WikiData/WD~cryptology,1430062|WD~cryptology,1430062]]'
- '[[_Standards/WikiData/WD~mathematical_psychology,1908389|WD~mathematical_psychology,1908389]]'
- '[[_Standards/WikiData/WD~engineering_mathematics,2235851|WD~engineering_mathematics,2235851]]'
- '[[_Standards/WikiData/WD~theoretical_biology,2419229|WD~theoretical_biology,2419229]]'
- '[[_Standards/WikiData/WD~control_theory,6501221|WD~control_theory,6501221]]'
- '[[_Standards/WikiData/WD~numerical_analysis,11216|WD~numerical_analysis,11216]]'
opposite_of: '[[_Standards/WikiData/WD~pure_mathematics,837863|WD~pure_mathematics,837863]]'
instance_of:
- '[[_Standards/WikiData/WD~academic_major,4671286|WD~academic_major,4671286]]'
- '[[_Standards/WikiData/WD~academic_discipline,11862829|WD~academic_discipline,11862829]]'
topic_s_main_template: '[[_Standards/WikiData/WD~Template_Industrial_and_applied_mathematics,6681889|WD~Template_Industrial_and_applied_mathematics,6681889]]'
practiced_by: '[[_Standards/WikiData/WD~applied_mathematician,102038373|WD~applied_mathematician,102038373]]'
subclass_of: '[[_Standards/WikiData/WD~mathematics,395|WD~mathematics,395]]'
Dewey_Decimal_Classification: 519
All_Science_Journal_Classification_Codes: 2604
U_S_National_Archives_Identifier: 10636859
OmegaWiki_Defined_Meaning: 662575
related_image: http://commons.wikimedia.org/wiki/Special:FilePath/Vehicle%20Routing%20Problem%20Example.svg
Classification_of_Instructional_Programs_code:
- 27.03
- 27.0301
Basisklassifikation: 31.80
P8189: 987007556367205171
Commons_category: Applied mathematics
dv_has_:
  name_:
    af: toegepaste wiskunde
    ar: رياضيات تطبيقية
    ast: matemátiques aplicaes
    ...
    cv: маякилтерĕш математика
    cy: mathemateg gymhwysol
    ...
    eu: matematika aplikatuak
    fa: ریاضیات کاربردی
    fi: sovellettu matematiikka
    fr: mathématiques appliquées
    ga: matamaitic fheidhmeach
    gl: matemática aplicada
    he: מתמטיקה שימושית
    hi: व्यावहारिक गणित
    hr: primijenjena matematika
    ht: matematik aplike
    hu: alkalmazott matematika
    hy: կիրառական մաթեմատիկա
    ia: mathematica applicate
    id: matematika terapan
    io: aplikita matematiko
    is: heimfærð stærðfræði
    it: matematica applicata
    ja: 応用数学
    jv: matématika terapan
    ka: გამოყენებითი მათემატიკა
    kk: қолданбалы математика
    ko: 응용수학
    la: mathematica adhibita
    lfn: matematica aplicada
    lt: taikomoji matematika
    lv: lietišķā matemātika
    mk: применета математика
    ml: പ്രയോഗ ഗണിതം
    ...
    sco: applee'd mathematics
    sd: عملي رياضي
    se: heivehuvvon matematihkka
    sh: primenjena matematika
    shi: tusnakt tisnsit
    sk: aplikovaná matematika
    sl: uporabna matematika
    smn: heiviittum matematiik
    ...
    tr: uygulamalı matematik
    tt: гамәли математика
    uk: прикладна математика
    ur: اطلاقی ریاضیات
    vec: matemàtega aplicada
...
> physics, engineering, medicine, biology, finance, business, computer science, and industry. 
> 
> Thus, applied mathematics is a combination of mathematical science and specialized knowledge. 
> The term "applied mathematics" also describes the professional specialty in which 
> mathematicians work on practical problems by formulating and studying mathematical models.
>
...
> 
> The activity of applied mathematics is thus 
> intimately connected with research in pure mathematics.
>
