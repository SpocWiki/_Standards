...
dv_has_:
  name_:
    ...
    ckb: پێوەری ژمارە زانین
    cs: modulární aritmetika
    da: modulær aritmetik
    ...
    eu: kongruentzia
    fa: همنهشتی (نظریه اعداد)
    fi: modulaarinen aritmetiikka
    fr: arithmétique modulaire
    gl: aritmética modular
    he: חשבון מודולרי
    hi: मॉड्युलर गणित
    hr: modularna aritmetika
    hu: moduláris aritmetika
    hy: Մոդուլար հանրահաշիվ
    id: aritmetika modular
    io: kongruo
    is: mátreikningur
    ...
    ko: 모듈러 산술
    la: congruentia
    lmo: aritmetega modulara
    ml: മോഡ്യുലർ അങ്കഗണിതം
    nb: modulær aritmetikk
    nl: modulair rekenen
    ...
    sk: modulárna aritmetika
    sl: kongruenca
    sq: Aritmetika modulare
    sr: модуларна аритметика
    sv: modulär aritmetik
    ta: சமானம், மாடுலோ n
    th: เลขคณิตมอดุลาร์
    tr: modüler aritmetik
...
#is_/same_as :: [[_Standards/WikiData/WD~Modular_arithmetic,319400|WD~Modular_arithmetic,319400]] 
