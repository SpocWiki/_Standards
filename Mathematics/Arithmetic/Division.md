...
Unicode_character: ➗
IEV_number: 102-01-21
Iconclass_notation: 49D124
Commons_category: Division (mathematics)
dv_has_:
  name_:
    af: deling
    an: división
    ...
    fo: brot
    fr: division
    frr: Dialen (Matematiik)
    gan: 除法
    gcr: divizyon
    gd: roinn
    gl: división
    gsw: Division (Mathematik)
    hak: chhù-fap
    he: חילוק
    hi: भाग
    hif: baatna
