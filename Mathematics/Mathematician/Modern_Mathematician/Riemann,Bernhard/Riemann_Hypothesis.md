...
Stack_Exchange_tag:
- https://math.stackexchange.com/tags/riemann-hypothesis
- https://mathoverflow.net/tags/riemann-hypothesis
Commons_category: Riemann hypothesis
dv_has_:
  name_:
    ar: فرضية ريمان
    ...
    gl: Hipótese de Riemann
    he: השערת רימן
    hi: रीमान हैपोथिसिस
    ht: Ipotèz Riemann
    hu: Riemann-sejtés
    id: Hipotesis Riemann
    it: ipotesi di Riemann
    ja: リーマン予想
    kk: Риман гипотезасы
    ko: 리만 가설
    la: Hypothesis Riemanniana
    lt: Rymano hipotezė
    lv: Rīmaņa hipotēze
    mk: Риманова хипотеза
    mn: Риманы таамаглал
    ms: Hipotesis Riemann
    nb: Riemann-hypotesen
    ne: रिएमन्न हाइपोथेसिस
...
> In mathematics, the Riemann hypothesis is the conjecture that 
> the Riemann zeta function has its zeros only 
...
> It is of great interest in number theory 
> because it implies results about the distribution of prime numbers. 
