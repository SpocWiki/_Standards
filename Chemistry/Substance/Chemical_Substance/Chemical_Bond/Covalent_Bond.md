...
has_part_s_: '[[_Standards/WikiData/WD~Bonding_electron,863666|WD~Bonding_electron,863666]]'
...
dv_has_:
  name_:
    ...
    ga: nasc comhfhiúsach
    gl: enlace covalente
    gv: Nastey co-ioosagh
    he: קשר קוולנטי
    hi: सहसंयोजी आबंध
    hr: Kovalentna veza
    ht: Lyezon kovalan
    ...
    skr: شریک گرفتہ بند
    sl: kovalentna vez
    smn: kovalentlâš čoonâs
    sms: kovaleentlaž čõõnâs
    ...
    th: พันธะโคเวเลนต์
    tr: Kovalent bağ
    tt: Ковалент бәйләнеш
    udm: ковалентлыко хими герӟос
    uk: ковалентний зв’язок
    ur: کوویلنٹ بونڈ
    uz: Kovalent va ion bogʻlanish
    vi: liên kết cộng hóa trị
    wuu: 共价键
    xmf: კოვალენტური ბუნაფა
    yi: קאוואלנטער בונד
