...
dv_has_:
  name_:
    ...
    fj: veiwekani kemikali
    fr: liaison chimique
    ga: nasc ceimiceach
    gcr: lyèzon chimik
    gl: enlace químico
    gv: kiangley kemmigagh
    he: קשר כימי
    hi: रासायनिक बन्धन
    hr: kemijska veza
    ht: lyezon chimik
    ...
    mr: रासायनिक बंध
    ms: Ikatan kimia
    nan: hoà-ha̍k kiat-ha̍p
    nb: kjemisk binding
    nds: Cheemsch Binnen
    nl: chemische binding
    nn: kjemisk binding
    oc: ligam quimic
    om: hidhoo keemikaalaa
    pa: ਰਸਾਇਣਕ ਜੋੜ
    ...
    si: රසායනික බන්ධන
    sk: chemická väzba
    skr: کیمیکل بانڈ کیا ہے ؟
    sl: kemijska vez
    smn: kemiallâš čoonâs
