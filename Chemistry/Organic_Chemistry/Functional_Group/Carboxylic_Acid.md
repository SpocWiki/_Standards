...
- asid carbocsylig
- asid karboksilik
- asidong karboksiliko
- azeffar akaṛbuksilin
- azido karboxiliko
- Carbonsäuren
- carbonzuur
- Carboxylic Acid
...
dv_is_:
  same_as:
    ...
    - "[[/_protect/Chemistry/Organic_Chemistry/Carboxylic_Acid.protect|Carboxylic_Acid.protect]]"
...
dv_has_:
  ...
  name_:
    ...
    ml: കാർബോക്സിലിക് ആസിഡ്
    ms: asid karboksilik
    nb: karboksylsyre
    nl: carbonzuur
    nn: karboksylsyre
    oc: acid carboxilic
    pa: ਕਾਰਬੌਕਸਿਲੀ ਤਿਜ਼ਾਬ
    pl: kwas karboksylowy
    pnb: کاربوکسلک تیزاب
    pt: ácido carboxílico
    ro: acid carboxilic
    ru: карбоновые кислоты
    sh: karboksilna kiselina
    si: කාබොක්සිලික් අම්ලය
    ...
    te: కార్బోక్సిలిక్ ఆమ్లం
    th: กรดคาร์บอกซิลิก
    tr: karboksilik asit
    udm: карбон чырсалъёс
    uk: карбонові кислоти
    uz: karbon kislotalar
    vec: àsido carbosìłego
    vi: acid carboxylic
    war: carboxylic acid
    wuu: 羧酸
    yue: 羧酸
