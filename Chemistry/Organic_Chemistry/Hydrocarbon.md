...
dv_has_:
  name_:
    ...
    ms: hidrokarbon
    my: ဟိုက်ဒရိုကာဘွန်
    nan: Thòaⁿ-hòa chúi-sò͘
    nb: hydrokarbon
    ne: हाइड्रोकार्बन
    nl: koolwaterstof
    nn: hydrokarbon
    oc: idrocarbur
    om: haayidirookaarboonii
    os: æвзалыдонгуыртæ
    pa: ਹਾਈਡਰੋਕਾਰਬਨ
    pl: węglowodór
    pnb: ہائیڈروکاربن
...
> 
> Hydrocarbons are generally colourless and hydrophobic; 
> their odor is usually faint, and may be similar to that of gasoline or lighter fluid. They occur in a diverse range of molecular structures and phases: they can be gases (such as methane and propane), liquids (such as hexane and benzene), low melting solids (such as paraffin wax and naphthalene) or polymers (such as polyethylene and polystyrene).
>
