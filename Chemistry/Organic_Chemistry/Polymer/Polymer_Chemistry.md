...
- polimerkemio
- polimerkémia
- Polimerlar kimyosi fanining yaratilish tarixi
- Polimerlər kimyası
- Polimeroen kimika
- Polimerų chemija
- polymeerchemie
...
dv_has_:
  name_:
    ...
    ja: 高分子化学
    jv: Kimia polimer
    ka: პოლიმერების ქიმია
    ko: 고분자화학
    la: Chemia polymerica
    lt: Polimerų chemija
    ml: പോളിമർ കെമിസ്ട്രി
    ms: Kimia polimer
    nan: Ko-hun-chú hoà-ha̍k
    nb: polymerkjemi
    nl: polymeerchemie
    ...
    se: polymerakemiija
    sh: Hemija polimera
    sk: makromolekulová chémia
    sl: kemija polimerov
    smn: polymeerkemia
    sms: polymeeʹrkemia
    sq: Kimia makromolekulare
    sr: Hemija polimera
    sv: polymerkemi
    ta: பலபடி வேதியியல் chemistry
    th: เคมีพอลิเมอร์
    tr: Polimer kimyası
    tt: полимерлар химиясе
    uk: хімія полімерів
    uz: Polimerlar kimyosi fanining yaratilish tarixi
    vi: hóa học polymer
    wuu: 高分子化学
