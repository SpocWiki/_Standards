...
- Innkirtlakerfi
- kevreyth endokrin
- Losmeo cabros qls del segundomedi oa
- Lāi-hun-pì hē-thóng
- Mfumo wa homoni
...
dv_has_:
  name_:
    af: Endokriene stelsel
    an: Sistema endocrino
    ar: جهاز الغدد الصماء
    arn: Losmeo cabros qls del segundomedi oa
    as: অন্তঃস্ৰাৱী তন্ত্ৰ
    ast: Sistema endocrín
    av: Эндокринаб система
    az: Endokrin sistemi
    ba: Эндокрин система
    ...
    bs: Endokrini sistem
    ca: sistema endocrí
    ce: ЧуӀийдаргийн къеп
    ckb: کۆئەندامی کوێرەڕژێنە
    crh: endokrin sisteması
    cs: soustava žláz s vnitřní sekrecí
    cy: System endocrinaidd
    da: endokrine system
    de: Hormonsystem
    diq: Sistemê endokrini
    dv: އެންޑަކްރިން ނިޒާމް
    ...
    ga: córas inchríneach
    gl: sistema endócrino
    gsw: Hormonsystem
    he: המערכת האנדוקרינית
    hi: अंतःस्रावी तंत्र
    hif: Endocrine system
    hr: endokrini sustav
    hu: endokrin rendszer
    hy: Ներզատական համակարգ
    ia: Systema Endocrina
    id: Sistem endokrin
    ilo: sistema ti endokrina
    is: Innkirtlakerfi
    ...
    ko: 내분비계
    ku: Sîstema hormonan
    kw: kevreyth endokrin
    ky: эндокрин тутуму
    la: systema endocrinum
    lb: Hormonsystem
    li: Endocrien systeem
    lt: endokrininė sistema
    lv: endokrīnā sistēma
    mk: Ендокрин систем
    ml: അന്തഃസ്രാവീ വ്യൂഹം
    ms: Sistem endokrin
    mt: Sistema endokrinali
    my: အင်ဒိုခရိုင်း စနစ်
    nan: Lāi-hun-pì hē-thóng
    nb: det endokrine system
    nds: Hormoonsysteem
    new: इन्दोक्राइन सिस्तम
    nl: endocrien systeem
    nn: hormonsystem
    oc: Sistèma endocrin
    pa: ਐਂਡੋਕਰਾਈਨ ਪ੍ਰਬੰਧ
    pam: Endocrine system
    pl: układ hormonalny
    pms: Sistema endòcrin
    pnb: اینڈوکرائن پربندھ
    pt: sistema endócrino
    qu: Ukhuman sapachaq ch'añan
    rki: အင်ဒိုခရိုင်း စနစ်
    ro: Sistem endocrin
    ru: эндокринная система
    rue: Ендокрінна сістема
    sa: मेदोजीरकग्रन्थिः
    sah: Эндокрин система
    sd: اينڊوڪرائن نظام
    sgs: Enduokrėnėnė sėstema
    sh: Endokrini sistem
...
### #is_/same_as :: [[/_Standards/Chemistry/Organic_Chemistry/Biochemistry/Hormone/Endocrine_System|Endocrine_System]] 

### #is_/same_as :: [[/_public/Chemistry/Organic_Chemistry/Biochemistry/Hormone/Endocrine_System.public|Endocrine_System.public]] 

### #is_/same_as :: [[/_internal/Chemistry/Organic_Chemistry/Biochemistry/Hormone/Endocrine_System.internal|Endocrine_System.internal]] 

### #is_/same_as :: [[/_protect/Chemistry/Organic_Chemistry/Biochemistry/Hormone/Endocrine_System.protect|Endocrine_System.protect]] 

### #is_/same_as :: [[/_private/Chemistry/Organic_Chemistry/Biochemistry/Hormone/Endocrine_System.private|Endocrine_System.private]] 

### #is_/same_as :: [[/_personal/Chemistry/Organic_Chemistry/Biochemistry/Hormone/Endocrine_System.personal|Endocrine_System.personal]] 

### #is_/same_as :: [[/_secret/Chemistry/Organic_Chemistry/Biochemistry/Hormone/Endocrine_System.secret|Endocrine_System.secret]] 
