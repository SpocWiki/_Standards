...
dv_has_:
  name_:
    ...
    et: vesinikfluoriidhape
    eu: azido fluorhidriko
    fa: هیدروفلوئوریک اسید
    fi: fluorivetyhappo
    fr: acide fluorhydrique
    frr: Fluorweederstoofsüren
    ga: aigéad hidreafluarach
    gv: geayrag hiddrafluoragh
    he: חומצה הידרופלואורית
    hi: हाइड्रोफ्लोरिक अम्ल
    hr: fluorovodična kiselina
    hu: folysav
    hy: Ֆտորաջրածնական թթու
    id: asam fluorida
    it: acido fluoridrico
    ja: フッ化水素酸
    ka: ფთორწყალბადმჟავა
    kk: балқытқыш қышқыл
    kn: ಹೈಡ್ರೊಫ್ಲೋರಿಕ್ ಆಮ್ಲ
    ko: 플루오린화 수소산
    lt: Vandenilio fluorido rūgštis
    lv: fluorūdeņražskābe
    mk: флуороводородна киселина
    ...
    pnb: ہائیڈروفلورک ایسڈ
    pt: ácido fluorídrico
    ro: acid fluorhidric
    ru: плавиковая кислота
    sco: hydrofluoric acid
    sh: fluorovodonička kiselina
    ...
    th: กรดไฮโดรฟลูออริก
    tr: hidroflorik asit
    uk: плавикова кислота
    uz: ftorid kislota
    vi: axit flohydric
    war: aksido hidrofluorico
    wuu: 氢氟酸
    yue: 氫氟酸
    zh: 氢氟酸
    zh_cn: 氢氟酸
