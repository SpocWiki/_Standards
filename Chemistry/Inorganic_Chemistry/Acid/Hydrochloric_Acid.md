...
pKa: -6.3
vapor_pressure: 190
electric_dipole_moment: 1.109
ionization_energy: 12.75
mass: 54.47
OmegaWiki_Defined_Meaning: 1820
ZVG_number: 520030
E_number: E507
CAS_Registry_Number: 7647-01-0
RTECS_number: MW4025000
UNII: QTT17582CB
spoken_text_audio: http://commons.wikimedia.org/wiki/Special:FilePath/Hydrochloric%20acid.ogg
image: http://commons.wikimedia.org/wiki/Special:FilePath/Hydrochloric%20acid%2005.jpg
UNSPSC_Code: 12352323
...
dv_has_:
  name_:
    ...
    he: חומצת מימן כלורי
    hi: हाइड्रोक्लोरिक अम्ल
    hr: klorovodična kiselina
    hu: sósav
    hy: աղաթթու
    ia: Acido chlorhydric
    id: asam klorida
    is: Saltsýra
    it: acido cloridrico
    ja: 塩酸
    ...
    mn: Давсны хүчил
    mr: हायड्रोक्लोरिक आम्ल
    ms: Asid hidroklorik
    my: ဟိုက်ဒရိုကလောရစ်အက်ဆစ်
    nan: Iâm-sng
    nb: Saltsyre
    nds: Chlorwaterstoff
    nl: zoutzuur
    ...
    su: Asam klorida
    sv: saltsyra
    sw: Asidi ya haidrokloriki
    ta: ஐதரோகுளோரிக் காடி
    te: హైడ్రోక్లోరిక్ ఆమ్లం
    th: กรดไฮโดรคลอริก
    tr: hidroklorik asit
    uk: хлоридна кислота
    uz: Xlorid kislota
    vi: acid hydrochloric
...
> Hydrochloric acid, also known as muriatic acid or spirits of salt, 
> is an aqueous solution of hydrogen chloride (HCl). 
> 
> It is a colorless solution with a distinctive pungent smell. 
