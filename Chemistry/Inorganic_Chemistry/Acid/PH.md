...
dv_is_:
  ...
  - '[[/_protect/Chemistry/Inorganic_Chemistry/Acid/PH.protect|PH.protect]]'
...
dv_has_:
  name_:
    anp: पीएच मान
    ar: أس هيدروجيني
    az: Hidrogen göstəricisi
    be: Вадародны паказчык
    be_tarask: узровень кісьліннасьці
    ...
    te: pH
    th: พีเอช
    udm: водород возьматэт
    ur: پی ایچ (کیمیاء)
    wa: Potentiel idrodjinne
    wuu: pH值
    zh: 氢离子浓度指数
aliases:
- happamuus
...
#is_/same_as :: [[_Standards/WikiData/WD~PH,40936|WD~PH,40936]] 
