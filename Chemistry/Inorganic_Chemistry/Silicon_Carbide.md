...
dv_has_:
  name_:
    ...
    ga: cairbíd sileacain
    he: צורן קרביד
    hi: सिलिकन कार्बाइड
    hr: Silicijev karbid
    hu: szilícium-karbid
    hy: Սիլիցիումի կարբիդ
    id: Silikon karbida
    it: Carburo di silicio
    ja: 炭化ケイ素
    kk: Карборунд
    kn: ಸಿಲಿಕಾನ್ ಕಾರ್ಬೈಡ್
    ko: 탄화 규소
    ky: Кремний карбиди
    mk: силициум карбид
    ml: സിലിക്കൺ കാർബൈഡ്
    ...
    nl: siliciumcarbide
    pl: węglik krzemu
    pt: carbeto de silício
    ro: Carbură de siliciu
    ru: карбид кремния
    sh: Silicijum karbid
    sk: Karbid kremíka
    sl: silicijev karbid
