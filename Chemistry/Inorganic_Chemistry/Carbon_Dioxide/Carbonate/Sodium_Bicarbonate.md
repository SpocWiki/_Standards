...
- '[[_Standards/WikiData/WD~abrasive,372301|WD~abrasive,372301]]'
...
- '[[_Standards/WikiData/WD~buffering_agent,2826769|WD~buffering_agent,2826769]]'
- '[[_Standards/WikiData/WD~soda_blasting,7553210|WD~soda_blasting,7553210]]'
- '[[_Standards/WikiData/WD~intravenous_sodium_bicarbonate,17147112|WD~intravenous_sodium_bicarbonate,17147112]]'
...
- '[[_Standards/WikiData/WD~renal_tubular_acidosis,1516211|WD~renal_tubular_acidosis,1516211]]'
has_part_s_:
- '[[_Standards/WikiData/WD~bicarbonate_ion,409202|WD~bicarbonate_ion,409202]]'
...
subclass_of:
- '[[_Standards/WikiData/WD~acid_salt,622311|WD~acid_salt,622311]]'
- '[[_Standards/WikiData/WD~sodium_salt,1508568|WD~sodium_salt,1508568]]'
- '[[_Standards/WikiData/WD~bicarbonate,56810858|WD~bicarbonate,56810858]]'
...
mass: 83.982338
different_from: '[[_Standards/WikiData/WD~baking_powder,29476|WD~baking_powder,29476]]'
...
- B05XA02
- B05CB04
image: http://commons.wikimedia.org/wiki/Special:FilePath/Sodium%20bicarbonate.jpg
chemical_structure: http://commons.wikimedia.org/wiki/Special:FilePath/SodiumBicarbonate.png
WordLift_URL: http://data.wordlift.io/wl01714/entity/baking-soda.html
CAS_Registry_Number: 144-55-8
EC_number: 205-633-8
Reaxys_registry_number: 4153970
Amazon_com_browse_node: 6492289011
MedlinePlus_drug_identifier: a682001
canonical_SMILES: C(=O)(O)[O-].[Na+]
UMLS_CUI: C0074722
MeSH_tree_code:
...
dv_has_:
  name_:
    af: Natriumbikarbonaat
    ar: بيكربونات الصوديوم
    as: বেকিং ছ’ডা
    ast: Bicarbonatu de sodiu
    ...
    hu: nátrium-hidrogén-karbonát
    hy: Սոդա
    ia: Bicarbonato de Sodium
    ...
    jv: Soda kuwé
    kk: Ас содасы
    kn: ಸೋಡಿಯಂ ಬೈ ಕಾರ್ಬೋನೇಟ್
    ko: 탄산수소 나트륨
    ky: Натрий карбонаты
    lt: natrio hidrokarbonatas
    lv: nātrija hidrogēnkarbonāts
    lzh: 碳酸氫鈉
    mi: pēkana houra
    mk: натриум бикарбонат
    ml: സോഡിയം ബൈകാർബണേറ്റ്
    mr: सोडा
    ms: Natrium bikarbonat
    nan: Thoàⁿ-sng chúi-sò͘ natrium
    nb: natron
    nl: natriumwaterstofcarbonaat
    nn: natriumhydrogenkarbonat
    oc: Idrogenocarbonat de sòdi
    or: ସୋଡ଼ିଅମ ବାଇକାର୍ବୋନେଟ
    pa: ਮਿੱਠਾ ਸੋਡਾ
    ...
    sco: sodium bicarbonate
    sh: Natrijum hidrogenkarbonat
    si: සෝඩියම් බයිකාබනේට්
    sk: Hydrogenuhličitan sodný
    sl: natrijev hidrogenkarbonat
    ...
    sw: Magadi
    ta: சமையல் சோடா
    te: సోడియం బైకార్బొనేట్
    th: โซเดียมไบคาร์บอเนต
    tl: sodium bicarbonate
    tr: sodyum bikarbonat
    uk: гідрокарбонат натрію
    ur: میٹھا سوڈا
    vi: natri bicacbonat
    war: Sodium bicarbonate
    wuu: 碳酸氢钠
    yue: 梳打粉
    zh: 碳酸氢钠
    zh_cn: 碳酸氢钠
...
> Sodium bicarbonate (IUPAC name: sodium hydrogencarbonate), 
...
> although it is more commonly found as a component of the mineral trona.
>
> As it has long been known and widely used, the salt has many different names 
> such as baking soda, bread soda, cooking soda, brewing soda and bicarbonate of soda 
> and can often be found near baking powder in stores. 
> 
> The term baking soda is more common in the United States, 
> while bicarbonate of soda is more common in Australia, 
> the United Kingdom, and New Zealand. 
> 
> Abbreviated colloquial forms such as 
> sodium bicarb, bicarb soda, bicarbonate, and bicarb are common.
>
...
> 
> The modern chemical formulas of these compounds 
> now express their precise chemical compositions 
> which were unknown when the name bi-carbonate of potash was coined (see also: bicarbonate).
>
...
### #is_/same_as :: [[/_Standards/Chemistry/Inorganic_Chemistry/Carbon_Dioxide/Carbonate/Sodium_Bicarbonate|Sodium_Bicarbonate]] 

### #is_/same_as :: [[/_public/Chemistry/Inorganic_Chemistry/Carbon_Dioxide/Carbonate/Sodium_Bicarbonate.public|Sodium_Bicarbonate.public]] 

### #is_/same_as :: [[/_internal/Chemistry/Inorganic_Chemistry/Carbon_Dioxide/Carbonate/Sodium_Bicarbonate.internal|Sodium_Bicarbonate.internal]] 

### #is_/same_as :: [[/_protect/Chemistry/Inorganic_Chemistry/Carbon_Dioxide/Carbonate/Sodium_Bicarbonate.protect|Sodium_Bicarbonate.protect]] 

### #is_/same_as :: [[/_private/Chemistry/Inorganic_Chemistry/Carbon_Dioxide/Carbonate/Sodium_Bicarbonate.private|Sodium_Bicarbonate.private]] 

### #is_/same_as :: [[/_personal/Chemistry/Inorganic_Chemistry/Carbon_Dioxide/Carbonate/Sodium_Bicarbonate.personal|Sodium_Bicarbonate.personal]] 

### #is_/same_as :: [[/_secret/Chemistry/Inorganic_Chemistry/Carbon_Dioxide/Carbonate/Sodium_Bicarbonate.secret|Sodium_Bicarbonate.secret]] 
