...
- D01.200.275.150.150
- D01.578.200
DSSTOX_compound_identifier: DTXCID1016238
...
- 15
solubility: 0.001
defined_daily_dose: 3
pKa: 9
refractive_index: 1.6
density:
- 2.7
- 2.95
median_lethal_dose_LD50_: 6450
decomposition_point:
- 825
- 1517
- 2442
...
image_of_molecular_model_or_crystal_lattice_model: http://commons.wikimedia.org/wiki/Special:FilePath/Calcium-carbonate-xtal-3D-SF.png
image: http://commons.wikimedia.org/wiki/Special:FilePath/Calcium%20carbonate.jpg
chemical_structure: http://commons.wikimedia.org/wiki/Special:FilePath/Calcium%20carbonate.png
EC_number: 207-439-9
CAS_Registry_Number: 471-34-1
P2167: 51171501
ATC_code:
- A02AC01
- A12AA04
MedlinePlus_drug_identifier: a601032
...
dv_has_:
  ...
  name_:
    ...
    frr: Kaltsiumkarbonaat
    ga: carbónáit chailciam
    gl: Carbonato de calcio
    gv: carbonaid chelkium
    he: gal blech
    hi: कैल्सियम कार्बोनेट
    hr: kalcijev karbonat
    hu: kalcium-karbonát
    hy: Կալցիումի կարբոնատ
    id: calsium carbonat
    is: Kalsíumkarbónat
    it: carbonato di calcio
    ja: 炭酸カルシウム
    jv: Kalsium karbonat
    kk: Кальций корбанаты
    kk-kz: кальций карбонаты
    ko: 탄산 칼슘
    ky: Кальций карбонаты
    la: Carbonatum calcii
    lt: kalcio karbonatas
    lv: kalcija karbonāts
    lzh: 碳酸鈣
    mi: konupūmā pākawa waro
    mk: калциум карбонат
    ml: ചുണ്ണാമ്പ്
    ...
    sco: calcium carbonate
    sd: ڪيلشيئم ڪاربونيٽ
    sh: Kalcijum karbonat
    si: කැල්සියම් කාබනේට්
    sk: uhličitan vápenatý
    sl: kalcijev karbonat
    sms: kalsiumkarbonatt
    sr: калцијум карбонат
    sv: kalciumkarbonat
    ta: கால்சியம் கார்பனேட்
    th: แคลเซียมคาร์บอเนต
    tr: Kalsiyum Karbonat
    uk: карбонат кальцію
    ur: کیلشیم کاربنیٹ
    uz: Kalsiy karbonat
    vec: carbonato de càlcio
    vi: calci carbonat
    war: Calcium carbonate
    wuu: 碳酸钙
    yue: 碳酸鈣
    zh: 碳酸鈣
dv_is_:
