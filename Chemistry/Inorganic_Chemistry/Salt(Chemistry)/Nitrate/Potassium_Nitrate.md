...
UNII: RU45X2JN0Z
E_number: E252
OmegaWiki_Defined_Meaning: 740989
chemical_formula: KNO₃
chemical_structure: http://commons.wikimedia.org/wiki/Special:FilePath/Potassium%20nitrate%20structure.svg
canonical_SMILES: '[N+](=O)([O-])[O-].[K+]'
Reaxys_registry_number: 16014598
EC_number: 231-818-8
CAS_Registry_Number: 7757-79-1
UMLS_CUI:
- C0071772
- C0953464
...
dv_has_:
  ...
  name_:
    ...
    bs: Kalij-nitrat
    ca: nitrat de potassi
    cs: dusičnan draselný
    cv: Инди селитри
    da: kaliumnitrat
    dag: Kaŋwa
    de: Kaliumnitrat
    ...
    ga: níotráit photaisiam
    gl: nitrato de potasio
    he: אשלגן חנקתי
    hi: पोटैशियम नाइट्रेट
    hr: Kalijev nitrat
    hu: kálium-nitrát
    hy: Կալիումի նիտրատ
    id: kalium nitrat
    ...
    lv: kālija nitrāts
    mk: шалитра
    ml: പൊട്ടാസ്യം നൈട്രേറ്റ്
    ms: kalium nitrat
    mt: nitrat tal-potassju
    my: ယမ်းစိမ်း
    mzn: سالیتر
    nb: kaliumnitrat
    nl: kaliumnitraat
...
> Potassium nitrate is a chemical compound with a sharp, salty, bitter taste 
...
> It is a source of nitrogen, and nitrogen was named after niter. 
> 
> Potassium nitrate is one of several nitrogen-containing compounds 
> collectively referred to as saltpetre (or saltpeter in the United States).
>
> Major uses of potassium nitrate are in fertilizers, tree stump removal, 
> rocket propellants and fireworks. 
> 
> It is one of the major constituents of traditional gunpowder (black powder). 
> 
> In processed meats, potassium nitrate reacts with hemoglobin and myoglobin 
> generating a red color.
>
