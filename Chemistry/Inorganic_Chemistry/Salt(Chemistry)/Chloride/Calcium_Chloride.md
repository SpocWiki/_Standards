...
dv_has_:
  ...
  name_:
    ...
    ga: clóiríd chailciam
    gl: cloruro de calcio
    he: סידן כלורי
    hi: कैल्सियम क्लोराइड
    hu: kalcium-klorid
    hy: Կալցիումի քլորիդ
    id: kalsium klorida
    ...
    mk: калциум хлорид
    ms: kalsium klorida
    mt: klorur tal-kalċju
    nan: Iâm-hoà khā-lú-siúm
    nb: kalsiumklorid
    nl: calciumchloride
    nn: kalsiumklorid
    pl: chlorek wapnia
    pt: cloreto de cálcio
    ro: clorură de calciu
    ru: хлорид кальция
    sh: kalcijum hlorid
    sk: chlorid vápenatý
    sl: kalcijev klorid
    ...
    tr: kalsiyum klorür
    uk: кальцій хлористий
    vi: calci chloride
    war: calcium chloride
    wuu: 氯化钙
    yue: 氯化鈣
    zh: 氯化鈣
    zh_cn: 氯化钙
