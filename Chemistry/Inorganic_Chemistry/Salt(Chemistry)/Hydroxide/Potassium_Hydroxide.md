...
- 406
- 716
molar_fusion_enthalpy: 7.5
solubility: 107
density: 2.04
molar_enthalpy_of_vaporization: 128.9
boiling_point:
- 1324
- 1327
- 2415
...
image: http://commons.wikimedia.org/wiki/Special:FilePath/Potassium%20hydroxide.jpg
canonical_SMILES: '[OH-].[K+]'
UNSPSC_Code: 12352320
CAS_Registry_Number: 1310-58-3
EC_number: 215-181-3
UMLS_CUI: C0071767
DSSTOX_compound_identifier: DTXCID209633
Commons_category: Potassium hydroxide
RTECS_number: TT2100000
mass: 55.966446332000004
dv_has_:
  formula_: KOH
  name_:
    af: Kaliumhidroksied
    ...
    bs: Kalij hidroksid
    ca: hidròxid de potassi
    cs: hydroxid draselný
    cv: Калийлĕ сĕлтĕк
    da: kaliumhydroxid
    de: Kaliumhydroxid
    ...
    eu: potasio hidroxido
    fa: پتاسیم هیدروکسید
    fi: kaliumhydroksidi
    fr: hydroxyde de potassium
    gl: Hidróxido de potasio
    he: אשלגן הידרוקסידי
    hi: पोटासियम हाइड्राक्साइड
    hu: kálium-hidroxid
    hy: Կալիումի հիդրօքսիդ
    id: kalium hidroksida
    it: idrossido di potassio
    ja: 水酸化カリウム
    jv: Kalium hidroksida
    ka: კალიუმის ჰიდროქსიდი
    ko: 수산화 칼륨
    ky: калий гидроксиди
    la: Hydroxidum kalii
    lo: ໂພແທດຊຽມໄຮໂດຣໄຊ
    lt: Kalio šarmas
    lv: kālija hidroksīds
    mk: Калиум хидроксид
    ml: പൊട്ടാസ്യം ഹൈഡ്രോക്സൈഡ്
    mn: Калийн гидроксид
    ms: Kalium hidroksida
    mt: Idrossidu tal-potassju
    nb: kaliumhydroksid
    nl: kaliumhydroxide
    nn: kaliumhydroksid
    pl: wodorotlenek potasu
    pt: hidróxido de potássio
    ro: Hidroxid de potasiu
    ru: гидроксид калия
    sco: potassium hydroxide
    sh: Kalijum hidroksid
    ...
    tr: potasyum hidroksit
    uk: гідроксид калію
    ur: پوٹاشیم ہائیڈروآکسائڈ
    vi: Kali hiđroxit
    war: Potassium hydroxide
    wuu: 氢氧化钾
    yue: 氫氧化鉀
    zh: 氢氧化钾
    zh-hans: 氢氧化钾
dv_is_:
  ...
  - '[[/_Standards/Chemistry/Inorganic_Chemistry/Salt(Chemistry)/Hydroxide/Potassium_Hydroxide|Potassium_Hydroxide]]'
  - '[[/_public/Chemistry/Inorganic_Chemistry/Salt(Chemistry)/Hydroxide/Potassium_Hydroxide.public|Potassium_Hydroxide.public]]'
  - '[[/_internal/Chemistry/Inorganic_Chemistry/Salt(Chemistry)/Hydroxide/Potassium_Hydroxide.internal|Potassium_Hydroxide.internal]]'
  - '[[/_protect/Chemistry/Inorganic_Chemistry/Salt(Chemistry)/Hydroxide/Potassium_Hydroxide.protect|Potassium_Hydroxide.protect]]'
  - '[[/_private/Chemistry/Inorganic_Chemistry/Salt(Chemistry)/Hydroxide/Potassium_Hydroxide.private|Potassium_Hydroxide.private]]'
...
#is_/same_as :: [[../../../../WikiData/WD~Potassium_hydroxide,132298|WD~Potassium_hydroxide,132298]]  
...
> It has many industrial and niche applications, 
> most of which utilize its caustic nature and its reactivity toward acids. 
> 
> About 2.5 million tonnes were produced in 2023. 
> KOH is noteworthy as the precursor to most soft and liquid soaps, 
> as well as numerous potassium-containing chemicals.  
> 
