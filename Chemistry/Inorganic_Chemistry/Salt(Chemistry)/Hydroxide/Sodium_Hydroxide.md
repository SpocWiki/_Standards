...
MeSH_tree_code:
- D01.045.250.750
- D01.248.497.158.459.475
DSSTOX_compound_identifier: DTXCID609634
chemical_formula:
- HNaO
- NaOH
...
dv_has_:
  name_:
    ...
    ca: hidròxid de sodi
    cs: hydroxid sodný
    cv: натрий гидроксичĕ
    da: natriumhydroxid
    de: Natriumhydroxid
    el: υδροξείδιο του νατρίου
    en: sodium hydroxide
    eo: natria hidroksido
    ...
    frr: Natriumhydroxid
    ga: hiodrocsaíd sóidiam
    gl: Hidróxido de sodio
    gv: hiddrocseed hodjum
    he: נתרן הידרוקסידי
    hi: क्षारातु उदजारेय
    hr: Natrijev hidroksid
    hu: nátrium-hidroxid
    ...
    ja: 水酸化ナトリウム
    jv: Natrium hidroksida
    ka: ნატრიუმის ჰიდროქსიდი
    kaa: Natriy gidroksid
    kk: Натрий гидроксиді
    ko: 수산화 나트륨
    ky: Натрий гидроксиди
    la: Lixivium
    lo: ໂຊດຽມໄຮໂດຣໄຊ
    lt: Natrio hidroksidas
    lv: nātrija hidroksīds
    lzh: 氫氧化鈉
    mk: Натриум хидроксид
    ml: സോഡിയം ഹൈഡ്രോക്സൈഡ്
    mn: Натрийн гидроксид
    ms: Natrium hidroksida
    mt: Idrossidu tas-sodju
    my: ကော့စတစ်ဆိုဒါ
    nan: Chúi-sng-hoà natrium
    nb: natriumhydroksid
    nds: Natriumhydroxid
    nl: natriumhydroxide
    nn: natriumhydroksid
    ...
    sco: sodium hydroxide
    sd: ڪاسٽڪ سوڊا
    sh: Natrijum hidroksid
    sk: hydroxid sodný
...
> and may cause severe chemical burns at high concentrations. 
> 
...
> The commercially available "sodium hydroxide" is often this monohydrate, 
> and published data may refer to it instead of the anhydrous compound.
>
> As one of the simplest hydroxides, sodium hydroxide is frequently used 
> alongside neutral water and acidic hydrochloric acid 
> to demonstrate the pH scale to chemistry students.
>
> Sodium hydroxide is used in many industries: 
> in the making of wood pulp and paper, textiles, drinking water, soaps and detergents, 
