...
- хімія довкілля
- хімія навакольнага асяродзьдзя
- Химия на околната среда
- Химия окружающей среды
- Хүрээлэн буй орчны хими
- әйләнә-тирә мохит химиясе
- Էկոլոգիական քիմիա
- כימיה סביבתית
- شیمی محیط زیست
- كيمياء بيئية
...
practiced_by: '[[_Standards/WikiData/WD~environmental_chemist,66816554|WD~environmental_chemist,66816554]]'
...
dv_has_:
  name_:
    ...
    cs: chemie životního prostředí
    cy: cemeg amgylcheddol
    da: miljøkemi
    de: Umweltchemie
    el: Χημεία περιβάλλοντος
    en: environmental chemistry
    eo: media ĥemio
    es: química ambiental
    et: keskkonnakeemia
    eu: Ingurumen-kimika
    fa: شیمی محیط زیست
    fi: ympäristökemia
    fr: chimie environnementale
    gl: química ambiental
    he: כימיה סביבתית
    hi: पर्यावरण रसायन विज्ञान
    hr: Kemija okoliša
    hy: Էկոլոգիական քիմիա
    id: Kimia lingkungan
    ig: Chemistry gburugburu
    it: chimica ambientale
    ja: 環境化学
    kn: ಪರಿಸರ ರಸಾಯನಶಾಸ್ತ್ರ
    ko: 환경화학
    lb: Ëmweltchimie
    ...
    pt: química ambiental
    ro: Chimie ecologică
    ru: Химия окружающей среды
    se: biraskemiija
    sh: Hemija životne sredine
    si: පාරිසරික රසායන විද්යාව
    sl: kemija okolja
    smn: pirâskemia
    sms: pirrõskemia
    sr: Hemija životne sredine
    su: Kimia lingkungan
    sv: miljökemi
    ta: சுற்றுச்சூழல் வேதியியல்
    te: environmental study
    th: เคมีสิ่งแวดล้อม
    tl: Kimikang Pampaligid
    tr: Çevre kimyası
    tt: әйләнә-тирә мохит химиясе
    uk: хімія довкілля
    vi: hóa học môi trường
