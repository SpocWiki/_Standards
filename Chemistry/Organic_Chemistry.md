...
history_of_topic: '[[_Standards/WikiData/WD~history_of_organic_chemistry,17480697|WD~history_of_organic_chemistry,17480697]]'
...
is_the_study_of: '[[_Standards/WikiData/WD~organic_compound,174211|WD~organic_compound,174211]]'
...
opposite_of: '[[_Standards/WikiData/WD~inorganic_chemistry,11165|WD~inorganic_chemistry,11165]]'
part_of: '[[_Standards/WikiData/WD~chemistry,2329|WD~chemistry,2329]]'
PhilPapers_topic: organic-chemistry
practiced_by: '[[_Standards/WikiData/WD~organic_chemist,34463094|WD~organic_chemist,34463094]]'
...
topic_s_main_template: '[[_Standards/WikiData/WD~Template_Organic_chemistry,8084585|WD~Template_Organic_chemistry,8084585]]'
UMLS_CUI: C0008002
Universal_Decimal_Classification: 547
Wikimedia_outline: '[[_Standards/WikiData/WD~outline_of_organic_chemistry,7112694|WD~outline_of_organic_chemistry,7112694]]'
dv_is_:
  same_as:
...
dv_has_:
  name_:
    af: organiese chemie
    an: quimica organica
    ang: cōles gesceaftcræft
    anp: कार्बनिक रसायन
    ar: كيمياء عضوية
    ary: شيمي عضوية
    arz: كيميا عضويه
    as: জৈৱ ৰসায়ন
    ast: química orgánica
    az: üzvi kimya
    azb: اؤزوی کیمیا
    ba: органик химия
    ...
    fr: chimie organique
    frr: orgaanisk chemii
    fur: chimiche organiche
    ga: ceimic orgánach
    gcr: chimi organik
    gd: ceimigeachd fhàs-bheairteach
    gl: química orgánica
    gsw: organische Chemie
    ha: Organic chemistry
    he: כימיה אורגנית
    hi: कार्बनिक रसायन
    hif: organic chemistry
    hr: organska kemija
    hsb: organiska chemija
    ht: chimi òganik
    hu: szerves kémia
    hy: օրգանական քիմիա
    ia: chimia organic
    ...
    it: chimica organica
    ja: 有機化学
    jam: aagianik kimischri
    jv: kimia organik
    ka: ორგანული ქიმია
    kab: takrura tagmant
    kbp: kpɛlɩkpɛlɩ ɛyɔlɩyɛ
    kk: органикалық химия
    kn: ಇಂಗಾಲೀಯ ರಸಾಯನಶಾಸ್ತ್ರ
    ko: 유기화학
    kw: kymygieth organek
    ky: органикалык химия
    la: chemia organica
    lb: Organesch Chimie
    lfn: cimica organica
    lmo: chimica urganiga
    lt: organinė chemija
    lv: organiskā ķīmija
    lzh: 有機化學
    ...
    rue: орґанічна хемія
    sah: Органическай химия
    scn: chìmica urgànica
    sco: organic chemistry
    sd: نامياتي ڪيميا
    se: orgánalaš kemiija
    sgs: uorganėnė chemėjė
    sh: organska kemija
    si: කාබනික රසායනය
    sk: organická chémia
    sl: organska kemija
    ...
    te: ఆంగిక రసాయనం
    th: เคมีอินทรีย์
    tl: kimikang organiko
    tr: organik kimya
    tt: органик химия
    udm: органической хими
    ug: ئورگانىك خىمىيە
    uk: органічна хімія
    ur: نامیاتی کیمیا
    uz: organik kimyo
    vec: chimega orgànega
    vep: Organine himii
    vi: hóa hữu cơ
    vro: orgaanilinõ keemiä
    war: organiko kemika
    wuu: 有机化学
    xmf: ორგანული ქიმია
    yi: ארגאנישע כעמיע
