...
dv_has_:
  name_:
    ...
    ca: carbó actiu
    cs: aktivní uhlí
    cv: активациленĕ кăмрăк
    de: Aktivkohle
    el: ενεργός άνθρακας
    en: activated carbon
    eo: aktivigita karbono
    es: carbón activado
    et: aktiivsüsi
    eu: Ikatz aktibatu
    fa: زغال فعال
