---
aliases:
- 14. grupa (ķīmiskie elementi)
- 14. grupa hemijskih elemenata
- 14. Grupp vum Periodesystem
- 14. Hauptgruppe des Periodensystems
- 14. skupina
- 14. taldeko elementu
...
dv_has_:
  name_:
    ...
    he: קבוצת יסודות 14
    hi: कार्बन समूह
    hr: ugljikova skupina
    hu: széncsoport
    hy: ածխածնի ենթախումբ
    ia: gruppo 14
    id: golongan karbon
    is: kolefnisflokkur
    ...
    ko: 14족
    kw: bagas 14
    lb: 14. Grupp vum Periodesystem
    lmo: Grupp del carbòni
    lv: 14. grupa (ķīmiskie elementi)
    mk: Група 4А на периодниот систем
    ml: കാർബൺ കുടുംബം
    ms: Kumpulan karbon
    ...
    th: หมู่คาร์บอน
    tr: karbon grubu
    uk: Група 14 періодичної системи елементів
