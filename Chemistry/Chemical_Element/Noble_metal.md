...
has_characteristic: '[[_Standards/WikiData/WD~inertness,262175|WD~inertness,262175]]'
different_from: '[[_Standards/WikiData/WD~precious_metal,271449|WD~precious_metal,271449]]'
subclass_of: '[[_Standards/WikiData/WD~metal_element,11646938|WD~metal_element,11646938]]'
described_by_source:
...
dv_has_:
  name_:
    ...
    ta: உயர் உலோகம்
    th: โลหะมีสกุล
    tl: mariringal na mga metal
    tr: soy metal
    udm: сыномисьтэм дуно металлъёс
    uk: благородні метали
    uz: asl metallar
    vi: kim loại quý
    wuu: 抗腐蚀金属
    yue: 惰性金屬
