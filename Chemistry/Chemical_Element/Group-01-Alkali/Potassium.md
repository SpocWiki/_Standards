...
- '[[_Standards/WikiData/WD~Potassium,108309884|WD~Potassium,108309884]]'
Dewey_Decimal_Classification: 546.383
different_from: '[[_Standards/WikiData/WD~serum_potassium_level,658883|WD~serum_potassium_level,658883]]'
...
- '[[_Standards/WikiData/WD~Equisetum_telmateia,936546|WD~Equisetum_telmateia,936546]]'
...
- 1.51
- 1.64
Krugosvet_article: nauka_i_tehnika/himiya/KALI.html
mass: 39.0983
melting_point:
- 336.7
- 63.65
...
- D01.552.528.652
- D01.552.547.650
named_after: '[[_Standards/WikiData/WD~potash,10564271|WD~potash,10564271]]'
...
dv_has_value_for_radius: 2.77
dv_has_value_for_volume_ccm_mol: 45.46
dv_has_value_for_unknown2: 2.03
dv_has_value_for_radius_nano_m: 4.341
dv_has_value_for_electronegativity: 0.8
dv_has_value_for_density: 0.86
dv_has_value_for_temperature_melt_c: 63.65
dv_has_value_for_temperature_boil_c: 774
dv_has_value_for_capacity_heat: 0.75
dv_has_value_for_conductivity_heat: 1.024
dv_has_value_for_enthalpy: 2.334
dv_has_value_for_energy_form_kj_mol: 79.87
...
> with the symbol has_name_abbreviated = `=this.dv_has_name_abbreviated`  (from Neo-Latin kalium) and atomic number has_number_of_electrons = `=this.dv_has_number_of_electrons` . 
> 
...
> to form flaky white potassium peroxide in only seconds of exposure. 
> 
...
> all of which have a single valence electron in the outer electron shell, 
> which is easily removed to create an ion with a positive charge 
> (which combines with anions to form salts). 
> 
...
> and burning with a lilac-colored flame. 
> 
> It is found dissolved in seawater (which is 0.04% potassium by weight), and occurs in many minerals 
> such as orthoclase, a common constituent of granites and other igneous rocks.
> 
> Potassium is chemically very similar to sodium, the previous element in group 1 of the periodic table. 
> They have a similar first ionization energy, 
> which allows for each atom to give up its sole outer electron. 
> 
> It was suspected in 1702 that they were distinct elements that combine with the same anions 
> to make similar salts, and this was proven in 1807 through using electrolysis. 
> Naturally occurring potassium is composed of three isotopes, of which 40K is radioactive. 
> Traces of 40K are found in all potassium, and it is the most common radioisotope in the human body.
>
> Potassium ions are vital for the functioning of all living cells. 
> The transfer of potassium ions across nerve cell membranes 
> is necessary for normal nerve transmission; 
> potassium deficiency and excess can each result in numerous signs and symptoms, 
> including an abnormal heart rhythm and various electrocardiographic abnormalities. 
> Fresh fruits and vegetables are good dietary sources of potassium. 
> The body responds to the influx of dietary potassium, which raises serum potassium levels, 
> by shifting potassium from outside to inside cells and increasing potassium excretion by the kidneys.
>
> Most industrial applications of potassium exploit the high solubility of its compounds in water, 
> such as saltwater soap. 
> 
> Heavy crop production rapidly depletes the soil of potassium, 
