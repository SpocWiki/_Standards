...
> as one of the three residual rare inert elements remaining in dry air, 
> after nitrogen, oxygen, argon and carbon dioxide were removed. 
> Neon was the second of these three rare gases to be discovered 
> and was immediately recognized as a new element from its bright red emission spectrum. 
> 
> The name neon is derived from the Greek word, νέον, neuter singular form of νέος (neos), 
> meaning 'new'. 
> 
> Neon is chemically inert, and no uncharged neon compounds are known. 
> The compounds of neon currently known include ionic molecules, 
> molecules held together by van der Waals forces and clathrates.
>
> During cosmic nucleogenesis of the elements, 
> large amounts of neon are built up from the alpha-capture fusion process in stars. 
> 
> Although neon is a very common element in the universe and solar system 
> (it is fifth in cosmic abundance after hydrogen, helium, oxygen and carbon), it is rare on Earth. 
> 
