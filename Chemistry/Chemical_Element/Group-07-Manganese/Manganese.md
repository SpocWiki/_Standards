...
- 3564
canonical_SMILES: '[Mn]'
CAS_Registry_Number: 7439-96-5
ceiling_exposure_limit: 5
chemical_formula: Mn
Commons_category: Manganese
Commons_gallery: Manganese
...
dv_has_:
  name_:
    ...
    ia: manganese
    id: mangan
    inh: Ӏаьржадаьредаш (химе элемент)
    io: mangano
    is: mangan
    it: manganese
    ja: マンガン
...
> Manganese oxide is used as an oxidising agent; as a rubber additive; 
> and in glass making, fertilisers, and ceramics. Manganese sulfate can be used as a fungicide.
>
> Manganese is also an essential human dietary element, 
> important in macronutrient metabolism, bone formation, and free radical defense systems. 
> 
...
> In the human brain, the manganese is bound to manganese metalloproteins, 
> most notably glutamine synthetase in astrocytes.
>
> Manganese was first isolated in 1774. 
> It is familiar in the laboratory in the form of the deep violet salt potassium permanganate. 
