...
dv_has_value_for_radius: 1.97
dv_has_value_for_volume_ccm_mol: 8.85
dv_has_value_for_unknown2: 1.28
dv_has_value_for_radius_nano_m: 7.88
dv_has_value_for_electronegativity: 1.9
dv_has_value_for_density: 21
dv_has_value_for_temperature_melt_c: 3180
dv_has_value_for_capacity_heat: 0.13
dv_has_value_for_conductivity_heat: 0.479
dv_has_value_for_enthalpy: 33.2
...
> **Rhenium** is a chemical element with the symbol has_name_abbreviated = `=this.dv_has_name_abbreviated`  and atomic number has_number_of_electrons = `=this.dv_has_number_of_electrons` . 
> It is a silvery-gray, heavy, third-row transition metal in group has_number_of_group = `=this.dv_has_number_of_group`  of the periodic table. 
> 
