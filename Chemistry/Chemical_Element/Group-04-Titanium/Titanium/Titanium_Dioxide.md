...
- دوانە ئۆکسیدی تیتانیۆم
- टाइटानियम डाइऑक्साइड
...
subject_has_role:
- '[[_Standards/WikiData/WD~biocompatible_material,177664|WD~biocompatible_material,177664]]'
...
- '[[_Standards/WikiData/WD~sunscreen,827658|WD~sunscreen,827658]]'
...
associated_hazard: '[[_Standards/WikiData/WD~titanium_dioxide_exposure,21175372|WD~titanium_dioxide_exposure,21175372]]'
has_effect: '[[_Standards/WikiData/WD~titanium_dioxide_exposure,21175372|WD~titanium_dioxide_exposure,21175372]]'
...
subclass_of: '[[_Standards/WikiData/WD~titanium_oxide,61670599|WD~titanium_oxide,61670599]]'
...
decomposition_point: 2900
density: 4.26
Gmelin_number: 19206
ionization_energy: 9.54
melting_point:
- 1843
- 3326
- 3362
...
E_number: E171
chemical_formula: TiO₂
image: http://commons.wikimedia.org/wiki/Special:FilePath/Titanium%28IV%29%20oxide.jpg
CAS_Registry_Number: 13463-67-7
EC_number: 236-675-5
...
dv_is_:
  same_as:
  - '[[../../../../WikiData/WD~Titanium_dioxide,193521|WD~Titanium_dioxide,193521]]'
...
dv_has_:
  name_:
    ...
    et: titaandioksiid
    eu: titanio oxido
    fa: تیتانیوم دی اکسید
    fi: titaanidioksidi
    fr: dioxyde de titane
    ga: dé-ocsaíd tíotáiniam
    he: טיטניום דו-חמצני
    hi: टाइटानियम डाइऑक्साइड
    hr: titanijev dioksid
    hu: titán-dioxid
    hy: տիտանի երկօքսիդ
    ...
    ja: 酸化チタン(IV)
    jv: titaniyum dioksida
    ko: 이산화 타이타늄
    ky: титан оксиддери
    lt: titano dioksidas
    lv: titāna dioksīds
    mg: diôksidana titanina
    mk: титан диоксид
    ml: ടൈറ്റാനിയം ഡൈഓക്സൈഡ്
    ms: titanium dioksida
    mt: diossidu tat-titanju
    nb: titandioksid
    ...
    ro: dioxid de titan
    ru: оксид титана(IV)
    sco: titanium dioxide
    sh: titanijum dioksid
    ...
    th: TiO2
    tr: titanyum dioksit
    tt: титанның икеләтә әчемәсе
    uk: білила титанові
    uz: titan dioksidi
    vi: titan(IV) oxit
    war: titanium dioxide
    wuu: 二氧化钛
    yue: 鈦白粉
    zh: 二氧化鈦
    zh_cn: 二氧化钛
...
#is_/same_as :: [[_Standards/WikiData/WD~Titanium_dioxide,193521|WD~Titanium_dioxide,193521]] 

## #has_/text_of_/abstract 

> Titanium dioxide, also known as titanium(IV) oxide or titania, 
> is the inorganic compound derived from titanium with the chemical formula TiO2. 
> 
> When used as a pigment, it is called titanium white, Pigment White 6 (PW6), or CI 77891. 
> 
> It is a white solid that is insoluble in water, although mineral forms can appear black. 
...
> 
> It has been estimated that titanium dioxide is used in two-thirds of all pigments, 
> and pigments based on the oxide have been valued at a price of $13.2 billion.
>
