...
- alkáliföldfémek
- allpa alkali q'illay
- bagas 2
- berylowce
- Eerdalkaalimetal
- Eerdalkalimetall
- elimentu dû gruppu 2
- Erdalkalimetalle
- Giĕng-tū gĭng-sṳ̆k
- Group-02-Earth-Alkaline
- groupe 2
- grupi i dytë i elementeve kimike
- gruppe 2
- Ierdalkalymetaal
...
- maa-alkalimetalli
- Macdin dhuleed ah
- meain chray-alkalaihagh
- metai alcalitt-teros
...
- земноалкален метал
- Земноалкалны металы
- лужназямельныя мэталы
- лужноземельні метали
- сĕлтĕ çĕр металлĕсем
- Сілтілік жер металдар
- шчолачназямельныя металы
- щёлочноземельной металлъёс
...
dv_has_:
  name_:
    ...
    bn: মৃৎক্ষার ধাতু
    bo: སེ་རུལ་ཅན་གྱི་ལྕགས་རིགས།
    bs: zemnoalkalni metali
    ca: alcalinoterri
    cdo: Giĕng-tū gĭng-sṳ̆k
    cs: 2. skupina
    ...
    fr: groupe 2
    frr: Eerdalkaalimetal
    fy: Ierdalkalymetaal
    ga: miotal cré-ailcealach
    gan: 鹼土金屬
    gl: alcalinotérreo
    gu: આલ્ક્લાઇન પાર્થિવ ધાતુ
    gv: meain chray-alkalaihagh
    hak: Kán-thú kîm-su̍k
    ...
    lt: Šarminiai žemės metalai
    lv: sārmzemju metāli
    lzh: 鹼土金屬
    mk: земноалкален метал
    ml: ആൽക്കലൈൻ എർത്ത് ലോഹങ്ങൾ
    mn: Газрын шүлтийн металл
    mr: अल्कमृदा धातू
    ms: logam alkali bumi
    my: အယ်ကာလိုင်း သတ္တုများ
    nan: Kiⁿ-thó͘ kim-sio̍k
    nb: jordalkalimetall
    ...
    rue: Земноалкалны металы
    rup: Metal alcalino-pământos
    sah: алкалин сир метал
    scn: elimentu dû gruppu 2
    sco: Alkaline yird metal
    sh: zemnoalkalijski metali
    si: ක්ෂාරීය පාංශු ලෝහය
    sk: kov alkalických zemín
    sl: zemljoalkalijska kovina
    so: Macdin dhuleed ah
    sq: grupi i dytë i elementeve kimike
    sr: земно-алкални метал
    su: Logam alkali taneuh
    ...
    udm: щёлочноземельной металлъёс
    uk: лужноземельні метали
    uz: Ishqoriy-yer metallar
