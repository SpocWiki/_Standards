...
subclass_of:
- '[[_Standards/WikiData/WD~spectroscopy,483666]]'
- '[[_Standards/WikiData/WD~spectrometry,65306641]]'
- '[[_Standards/WikiData/WD~mass_analysis,93405460]]'
has_part_s_: '[[_Standards/WikiData/WD~ion_source,905291]]'
uses: '[[_Standards/WikiData/WD~mass_spectrometer,1327691]]'
instance_of: '[[_Standards/WikiData/WD~analytical_chemical_technique,4751159]]'
topic_has_template: '[[_Standards/WikiData/WD~Template_Mass_spectrometry,11229192]]'
described_by_source:
- '[[_Standards/WikiData/WD~Great_Soviet_Encyclopedia_(1926_1947),20078554]]'
- '[[_Standards/WikiData/WD~Armenian_Soviet_Encyclopedia,_vol._7,123625363]]'
practiced_by: '[[_Standards/WikiData/WD~mass_spectrometrist,114575069]]'
...
Wikimedia_import_URL: https://en.wikipedia.org/wiki/Mass_spectrometry
Dewey_Decimal_Classification:
- 539.60287
- 543.65
Datahub_page: bioportal-ms
UMLS_CUI: C0037813
MeSH_tree_code: E05.196.566
...
dv_has_:
  name_:
    ...
    ckb: شەبەنگپێوی بارستایی
    cs: hmotnostní spektrometrie
    ...
    eu: Masa-espektrometro
    fa: طیفسنجی جرمی
    fi: massaspektrometri
    fr: spectrométrie de masse
    ga: mais-speictriméadar
    gl: Espectrometría de masas
    he: ספקטרומטריית מסות
    hi: द्रव्यमान वर्णक्रममाप
    hr: Masena spektrometrija
    ht: Espektwomèt mas
    hu: tömegspektrometria
    hy: Մաս-սպեկտրոսկոպիա
    id: Spektrometri massa
    io: Mas-spektrogramo
    ...
    lt: Masių spektrometrija
    lv: Masspektrometrija
    mk: масена спектрометрија
    ml: മാസ്സ് സ്പെക്ട്രോമെട്രി
    mn: Масс спектрометрчлэл
    nb: massespektrometri
    nl: massaspectrometrie
    nn: massespektrometri
    ...
    se: mássáspektrografiija
    sh: Masena spektrometrija
    sk: Hmotnostná spektrometria
    skr: ماس سپیکٹرومیٹری
    ...
    th: แมสสเปกโตรเมทรี
    tr: Kütle spektrometrisi
    uk: Мас-спектрометрія
    ur: کمیتی طیف پیمائی
    uz: Mass-spektroskopiya
    vi: Phương pháp phổ khối lượng
    wuu: 质谱法
    yue: 質譜學
    zh: 质谱法
    zh_cn: 质谱法
...
> Mass spectrometry (MS) is an analytical technique that is 
> used to measure the mass-to-charge ratio of  ions. 
> 
> The results are presented as a mass spectrum, 
