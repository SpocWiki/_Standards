...
different_from: '[[_Standards/WikiData/WD~high-quality_steel,1283378|WD~high-quality_steel,1283378]]'
discoverer_or_inventor: '[[_Standards/WikiData/WD~Harry_Brearley,470651|WD~Harry_Brearley,470651]]'
EC_number: 603-108-1
hardness: 250
has_characteristic: '[[_Standards/WikiData/WD~corrosion_resistance,4234269|WD~corrosion_resistance,4234269]]'
has_part_s_:
- '[[_Standards/WikiData/WD~chromium,725|WD~chromium,725]]'
- '[[_Standards/WikiData/WD~steel,11427|WD~steel,11427]]'
history_of_topic: '[[_Standards/WikiData/WD~history_of_stainless_steel,90563588|WD~history_of_stainless_steel,90563588]]'
...
subclass_of: '[[_Standards/WikiData/WD~alloy_steel,1070521|WD~alloy_steel,1070521]]'
...
dv_has_:
  name_:
    af: vlekvrye staal
    ar: فولاذ مقاوم للصدأ
    arz: ستانلس ستيل
    ast: Aceru inoxidable
    az: Paslanmaz polad
    azb: پاسلانماز پولاد
    ...
    ca: acer inoxidable
    cdo: Bók-séu-gáung
    chr: ᎠᏯᏍᎳᏗᏍᎩ ᏂᎨᏒᎾ ᏔᎷᎩᏍᎩ
    ckb: پۆڵای ژەنگنەھێن
    cs: korozivzdorná ocel
    cy: dur gwrthstaen
    da: rustfrit stål
    de: rostfreier Stahl
    ...
    es: acero inoxidable
    et: Roostevaba teras
    eu: altzairu herdoilgaitz
    fa: فولاد زنگنزن
    fi: ruostumaton teräs
    fr: acier inoxydable
    ga: cruach dhomheirgthe
    gl: Aceiro inoxidábel
    gsw: rostfreie Stahl
    he: פלדת אל-חלד
    hi: स्टेनलेस स्टील
    hr: nehrđajući čelik
    hu: rozsdamentes acél
    hy: Չժանգոտող պողպատ
    id: Baja tahan karat
    is: Ryðfrítt stál
    ...
    lv: nerūsošais tērauds
    mi: maitai waikura-kore
    min: Baja nirkarat
    mk: не’рѓосувачки челик
    mr: निष्कलंक स्टील
    ms: Keluli tahan karat
    nan: Su-tén-lè-sù
    nb: rustfritt stål
    nds: rustfree Stahl
    nl: roestvast staal
    ...
    uk: неіржавна сталь
    uz: zanglamas poʻlat
    vec: Aciaio inosidabiłe
    vi: thép không gỉ
    war: Diri nataoy nga puthaw
    wuu: 不锈钢
    yi: זשאווערפריי שטאל
    yue: 不鏽鋼
    zh: 不鏽鋼
