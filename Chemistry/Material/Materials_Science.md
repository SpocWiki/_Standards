...
dv_has_:
  name_:
    af: materiaalkunde
    am: የቁሶች ጥናት ሳይንስ ወይም ምህንድስና
    ar: علم المواد
    ast: ciencia de materiales
    az: materialşünaslıq
    ...
    ckb: زانستی ماددە
    cs: materiálové vědy
    cv: материалсен пĕлĕвĕ
    da: materialevidenskab
    de: Materialwissenschaft
    diq: materyalşınasiye
    el: επιστήμη υλικών
    ...
    ja: 材料科学
    kab: tussna n warrumen
    kk: материалтану
    ko: 재료과학
    kw: godhonieth stoffow
    ky: материал таануу
    lb: Materialwëssenschaft
    lt: medžiagotyra
    lv: materiālzinātne
    mk: наука за материјалите
    ...
    ru: материаловедение
    sa: पदार्थ विज्ञानं
    sco: materials science
    sh: znanost o materijalima
    si: ද්රව්යයමය විද්යාව හැදින්වීම
    sl: znanost o materialih
    sq: shkenca e materialeve
    sr: наука о материјалима
    su: élmu bahan
    sv: materialvetenskap
    ta: பொருளறிவியல்
    tg: маводшиносӣ
    th: วัสดุศาสตร์
    tl: agham ng mga materyal
    tr: malzeme bilimi
    tt: материаллар белеме
    ug: ماتېرىيال ئىلمى
    uk: матеріалознавство
    ur: اموادی علم
    uz: materialshunoslik
    vec: siensa dei materiłi
    vi: khoa học vật liệu
    war: syensya hin materyales
    wuu: 材料科学
    yue: 材料科學
    zh: 材料科学
    zh-cn: 材料科学
