...
dv_has_:
  name_:
    ...
    ar: هندسة كيميائية
    as: ৰাসায়নিক অভিযান্ত্ৰিকী
    ast: Inxeniería química
    ...
    cy: Peirianneg gemegol
    da: kemiteknik
    de: Chemieingenieurwesen
    el: Χημική μηχανική
    en: chemical engineering
    eo: ĥemia inĝenierarto
    es: ingeniería química
    et: Keemiatehnoloogia
    eu: Ingeniaritza kimiko
    fa: مهندسی شیمی
    fi: kemiantekniikka
    fr: génie chimique
    ga: innealtóireacht cheimiceach
    gl: enxeñaría química
    he: הנדסת כימיה
    hi: रासायनिक अभियान्त्रिकी
    hr: kemijsko inženjerstvo
    hu: vegyészmérnöki tudomány
    hy: քիմիական ինժեներիա
    id: rekayasa kimia
    is: efnaverkfræði
    it: ingegneria chimica
    ja: 化学工学
    jv: Tèknik kimia
    ka: ქიმიური ტექნოლოგია
    ...
    mag: रासायनिक अभियान्त्रिकी
    mk: хемиско инженерство
    mn: Химийн инженерчлэл
    mr: रासायनिक अभियांत्रिकी
    ms: Kejuruteraan kimia
    my: ဓာတု အင်ဂျင်နီယာ ဘာသာရပ်
    nan: Hoà-ha̍k kang-tîng
    nb: kjemiteknikk
    ...
    sd: ڪيميائي انجنيئرنگ
    sh: hemijsko inženjerstvo
    si: රසායනික ඉංජිනේරු විද්යාව
    sk: chemické inžinierstvo
    sl: kemijska tehnologija
    sq: Inxhinieria kimike
    sr: хемијско инжењерство
    sv: kemiteknik
    sw: uhandisi wa kemikali
    ta: வேதிப் பொறியியல்
    tg: муҳандисии шимӣ
    th: วิศวกรรมเคมี
    tk: Himiýa inženerligi
    tl: inhinyeriyang pangkimika
    tr: kimya mühendisliği
    tt: химик инженерлык
    uk: хімічна технологія
    ur: کیمیائی ہندسیات
    uz: Kimyoviy texnologiya
    vec: inzegnaria chìmega
    vi: kỹ thuật hóa học
...
### #is_/same_as :: [[/_Standards/Chemistry/Chemical_Engineering|Chemical_Engineering]] 

### #is_/same_as :: [[/_public/Chemistry/Chemical_Engineering.public|Chemical_Engineering.public]] 

### #is_/same_as :: [[/_internal/Chemistry/Chemical_Engineering.internal|Chemical_Engineering.internal]] 

### #is_/same_as :: [[/_protect/Chemistry/Chemical_Engineering.protect|Chemical_Engineering.protect]] 

### #is_/same_as :: [[/_private/Chemistry/Chemical_Engineering.private|Chemical_Engineering.private]] 

### #is_/same_as :: [[/_personal/Chemistry/Chemical_Engineering.personal|Chemical_Engineering.personal]] 

### #is_/same_as :: [[/_secret/Chemistry/Chemical_Engineering.secret|Chemical_Engineering.secret]] 
