...
dv_has_:
  name_:
    af: chemiese reaksie
    anp: रासायनिक अभिक्रिया
    ar: تفاعل كيميائي
    ary: تفاعل كيماوي
    as: ৰাসায়নিক বিক্ৰিয়া
    ast: Reacción química
    az: kimyəvi reaksiya
    azb: تَپکیمه
    ba: химик реакция
    ...
    fj: Veisau ni kemikali
    fr: réaction chimique
    frc: réaction chimique
    frr: Cheemisk reaksioon
    fy: gemyske reaksje
    ga: imoibriú ceimiceach
    gcr: Réaksyon chimik
    gd: Iom-obrachadh ceimigeach
    gl: reacción química
    he: תגובה כימית
    hi: रासायनिक अभिक्रिया
    hr: kemijska reakcija
    hsb: chemiska reakcija
    ht: reyaksyon chimik
    hu: kémiai reakció
    hy: քիմիական ռեակցիա
    ia: reaction chimic
    ...
    it: reazione chimica
    ja: 化学反応
    jam: kimikal riakshan
    jv: reaksi kimia
    ka: ქიმიური რეაქცია
    kaa: хimiyalıq reaksiya
    kab: Tasedmirt takrurant
    kbp: Kpɛlɩ kpɛlɛkʋʋ tɛ lakayaɣ
    kk: алмасу реакциясы
    km: ប្រត្តិកម្មគីមី
    kn: ರಾಸಾಯನಿಕ ಕ್ರಿಯೆ
    ko: 화학 반응
    ...
    lmo: reaziun chimiga
    ln: Bobongoli na shimi
    lt: cheminė reakcija
    lv: ķīmiskā reakcija
    lzh: 化學反應
    mag: रासायनिक प्रतिक्रिया
    mg: Fiota simika
    mk: хемиска реакција
    ml: രാസപ്രവർത്തനം
    mn: Химийн урвал
    ...
    sco: chemical reaction
    sd: ڪيميائي عمل
    se: kemihkalaš reakšuvdna
    sh: hemijska reakcija
    si: රසායනික ප් රතික් රියා
    sk: chemická reakcia
    sl: kemična reakcija
    smn: kemiallâš reaktio
    sms: kemiaalʼlaž reaktio
    ...
    vec: reasion chìmega
    vi: phản ứng hóa học
    vro: aadomidõ ümbreistmine
    war: reaksyon hin kimikal
    wuu: 化学反应
    yi: כעמישע רעאקציע
