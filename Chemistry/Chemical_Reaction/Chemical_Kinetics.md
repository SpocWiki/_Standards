...
dv_has_:
  name_:
    af: Chemiese kinetika
    ar: حركية كيميائية
    ast: Cinética química
    az: Kimyəvi kinetika
    ba: химик кинетикаһы
    ...
    eu: Zinetika kimiko
    fa: سینتیک شیمیایی
    fi: Kemiallinen kinetiikka
    fr: cinétique chimique
    he: קינטיקה כימית
    hi: रासायनिक गतिकी
    hr: Kemijska kinetika
    hu: reakciókinetika
    hy: Քիմիական կինետիկա
    id: Kinetika kimia
    it: cinetica chimica
    ja: 反応速度論
    ka: ქიმიური კინეტიკა
    kk: Химиялык кинетика
    ko: 화학 반응속도론
    li: Kinetiek
