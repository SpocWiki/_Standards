...
- reacție de metateză
- reakcija dvojne zamenjave
- Reaksi metatesis
- Reação de dupla troca
- retatesi
- Reyaksyon deplasman doub
...
dv_has_:
  name_:
    ...
    fa: واکنش جانشینی دوگانه
    fi: Metateesi
    fr: métathèse
    gl: Reacción de metátese
    he: מטתזה
    ht: Reyaksyon deplasman doub
    hu: cserebomlási reakciók
    id: Reaksi metatesis
    it: retatesi
    ja: 複分解
    kk: Алмасу реакциясы
