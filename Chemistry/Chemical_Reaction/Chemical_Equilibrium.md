...
- Hòa-ha̍k pêng-hêng
- keemiline tasakaal
- kemiaalʼlaž tääʹssteädd
- Kemiala equilibro
- kemiallinen tasapaino
- Kemiijalaš dássedeaddu
- Kemijska ravnoteža
- kemijsko ravnovesje
- kemisk jämvikt
- kemisk ligevægt
...
subclass_of:
- '[[_Standards/WikiData/WD~steady_state,903414|WD~steady_state,903414]]'
- '[[_Standards/WikiData/WD~equilibrium,11061286|WD~equilibrium,11061286]]'
topic_has_template: '[[_Standards/WikiData/WD~Template_Chemical_equilibria,6852697|WD~Template_Chemical_equilibria,6852697]]'
instance_of: '[[_Standards/WikiData/WD~type_of_equilibrium,111796904|WD~type_of_equilibrium,111796904]]'
...
dv_has_:
  name_:
    ...
    et: keemiline tasakaal
    eu: Oreka kimiko
    fa: تعادل شیمیایی
    fi: kemiallinen tasapaino
    fr: équilibre chimique
    gl: Equilibrio químico
    he: שיווי משקל כימי
    hi: रासायनिक साम्य
    hr: Kemijska ravnoteža
    ht: Ekilib chimik
    hu: kémiai egyensúly
    hy: Քիմիական հավասարակշռություն
    id: Kesetimbangan kimia
    io: Kemiala equilibro
    it: equilibrio chimico
    ja: 化学平衡
    ka: ქიმიური წონასწორობა
    kk: Химиялық тепе-теңдік
    ko: 화학 평형
    lv: ķīmiskais līdzsvars
    mk: хемиска рамнотежа
    ml: രാസസംതുലനം
    mn: Химийн тэнцвэрт байдал
    mo: Echilibru chimic
    ms: Keseimbangan kimia
    nan: Hòa-ha̍k pêng-hêng
    nb: kjemisk likevekt
    nl: chemisch evenwicht
    nn: kjemisk likevekt
    ...
    se: Kemiijalaš dássedeaddu
    sh: Hemijska ravnoteža
    sk: Chemická rovnováha
    sl: kemijsko ravnovesje
