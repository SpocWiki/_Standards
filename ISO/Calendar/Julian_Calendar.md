...
dv_has_:
  name_:
    ...
    ann: Òfuk-acha kè Juliọs
    ar: تقويم يوليوسي
    arc: ܣܘܪܓܕܐ ܝܘܠܝܝܐ
    arq: بن دالي مصطفى
    arz: تقويم يوليانى
    ast: Calendariu xulianu
    av: Юлианияб календар
    az: Yuli təqvimi
    ba: Юлиан календары
    ban: Kalénder Julian
    ...
    ca: calendari julià
    ce: Юлианан рузма
    ceb: Kalendaryong Hulyano
    ckb: ڕۆژژمێری جولیانی
    ...
    ga: féilire Iúil
    gcr: Kalandriyé julyen
    gd: Mìosachan Iulianach
    gl: calendario xuliano
    gsw: Julianischer Kalender
    gv: feaillere Yool
    he: הלוח היוליאני
    hi: जूलियन कैलेंडर
    ...
    hu: julián naptár
    hy: Հուլյան օրացույց
    hyw: Յուլիեան Օրացոյց
    ia: calendario julian
    iba: Kalenda Julius
    id: kalender Julian
    ilo: kalendario a Huliano
    inh: Юле ханорг
    ...
    kaa: yulian kalendarı
    kcg: Ka̱la̱nda Juliyot
    kk: Юлиан күнтізбесі
    ko: 율리우스력
    krc: Юлиан орузлама
    ...
    ms: Takwim Julius
    mt: kalendarju Ġuljan
    mzn: یولیانی تقویم
    nan: Julius Le̍k-hoat
    nb: juliansk kalender
    nl: juliaanse kalender
    nn: den julianske kalenderen
    oc: Calendièr julian
    os: юлийы къæлиндар
    pa: ਜੂਲੀਅਨ ਕੈਲੰਡਰ
    pap: kalènder juliano
    ...
    ur: جولینی تقویم
    uz: Yuliy kalendari
    vec: całendàrio zulian
    vi: lịch Julius
    vls: Julioansche kalender
    war: Kalendaryo Hulyano
    wuu: 儒略曆
    xmf: იულიუსიშ კალენდარი
...
#is_/same_as :: [[_Standards/WikiData/WD~Julian_calendar,11184|WD~Julian_calendar,11184]] 
