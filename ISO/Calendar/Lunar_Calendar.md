...
dv_has_:
  name_:
    ...
    hr: lunarni kalendar
    hu: holdnaptár
    hy: Լուսնային օրացույց
    ia: Calendario lunar
    id: kalender candra
    it: calendario lunare
    ja: 太陰暦
    jv: Pananggalan candra
    ka: მთვარისმიერი კალენდარი
    kaa: Ay kalendarı
    kab: Taswast tanayyurt
    km: ចន្ទគតិ
    ko: 태음력
    ks: ژٕندٕر کیلینڈر
    ku: Salnameya heyvê
    ...
    lt: mėnulio kalendorius
    lv: Mēness kalendārs
    mg: Tetiandro manara-bolana
    mi: maramataka
    mk: месечев календар
    ml: ചാന്ദ്ര കലണ്ടർ
    mn: Билгийн тоолол
    ...
    te: చాంద్రమాన కేలండర్
    th: ปฏิทินจันทรคติ
    tr: ay takvimi
    uk: місячний календар
    ur: قمری تقویم
    uz: Oy kalendari
    vec: całendàrio lunar
    vi: âm lịch
    wa: Calindrî lunrece
    wuu: 阴历
    xmf: თუთაშ კალენდარი
...
#is_/same_as :: [[_Standards/WikiData/WD~Lunar_calendar,185688|WD~Lunar_calendar,185688]] 
