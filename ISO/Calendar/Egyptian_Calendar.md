...
dv_has_:
  name_:
    ...
    kk: Мысыр күнтізбесі
    ko: 이집트력
    la: Calendarium Aegyptium
    lt: Egiptiečių kalendorius
    mg: Tetiandro egiptiana
    mk: Египетски календар
    ml: ഈജിപ്ഷ്യൻ കലണ്ടർ
    nb: Egyptisk kalender
    ...
    sk: Staroegyptský kalendár
    sr: Египатски календар
    sv: Egyptiska kalendern
    sw: Kalenda ya Misri ya Kale
    uk: Єгипетський календар
    vec: całendàrio ezisian
    vi: Lịch Ai Cập
    wuu: 古埃及历法
    yue: 古埃及曆
    zh: 埃及历法
