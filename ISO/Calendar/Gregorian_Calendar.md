...
- Calendriér grègorien
- Calendàriu gregorianu
- Calendário gregoriano
- Calindrî grigoryin
- całendàrio gregorian
- Deiziadur gregorian
...
- Gregorian_Calendar
- Gregoriaonse kalender
- Gregorijansczi kalãdôrz
- Gregorijanski kalendar
- gregorijanski koledar
- Gregorio xiuhpōhualli
- Gregorioansche kalender
...
- Gregorius Lĭk-huák
- Gregoriuse kalender
- Gregoriusõ kallendri
- gregoriálaš kaleandar
- gregoriánsky kalendár
- gregoriánský kalendář
- Gregorjaniska pratyja
- Gregoryanong kalendaryo
...
- Grygůrjański kalyndorz
- Grėgaliaus kalėnduorios
...
- Tohi māhina faka-Kelekōlió
- Tšhupamabaka ya Gregorian
- y feaillere Gregoiragh
...
dv_has_:
  name_:
    ...
    ann: Òfuk-acha kè Giregọri
    anp: ग्रेगोरी कैलंडर
    ar: تقويم ميلادي
    arc: ܣܘܪܓܕܐ ܓܪܝܓܘܪܝܐ
    ary: تقويم ݣريݣوري
    arz: تقويم جريجورى
    as: গ্ৰেগৰিয়ান বৰ্ষপঞ্জী
    ast: calendariu gregorianu
    av: Григорианияб каленьдар
    awa: ग्रेगोरियन कलेंडर
    az: Qriqori təqvimi
    azb: میلادی تقویم
    ba: Григориан календары
    ban: Kaléndér Grégorian
    ...
    kaa: grigorian kalendarı
    kab: taswast tagrigurt
    kcg: ka̱la̱nda Gi̱regi̱ri
    ...
    mn: Григорийн тоолол
    mni: ꯒ꯭ꯔꯦꯒꯣꯔꯤꯌꯥꯟ ꯊꯄꯥꯂꯣꯟ
    mr: ग्रेगरीय दिनदर्शिका
    ms: takwim Gregory
    mt: kalendarju Gregorjan
    my: ဂရီဂေါရီးယန်း ပြက္ခဒိန်
    mzn: میلادی تقویم
    nah: Gregorio xiuhpōhualli
    nan: Gregorius Le̍k-hoat
    ...
    om: Dhaha Giriigooriyaa
    or: ଗ୍ରେଗୋରି ପାଞ୍ଜି
    os: григорийы къæлиндар
    pa: ਗ੍ਰੈਗਰੀ ਕਲੰਡਰ
    pap: kalènder gregoriano
    pl: kalendarz gregoriański
    pms: Calendari gregorian
    pnb: گریگری کلنڈر
    ...
    sc: Calendàriu gregorianu
    scn: calannariu grigurianu
    sco: Gregorian calendar
    sd: عيسوي سال
    se: gregoriálaš kaleandar
    sgs: Grėgaliaus kalėnduorios
    sh: Gregorijanski kalendar
    si: ග් රෙගරි දින දසුන
    sk: gregoriánsky kalendár
    sl: gregorijanski koledar
    sm: Kalena Kurekoria
    smn: gregoriaanlâš kalender
    sms: gregoriaanlaž kaʹlndar
    sn: Karenda ya Gregori
    ...
    szl: Grygůrjański kalyndorz
    ta: கிரெகொரியின் நாட்காட்டி
    te: గ్రెగోరియన్ కేలండర్
    tg: Гоҳшумори мелодӣ
    th: ปฏิทินเกรโกเรียน
    tl: Kalendaryong Gregoryano
    tly: Grigoriani təǧvim
    to: Tohi māhina faka-Kelekōlió
    ...
    ur: عیسوی تقویم
    uz: Grigoriy taqvimi
    vec: całendàrio gregorian
    vi: lịch Gregory
    vls: Gregorioansche kalender
    vro: Gregoriusõ kallendri
