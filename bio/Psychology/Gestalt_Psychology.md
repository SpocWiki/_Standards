...
- psicologìa dla forma
- psicología de la Gestalt
- Psicolojia de gestaltes
- psicoloxía da Gestalt
- Psicoloxía de la Gestalt
- Psikologi Gestalt
- Psychologia gestalt
- psychologia postaci
...
has_use: '[[_Standards/WikiData/WD~user_interface_design,135707|WD~user_interface_design,135707]]'
practiced_by: '[[_Standards/WikiData/WD~Gestalt_psychologists,5674506|WD~Gestalt_psychologists,5674506]]'
...
dv_has_:
  name_:
    ...
    el: Ψυχολογία Gestalt
    en: Gestalt psychology
    eo: Geŝtalt-psikologio
    es: psicología de la Gestalt
    et: Geštaltpsühholoogia
    eu: Gestalt
    fa: گشتالت
    fi: Hahmopsykologia
    fr: psychologie de la forme
    ga: Síceolaíocht Gestalt
    gl: psicoloxía da Gestalt
    he: פסיכולוגיית הגשטלט
    hi: गेस्टाल्ट मनोविज्ञान
    hr: Geštaltizam
    hu: gestaltpszichológia
    hy: Գեշտալդ հոգեբանություն
    id: Gestalt
    ...
    ko: 게슈탈트 심리학
    ky: Гештальт
    la: Psychologia gestalt
    lfn: Psicolojia de gestaltes
    lt: geštaltpsichologija
    lv: Geštalts
    ml: ജെസ്റ്റാൾട്ട് സൈക്കോളജി
    ms: Psikologi Gestalt
    nb: gestaltpsykologi
    nl: gestaltpsychologie
    nn: gestaltpsykologi
    pa: ਗੇਸਟਾਲਟ ਮਨੋਵਿਗਿਆਨ
    pl: psychologia postaci
    pms: psicologìa dla forma
    ps: د ګشتالت ارواپوهنه
    pt: Gestalt
    ro: Gestaltism
    ru: гештальтпсихология
    sh: Geštalt psihologija
    sk: Gestaltistická metodológia
    sl: Gestalt psihologija
    sr: Geštaltizam
    sv: gestaltpsykologi
    ta: முழுநிலை கோட்பாடு
    tg: Гешталтпсихология
    th: จิตวิทยาเกสตัลต์
    tl: Sikolohiyang Gestalt
    tr: Gestalt psikolojisi
    uk: ґештальтпсихологія
    uz: Geshtaltpsixologiya
    vi: Tâm lý học Gestalt
    wuu: 格式塔学派
    yue: 完形心理學
    zh: 格式塔学派
    zh_cn: 格式塔学派
