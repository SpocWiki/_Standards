...
dv_has_:
  name_:
    ar: 'رقم سبعة السحري: بجمع أو طرح اثنين'
    ast: The Magical Number Seven, Plus or Minus Two
    bg: Магическото число седем плюс или минус две
    cs: Millerovo magické číslo
    ...
    fr: Le nombre magique sept, plus ou moins deux
    he: המספר הקסום שבע, פלוס או מינוס שתיים
    hy: Կախարդական թիվ յոթ պլյուս-մինուս երկու
    it: Il magico numero sette, più o meno due
    ja: マジカルナンバー7+-2
    ko: 매직 넘버 7, ±2
    nl: The Magical Number Seven, Plus or Minus Two
    pl: Liczba Millera
    ru: Магическое число семь плюс-минус два
    sv: Det magiska talet sju, plus minus två
    tr: Sihirli Sayı Yedi, Artı veya Eksi İki
    uk: Магічне число сім, плюс-мінус два
