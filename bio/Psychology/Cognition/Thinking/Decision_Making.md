...
studied_by: '[[_Standards/WikiData/WD~decision_theory,177571|WD~decision_theory,177571]]'
has_characteristic:
- '[[_Standards/WikiData/WD~trade_off,638123|WD~trade_off,638123]]'
- '[[_Standards/WikiData/WD~preference,908656|WD~preference,908656]]'
- '[[_Standards/WikiData/WD~mindset,1339824|WD~mindset,1339824]]'
- '[[_Standards/WikiData/WD~Strategic_Assumptions,7621770|WD~Strategic_Assumptions,7621770]]'
subclass_of:
...
has_cause: '[[_Standards/WikiData/WD~administering_agent,4445086|WD~administering_agent,4445086]]'
different_from:
- '[[_Standards/WikiData/WD~selection,12888920|WD~selection,12888920]]'
- '[[_Standards/WikiData/WD~decision,16513426|WD~decision,16513426]]'
said_to_be_the_same_as: '[[_Standards/WikiData/WD~selection,12888920|WD~selection,12888920]]'
has_effect: '[[_Standards/WikiData/WD~decision,16513426|WD~decision,16513426]]'
...
dv_has_:
  name_:
    ...
    ckb: بڕیاردان
    cs: rozhodování
    da: beslutningsproces
    de: Entscheidungsprozess
    el: λήψη αποφάσεων
    en: decision making
    eo: decidado
    ...
    gl: toma de decisións
    gsw: Entscheidigsprozäss
    he: קבלת החלטות
    hi: निर्णयन
    hr: odlučivanje
    hu: döntéshozatal
    hy: Որոշման ընդունում
    id: Keputusan
    is: Ákvarðanataka
    it: processo decisionale
    ja: 意思決定
    jv: Gumawé pepunton
    kaa: qarar qabıl etiw
    ko: 의사결정
    lt: apsisprendimas
    lv: lēmumu pieņemšana
    mk: одлучување
    mn: Шийдвэр гаргалт
    ms: pembuatan keputusan
    nb: avgjørelsesprosess
    ne: निर्णय निर्माण प्रक्रिया
    nl: besluitvorming
    nn: avgjerdsprosess
...
> is regarded as the cognitive process resulting in the selection of a belief or a course of action 
> among several possible **alternative options**. 
> 
> It could be either rational or irrational. 
> The decision-making process is a reasoning process 
> based on assumptions of values, preferences and beliefs of the decision-maker. 
> Every decision-making process 
> produces a **final choice, which may or may not prompt action**.
>
> Research about decision-making is also published under the 
> label problem solving, particularly in European psychological research.
>
