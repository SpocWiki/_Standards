...
dv_has_:
  name_:
    ...
    hr: Intimni odnos
    hu: párkapcsolat
    hy: ինտիմ հարաբերություններ
    it: relazione intima
    ja: 親密な関係
    kn: ನಿಕಟ ಸಂಬಂಧ
    ko: 친밀 관계
    kw: karder ogas
    lt: intymūs santykiai
    ...
    pa: ਗੂੜ੍ਹਾ ਰਿਸ਼ਤਾ
    pl: związek intymny
    pt: relacionamento íntimo
    ro: parteneriat intim
    ru: интимные отношения
    sh: intimni odnos
    skr: قربت دا ساک
    sl: intimno razmerje
    sq: marrëdhënia intime
    sr: интимни однос
    sv: nära relation
    tr: yakın ilişki
    uk: романтичне партнерство
    ur: قربت کا رشتہ
    vi: mối quan hệ thân mật
    wuu: 亲密关系
    yi: אינטימיטעט
    yue: 親密關係
    zh: 親密關係
...
#is_/same_as :: [[_Standards/WikiData/WD~Intimate_relationship,736922|WD~Intimate_relationship,736922]] 
