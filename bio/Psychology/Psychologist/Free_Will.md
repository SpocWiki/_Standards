...
- llibre albedríu
- lliure albir
- Lugaring nga pagboot
- Lìber volèj
- Malayang kalooban
- Mennerezh
- Nawaya a nakem
- Paradoksê iradeyê serbesti
- Rieda ħielsa
- Safidy malalaka
- Slobodna volja
- Slobodná vôľa
...
does_not_have_characteristic: '[[_Standards/WikiData/WD~limitation,105766481|WD~limitation,105766481]]'
facet_of: '[[_Standards/WikiData/WD~will,364340|WD~will,364340]]'
has_characteristic: '[[_Standards/WikiData/WD~liberty,2979|WD~liberty,2979]]'
instance_of:
...
dv_has_:
  name_:
    ...
    bs: Slobodna volja
    btm: Giot bebas
    bxr: Һанаанай эрхэ сүлөө
    ca: lliure albir
    ce: Лааман маршо
    ckb: ئازادیی ھەڵبژاردن
    crh: Azat irade
    cs: svobodná vůle
    cy: ewyllys rydd
    da: fri vilje
    ...
    ja: 自由意志
    jam: Frii wil
    ka: ნების თავისუფლება
    kbp: Fɩtɩyɩm taa maɣzʊʊ ɖoŋ
    kk: Ерік бостандығы
    ko: 자유의지
    ku: Azadî
    ky: Эрктин эркиндиги
    la: Liberum arbitrium
    lfn: Sur la vole libre
    li: Vrieje wil
    lmo: Liber arbitri
    lo: ເຈດຈຳນົງເສລີ
    lt: laisva valia
...
>
> Free will is closely linked to the concepts of moral responsibility, praise, culpability, 
> and other judgements which apply only to actions that are freely chosen. 
> 
> It is also connected with the concepts of advice, persuasion, deliberation, 
> and prohibition. 
> 
> Traditionally, only actions that are freely willed are seen as deserving credit or blame. 
> Whether free will exists, what it is and the implications of whether it exists or not 
> constitute some of the longest running debates of philosophy. 
> Some conceive of free will as the ability 
> to act beyond the limits of external influences or wishes.
>
