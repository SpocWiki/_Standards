...
dv_has_:
  name_:
    ...
    la: psychoanalysis
    lb: Psychoanalys
    lfn: Sigmund Freud e psicoanalise
    lij: psicoanalixi
    lt: psichoanalizė
    lv: psihoanalīze
    mk: Психоанализа
    ...
    mn: Психоанализ
    ms: Psikoanalisis
    my: စိတ်ခွဲခြားစိစစ်ရေးပညာ
    mzn: روان کاوی
    nan: cheng-sîn-hun-sek
    nb: psykoanalyse
    nl: psychoanalyse
    nn: psykoanalyse
    oc: psicanalisi
...
#is_/same_as :: [[_Standards/WikiData/WD~Psychoanalysis,41630|WD~Psychoanalysis,41630]] 
