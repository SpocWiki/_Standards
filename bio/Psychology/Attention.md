...
different_from: '[[_Standards/WikiData/WD~meditation,108458|WD~meditation,108458]]'
subclass_of:
...
- '[[_Standards/WikiData/WD~alertness,1423044|WD~alertness,1423044]]'
- '[[_Standards/WikiData/WD~Muraqaba,2275149|WD~Muraqaba,2275149]]'
has_part_s_: '[[_Standards/WikiData/WD~attentional_control,4818236|WD~attentional_control,4818236]]'
part_of:
- '[[_Standards/WikiData/WD~psychology_terminology,77468620|WD~psychology_terminology,77468620]]'
- '[[_Standards/WikiData/WD~memory_and_attention,110620109|WD~memory_and_attention,110620109]]'
...
> **Attention** or focus, is the concentration of awareness on some phenomenon 
> to the exclusion of other stimuli. 
> 
> It is the selective concentration on discrete information, 
...
> 
> Attention has also been described as the 
> allocation of limited cognitive processing resources. 
> 
> Attention is manifested by an attentional bottleneck, 
> in terms of the amount of data the brain can process each second; 
> for example, in human vision, less than 1% of the visual input data stream of 1MByte/sec can enter the bottleneck, leading to inattentional blindness.
>
