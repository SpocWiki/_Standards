...
exact_match: http://purl.obolibrary.org/obo/GO_0050890
Basisklassifikation: 77.31
P8189: 987007284035305171
UMLS_CUI: C0009240
MeSH_tree_code: F02.463.188
Colon_Classification: S:4
dv_has_:
  name_:
    af: kognisie
    ar: استعراف
    ...
    se: kognišuvdna
    sh: spoznaja
    si: ප්රජානනය (ප්රජානනය පිළිබඳ හැඳින් වීමක් )
    sk: poznanie
    sl: kognicija
    smj: kognisjåvnnå
    smn: kognitio
...
> **Cognition** refers to the broad set of mental processes that relate to acquiring knowledge 
...
> perception, attention, thought, imagination, intelligence, the formation of knowledge, 
...
> Cognitive processes use existing knowledge to discover new knowledge.
>
