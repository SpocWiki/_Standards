...
- 35.75
- 35.65
image: http://commons.wikimedia.org/wiki/Special:FilePath/1bna%20naba%20ribbon%20v.png
Universal_Decimal_Classification: 547.963.32
CAS_Registry_Number: 9008-72-4
UMLS_CUI: C0028606
MeSH_tree_code: D13.444
Krugosvet_article_archived_: nauka_i_tehnika/himiya/NUKLEINOVIE_KISLOTI.html
Commons_category: Nucleic acids
dv_has_:
  name_:
    ar: حمض نووي
    arz: الاحماض النوويه
    ast: ácidu nucleico
    az: nuklein turşuları
    ba: нуклеин кислоталары
    ban: Asam nukleat
    ...
    km: អាស៊ីតនុយក្លេអ៊ិច
    kn: ನ್ಯೂಕ್ಲಿಯಿಕ್ ಆಮ್ಲ
    ko: 핵산
    ks: نیوکِلیک اسیڈ
    ku: asîdên navikê
    ...
    te: కేంద్రకామ్లాలు
    th: กรดนิวคลีอิก
    tk: nuklein kislotalary
    tl: asidong nukleyiko
    tr: nükleik asit
    udm: нуклеин чырсалъёс
    ug: يادور كىسلاتاسى
    uk: нуклеїнові кислоти
    uz: nuklein kislotalar
    vi: axit nucleic
    war: asido nukleyiko
    wuu: 核酸
    yue: 核酸
...
#is_/same_as :: [[_Standards/WikiData/WD~Nucleic_acids,123619|WD~Nucleic_acids,123619]] 
