...
Commons_category: Heredity
Krugosvet_article_archived_: nauka_i_tehnika/biologiya/NASLEDSTVENNOST.html
dv_has_:
  name_:
    ar: توريث
    ast: Heriedu xenéticu
    az: İrsiyyət
    ba: Нәҫелсәнлек
    be: спадчыннасць
    ...
    et: Pärilikkus
    eu: herentzia genetiko
    fa: وراثت
    fi: perinnöllisyys
    fr: hérédité
    ga: oidhreachtúlacht
    gcr: Érédité
    gl: Herdanza xenética
    gn: heñoi'ypy
    ha: Ga do
    he: תורשה
    hi: अनुवांशिकता
    ...
    ht: Eredite
    hu: öröklődés
    hy: Ժառանգականություն
    id: Hereditas
    io: Heredo
    it: ereditarietà genetica
    ja: 遺伝
    jam: Erediti
    jv: Héréditas
    ka: მემკვიდრეობითობა
    ...
    tg: Ирсият
    th: กรรมพันธุ์
    tl: Pagmamana ng katangian
    tr: kalıtım
    tt: Нәселдәнлек
    uk: спадковість
    ur: نسب
    uz: Ajdod
    vec: eredità zenètega
    vi: di truyền
    wuu: 遗传
    yue: 遺傳
    zh: 遺傳
