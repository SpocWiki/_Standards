...
equivalent_class: http://purl.org/ontology/wo/Adaptation
Krugosvet_article_archived_: nauka_i_tehnika/biologiya/ADAPTATSIYA.html
Dewey_Decimal_Classification: 578.47
dv_has_:
  name_:
    af: Biologiese aanpassing
    ar: تكيف
    ast: adautación biolóxica
    az: Adaptasiya
    bas: lìádɓɛ̀
    be: адаптацыя
    be_tarask: адаптацыя
    ...
    ky: Адаптация
    la: Adaptatio
    lfn: Ajusta en evolui
    lt: adaptacija
    lv: adaptācija
    mk: адаптација
    ml: അനുകൂലനം
    mn: Дасан зохицолт (биологи)
    ms: penyesuaian
    nan: Sek-èng
    nb: tilpasning
    ne: अनुकूलन
    ...
    pt: adaptação
    ro: adaptare
    ru: эволюционная адаптация
    rue: Адаптація
    sat: ᱟ.ᱨᱩ ᱯᱷᱮᱨᱟᱣ
    sh: Adaptacija
    sk: Adaptácia (biológia)
    sl: prilagoditev
    sq: Adaptimi
    sr: прилагођавање
    sr_ec: Адаптација
...
> 
> Firstly, it is the dynamic evolutionary process of natural selection 
...
### #is_/same_as :: [[/_Standards/bio/Ecology/Adaptation|Adaptation]] 

### #is_/same_as :: [[/_public/bio/Ecology/Adaptation.public|Adaptation.public]] 

### #is_/same_as :: [[/_internal/bio/Ecology/Adaptation.internal|Adaptation.internal]] 

### #is_/same_as :: [[/_protect/bio/Ecology/Adaptation.protect|Adaptation.protect]] 

### #is_/same_as :: [[/_private/bio/Ecology/Adaptation.private|Adaptation.private]] 

### #is_/same_as :: [[/_personal/bio/Ecology/Adaptation.personal|Adaptation.personal]] 

### #is_/same_as :: [[/_secret/bio/Ecology/Adaptation.secret|Adaptation.secret]] 
