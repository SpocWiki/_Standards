...
- Bioferskaat
- Biokepelbagaian
- biologalaš máŋggahápmásašvuohta
- biologická diverzita
- biologinė įvairovė
- Biologisk mangfald
- biologisk mangfold
- biologisk mångfald
- biologisâš maaŋgâhámásâšvuotâ
- Bioloji müxtəliflik
- bioloogiline mitmekesisus
- biolooglaž määŋghämmsažvuõtt
...
- Biyodibersidad
- biyoçeşitlilik
- diversitas biologica
- Divèsite byolojik
- Keanekaragaman hayati
- Lubdaneessummaa
- Líffræðilegur fjölbreytileiki
- mìnten ndi minten li ŋkɔ̀ŋ
...
dv_has_:
  name_:
    ...
    hi: जैव विविधता
    hr: Bioraznolikost
    ht: Divèsite byolojik
    hu: biodiverzitás
    hy: կենսաբազմազանություն
    ia: Biodiversitate
    id: Keanekaragaman hayati
    ig: Biodiversity
    io: Biodiverseso
    is: Líffræðilegur fjölbreytileiki
    it: biodiversità
    ja: 生物多様性
    ...
    ko: 생물 다양성
    ku: Zorbûna jiyanî
    la: diversitas biologica
    lb: Biodiversitéit
    lg: Obulamu obw'Enjawulo
    li: Biodiversiteit
    lt: biologinė įvairovė
    lv: bioloģiskā daudzveidība
    mk: биоразновидност
    ml: ജൈവവൈവിധ്യം
    mn: Биологийн олон янз байдал
    mnw: ဂကူဗဳဇဇဳဝ
    mr: जैवविविधता
    ms: Biokepelbagaian
    mt: bijodiversità
    my: ဇီဝမျိုးစုံမျိုးကွဲ
    nb: biologisk mangfold
    ne: जैविक विविधता
    new: जैविक विविधता
    nl: biodiversiteit
    nn: Biologisk mangfald
    nov: biodiverseso
    oc: Biodiversitat
    om: Lubdaneessummaa
    pa: ਜੀਵ ਵੰਨ-ਸੁਵੰਨਤਾ
    pl: różnorodność biologiczna
    pnb: حیاتی تنوع
    ps: دژوندبڼو ډولونه
    pt: biodiversidade
    ...
    sco: biodiversity
    sd: حياتياتي تنوع
    se: biologalaš máŋggahápmásašvuohta
    sh: Bioraznolikost
    si: ජෛව විවිධත්වය
    sk: biodiverzita
    sl: biotska pestrost
    smn: biologisâš maaŋgâhámásâšvuotâ
    sms: biolooglaž määŋghämmsažvuõtt
    sq: Biodiversiteti
    sr: биолошка разноврсност
    sv: biologisk mångfald
    sw: viumbe hai
    ta: உயிரியற் பல்வகைமை
    te: జీవవైవిధ్యం
    tg: Гуногунии зистӣ
