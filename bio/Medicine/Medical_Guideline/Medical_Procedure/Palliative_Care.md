...
dv_has_:
  name_:
    ...
    ca: cura pal·liativa
    cs: paliativní péče
    da: palliativ behandling
    de: Palliative Care
    el: παρηγορητική φροντίδα
    en: palliative care
    eo: paliativa zorgado
    es: cuidados paliativos
    eu: zainketa aringarriak
    fa: مراقبت تسکینی
    fi: palliatiivinen hoito
    fr: soin palliatif
    fy: Palliative soarch
    ga: cúram maolaitheach
    gl: coidados paliativos
    he: טיפול פליאטיבי
    hi: प्रशामक उपचार
    hr: palijativna skrb
    hu: palliatív terápia
    hy: Պալիատիվ օգնություն
    id: Perawatan paliatif
    it: cure palliative
    ja: 緩和ケア
    ka: პალიატიური მზრუნველობა
    ko: palliative
    lb: Palliativfleeg
    lv: paliatīvā aprūpe
    ml: സാന്ത്വനചികിത്സ
    nb: palliativ behandling
    nl: palliatieve zorg
    nn: palliativ behandling
    pt: paliativismo
    ro: îngrijire paliativă
    ru: паллиативная помощь
    se: palliatiiva dikšu
    sh: palijativna skrb
    sl: paliacija
    smn: palliativlâš tipšo
    sms: palliatiivlaž håidd
    sr: Palijativna nega
    sv: palliativ vård
    ta: மரணவலி தணிப்புச் சிகிச்சை
    th: การรักษาบรรเทา
    tr: palyatif bakım
    tt: паллиатив ярдәм
    uk: паліативна допомога
    uz: Palliativ terapiya
    vi: Chăm sóc giảm nhẹ
