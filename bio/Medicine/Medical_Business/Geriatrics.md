...
- геријатрија
- гериатрия
- Гериатриялық тәжірибенің нозологиясы
- герыятрыя
- Пирпизишкӣ
- גריאטריה
- طب المسنين
...
dv_has_:
  name_:
    ...
    eu: geriatria
    fa: پیرپزشکی
    fi: kliininen gerontologia
    fr: gériatrie
    ga: leigheas seanaoise
    gl: xeriatría
    he: גריאטריה
    hi: जरारोगविद्या
    hr: Gerijatrija
    ...
    ja: 老人医学
    ka: გერიატრია
    kk: Гериатриялық тәжірибенің нозологиясы
    ko: 노인의학
    ku: Doktorî a pîr û kalan
    lt: geriatrija
    lv: geriatrija
    mk: геријатрија
    ml: ജെറിയാട്രിക്സ്
    ...
    sr: геријатрија
    sv: geriatrik
    ta: முதியோர் மருத்துவம்
    te: జిరియాట్రిక్స్
    tg: Пирпизишкӣ
    tl: heriyatriko
    tr: yaşlılık hekimliği
    uk: геріатрія
    uz: Geriatriya
    vi: Lão khoa
    war: heriyatrika
...
### #is_/same_as :: [[/_Standards/bio/Medicine/Medical_Business/Geriatrics|Geriatrics]] 

### #is_/same_as :: [[/_public/bio/Medicine/Medical_Business/Geriatrics.public|Geriatrics.public]] 

### #is_/same_as :: [[/_internal/bio/Medicine/Medical_Business/Geriatrics.internal|Geriatrics.internal]] 

### #is_/same_as :: [[/_protect/bio/Medicine/Medical_Business/Geriatrics.protect|Geriatrics.protect]] 

### #is_/same_as :: [[/_private/bio/Medicine/Medical_Business/Geriatrics.private|Geriatrics.private]] 

### #is_/same_as :: [[/_personal/bio/Medicine/Medical_Business/Geriatrics.personal|Geriatrics.personal]] 

### #is_/same_as :: [[/_secret/bio/Medicine/Medical_Business/Geriatrics.secret|Geriatrics.secret]] 
