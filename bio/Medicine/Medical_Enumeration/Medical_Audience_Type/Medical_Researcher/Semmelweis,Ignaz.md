...
dv_has_:
  name_:
    ...
    az: İqnaç Zemmelveys
    azb: ایقناز سملویس
    ba: Игнац Филипп Земмельвайс
    bcl: Ignaz Semmelweis
    be: Ігнац Земельвейс
    bg: Игнац Земелвайс
    bn: ইগনাৎস জেমেলভাইস
    br: Ignaz Semmelweis
    bs: Ignaz Semmelweis
    ca: Ignaz Semmelweis
    cs: Ignác Filip Semmelweis
    da: Ignaz Semmelweis
    de: Ignaz Semmelweis
    el: Ιγκνάτς Σέμελβαϊς
    en: Ignaz Semmelweis
    eo: Ignaz Semmelweis
    es: Ignaz Semmelweis
    et: Ignaz Semmelweis
    ...
    fr: Ignaz Philipp Semmelweis
    ga: Ignaz Phillipp Semmelweis
    gl: Ignaz Semmelweis
    he: איגנץ זמלווייס
    hr: Ignaz Semmelweis
    hu: Semmelweis Ignác
    hy: Իգնաց Ֆիլիպ Զեմելվայս
    id: Ignaz Semmelweis
    io: Ignaz Semmelweis
    it: Ignác Semmelweis
    ja: イグナーツ・ゼンメルヴァイス
    ...
    ko: 이그나츠 제멜바이스
    kw: Ignaz Semmelweis
    la: Ignatius Semmelweis
    lb: Ignaz Semmelweis
    lij: Ignàc Filip Semmelweis
    lt: Ignaz Philipp Semmelweis
    lv: Ignācs Šemmelveišs
    mg: Ignace Philippe Semmelweis
    ml: ഇഗ്നാസ് ഫിലിപ്പ് സെമ്മൽവെയ്സ്
    ms: Ignaz Semmelweis
    nb: Ignaz Semmelweis
    nl: Ignaz Semmelweis
    nn: Ignaz Semmelweis
    pam: Ignaz Semmelweis
    pl: Ignaz Semmelweis
    ps: اېګناز زېملوایس
    pt: Ignaz Semmelweis
    ...
    sc: Ignàc Fülöp Semmelweis
    scn: Ignàzziu Semmelweis
    sh: Ignaz Semmelweis
    sk: Ignác Filip Semmelweis
    sl: Ignaz Semmelweis
    sq: Ignaz Semmelweis
    sr: Игнац Земелвајс
    sv: Ignaz Semmelweis
    ta: இக்னாஸ் செம்மல்விஸ்
    te: ఇగ్నాజ్ సెమెల్వెయ్స్
    th: อิกนาทซ์ เซ็มเมิลไวส์
    tl: Ignaz Semmelweis
    tr: Ignaz Semmelweis
    uk: Ігнац Земмельвейс
    uz: Ignaz Semmelweis
    vi: Ignaz Semmelweis
    war: Ignaz Semmelweis
    wuu: 伊格纳兹·塞麦尔维斯
...
### #is_/same_as :: [[/_Standards/bio/Medicine/Medical_Enumeration/Medical_Audience_Type/Medical_Researcher/Semmelweis,Ignaz|Semmelweis,Ignaz]] 

### #is_/same_as :: [[/_public/bio/Medicine/Medical_Enumeration/Medical_Audience_Type/Medical_Researcher/Semmelweis,Ignaz.public|Semmelweis,Ignaz.public]] 

### #is_/same_as :: [[/_internal/bio/Medicine/Medical_Enumeration/Medical_Audience_Type/Medical_Researcher/Semmelweis,Ignaz.internal|Semmelweis,Ignaz.internal]] 

### #is_/same_as :: [[/_protect/bio/Medicine/Medical_Enumeration/Medical_Audience_Type/Medical_Researcher/Semmelweis,Ignaz.protect|Semmelweis,Ignaz.protect]] 

### #is_/same_as :: [[/_private/bio/Medicine/Medical_Enumeration/Medical_Audience_Type/Medical_Researcher/Semmelweis,Ignaz.private|Semmelweis,Ignaz.private]] 

### #is_/same_as :: [[/_personal/bio/Medicine/Medical_Enumeration/Medical_Audience_Type/Medical_Researcher/Semmelweis,Ignaz.personal|Semmelweis,Ignaz.personal]] 

### #is_/same_as :: [[/_secret/bio/Medicine/Medical_Enumeration/Medical_Audience_Type/Medical_Researcher/Semmelweis,Ignaz.secret|Semmelweis,Ignaz.secret]] 
