...
dv_has_:
  name_:
    ...
    csb: Pòtrusë
    de: Pilzvergiftung
    el: δηλητηρίαση από μανιτάρια
    en: mushroom poisoning
    eo: veneniĝo per fungoj
    es: envenenamiento por setas
    et: seenemürgitus
    eu: mizetismoa
    fa: مسمومیت با قارچ
    fi: sienimyrkytys
    fr: mycétisme
    gl: Intoxicación por cogomelos velenosos
    hi: मशरूम विषाक्तता
    hr: Micetizam
    hu: gombamérgezés
    hy: Սնկային թունավորումներ
    id: Keracunan jamur
    is: Sveppaeitrun
    it: fungo velenoso
    ja: キノコ中毒
    ko: 버섯 중독
    lt: Nuodingieji grybai
    lv: Indīgās sēnes
    nb: soppforgiftning
    nl: paddenstoelvergiftiging
    nn: soppforgifting
    pl: zatrucie grzybami
    pt: envenenamento por cogumelos
    ro: Intoxicația acută cu ciuperci necomestibile
    ru: отравление грибами
    sh: Trovanje gljivama
    sl: zastrupitev z gobami
    sq: Helmimi nga kërpudhat
    sr: тровање гљивама
    sv: svampförgiftning
    ta: காளான் நஞ்சாதல்
    tr: Mantar zehirleri
    uk: отруєння грибами
    uz: Zaharli zamburugʻlar
    vi: Ngộ độc nấm
    wa: Epweznant tchampion
    yue: 菇類中毒
    zh: 蕈類中毒
---
...
#is_/same_as :: [[_Standards/WikiData/WD~Mushroom_poisoning,852186|WD~Mushroom_poisoning,852186]] 
