...
type: Type
Krugosvet_article_archived_: meditsina/infektsionnye-bolezni
has_immediate_cause: '[[_Standards/WikiData/WD~infection,166231|WD~infection,166231]]'
has_cause: '[[_Standards/WikiData/WD~pathogen,170065|WD~pathogen,170065]]'
has_characteristic: '[[_Standards/WikiData/WD~incubation_period,193566|WD~incubation_period,193566]]'
manifestation_of: '[[_Standards/WikiData/WD~pathogenesis,372016|WD~pathogenesis,372016]]'
described_by_source:
...
- '[[_Standards/WikiData/WD~human_disease_ecology,102123539|WD~human_disease_ecology,102123539]]'
health_specialty: '[[_Standards/WikiData/WD~infectious_diseases,788926|WD~infectious_diseases,788926]]'
has_list: '[[_Standards/WikiData/WD~list_of_infectious_diseases,1303328|WD~list_of_infectious_diseases,1303328]]'
different_from:
- '[[_Standards/WikiData/WD~vector_borne_disease,2083837|WD~vector_borne_disease,2083837]]'
- '[[_Standards/WikiData/WD~Infectious_Diseases,27720013|WD~Infectious_Diseases,27720013]]'
opposite_of: '[[_Standards/WikiData/WD~non_communicable_disease,3137154|WD~non_communicable_disease,3137154]]'
...
history_of_topic: '[[_Standards/WikiData/WD~history_of_infectious_diseases,6139317|WD~history_of_infectious_diseases,6139317]]'
instance_of:
- '[[_Standards/WikiData/WD~academic_discipline,11862829|WD~academic_discipline,11862829]]'
- '[[_Standards/WikiData/WD~class_of_disease,112193867|WD~class_of_disease,112193867]]'
has_effect: '[[_Standards/WikiData/WD~infective_psychosis,15640367|WD~infective_psychosis,15640367]]'
topic_has_template:
- '[[_Standards/WikiData/WD~Template_Infectious_disease,18041655|WD~Template_Infectious_disease,18041655]]'
- '[[_Standards/WikiData/WD~Template_Infobox_medical_condition,22765453|WD~Template_Infobox_medical_condition,22765453]]'
- '[[_Standards/WikiData/WD~Template_Concepts_in_infectious_disease,101413638|WD~Template_Concepts_in_infectious_disease,101413638]]'
subclass_of:
- '[[_Standards/WikiData/WD~infection_associated_with_diseases,42417296|WD~infection_associated_with_diseases,42417296]]'
...
IAB_code: 297
OmegaWiki_Defined_Meaning: 757231
page_banner: http://commons.wikimedia.org/wiki/Special:FilePath/WV%20banner%20Infectious%20diseases%20Vaccine.jpg
image: http://commons.wikimedia.org/wiki/Special:FilePath/Malaria.jpg
ICD_9_CM:
- 136.8
- 079.0
- 136.9
Commons_category: Infectious diseases and disorders
WordLift_URL: http://data.thenextweb.com/tnw/entity/infectious_disease
exact_match: http://purl.obolibrary.org/obo/DOID_0050117
Stack_Exchange_tag: https://biology.stackexchange.com/tags/infectious-diseases
equivalent_class: https://schema.org/InfectiousDisease
ICD_10_CM: A00.B99
UMLS_CUI:
- C0001485
- C0009450
...
dv_has_:
  name_:
    af: Aansteeklike siekte
    an: Malautía infecciosa
    ar: مرض معد
    arz: مرض معدى
    as: সংক্ৰামক ৰোগ
    ...
    fy: Ynfeksjesykte
    ga: galar tógálach
    gl: doenza infecciosa
    gn: mba'asy pámo
    gv: gorley gowaltagh
    hak: Chhòn-ngiam-phiang
    he: מחלה מידבקת
    hi: संक्रामक रोग
    hr: infektivna bolest
    hsb: infekciska chorosć
    ht: Maladi kontajye
    hu: fertőző betegség
    hy: վարակիչ հիվանդություն
    id: penyakit infeksi
    ig: ọrịa ọrịa
    ...
    kw: dises klevesus
    ky: Жугуштуу оорулар
    la: morbus infectiosus
    lb: Infektiounskrankheet
    lt: infekcinė liga
    lv: infekcijas slimība
    mhr: пижедылше чер
    mk: заразна болест
    mr: संसर्गजन्य रोग
    ...
    nl: infectieziekte
    nn: infeksjonssjukdom
    nqo: ߖߊ߲߬ߞߊ߬ߙߏ߬ ߞߟߊߞߟߊߡߊ
    oc: malautiá infecciosa
    or: ସଂକ୍ରାମକ ରୋଗ
    pap: enfermedat infeksioso
    pl: choroba zakaźna
    ps: ساري ناروغۍ
    pt: doença infeciosa
    ...
    rue: инфекчна хворота
    sa: औपसर्गिकव्याधिः
    sah: Инфекционнай ыарыыннан
    sco: infectious disease
    se: njoammudávda
    sh: Infektivne bolesti
    si: බෝවන රෝග
    simple: Infectious disease
    sk: infekčná choroba
    sl: infekcijska bolezen
    smn: njuámmootavdâ
    sms: pâššnemkõpp
    ...
    ur: متعدی امراض
    uz: Infeksion kasalliklar
    vi: bệnh truyền nhiễm
    vo: näfätamaläd
    vro: Külgenakkaja tõbi
    war: Nakakatapon nga sakit
    wuu: 传染病
    yue: 傳染病
    za: Binghlah
    zh: 傳染病
...
> An infection is the invasion of tissues by pathogens, their multiplication, 
> and the reaction of host tissues to the infectious agent and the toxins they produce. 
> 
> An **infectious disease**, also known as a transmissible disease or communicable disease, 
...
>
> Treatment for infections depends on the type of pathogen involved. 
...
> causing approximately 9.2 million deaths in 2013 (17% of all deaths).  
