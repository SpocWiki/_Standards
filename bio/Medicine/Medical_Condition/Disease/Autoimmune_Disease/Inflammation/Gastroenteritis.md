...
ICD_9_CM: 558.9
image: http://commons.wikimedia.org/wiki/Special:FilePath/Gastroenteritis%20viruses.jpg
exact_match:
- http://identifiers.org/doid/DOID:2326
- http://purl.obolibrary.org/obo/DOID_2326
- http://purl.obolibrary.org/obo/SYMP_0019159
UMLS_CUI: C0017160
MeSH_tree_code: C06.405.205
ICD_10_CM: K52.9
dv_has_:
  name_:
    af: gastroenteritis
    ...
    fr: gastro-entérite
    ga: gastaireintríteas
    gcr: Gastro-antérit
    gl: Gastroenterite
    gn: kambyrujere mba'asy
    gsw: Gastroenteritis
    ha: Gastroenteritis
    he: דלקת הקיבה והמעיים
    hi: जठरांत्र शोथ
    hif: gastroenteritis ke bemari
    hr: gastroenteritis
    hu: gyomor-bél hurut
    hy: սուր գաստրոէնտերիտ
    ia: gastroenteritis
    id: Gastroenteritis
    is: Maga- og garnabólga
    it: gastroenterite
    ja: 胃腸炎
    kk: Гастроэнтерит
    ko: 장염
    ...
    lv: gastroenterīts
    mk: Гастроентеритис
    ml: ഗാസ്ട്രോ എന്ററൈറ്റിസ്
    mr: गॅस्ट्रोएन्टेरिटिस
    ms: Gastroenteritis
    nb: mage-tarmkatarr
    nds: Gastroenteritis
    ne: सङ्क्रामक पखाला
