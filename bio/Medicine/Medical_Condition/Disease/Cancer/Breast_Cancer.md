...
symptoms_and_signs:
  ...
  - "[[db/nipple_discharge]]"
  - "[[db/lump_in_chest]]"
health_specialty: "[[db/oncology]]"
drug_or_therapy_used_for_treatment:
  - "[[db/letrozole]]"
  - "[[db/fluorouracil]]"
  - "[[db/mitoxantrone]]"
  - "[[db/(RS)_aminoglutethimide]]"
  - "[[db/vinblastine]]"
  - "[[db/(RS)_cyclophosphamide]]"
  - "[[db/eribulin]]"
  - "[[db/megestrol]]"
  - "[[db/fluoxymesterone]]"
  - "[[db/tamoxifen]]"
  ...
  - "[[db/everolimus]]"
  - "[[db/nandrolone]]"
  - "[[db/methyltestosterone]]"
  - "[[db/methotrexate]]"
  - "[[db/17β_estradiol]]"
  - "[[db/paclitaxel]]"
  - "[[db/diethylstilbestrol]]"
  - "[[db/epirubicin]]"
  - "[[db/dexrazoxane]]"
  - "[[db/leuprolide]]"
  - "[[db/idarubicin]]"
  ...
  - "[[db/tucatinib]]"
  - "[[db/ribociclib]]"
  - "[[db/goserelin_acetate]]"
  - "[[db/doxorubicin]]"
criterion_used: "[[db/transforming_growth_factor]]"
risk_factor: "[[db/smoking]]"
handled_mitigated_or_managed_by: "[[db/Breast_cancer_management]]"
medical_examination: "[[db/MammaPrint]]"
on_focus_list_of_Wikimedia_project:
  - "[[db/WikiProject_Medicine]]"
  - "[[db/gender_gap_on_Dutch_Wikipedia]]"
subclass_of:
  - "[[db/breast_disease]]"
  - "[[db/thoracic_cancer]]"
  - "[[db/breast_neoplasm]]"
  - "[[db/disease]]"
facet_of: "[[db/women's_health]]"
genetic_association:
  - "[[db/COL1A1]]"
  - "[[db/ESR1]]"
  - "[[db/TGFBR2]]"
...
instance_of:
  - "[[db/class_of_disease]]"
  - "[[db/symptom_or_sign]]"
studied_by: "[[db/breast_cancer_research]]"
anatomical_location: "[[db/female_breast]]"
DiseasesDB: "1598"
