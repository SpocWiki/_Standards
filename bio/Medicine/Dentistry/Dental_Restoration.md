...
- Pasta sa ngipin
- Plomb
- plomba (stomatologiya)
- Plombas (zobārstniecība)
- plombo
- restauració dental
- Restauração dental
- Siu-ho̍k-thé
...
dv_has_:
  name_:
    ...
    cs: zubní plomba
    de: Füllungstherapie
    el: Οδοντική αποκατάσταση
    en: dental restoration
    eo: plombo
    es: empaste
    eu: Hortz-errestaurazio
    fa: پرکردن دندان
    fi: hammaspaikka
    fr: odontologie conservatrice
    gl: Empaste
    he: שחזור דנטלי
    hi: दंत पुनर्स्थापना
    hu: Tömés
    hy: Պլոմբավորում (ատամնաբուժություն)
    it: odontoiatria conservativa
    ja: 歯科修復
    ko: 치아 수복물
    ky: тишти пломбалоо
    lv: Plombas (zobārstniecība)
    mn: Ломбо
    nan: Siu-ho̍k-thé
    nb: Tannfylling
    pl: wypełnienie
    pt: Restauração dental
    ru: пломба
    sl: Zobna zalivka
    sq: Mbushja e dhëmbit
    sr: Zubna obnova
    tl: Pasta sa ngipin
    tr: diş dolgusu
    uk: пломба
    uz: plomba (stomatologiya)
    wuu: 补牙
    yue: 補牙
    zh: 牙齒修復
---
