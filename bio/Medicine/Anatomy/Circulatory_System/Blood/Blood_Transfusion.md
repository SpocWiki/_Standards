...
dv_has_:
  name_:
    ...
    fur: Alternativis a lis trasfusions
    fy: Bloedtransfúzje
    ga: fuilaistriú
    gl: Transfusión de sangue
    gom: रगत घालप(Blood transfusion)
    he: עירוי דם
    hi: रक्ताधान
    hr: Transfuzija krvi
    hu: vérátömlesztés
    hy: արյան փոխներարկում
    hyw: արեան փոխներարկում
    ia: Transfusion sanguine
    id: Transfusi darah
    it: trasfusione
    ja: 輸血
    kk: Гемотрансфузия
    ...
    tg: Хунгузаронӣ
    th: การถ่ายเลือด
    tl: Pagsasalin ng dugo
    tr: Kan nakli
    tt: Кан күчерү
    uk: переливання крові
    uz: Qon quyish
    vi: Truyền máu
    wuu: 输血
    yue: 輸血
