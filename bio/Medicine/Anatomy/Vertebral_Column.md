...
- 573.76
- 611.711
3D_model: http://commons.wikimedia.org/wiki/Special:FilePath/BodyParts3D%20Vertebral%20column.stl
image: http://commons.wikimedia.org/wiki/Special:FilePath/Illu%20vertebral%20column.svg
TA98_Latin_term: columna vertebralis
Commons_category: Vertebral column
dv_has_:
  name_:
    af: Werwelkolom
    am: ደንደስ
    an: Columna vertebral
    ar: عمود فقري
    arc: ܥܡܘܕܐ ܦܩܪܝܐ
    ast: Columna vertebral
    atj: Ototokwakan
    av: Мугъзагод
    ay: Jikhani k'ili
    az: Onurğa sütunu
    ...
    fy: Wringe
    ga: colún veirteabrach
    gl: columna vertebral
    gn: Atukupe kangue rysýi
    got: "\U00010337\U00010342\U0001033F\U00010332\U0001033E\U00010330\U00010331\U00010330\U00010339\U0001033D"
    gsw: Wirbelsüüli
    hak: Poi-nòng-kut
    he: עמוד השדרה
    hi: मेरूदण्ड
    ...
    mk: ‘Рбетен столб
    ml: നട്ടെല്ല്
    mn: Хүний нугалам нуруу
    mnc: ᠰᡳᡝᡵᡝ
    ms: turus ruas tulang belakang
    mzn: پشتمرزی
    nan: Chek-chui
    nb: ryggsøyle
    ne: मेरुदण्ड
    nl: wervelkolom
    nn: virvelsøyle
    oc: Colomna vertebrala
    pa: ਰੀੜ ਦੀ ਹੱਡੀ
    pam: Galudgud
    pap: kolòm vertebral
    pap-aw: kolom vertebral
    pl: kręgosłup
    pnb: کنگریڑ
    pt: coluna vertebral
    qu: Wasa tullu
...
> The spinal column, also known as the vertebral column, spine or backbone, 
> is the core part of the axial skeleton in vertebrates. 
> 
> The vertebral column is the defining and eponymous characteristic of the vertebrate. 
> The spinal column is a segmented column of vertebrae 
> that surrounds and protects the spinal cord. 
> The vertebrae are separated by intervertebral discs in a series of cartilaginous joints. 
> The dorsal portion of the spinal column houses the spinal canal, 
> an elongated cavity formed by the alignment of the vertebral neural arches 
> that encloses and protects the spinal cord, 
> with spinal nerves exiting via the intervertebral foramina to innervate each body segment.
>
> There are around 50,000 species of animals that have a vertebral column. 
> The human spine is one of the most-studied examples, 
> as the general structure of human vertebrae is fairly typical of that found in other mammals, reptiles, and birds. The shape of the vertebral body does, however, vary somewhat between different groups of living species.
>
