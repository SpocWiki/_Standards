...
MeSH_tree_code: A10.165
UMLS_CUI: C0009780
Commons_category: Connective tissues
Krugosvet_article: medicina/SOEDINITELNAYA_TKAN.html
dv_has_:
  name_:
    af: Bindweefsel
    ar: نسيج ضام
    ...
    fr: tissu conjonctif
    ga: fíochán tacaíochta
    gl: tecido conxuntivo
    he: רקמת חיבור
    hi: संयोजी उत्तक
    hr: vezivno tkivo
    hu: kötőszövet
    hy: Շարակցական հյուսվածք
    ia: Texito connective
    id: jaringan Ikat
    is: Bandvefur
    it: tessuto connettivo
    ja: 結合組織
    ka: შემაერთებელი ქსოვილი (ბიოლოგია)
    kab: imezṭi anesɣun
    kk: Дәнекер ұлпасы
    ko: 결합 조직
    ku: bestereşane
    ...
    nl: bindweefsel
    nn: bindevev
    om: Connective tissue
    pl: tkanka łączna
    pt: tecido conjuntivo
    ro: țesut conjunctiv
    ru: соединительная ткань
    sco: connective tissue
    sh: Vezivno tkivo
    si: සම්බන්ධක පටකය
    sk: spojivové tkanivo
    sl: vezivo
    sr: везивно ткиво
    sv: bindväv
    ta: இணைப்பிழையம்
    te: ఆధార కణజాలము
    th: เนื้อเยื่อเกี่ยวพัน
    tr: bağ doku
    tt: тоташтыргыч тукыма
    uk: сполучна тканина
    ur: نسج الحاقی
    uz: Biriktiruvchi toʻqima
    vi: mô liên kết
    wuu: 结缔组织
    yue: 結締組織
    zh: 结缔组织
