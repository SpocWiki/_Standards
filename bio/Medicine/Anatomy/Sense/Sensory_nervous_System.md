...
- Sistem indriya
- sistem senzorial
- Sistema ning pamamau
- Sistema pangabat
- sistema sensorial
- sistema sensoriale
- sistema ti panagrikna
- Sistemang pandama
...
- C0682647
- C2339537
Colon_Classification: S:21
Commons_category: Sensory system
dv_has_:
  name_:
    af: Sensoriese senuweestelsel
    an: sistema sensorial
    ar: جهاز إحساس
    ary: جهاز د لحسان
    as: সংবেদন তন্ত্ৰ
    ...
    ce: Сенсорийн система
    ckb: کۆئەندامی ھەست
    crh: duyuş sisteması
    cs: smyslová soustava
    cy: system y synhwyrau
    da: sansesystemet
    de: Sinnessystem
    dv: ސެންސަރީ ސިސްޓަމް
    el: αισθητικό σύστημα
    en: sensory nervous system
    eo: sensa sistemo
    es: sistema sensorial
    eu: zentzumen sistema
    fa: دستگاه حسی
    fi: Aistinelin
    fr: système sensoriel
    ga: córas céadfach
    gl: sistema sensorial
    he: מערכות חישה
    hi: ज्ञानेन्द्रिय
    hif: central nervous system
    hr: Osjetilni sustav
    hu: érző idegrendszer
    hy: զգայական համակարգ
    id: Sistem indera
    ilo: sistema ti panagrikna
    is: Athygli
    it: sistema sensoriale
    ja: 感覚器系
    jv: Sistem indriya
    kk: Сенсорлық жүйе
    kn: ಇಂದ್ರಿಯ
    ...
    ko: 감각 기관
    ku: koendama hestê
    kw: Kevreyth an sensys
    la: Systema sensorium
    lt: Sensorinė sistema
    lv: maņu orgānu sistēma
    mk: Сетилен систем
    ml: ഇന്ദ്രിയം
    ms: Sistem deria
    nan: Ti-kak hē-thóng
    ...
    sk: Telesný zmysel
    sl: čutilo
    sq: Sistemi nervor ndijor
    sr: Чулни органи
    sv: Sensoriska nervsystemet
    sw: Milango ya fahamu
    ta: உணர்வுத் தொகுதி
    tg: Анализатор
    th: ระบบรับความรู้สึก
    tl: Sistemang pandama
    tr: Duyu sistemi
    tt: сенсорлы система
    uk: сенсорна система
    ur: حسّی نظام
...
> neural pathways, and parts of the brain involved in sensory perception and interoception.  
> 
> Commonly recognized sensory systems are those for 
> vision, hearing, touch, taste, smell, balance and visceral sensation. 
> 
...
### #is_/same_as :: [[/_Standards/bio/Medicine/Anatomy/Sense/Sensory_nervous_System|Sensory_nervous_System]] 

### #is_/same_as :: [[/_public/bio/Medicine/Anatomy/Sense/Sensory_nervous_System.public|Sensory_nervous_System.public]] 

### #is_/same_as :: [[/_internal/bio/Medicine/Anatomy/Sense/Sensory_nervous_System.internal|Sensory_nervous_System.internal]] 

### #is_/same_as :: [[/_protect/bio/Medicine/Anatomy/Sense/Sensory_nervous_System.protect|Sensory_nervous_System.protect]] 

### #is_/same_as :: [[/_private/bio/Medicine/Anatomy/Sense/Sensory_nervous_System.private|Sensory_nervous_System.private]] 

### #is_/same_as :: [[/_personal/bio/Medicine/Anatomy/Sense/Sensory_nervous_System.personal|Sensory_nervous_System.personal]] 

### #is_/same_as :: [[/_secret/bio/Medicine/Anatomy/Sense/Sensory_nervous_System.secret|Sensory_nervous_System.secret]] 
