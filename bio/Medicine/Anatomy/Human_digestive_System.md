...
- Insaan ke paachan tantr
- insan mide-içek sisteması
...
- Mikhuna yawri
- Muronga wechikafu
- Nzelá elekaka bilía na líkundú
- Ovqat hazm qilish sistemasi
- Probavni sistem
- probavni sistem čovjeka
- purrâmâšsuddâdemuáli
- ruoansulatuskanava
...
- Этемĕн апат ирĕлтерекен тытăмĕ
- մարսողական համակարգ
- מערכת העיכול
- פארדייאונג סיסטעם
- انسانی ہضمی نظام
...
- ہاضمہ پربندھ
- ހަޖަމުކުރާ ނިޒާމް
- ߡߐ߱ ߟߊ߬ߛߙߏ߬ߟߌ߫ ߞߊ߲ߞߋ
- ग्यास्ट्रोइन्टेस्टिनल सिस्टम
- मानव का पोषण नाल
- मानव पाचन तंत्र
- পাচন তন্ত্ৰ
- মানব পরিপাকতন্ত্র
...
development_of_anatomical_structure: '[[_Standards/WikiData/WD~digestive_system_development,21100420|WD~digestive_system_development,21100420]]'
different_from: '[[_Standards/WikiData/WD~digestion,11978|WD~digestion,11978]]'
facet_of: '[[_Standards/WikiData/WD~human_anatomy,3999|WD~human_anatomy,3999]]'
has_part_s_:
- '[[_Standards/WikiData/WD~salivary_gland,134938|WD~salivary_gland,134938]]'
- '[[_Standards/WikiData/WD~rectum,158716|WD~rectum,158716]]'
- '[[_Standards/WikiData/WD~esophagus,173710|WD~esophagus,173710]]'
- '[[_Standards/WikiData/WD~pharynx,174778|WD~pharynx,174778]]'
...
- '[[_Standards/WikiData/WD~Biliary_tract,79216892|WD~Biliary_tract,79216892]]'
- '[[_Standards/WikiData/WD~liver,9368|WD~liver,9368]]'
- '[[_Standards/WikiData/WD~pancreas,9618|WD~pancreas,9618]]'
- '[[_Standards/WikiData/WD~large_intestine,11083|WD~large_intestine,11083]]'
- '[[_Standards/WikiData/WD~small_intestine,11090|WD~small_intestine,11090]]'
has_part_s_of_the_class: '[[_Standards/WikiData/WD~organ,712378|WD~organ,712378]]'
has_use: '[[_Standards/WikiData/WD~digestion,11978|WD~digestion,11978]]'
IAB_code: 318
...
location: '[[_Standards/WikiData/WD~abdomen,9597|WD~abdomen,9597]]'
MeSH_tree_code: A03
OmegaWiki_Defined_Meaning: 1033886
part_of: '[[_Standards/WikiData/WD~human_body,23852|WD~human_body,23852]]'
...
- '[[_Standards/WikiData/WD~human_anatomical_structure,25452965|WD~human_anatomical_structure,25452965]]'
- '[[_Standards/WikiData/WD~human_organ_system,41653490|WD~human_organ_system,41653490]]'
...
topic_s_main_template: '[[_Standards/WikiData/WD~Template_Digestive_system_navs,10862909|WD~Template_Digestive_system_navs,10862909]]'
UMLS_CUI: C0012240
...
dv_has_:
  name_:
    ...
    br: benvegad koazhañ
    bs: probavni sistem čovjeka
    ca: aparell digestiu
    ckb: کۆئەندامی ھەرس
    crh: insan mide-içek sisteması
    cs: trávicí soustava člověka
    cv: Этемĕн апат ирĕлтерекен тытăмĕ
    cy: system dreulio
    ...
    eu: Digestio-aparatu
    ext: Sistema digestivu
    fa: دستگاه گوارش
    fi: ruoansulatuskanava
    fr: appareil digestif humain
    fy: Spiisfertarring
    ga: córas díleáite
    gcr: Aparey dijestif moun
    gl: aparello dixestivo
    gsw: Verdauungstrakt
    he: מערכת העיכול
    hi: मानव का पोषण नाल
    hif: Insaan ke paachan tantr
    hr: ljudska probava
    ht: Disjesyon
    hu: emésztőrendszer
    hy: մարսողական համակարգ
    ia: Apparato digestive
    id: sistem pencernaan
    io: Digestiva sistemo
    is: Meltingarkerfi
    it: apparato digerente umano
    iu: ᓂᕆᓂᑯᑦᑎᓐᓂᒃ ᐊᕕᒃᑎᕆᔾᔪᑎᑦ
    ja: 消化器系
    jam: Gaschroyintestinal Chrak
    jbo: canti
    jv: Sistem pancernan
    ka: საჭმლის მომნელებელი სისტემა
    kk: Ас қорыту жүйесі
    kn: ಮಾನವನ ಪಚನ ವ್ಯವಸ್ಥೆ
    ko: 소화계통
    ks: شرٛٔپرَن تَگ
    ku: koendama herisê
    ...
    lfn: Sistem de dijesta
    li: Maag-dermsjtèlsel
    ln: Nzelá elekaka bilía na líkundú
    lt: virškinimo sistema
    lv: gremošanas orgānu sistēma
    mk: Систем за варење
    ml: മനുഷ്യരിലെ പചനവ്യൂഹം
    mn: Хоол боловсруулах систем
    mo: Tubul digestiv
    ms: Salur perut usus manusia
    mt: sistema diġestiva
    my: လူ၏ အစာအိမ်နှင့် အူလမ်းကြောင်း
    nan: Siau-hòa hē-thóng
    nb: fordøyelsessystem
    nds: Verdausysteem
    new: ग्यास्ट्रोइन्टेस्टिनल सिस्टम
    nl: menselijk spijsverteringsstelsel
    nn: meltingsapparatet
    nqo: ߡߐ߱ ߟߊ߬ߛߙߏ߬ߟߌ߫ ߞߊ߲ߞߋ
    oc: Sistèma digestiu
    om: Sirni bullaa’insa nyaataa
    pa: ਮਨੁੱਖੀ ਭੋਜਨ ਨਾਲੀ
    pam: Gastrointestinal system
    ...
    sah: Ас буhарар система
    sd: هاضمي جو سرشتو
    sgs: Vėrškėnėma trakts
    sh: Probavni sistem
    si: මිනිසාගේ ආහාර ජීරණ පද්ධතිය
    sk: tráviaca sústava
    sl: človeška prebavila
    smn: purrâmâšsuddâdemuáli
    sn: Muronga wechikafu
    sq: Sistemi i tretjes
    sr: систем органа за варење
    su: Saluran cerna
    sv: mag-tarmkanalen
    sw: Mfumo wa Mmeng'enyo wa Chakula
    ta: மனித சமிபாட்டு மண்டலம்
    te: మానవ జీర్ణవ్యవస్థ
    th: ระบบทางเดินอาหารของมนุษย์
    tk: iýmit siňdiriş ulgamy
    tl: Sistemang panunaw
    tr: İnsan sindirim sistemi
    tt: ашкайнату системасы
    udm: адямилэн сиён сылмон сӧзнэтэз
    uk: травна система
    ur: انسانی ہضمی نظام
    uz: Ovqat hazm qilish sistemasi
    vec: Aparato degerente
    vi: hệ tiêu hóa
    war: Sistema pantunaw
    wuu: 消化系统
    xh: Amathumbu
...
### #is_/same_as :: [[/_Standards/bio/Medicine/Anatomy/Human_digestive_System|Human_digestive_System]] 

### #is_/same_as :: [[/_public/bio/Medicine/Anatomy/Human_digestive_System.public|Human_digestive_System.public]] 

### #is_/same_as :: [[/_internal/bio/Medicine/Anatomy/Human_digestive_System.internal|Human_digestive_System.internal]] 

### #is_/same_as :: [[/_protect/bio/Medicine/Anatomy/Human_digestive_System.protect|Human_digestive_System.protect]] 

### #is_/same_as :: [[/_private/bio/Medicine/Anatomy/Human_digestive_System.private|Human_digestive_System.private]] 

### #is_/same_as :: [[/_personal/bio/Medicine/Anatomy/Human_digestive_System.personal|Human_digestive_System.personal]] 

### #is_/same_as :: [[/_secret/bio/Medicine/Anatomy/Human_digestive_System.secret|Human_digestive_System.secret]] 
