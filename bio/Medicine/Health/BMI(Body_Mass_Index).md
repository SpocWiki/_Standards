...
- Index Jisim Badan
- Index massae corporeae
- Index telesnej hmotnosti
- index tělesné hmotnosti
- indice de masse corporelle
- Indice de masă corporală
- indice di massa corporea
- Indici de massa corporala
- innéacs corpmhaise
- Keapa-Moss-Index
- Kehamassiindeks
- ketlete
...
dv_has_:
  name_:
    an: Índiz de masa corporal
    ar: مؤشر كتلة الجسم
    ast: Índiz de masa corporal
    ...
    da: Body Mass Index
    de: Body-Mass-Index
    dv: ބޮޑީ މާސް އިންޑެކްސް
    el: δείκτης μάζας σώματος
    en: body mass index
    eo: korpomasa indico
    es: índice de masa corporal
    et: Kehamassiindeks
    eu: Gorputz-masaren indize
    fa: شاخص توده بدنی
    fi: Painoindeksi
    fo: BMI
    fr: indice de masse corporelle
    ga: innéacs corpmhaise
    gl: Índice de masa corporal
    gu: શરીર વજન અનુક્રમ
    he: מדד מסת גוף
    hi: शरीर द्रव्यमान सूचकांक
    hr: Indeks tjelesne mase
    hu: testtömegindex
    hy: Մարմնի զանգվածի ինդեքս
    id: Indeks massa tubuh
    it: indice di massa corporea
    ja: ボディマス指数
    jbo: ketlete
    kk: Дене массасының индексі
    kn: ಭೌತಿಕ ದ್ರವ್ಯರಾಶಿ ಸೂಚಿ
    ko: 체질량 지수
    la: Index massae corporeae
    lt: Kūno masės indeksas
    lv: ķermeņa masas indekss
    mk: индекс на телесна маса
    ml: ശരീരഭാരസൂചിക
    mr: बॉडी मास इंडेक्स
    ...
    oc: Indici de massa corporala
    pl: wskaźnik masy ciała
    pt: índice de massa corporal
    ro: Indice de masă corporală
    ru: индекс массы тела
    sh: Indeks telesne mase
    si: ශරීර ස්කන්ධ දර්ශකය
