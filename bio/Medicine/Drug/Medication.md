...
- '[[_Standards/WikiData/WD~Derman,5262676|WD~Derman,5262676]]'
- '[[_Standards/WikiData/WD~Medication,16876752|WD~Medication,16876752]]'
...
has_characteristic:
- '[[_Standards/WikiData/WD~effective_dose,1425437|WD~effective_dose,1425437]]'
- '[[_Standards/WikiData/WD~drug_class,2585617|WD~drug_class,2585617]]'
- '[[_Standards/WikiData/WD~side_effect,3269441|WD~side_effect,3269441]]'
has_use:
...
permanent_duplicated_item: '[[_Standards/WikiData/WD~Medicines,56739955|WD~Medicines,56739955]]'
produced_by: '[[_Standards/WikiData/WD~pharmaceutical_company,19644607|WD~pharmaceutical_company,19644607]]'
pronunciation_audio:
...
said_to_be_the_same_as: '[[_Standards/WikiData/WD~medicinal_product,12034612|WD~medicinal_product,12034612]]'
...
subclass_of:
- '[[_Standards/WikiData/WD~medicinal_product,12034612|WD~medicinal_product,12034612]]'
- '[[_Standards/WikiData/WD~drug,8386|WD~drug,8386]]'
topic_s_main_template: '[[_Standards/WikiData/WD~Template_Infobox_drug,6033882|WD~Template_Infobox_drug,6033882]]'
...
dv_has_:
  name_:
    ...
    kv: Бурдӧдчантор
    kw: medhegneth
    ky: Дары-дармек каражаттары
    la: medicamentum pharmaceuticum
    lmo: Droga farmaceutega
    ln: Nkísi
    lt: vaistas
    lv: zāles
    mag: औषधि
    ...
    rup: Aradamatã cu yitrii
    sah: Эмп
    scn: Fàrmacu
    sco: pharmaceutical drug
    se: dálkkas
    sgs: Liekarsta
    sh: lijek
    shi: asafar
...
> A medication (also called medicament, medicine, **Pharmaceutical drug**, medicinal product, 
> medicinal drug or simply drug) is a drug used to diagnose, cure, treat, or prevent disease. 
> Drug therapy (pharmacotherapy) is an important part of the medical field 
> and relies on the science of pharmacology for continual advancement 
> and on pharmacy for appropriate management.
>
