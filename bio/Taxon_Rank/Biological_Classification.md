...
- Bioloji təsnifat
- Bioloogsche Klassifikatschoon
- Biyolohika nga pagarangay
- Ciencala klasifikuro di speci
- clasificación biológica
- clasificación biolóxica
- clasificación científica
- Clasificación scientifica
- clasificare științifică a speciilor
...
- Fanasokajiana ara-tsiansa ny zavamananaina
...
- Mitan kamay katiguriya
- mokslinė klasifikacija
- Muokslėnė klasėfėkacėjė
...
- siential klasifikatione
- Sincieus rindjmint do vicant
...
- біялягічная клясыфікацыя
- биологи пӧртэмлыкъя радъян
- Биологий классификаций
- Биологийн ангилал
- биологик классификация
- биологион классификаци
- биологическая классификация
- Биологиэ систематикэ
...
- ဇီဝဆိုင်ရာ အမျိုးအစား ခွဲခြားခြင်း
...
- 生物分類法
- 생물 분류
- "\U00010344\U00010334\U00010345\U00010330\U0001033D\U00010349\U0001033C\U0001033E\U00010330"
...
dv_has_:
  name_:
    ...
    btm: Klasifikasi ilmiah
    ca: classificació científica
    cdo: Sĕng-ŭk hŭng-lôi-huák
    ceb: Siyentipiko nga klasipikasyon
    ckb: پۆلێنزانی
    co: Classificazione scentifica
    crh: ayatiyat sınıflaştırması
    cs: biologická klasifikace
    cy: dosbarthiad gwyddonol
    da: biologisk klassifikation
    ...
    fa: ردهبندی علمی جانداران
    fi: tieteellinen luokittelu
    fr: classification scientifique des espèces
    frr: Taksonomii faan diarten an plaanten
    ga: aicmiú bitheolaíoch
    gl: clasificación científica
    gn: Tekovekuaaty ñemohenda
    got: "\U00010344\U00010334\U00010345\U00010330\U0001033D\U00010349\U0001033C\U0001033E\U00010330"
    gsw: Klassifikation
    hak: Sâng-vu̍t fûn-lui-fap
    he: טקסונומיה של עולם הטבע
    hi: जीववैज्ञानिक वर्गीकरण
    hif: Biological classification
    hr: taksonomske klasifikacije
    hu: rendszertan
    hy: Կենդանի օրգանիզմների դասակարգում
    ia: Classification scientific
    id: klasifikasi biologi
    ilo: biolohiko a pannakaidasig
    inh: Органикай дунен раж
    ...
    nap: Crassifecazzione scientìfeca
    nb: biologisk klassifikasjon
    nds: Bioloogsche Klassifikatschoon
    new: जैविक वर्गीकरण
    nl: taxonomie in de biologie
    nn: biologisk klassifisering
    nov: siential klasifikatione
    oc: Classificacion scientifica
    or: ବିଜ୍ଞାନଭିତ୍ତିକ ଶ୍ରେଣୀବିଭାଗ
    os: биологион классификаци
    ...
    sgs: Muokslėnė klasėfėkacėjė
    sh: Taksonomske kategorije
    sk: Vedecká klasifikácia
    sl: znanstvena klasifikacija živih bitij
    so: Abala-abalayn bayoloji
    sq: Klasifikimi biologjik
    sr: таксономске категорије
    su: Klasifikasi biologi
    sv: biologisk klassificering
    sw: Uainishaji wa kisayansi
    szl: Klasyfikacyjŏ biologicznŏ
    ...
    udm: биологи пӧртэмлыкъя радъян
    uk: біологічна класифікація
    ur: حیاتیاتی درجہ بندی
...
#has_/creator :: [[../../Science/Scientist/Early_Modern_Scientists/Linnaeus,Carl|Linnaeus,Carl]] 
