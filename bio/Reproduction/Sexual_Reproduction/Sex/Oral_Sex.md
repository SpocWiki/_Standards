...
dv_has_:
  name_:
    ...
    bho: मुख मैथुन
    bn: মুখমৈথুন
    bo: ཁ་ཐོག་གི་ཆགས་སྦྱོར།
    bs: Oralni seks
    ca: sexe oral
    ckb: کرداری جنسیی دەمی
    cs: orální sex
    cy: Rhyw geneuol
    da: oralsex
    de: Oralverkehr
    ...
    te: ముఖరతి
    th: การร่วมเพศทางปาก
    tl: Pakikipagtalik sa pamamagitan ng bibig
    tok: unpa uta
    tr: Oral seks
    uk: оральний секс
    ur: دہنی جماع
    uz: Oral jinsiy aloqa
    vec: Seso orałe
    vi: Làm tình bằng miệng
    wuu: 口交
    xmf: ორალური სექსი
    yi: ארעל סעקס
    yue: 口交
...
#is_/same_as :: [[_Standards/WikiData/WD~Oral_sex,2122|WD~Oral_sex,2122]] 
