...
- orientamento sesuałe
- Orientamentu sessuale
- orientamentu sissuali
- orientare sexuală
- orientashon seksual
- orientasi seks
- Orientasi seksual
...
- seksuaalʼlaž kärŋŋummuš
- Seksual orientasiya
- seksualinė orientacija
- seksuallâš sundâšume
...
- seksuellak luonndo
- seksuála orientašuvdna
- seksuële oriïntaasje
- seksuālā orientācija
- Sekswal na orientasyon
- sexu-joera
- sexual orientation
- Sexual orientizo
- sexuell läggning
...
WordLift_URL: http://data.medicalrecords.com/medicalrecords/healthwise/sexual_orientation
Commons_category: Sexual orientation
Archive_of_Our_Own_tag: Sexual Orientation
dv_has_:
  name_:
    af: seksuele oriëntasie
    an: Orientación sexual
    ar: توجه جنسي
    as: যৌন অভিমুখীতা
    ast: Orientación sexual
    az: Seksual orientasiya
    ba: сексуаль йүнәлеш
    ...
    bn: যৌন অভিমুখিতা
    br: Tuadur reizhel
    bs: seksualna orijentacija
    ca: orientació sexual
    ceb: Oryentasyong sekswal
    ckb: ڕووتێکەری زایەندی
    ...
    fy: seksuële oriïntaasje
    ga: gnéaschlaonadh
    gl: orientación sexual
    he: נטייה מינית
    hi: लैंगिक अभिविन्यास
    hr: seksualna orijentacija
    hu: szexuális irányultság
    hy: Սեռական կողմնորոշում
    ia: orientation sexual
    ...
    kk: Сексуалды бағыттану
    ko: 성적 지향
    ku: Berpêbûniya zayendî
    ky: Жыныстык артыкчылык
    la: propensio sexualis
    lb: sexuell Orientéierung
    lfn: orienta sesal
    lmo: Orientament sessual
    lo: ລົດສະນິຍົມທາງເພດ
    ...
    mk: полова определба
    ml: ലൈംഗികചായ്വ്
    mn: Бэлгийн чиг хандлага
    mr: लैंगिक कल
    ms: orientasi seks
    mt: orjentazzjoni sesswali
    nb: seksuell orientering
    ne: यौन झुकाव
    new: यचा क्वसाः
    nl: seksuele oriëntatie
    nn: seksuell orientering
    oc: orientacion sexuala
    pa: ਲਿੰਗਕ ਅਨੁਸਥਾਪਨ
    pap: orientashon seksual
    ...
    scn: orientamentu sissuali
    sco: sexual orientation
    se: seksuála orientašuvdna
    sh: Seksualna orijentacija
    si: සැකිල්ල:Sexual orientation
    sk: Sexuálna orientácia
    sl: spolna usmerjenost
    smj: seksuellak luonndo
    smn: seksuallâš sundâšume
    sms: seksuaalʼlaž kärŋŋummuš
    sq: orientimi seksual
    sr: сексуална оријентација
    sv: sexuell läggning
    ta: பாலியல் நாட்டம்
    te: రతిప్రవృతి
    tg: мавқеи ҷинсӣ
    th: รสนิยมทางเพศ
    tl: Oryentasyong seksuwal
    tr: cinsel yönelim
    uk: сексуальна орієнтація
    ur: جنسی رجحان
    uz: Jinsiy moyillik
    vec: orientamento sesuałe
    vi: thiên hướng tình dục
    wuu: 性取向
    xmf: სექსუალური ორიენტაცია
