...
- ཅི་འདྲ་ཞིག་ལ་བདེ་འཇགས་ལུས་འབྲེལ་ཟེར་རམ་
- စိတ်ချရသော လိင်ဆက်ဆံမှု
- လိင် မသက်ကုဘဲ
- セーファーセックス
- 安全性行为
- 安全性行為
...
subclass_of:
- '[[_Standards/WikiData/WD~harm_reduction,1458711|WD~harm_reduction,1458711]]'
...
- '[[_Standards/WikiData/WD~unprotected_sex,98381467|WD~unprotected_sex,98381467]]'
described_by_source: '[[_Standards/WikiData/WD~Q72527089,72527089|WD~Q72527089,72527089]]'
on_focus_list_of_Wikimedia_project: '[[_Standards/WikiData/WD~Wiki99_LGBT+,97285685|WD~Wiki99_LGBT+,97285685]]'
instance_of: '[[_Standards/WikiData/WD~sexual_intercourse,5873|WD~sexual_intercourse,5873]]'
uses: '[[_Standards/WikiData/WD~condom,14076|WD~condom,14076]]'
...
UMLS_CUI: C0597728
Wolfram_Language_entity_code: Entity["Concept", "SafeSex::s5f53"]
MeSH_tree_code: F01.145.802.845
Commons_category: Safer sex
dv_has_:
  name_:
    ar: جنس آمن
    arz: جنس امن
    ...
    fr: sécurisexe
    gl: Sexo seguro
    gn: Poreno ñeñangarekóre
    gu: સલામત મૈથુન
    he: מין בטוח
    hr: Siguran spolni odnos
    hu: biztonságos szex
    hy: Պաշտպանված սեռական հարաբերություններ
    id: Seks aman
    it: Sesso sicuro
    ja: セーファーセックス
    ko: 세이프 섹스
    ...
    th: การร่วมเพศอย่างปลอดภัย
    tl: Ligtas na pagtatalik
    tr: güvenli seks
    uk: безпечний секс
    ur: محفوظ ہم بستری
    vi: Tình dục an toàn
...
#is_/same_as :: [[_Standards/WikiData/WD~Safe_sex,318529|WD~Safe_sex,318529]] 

## #has_/text_of_/abstract 

> Safe sex is sexual activity using protective methods or contraceptive devices 
> (such as condoms) to reduce the risk of transmitting or acquiring 
> sexually transmitted infections (STIs), especially HIV. 
> 
> The terms safer sex and protected sex are sometimes preferred, 
> to indicate that even highly effective prevention practices 
> do not completely eliminate all possible risks. 
> 
> It is also sometimes used colloquially to describe methods aimed at 
...
> and possibly more specifically to the AIDS crisis in the United States. 
> 
> Promoting safe sex is now one of the main aims of sex education and STI prevention, 
> especially reducing new HIV infections. 
> 
> Safe sex is regarded as a harm reduction strategy aimed at reducing the risk of STI transmission.
>
> Although some safe sex practices (like condoms) 
> can also be used as birth control (contraception), 
> most forms of contraception do not protect against STIs. 
> 
> Likewise, some safe sex practices, such as partner selection and low-risk sex behavior, 
