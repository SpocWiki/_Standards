...
- Ilopọ
- Isitabane
- jan li olin e jan pi kule sama
- kehomoseksualan
- Khaniisnimada
- luwadi
- nwoke idina nwoke
...
subreddit: gay
hashtag_: homosexual
PhilPapers_topic: homosexuality
IMDb_keyword: homosexuality
image:
- http://commons.wikimedia.org/wiki/Special:FilePath/36.GayPrideParade.NYC.29June1997%20%2824365592385%29.jpg
- http://commons.wikimedia.org/wiki/Special:FilePath/Kamoni.GLBT.Parade.WDC.9jun96.jpg
flag_image: http://commons.wikimedia.org/wiki/Special:FilePath/Gay%20Pride%20Flag.svg
Commons_gallery: Homosexuality
Commons_category: Homosexuality
Archive_of_Our_Own_tag: Homosexuality
Dewey_Decimal_Classification: 306.766
icon: http://commons.wikimedia.org/wiki/Special:FilePath/Homosexuality%20symbols%20%284%20colors%29.svg
DOI: 10.1163/1875-3922_Q3_EQCOM_00085
UMLS_CUI: C0019899
dv_has_:
  name_:
    af: homoseksualiteit
    ...
    hyw: միասեռականութիւն
    ia: homosexualitate
    id: homoseksualitas
    ig: nwoke idina nwoke
    ilo: omoseksualidad
    io: homeosexualeso
    is: samkynhneigð
    it: omosessualità
    ...
    jbo: pavmitcinse
    ka: ჰომოსექსუალობა
    kbp: agbele waa ɖama sʊnaʊ
    kk: гомосексуалдылық
    km: អ្នកស្រឡាញ់ភេទដូចគ្នា
    kn: ಸಲಿಂಗ ಕಾಮ
    ko: 동성애
    krj: omoseksuwalidad
    ks: ہم جِنس پرستی
    ...
    sco: homosexuality
    sd: هم جنس پرست
    se: homoseksuálavuohta
    sh: Homoseksualnost
    si: සමලිංගිකතාව
    sk: homosexualita
    sl: homoseksualnost
    smn: homoseksualvuotâ
    sms: homoseksuaal’lažvuõtt
    sn: Ungochani
    so: Khaniisnimada
    sq: Homoseksualitet
    sr: хомосексуалност
...
#is_/same_as :: [[_Standards/WikiData/WD~Homosexuality,6636|WD~Homosexuality,6636]] 

## #has_/text_of_/abstract 

> **Homosexuality** is romantic attraction, sexual attraction, 
> or sexual behavior between people of the same sex or gender. 
> It also denotes identity based on attraction, related behavior, and community affiliation.
>
