...
- '[[_Standards/WikiData/WD~reproduction,11990|WD~reproduction,11990]]'
has_part_s_:
- '[[_Standards/WikiData/WD~sexual_partner,1611410|WD~sexual_partner,1611410]]'
- '[[_Standards/WikiData/WD~marriage_sex_in_Islam,127163683|WD~marriage_sex_in_Islam,127163683]]'
has_effect:
...
- '[[_Standards/WikiData/WD~vaginal_orgasm,61520979|WD~vaginal_orgasm,61520979]]'
- '[[_Standards/WikiData/WD~orgasm,5887|WD~orgasm,5887]]'
subclass_of:
- '[[_Standards/WikiData/WD~reciprocating_motion,3775883|WD~reciprocating_motion,3775883]]'
- '[[_Standards/WikiData/WD~copulation,30600878|WD~copulation,30600878]]'
- '[[_Standards/WikiData/WD~human_sexual_behavior,608|WD~human_sexual_behavior,608]]'
practiced_by: '[[_Standards/WikiData/WD~Q11665414,11665414|WD~Q11665414,11665414]]'
said_to_be_the_same_as: '[[_Standards/WikiData/WD~Q13098233,13098233|WD~Q13098233,13098233]]'
permanent_duplicated_item: '[[_Standards/WikiData/WD~Q22828725,22828725|WD~Q22828725,22828725]]'
different_from:
- '[[_Standards/WikiData/WD~copulation,30600878|WD~copulation,30600878]]'
...
has_cause: '[[_Standards/WikiData/WD~human_sexual_behavior,608|WD~human_sexual_behavior,608]]'
IMDb_keyword:
- sex
- fucking
hashtag: sex
image:
- http://commons.wikimedia.org/wiki/Special:FilePath/Wiki-tribadism02.png
- http://commons.wikimedia.org/wiki/Special:FilePath/Wiki-missionary.png
Commons_category: Human sexual intercourse
video: http://commons.wikimedia.org/wiki/Special:FilePath/Standing%20sexual%20intercourse.webm
Terminologia_Embryologica: E1.0.0.0.0.0.9
booru_tag: fucking
Commons_gallery: Sexual intercourse in humans
dv_has_:
  name_:
    af: seks
    am: ወሲባዊ ግንኙነት
    ...
    gan: 性交
    gd: dàirich
    gl: relación sexual humana
    glk: گأستن
    gn: poreno
    gsw: Gschlächtsverchehr
    gu: જાતીય સંભોગ
    hak: sin-hàng-vì
    he: יחסי מין
    hi: मैथुन
    ...
    mai: सम्भोग
    mcn: bùlo᷅
    mg: firaisana ara-nofo
    mi: mahimahi
    mk: полов однос
    ml: ലൈംഗികബന്ധം
    mni: ꯊꯨ ꯅꯥꯕ
    mnw: သိပ်ဂၠိပ် မေထုန်
    mr: संभोग
    ms: hubungan seks
    mt: relazzjoni sesswali
    my: လိင်ဆက်ဆံခြင်း
    mzn: گایش
    nan: sèng-kau
    nb: samleie
    ...
    sa: मैथुनम्
    sah: секс көрүҥнэрэ
    scn: rapportu sissuali
    sco: sexual intercoorse
    sd: جنسي ميلاپ
    se: anašeapmi
    sh: seks
    si: ලිංගික සංසර්ගය
...
> Sexual intercourse (also coitus or copulation) is a sexual activity 
> typically involving the insertion of the erect male penis inside the female vagina 
> and followed by thrusting motions for sexual pleasure, reproduction, or both. 
> 
> This is also known as vaginal intercourse or vaginal sex. 
> Sexual penetration is an instinctive form of sexual behaviour and psychology among humans. 
> Other forms of penetrative sexual intercourse include 
> - anal sex (penetration of the anus by the penis), 
> - oral sex (penetration of the mouth by the penis or oral penetration of the female genitalia), 
> - fingering (sexual penetration by the fingers) and 
> - penetration by use of a dildo (especially a strap-on dildo), and vibrators. 
> 
> These activities involve physical intimacy between two or more people 
> and are usually used among humans solely for physical or emotional pleasure. 
> They can contribute to human bonding.
>
