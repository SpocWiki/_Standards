...
OmegaWiki_Defined_Meaning: 530716
MeSH_tree_code: A05.360
IMDb_keyword: close-up-of-genitals
Commons_category: Genitalia
dv_has_:
  name_:
    af: Geslagsorgaan
    ar: عضو جنسي
    as: জননাংগ
    az: Cinsiyyət üzvləri
    ba: енес ағзалары
    ...
    hsb: splažny organ
    hu: nemi szervek
    hy: Մարդու վերարտադրողական համակարգ
    id: Alat kelamin
    is: Kynfæri
    it: organo sessuale
    ja: 性器
    ...
    lfn: organo sesal
    lo: ອະໄວຍະວະເພດ
    lt: dauginimosi organai
    lv: dzimumorgāns
    mi: taihemahema
    mk: полов орган
    ml: പ്രത്യുൽപ്പാദനാവയവം
    mr: गुप्तांग
    ms: Organ pembiakan
    nan: Seⁿ-si̍t-khì
    nb: kjønnsorgan
    ...
    th: อวัยวะเพศ
    ti: መሳርዕ ግብረ-ስጋ
    tl: Kasangkapang pangkasarian
    tr: cinsel organ
    udm: йылон люкетъёс
    uk: репродуктивні органи
    ur: جنسی عضو
    uz: Jinsiy aʼzolar
    vec: òrgano sesuałe
    vi: cơ quan sinh dục
...
> A sex organ, also known as a reproductive organ, 
> is a part of an organism that is involved in sexual reproduction. 
> 
> Sex organs constitute the primary sex characteristics of an organism. 
> Sex organs are responsible for producing and transporting gametes, 
> as well as facilitating fertilization and supporting the development and birth of offspring. 
> 
> Sex organs are found in many species of animals and plants, 
> with their features varying depending on the species.
>
