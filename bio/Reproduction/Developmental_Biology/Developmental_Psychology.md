...
- síceolaíocht forbartha
- Thuto-tswelopele ya kelello
...
- ترقیاتی نفسیات
- دەروونناسیی گەشەکردن
- روانشناسی رشد
- علم النفس التنموي
- پرمختيايي ارواپوهنه
- ڤسيکولوݢي ڤرکمبڠن
- बाल मनोविज्ञान
- বিকাশাত্মক মনোবিজ্ঞান
- ਵਿਕਾਸਮਾਨ ਮਨੋਵਿਗਿਆਨ
- அபிவிருத்தி உளவியல்
...
is_the_study_of: '[[_Standards/WikiData/WD~language_development,2330667|WD~language_development,2330667]]'
partially_coincident_with: '[[_Standards/WikiData/WD~child_psychology,3411686|WD~child_psychology,3411686]]'
described_by_source:
...
topic_has_template: '[[_Standards/WikiData/WD~Template_Human_psychological_development,67657421|WD~Template_Human_psychological_development,67657421]]'
part_of:
- '[[_Standards/WikiData/WD~applied_and_developmental_psychology,113043917|WD~applied_and_developmental_psychology,113043917]]'
- '[[_Standards/WikiData/WD~psychology,9418|WD~psychology,9418]]'
practiced_by: '[[_Standards/WikiData/WD~developmental_psychologist,122658333|WD~developmental_psychologist,122658333]]'
...
MeSH_tree_code: F04.096.628.270
dv_has_:
  name_:
    af: Ontwikkelingsielkunde
    ar: علم النفس التنموي
    ...
    ca: psicologia del desenvolupament
    ckb: دەروونناسیی گەشەکردن
    cs: vývojová psychologie
    da: udviklingspsykologi
    de: Entwicklungspsychologie
    el: Αναπτυξιακή ψυχολογία
    en: developmental psychology
    eo: disvolviĝa psiĥologio
    es: psicología del desarrollo
    et: arengupsühholoogia
    eu: Garapenaren psikologia
    fa: روانشناسی رشد
    fi: kehityspsykologia
    fr: psychologie du développement
    ga: síceolaíocht forbartha
    gl: psicoloxía do desenvolvemento
    he: פסיכולוגיה התפתחותית
    hi: बाल मनोविज्ञान
    hr: Dječja psihologija
    hu: fejlődéslélektan
    hy: տարիքային հոգեբանություն
    id: Psikologi perkembangan
    is: Þroskasálfræði
    it: psicologia dello sviluppo
    ja: 発達心理学
    kk: Даму психологиясы
    ko: 발달심리학
    la: Psychologia auctus
    lt: raidos psichologija
    lv: Attīstības psiholoģija
    mk: Развојна психологија
    ml: വികാസമനഃശാസ്ത്രം
    ...
    pa: ਵਿਕਾਸਮਾਨ ਮਨੋਵਿਗਿਆਨ
    pl: psychologia rozwoju człowieka
    ps: پرمختيايي ارواپوهنه
    pt: psicologia do desenvolvimento
    ro: psihologia dezvoltării
    ru: психология развития
    se: ovdánanpsykologiija
    sh: Dečija psihologija
    si: සංවර්ධනාත්මක මනෝවිද්යාව
    ...
    ta: அபிவிருத்தி உளவியல்
    te: వికాసాత్మక మనోవిజ్ఞానశాస్త్రం
    th: จิตวิทยาพัฒนาการ
...
> This field examines change across three major dimensions, which are 
> - physical development, 
> - cognitive development, and 
> - social emotional development. 
> 
> Within these three dimensions are a broad range of topics including 
> - motor skills, 
> - executive functions, 
> - moral understanding, 
