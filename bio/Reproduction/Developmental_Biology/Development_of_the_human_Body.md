...
different_from: '[[_Standards/WikiData/WD~human_development,2917873|WD~human_development,2917873]]'
has_effect: '[[_Standards/WikiData/WD~personality_development,3520110|WD~personality_development,3520110]]'
topic_has_template:
- '[[_Standards/WikiData/WD~Template_Human_development,6987795|WD~Template_Human_development,6987795]]'
- '[[_Standards/WikiData/WD~Template_Organ_system_development,96034308|WD~Template_Organ_system_development,96034308]]'
instance_of: '[[_Standards/WikiData/WD~academic_discipline,11862829|WD~academic_discipline,11862829]]'
subclass_of:
- '[[_Standards/WikiData/WD~animal_development,41805950|WD~animal_development,41805950]]'
...
characteristic_of: '[[_Standards/WikiData/WD~human,5|WD~human,5]]'
...
dv_has_:
  name_:
    af: Ontwikkeling van die menslike liggaam
    ar: تطور الإنسان
    ...
    cy: datblygiad y corff dynol
    de: Wachstum des menschlichen Körpers
    en: development of the human body
    eo: homa disvolviĝo
    es: desarrollo humano
    eu: Giza gorputzaren garapen
    fa: رشد
    fr: développement humain
    gl: desenvolvemento humano
    he: התפתחות גוף האדם
    hi: मानव विकास
    hu: az emberi test fejlődése
    hy: Մարդու զարգացում
    it: sviluppo umano
    ja: ヒトの成長
    kk: Адамның дамуы
    ko: 인간의 발달 과정
    lt: žmogaus amžiaus tarpsniai
    mk: човеков развој
    new: मनु विकासक्रम
    nl: levensfase
    pl: okresy rozwojowe człowieka
    pt: desenvolvimento do corpo humano
    ru: развитие человека
    sh: Humani razvoj
