...
- Bioloji inkişaf
- Bioloxía del desenvolvimientu
- bioloxía do desenvolvemento
- bitheolaíocht fhorbarthach
- developal biologia
...
dv_has_:
  name_:
    ar: علم الأحياء النمائي
    ast: Bioloxía del desenvolvimientu
    az: Bioloji inkişaf
    ba: Үҫеш биологияһы
    ...
    et: arengubioloogia
    eu: Garapenaren biologia
    fa: زیستشناسی رشد
    fi: kehitysbiologia
    fr: biologie du développement
    fur: Biologjie dal svilup
    ga: bitheolaíocht fhorbarthach
    gl: bioloxía do desenvolvemento
    he: ביולוגיה התפתחותית
    hi: परिवर्धन जैविकी
    hr: Razvojna biologija
    ht: Devlòpman
    hu: fejlődéstan
    hy: Զարգացման կենսաբանություն
    id: biologi perkembangan
    inh: ДегӀадара биологи
    is: Þroskunarfræði
    it: biologia dello sviluppo
    ja: 発生生物学
    ka: განვითარების ბიოლოგია
    ko: 발생생물학
    lb: Entwécklungsbiologie
    lt: vystymosi biologija
    lv: attīstības bioloģija
    mk: Развојна биологија
    mn: Биологийн өсөлт хөгжил
    ms: biologi perkembangan
    nan: Hoat-seⁿ seng-bu̍t-ha̍k
    nb: utviklingsbiologi
    nl: ontwikkelingsbiologie
    nn: utviklingsbiologi
    nov: developal biologia
    pl: biologia rozwoju
    ps: وده ييزه بيالوژي
    ...
    smn: ovdânembiologia
    sr: Biologija razvića
    sv: utvecklingsbiologi
    ta: விருத்தியாக்க உயிரியல்
    tay: ’nxan na mlikuy ro knerin Tayal
    th: ชีววิทยาการเจริญ
    tr: gelişim biyolojisi
    tt: үсеш биологиясе
    uk: біологія розвитку
    ur: نشونمائی حیاتیات
    uz: Rivojlanish biologiyasi
