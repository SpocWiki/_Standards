...
pronunciation_audio: http://commons.wikimedia.org/wiki/Special:FilePath/De-Aussterben.ogg
video: http://commons.wikimedia.org/wiki/Special:FilePath/Artensterben%20im%20Wandel%20der%20Zeit.webm
image:
- http://commons.wikimedia.org/wiki/Special:FilePath/Various%20dinosaurs.png
- http://commons.wikimedia.org/wiki/Special:FilePath/Various%20dinosaurs2.png
MeSH_tree_code: G16.510
dv_has_:
  name_:
    af: Uitsterwing
    an: extinción
    ...
    es: extinción
    et: väljasuremine
    eu: espezieen iraungipen
    ext: extinción
    fa: انقراض
    fi: sukupuutto
    fr: extinction des espèces
    fy: Utstjerren (biology)
    ga: díobhadh
    gcr: ekstenksyon di sé lèspès
    gl: extinción
    gu: વિલુપ્ત જાતિ
    ha: Karewar kwayoyin halitta
    hak: Chhie̍t-chúng
    he: מינים שנכחדו
    hi: विलुप्ति
    hr: izumiranje
    ...
    nov: extinktione
    nqo: ߕߌߢߍߟߌ
    oc: extincion d'una espècia
    or: ଲୁପ୍ତ
    pa: ਲੋਪ
    pl: wymieranie
    ps: انقراض/ له منځه تلل
    pt: extinção
    qu: rikch'aq wañuy
    ro: extincție
    ru: вымирание
...
> **Extinction** is the termination of an organism by the death of its last member. 
> A taxon may become functionally extinct before the death of its last member 
> if it loses the capacity to reproduce and recover. 
> 
> As a species' potential range may be very large, determining this moment is difficult, 
> and is usually done retrospectively. 
> 
