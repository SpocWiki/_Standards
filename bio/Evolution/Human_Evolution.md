...
Stack_Exchange_tag: https://biology.stackexchange.com/tags/human-evolution
IMDb_keyword: human-evolution
Krugosvet_article_archived_: nauka_i_tehnika/biologiya/EVOLYUTSIYA_CHELOVEKA.html
dv_has_:
  name_:
    af: Menslike evolusie
    anp: मानव केरऽ विकास
    ar: تطور الإنسان
    ast: Evolución humana
    az: Antropogenez
    azb: اینسان ائوریمی
    bar: Vuagschicht
    be: Антрапагенез
    ...
    de: Stammesgeschichte des Menschen
    diq: Evolusyonê merduman
    el: Ανθρώπινη εξέλιξη
    en: human evolution
    eo: homa deveno
    es: evolución humana
    ...
    fr: évolution humaine
    gl: Evolución humana
    gn: Yvypóra ñemoambue
    he: אבולוציה של האדם
    hi: मानव का विकास
    hr: Evolucija čovjeka
    hu: emberré válás
    hy: անթրոպոգենեզ
    id: evolusi manusia
    io: Evoluciono di homo
    is: Þróun mannsins
    it: evoluzione umana
    ja: 人類の進化
    kk: Антропогенез
    ...
    kn: ಮಾನವನ ವಿಕಾಸ
    ko: 인류의 진화
    ku: Paresana mirovahiyê
    ky: Антропогенез
    la: Evolutio hominis
    lfn: Evolui de Umania
    lt: Žmogaus evoliucija
    lv: Antropoģenēze
    mk: Еволуција на човекот
    ml: മനുഷ്യപരിണാമം
    mn: Хүний хувьсал
    ms: Evolusi manusia
    nan: Jîn-lūi chìn-hòa
    nb: menneskets evolusjon
    new: मनूया विकासक्रम
    nl: evolutie van de mens
    nov: homal evolutione
    oc: Evolucion umana
    pa: ਮਨੁੱਖ ਦਾ ਵਿਕਾਸ
    pap: Evolucion humano
    pl: antropogeneza
    pnb: ارتقائے آدم
    ps: د انسان تکامل
    pt: evolução humana
    rm: Evoluziun da l'uman
    ro: evoluția umană
    ru: антропогенез
    scn: Evuluzzioni umana
    sh: Ljudska evolucija
    si: මානව පරිණාමය
    sk: Antropogenéza
    ...
    uz: Antropogenez
    vec: evołusion umana
    vi: tiến hóa của loài người
    vls: Evoluusje van den miens
    vro: Inemise evoluts'uun
    war: Ebolusyon han tawo
    wuu: 人类演化
    yue: 人類演化
    zh: 人類演化
    zh_cn: 人类演化
...
> which also includes all the great apes. 
> 
> Over their evolutionary history, humans gradually developed traits such as bipedalism, dexterity, and complex language, as well as interbreeding with other hominins 
> (a tribe of the African hominid subfamily), 
