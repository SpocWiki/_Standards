...
- Penyu tempayan
- Rùa Quản Đồng
- Sini çanaqlı tısbağa (Caretta caretta
- Tartaruga común
- tartaruga-comum
- tortuga careta
- Tostoine de abba
- Táłtłʼááh chʼééh digháhii bitsiitsʼiin ntsaaígíí
...
- 붉은바다거북
- glattkarett
- dikkopschildpad, onechte karetschildpad
- Karetta
- Tartaruga-comum
- Логгерхед
- glavata kareta
...
3D_model: http://commons.wikimedia.org/wiki/Special:FilePath/Caretta%20caretta%203d%20scan%20Natural%20History%20Museum%20University%20of%20Pisa%20B%2032.stl
taxon_range_map_image: http://commons.wikimedia.org/wiki/Special:FilePath/Cypron-Range%20Caretta%20caretta.svg
pronunciation_audio: http://commons.wikimedia.org/wiki/Special:FilePath/De-Unechte%20Karettschildkr%C3%B6te.ogg
exact_match:
- http://wordnet-rdf.princeton.edu/wn30/01664065-n
- http://wordnet-rdf.princeton.edu/wn31/101666810-n
UMLS_CUI: C0999068
Commons_gallery: Caretta caretta
Commons_category: Caretta caretta
taxon_name: Caretta caretta
GenBank_assembly_accession_number: GCA_023653815.1
EPPO_Code: KARTCA
NBN_System_Key: NBNSYS0000188641
dv_has_:
  name_:
    af: Karetseeskilpad
    an: Caretta caretta
    ar: لجأة مكتلة الرأس
    arz: سلحفاه بحريه ضخمة الراس
    ast: Caretta caretta
    az: Sini çanaqlı tısbağa (Caretta caretta
    ban: Penyu jun
    bar: Caretta caretta
    bcl: Bulawon
    be_tarask: логергэд
    ...
    ca: tortuga careta
    ceb: Caretta caretta
    co: Cuppulata di mari
    cs: kareta obecná
    cy: Môr-grwban pendew
    da: Uægte karette
    ...
    mul: Caretta caretta
    nb: glattkarett
    nl: onechte karetschildpad
    nn: glattkarett
    nqo: ߕߊߥߏ
    nv: Táłtłʼááh chʼééh digháhii bitsiitsʼiin ntsaaígíí
    pl: Karetta
    pnb: کاریٹا کاریٹا
    pt: tartaruga-comum
    ...
    tl: Caretta caretta
    tr: Caretta caretta
    uk: довгоголова морська черепаха
    vi: Rùa Quản Đồng
    war: Caretta caretta
    wuu: 赤蠵龟
    yue: 赤蠵龜
...
#is_/same_as :: [[_Standards/WikiData/WD~Loggerhead_sea_turtle,192095|WD~Loggerhead_sea_turtle,192095]] 

## #has_/text_of_/abstract 

> The loggerhead sea turtle (Caretta caretta) is a species of oceanic turtle 
> distributed throughout the world. 
> 
> It is a marine reptile, belonging to the family Cheloniidae. 
> The average loggerhead measures around 90 cm (35 in) in carapace length when fully grown. 
> The adult loggerhead sea turtle weighs approximately 135 kg (298 lb), 
> with the largest specimens weighing in at more than 450 kg (1,000 lb). 
> The skin ranges from yellow to brown in color, and the shell is typically reddish brown. 
> 
> No external differences in sex are seen until the turtle becomes an adult, 
> the most obvious difference being the adult males have thicker tails and shorter plastrons 
> (lower shells) than the females.
>
> The loggerhead sea turtle is found in the Atlantic, Pacific, and Indian Oceans, 
> as well as the Mediterranean Sea. 
> 
> It spends most of its life in saltwater and estuarine habitats, 
> with females briefly coming ashore to lay eggs. 
> 
> The loggerhead sea turtle has a low reproductive rate; 
> females lay an average of four egg clutches and then become quiescent, 
...
> Young loggerheads are exploited by numerous predators; 
> the eggs are especially vulnerable to terrestrial organisms. 
> Once the turtles reach adulthood, 
> their formidable size limits predation to large marine animals, such as large sharks.
>
> The loggerhead sea turtle is considered a vulnerable species 
