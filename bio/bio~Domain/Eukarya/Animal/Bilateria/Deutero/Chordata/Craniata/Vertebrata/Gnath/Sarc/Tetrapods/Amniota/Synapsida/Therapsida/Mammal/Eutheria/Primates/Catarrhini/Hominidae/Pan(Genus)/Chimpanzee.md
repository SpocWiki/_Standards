...
- ချင်ပန်ဇီမျောက်ဝံ
- လိင်းၶျႅမ်ႉပႅၼ်းၸီး
- რჩქვანელობური შიმპანზე
- ჩვეულებრივი შიმპანზე
- チンパンジー
- 黑猩猩
- 침팬지
has_id_wikidata: Q4126704
different_from: '[[_Standards/WikiData/WD~Pan,80174|WD~Pan,80174]]'
...
original_combination: '[[_Standards/WikiData/WD~Simia_troglodytes,46122413|WD~Simia_troglodytes,46122413]]'
topic_s_main_category: '[[_Standards/WikiData/WD~Category_Pan_troglodytes,55301048|WD~Category_Pan_troglodytes,55301048]]'
...
gestation_period: 225
longest_observed_lifespan: 59.4
ITIS_TSN: 573082
taxon_common_name:
- Chimpanzee
- szympans zwyczajny
...
- navadni šimpanz
- 黑猩猩
OmegaWiki_Defined_Meaning: 1391514
audio: http://commons.wikimedia.org/wiki/Special:FilePath/Chimpanzee-Alarm-Call-Production-Meets-Key-Criteria-for-Intentionality-pone.0076674.s005.oga
short_name: P. troglodytes
start_time: -4000000-01-01T00:00:00Z
image:
- http://commons.wikimedia.org/wiki/Special:FilePath/013%20Alpha%20male%20chimpanzee%20at%20Kibale%20forest%20National%20Park%20Photo%20by%20Giles%20Laurent.jpg
- http://commons.wikimedia.org/wiki/Special:FilePath/Gombe%20Stream%20NP%20Beute.jpg
taxon_range_map_image: http://commons.wikimedia.org/wiki/Special:FilePath/Pan%20troglodytes%20area.png
exact_match: http://wordnet-rdf.princeton.edu/wn30/02481823-n
sequenced_genome_URL: http://www.ensembl.org/Pan_troglodytes
MeSH_tree_code: B01.050.150.900.649.313.988.400.112.400.620
UMLS_CUI: C0008111
Commons_gallery: Pan troglodytes
Commons_category: Pan troglodytes
...
dv_has_:
  name_:
    ...
    hr: Obična čimpanza
    hsb: wšědny šimpansa
    hu: közönséges csimpánz
    hy: շիմպանզե սովորական
    hyw: Շեմփանզէն
    ia: chimpanze commun
    id: simpanse biasa
    ig: adaka
    ...
    ja: チンパンジー
    jv: Simpanse
    ka: ჩვეულებრივი შიმპანზე
    kcg: Ja̱fi̱k
    kk: Шимпанзе
    ko: 침팬지
    la: Pan troglodytes
    lbe: Шимпанзе
    li: Gewoene chimpansee
    ln: Mokómbósó
    ...
    nn: Sjimpanse
    nqo: ߥߏ߬ߘߏ߲
    os: Хуымæтæджы шимпанзе
    pl: szympans zwyczajny
    pnb: عام چمپینزی
    ...
    sr: шимпанза
    sv: schimpans
    sw: Sokwe Mtu wa Kawaida
    ta: சிம்பன்சி
    th: ชิมแปนซี
    tl: Chimpanzee
    tr: Bayağı şempanze
    udm: Шимпанзе
    uk: Шимпанзе звичайний
    uz: Shimpanze
    vi: Tinh tinh thông thường
    war: Pan troglodytes
    wuu: 黑猩猩
...
#is_/same_as :: [[_Standards/WikiData/WD~Chimpanzee,4126704|WD~Chimpanzee,4126704]]
