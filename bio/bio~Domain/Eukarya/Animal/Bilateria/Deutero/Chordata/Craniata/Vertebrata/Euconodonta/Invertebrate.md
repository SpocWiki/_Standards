...
- bezobratlí
- Bezstavovce
- Biby tsy manana hazondamosina
- Biesse sins cronzoxhs
- bêbirrbirredar
- Bête sans héthèque
...
- Wringeleazen
- Çурăм шăммисĕрри
- čielgitävtittemes elleeh
- čiõʹljteʹmes jieʹlli
...
U_S_National_Archives_Identifier: 10638427
taxon_name: Invertebrata
pronunciation_audio: http://commons.wikimedia.org/wiki/Special:FilePath/LL-Q8752%20%28eus%29-ElsaBornFree-Ornogabe.wav
Stack_Exchange_tag: https://biology.stackexchange.com/tags/invertebrates
GS1_GPC_code: 89020100
MeSH_tree_code: B01.050.500
Commons_category: Invertebrates
Krugosvet_article_archived_: nauka_i_tehnika/biologiya/BESPOZVONOCHNIE.html
dv_has_:
  name_:
    af: Ongewerweldes
    am: ኢደንደሴ
    ...
    ky: Омурткасыздар
    la: invertebrata
    li: Oongewervelde bieste
    ln: Nyama ya mikúwa tɛ̂
    lt: bestuburiai
    lv: bezmugurkaulnieki
    mg: Biby tsy manana hazondamosina
    mk: безрбетници
    ml: അകശേരുകികൾ
    mn: Сээр нуруугүй амьтан
    mrj: Тупӹрдӹдӹмӹ йӓнвлӓ
    ms: Invertebrata
    my: ကျောရိုးမဲ့သတ္တဝါ
    mzn: بی میرکائون
    nan: Bô-chek-chui tōng-bu̍t
    nb: virvelløse dyr
    nds: Warvellose Deerter
    nl: ongewervelden
    nn: virvellause dyr
    nrm: Bête sans héthèque
    nv: Chʼosh
    oc: Invertebrata
    om: Duguggurmaleeyyii
    pa: ਕੰਗਰੋੜਹੀਣ
    pl: bezkręgowce
    pnb: انکنگریڑے
    ...
    sa: अकशेरुकाः
    sco: invertebrate
    sd: غير ڪرنگھيدار جانور
    se: rikkehis eallit
    sh: Beskralježnjaci
    si: අපෘෂ්ඨවංශීන්
    sk: Bezstavovce
    sl: nevretenčar
    smn: čielgitävtittemes elleeh
...
> **Invertebrate**s are animals that neither develop nor retain a vertebral column 
> (commonly known as a spine or backbone), which evolved from the notochord. 
> 
> It is a paraphyletic grouping including 
> **all animals excluding the chordate subphylum [[../../Vertebrata|Vertebrata]]**, i.e. vertebrates. 
...
> one estimate puts the figure at 97%.  
> Many invertebrate taxa have a greater number and diversity of species 
> than the entire subphylum of Vertebrata. 
> Invertebrates vary widely in size, from 10 μm (0.0004 in) myxozoans to the 9–10 m (30–33 ft) colossal squid.
>
> Some so-called invertebrates, such as the Tunicata and Cephalochordata, 
> are actually sister chordate subphyla to Vertebrata, being more closely related to vertebrates than to other invertebrates. This makes the "invertebrates" paraphyletic, so the term has no significance in taxonomy.
>
