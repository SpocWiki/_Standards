...
EPPO_Code: 1PSESO
UMLS_CUI: C1016222
NBN_System_Key: NHMSYS0000356759
Commons_category: Pseudoscorpiones
taxon_name: Pseudoscorpiones
taxon_common_name:
- pseudoescorpión
- Pseudoscorpions
- Pseudoscorpión
...
dv_has_:
  name_:
    ...
    hr: Lažištipavci
    hu: álskorpiók
    id: Kalajengking palsu
    is: Drekar
    it: Pseudoscorpionida
    ja: カニムシ
    ka: ცრუმორიელები
    kk: Жалған саршаяндар
    ko: 앉은뱅이목
    ky: Чаянсөрөйлөр
    la: Pseudoscorpionida
    lt: Pseudoskorpionai
    lv: Māņskorpioni
    mul: Pseudoscorpiones
    nb: mosskorpioner
    nn: bokskorpionar
    nv: Séigoʼchilí bitseeʼ ádinígíí
    pl: Zaleszczotki
    ps: تقلبي لړم
...
> **Pseudoscorpion**s, also known as false scorpions or book scorpions, 
> are small, scorpion-like arachnids belonging to the order Pseudoscorpiones, 
> also known as Pseudoscorpionida or Chelonethida.
>
