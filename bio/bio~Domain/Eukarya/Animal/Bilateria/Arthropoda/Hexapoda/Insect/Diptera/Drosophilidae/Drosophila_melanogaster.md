...
- navadna vinska mušica
image:
- http://commons.wikimedia.org/wiki/Special:FilePath/Drosophila%20melanogaster%20-%20side%20%28aka%29.jpg
- http://commons.wikimedia.org/wiki/Special:FilePath/202101%20Fruitfly.svg
Commons_gallery: Drosophila melanogaster
Commons_category: Drosophila melanogaster
taxon_name: Drosophila melanogaster
sequenced_genome_URL:
- http://www.ensembl.org/Drosophila_melanogaster
- https://metazoa.ensembl.org/Drosophila_melanogaster
MeSH_tree_code: B01.050.500.131.617.720.500.500.750.310.250.500
UMLS_CUI: C0013139
EPPO_Code: DROSME
NBN_System_Key: NBNSYS0000029555
short_name: D. melanogaster
dv_has_:
  name_:
    ace: Drosophila melanogaster
    ...
    eu: ozpin-euli
    ext: Drosophila melanogaster
    fa: مگس سرکه
    fi: banaanikärpänen
    fr: Drosophila melanogaster
    ga: Drosophila melanogaster
    gl: Mosca do vinagre
    he: תסיסנית המחקר
    hr: Vinska mušica
    hu: ecetmuslica
    ia: Drosophila melanogaster
    id: Drosophila melanogaster
    ie: Drosophila melanogaster
    io: Drosophila melanogaster
    is: Ávaxtafluga
    ...
    sh: Vinska mušica
    sk: Drozofila obyčajná
    sl: navadna vinska mušica
    sq: Drosophila melanogaster
    sr: vinska mušica
    su: Rametuk
    sv: bananfluga
    th: แมลงวันทอง
    tl: Drosophila melanogaster
    tr: Drosophila melanogaster
    uk: дрозофіла чорночерева
    vi: ruồi giấm thường
    vo: Drosophila melanogaster
    war: Drosophila melanogaster
    wuu: 黑腹果蝇
    yue: 黑腹果蠅
    zh: 黑腹果蠅
    zh_cn: 黑腹果蝇
...
> Drosophila melanogaster is a species of fly (an insect of the order Diptera) 
> in the family Drosophilidae. 
> The species is often referred to as the fruit fly or lesser fruit fly, 
> or less commonly the "vinegar fly", "pomace fly", or "banana fly". 
> 
> In the wild, D. melanogaster are attracted to rotting fruit and fermenting beverages, 
> and they are often found in orchards, kitchens and pubs.
>
> Starting with Charles W. Woodworth's 1901 proposal 
> of the use of this species as a model organism, 
> D. melanogaster continues to be widely used for biological research in genetics, 
> physiology, microbial pathogenesis, and life history evolution. 
> 
> D. melanogaster was the first animal to be launched into space in 1947. 
> As of 2017, six Nobel Prizes have been awarded to drosophilists 
> for their work using the insect.
>
> Drosophila melanogaster is typically used in research owing to its rapid life cycle, 
...
> D. melanogaster is a common pest in homes, restaurants, 
> and other places where food is served.
>
> Flies belonging to the family Tephritidae are also called "fruit flies". 
> This can cause confusion, especially in the Mediterranean, Australia, and South Africa, 
