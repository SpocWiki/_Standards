...
UMLS_CUI: C1201367
UNII: F5C4R60S7W
NBN_System_Key: NBNSYS0000003513
Commons_gallery: Ribes rubrum
Commons_category: Ribes rubrum
taxon_name: Ribes rubrum
EPPO_Code: RIBRU
dv_has_:
  name_:
    an: Ribes rubrum
    ...
    cs: rybíz červený
    csb: Swiãtojanka
    cy: Llwyn Cwrens Coch
    da: Have-Ribs
    de: Rote Johannisbeere
    dsb: Cerwjeny janowy krick
    el: Φραγκοστάφυλο
    en: Ribes rubrum
    eo: Ruĝa ribo
    es: Ribes rubrum
    ...
    ext: Ribes rubrum
    fa: انگورفرنگی سرخ
    fi: lännenpunaherukka
    fr: groseiller
    frr: Riiblis
    ga: cuirín dearg
    gl: Groselleira vermella
    gv: Berrish yiarg
    he: דומדמנית
    hr: Crveni ribiz
    hsb: Čerwjeny januškowc
    hu: vörös ribiszke
    hy: Կարմիր հաղարջ
    ia: Ribes rubrum
    ie: Ribes rubrum
...
> is a member of the genus Ribes in the family Grossulariaceae. 
> 
> It is native to western Europe. 
> The species is widely cultivated and has escaped into the wild in many regions.
>
