...
- https://protists.ensembl.org/Plasmodium_malariae_gca_900090045
UNII: AR76CST9I2
MeSH_tree_code: B01.043.075.380.611.661
GenBank_assembly_accession_number: GCA_900090005.1
Commons_category: Plasmodium malariae
taxon_name: Plasmodium malariae
short_name: P. malariae
taxon_common_name: zarodziec pasmowy
dv_has_:
  name_:
    an: Plasmodium malariae
    ar: متصورة وبالية
    arz: متصوره وباليه
    ast: Plasmodium malariae
    bg: Plasmodium malariae
    ca: plasmodi de la malària
    ceb: Plasmodium malariae
    da: Plasmodium malariae
    de: Plasmodium malariae
    en: Plasmodium malariae
    eo: Plasmodium malariae
    es: Plasmodium syriani
    eu: Plasmodium malariae
    ext: Plasmodium malariae
    fa: پلاسمودیوم مالاریه
    fi: Plasmodium malariae
    fo: Plasmodium malariae
    fr: Plasmodium malariae
    ga: Plasmodium malariae
    gl: Plasmodium malariae
    hi: प्लास्मोडियम मलेरिये
    hr: Plasmodium malariae
    hu: Plasmodium malariae
    ia: Plasmodium malariae
    id: Plasmodium malariae
    ie: Plasmodium malariae
    io: Plasmodium malariae
    is: Plasmodium malariae
    it: Plasmodium malariae
    ja: Plasmodium malariae
    kl: Plasmodium malariae
    ko: 사일열원충
    la: Plasmodium malariae
    mn: пласмод
    mul: Plasmodium malariae
    nb: Plasmodium malariae
    nl: Plasmodium malariae
    nn: Plasmodium malariae
    ...
    sq: Plasmodium malariae
    sv: Plasmodium malariae
    tr: Plasmodium malariae
    uk: Plasmodium malariae
...
#is_/same_as :: [[_Standards/WikiData/WD~Plasmodium_malariae,133969|WD~Plasmodium_malariae,133969]] 

## #has_/text_of_/abstract 

> Plasmodium malariae is a parasitic protozoan that causes [[../../../../../Medicine/Medical_Condition/Disease/Infectious_Disease/Malaria|Malaria]] in 
> amphibians, birds and mammals, including humans.  
> 
> It is one of several species of Plasmodium parasites 
> that infect other organisms as pathogens, 
> also including Plasmodium falciparum and Plasmodium vivax, 
> responsible for most malarial infection.  
> 
> Found worldwide, it causes a so-called "benign malaria", 
> not nearly as dangerous as that produced by P. falciparum or P. vivax. 
> 
> The signs include fevers that recur at approximately three-day intervals – 
> a quartan fever or quartan malaria – 
> longer than the two-day (tertian) intervals of the other malarial parasite.
>
