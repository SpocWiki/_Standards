...
> most of which have Gram-positive cell wall structure. 
> They have round cells, called cocci (singular coccus), or rod-like forms (bacillus). 
> 
> A few Bacillota, such as Megasphaera, Pectinatus, Selenomonas, 
> and Zymophilus from the class Negativicutes, 
> have a porous pseudo-outer membrane that causes them to stain Gram-negative. 
> 
...
> 
> Those in one family, the Heliobacteria, produce energy through anoxygenic photosynthesis. 
> Bacillota play an important role in beer, wine, and cider spoilage.
>
