...
image: http://commons.wikimedia.org/wiki/Special:FilePath/Transpiration%20Overview.svg
exact_match: http://purl.obolibrary.org/obo/ENVO_02500035
UMLS_CUI:
- C0242736
- C1326386
MeSH_tree_code: G15.713
dv_has_:
  name_:
    af: Transpirasie
    ar: نتح
    ...
    es: transpiración vegetal
    et: Transpiratsioon
    eu: Landareen transpirazioa
    fa: تعرق
    fi: Transpiraatio
    fr: transpiration végétale
    ga: trasghalú
    gl: Transpiración vexetal
    gu: બાષ્પોત્સર્જન
    ...
    nl: transpiratie
    nn: Transpirasjon
    oc: Transpiracion vegetala
    om: Tiraanispiireeshinii
    pa: ਵਾਸ਼ਪ ਉਤਸਰਜਨ
    pl: transpiracja
    pt: transpiração
    ro: transpirație
...
> Transpiration also cools plants, changes osmotic pressure of cells, 
