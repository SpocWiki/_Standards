...
dv_has_:
  name_:
    ...
    ar: أدينوسين ثلاثي الفوسفات
    ast: adenosín trifosfatu
    az: Hüceyrənin enerji mənbəyi - ATF
    ...
    frr: Adenosintriphosphat
    ga: trífhosfáit adanóisín
    ...
    lfn: Trifosfato de adenosina
    lmo: Adenosina trifosfad
    lt: ATP
...
> - chemical synthesis. 
> 
> Found in all known forms of life, it is often referred to as the 
> "molecular unit of currency" for intracellular energy transfer.
> 
> When consumed in a metabolic process, ATP converts 
> - either to adenosine diphosphate (ADP) 
> - or to adenosine monophosphate (AMP). 
> 
> Other processes regenerate ATP. 
> 
...
> which indicates that it consists of three components: 
