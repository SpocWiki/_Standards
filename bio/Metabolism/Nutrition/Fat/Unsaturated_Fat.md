...
dv_has_:
  name_:
    ...
    az: Doymamış yağlar
    ca: greix insaturat
    cy: braster annirlawn
    da: umættet fedt
    de: ungesättigte Fette
    dv: ފެޓް
    el: ακόρεστα λιπαρά
    en: unsaturated fat
    ...
    fa: چربی غیراشباع
    fi: tyydyttymätön rasva
    fr: graisses insaturées
    he: שומן בלתי רווי
    id: lemak tak jenuh
    it: grassi insaturi
    ja: 不飽和脂肪
...
#is_/same_as :: [[_Standards/WikiData/WD~Unsaturated_fat,652555|WD~Unsaturated_fat,652555]]
