...
PubChem_CID: 988
OmegaWiki_Defined_Meaning: 1191215
...
Gmelin_number: 775395
Reaxys_registry_number: 1727062
chemical_formula: C₉H₁₇NO₅
chemical_structure: http://commons.wikimedia.org/wiki/Special:FilePath/Pantothenic%20acid.svg
EC_number: 209-965-4
CAS_Registry_Number: 599-54-2
isomeric_SMILES: CC(C)(CO)[C@@H](O)C(=O)NCCC([O-])=O
canonical_SMILES: CC(C)(CO)C(C(=O)NCCC(=O)O)O
MeSH_tree_code:
- D02.478.520
- D12.125.042.070.500
DSSTOX_compound_identifier: DTXCID5027229
Krugosvet_article_archived_: meditsina/pantotenovaya-kislota
Commons_category: Pantothenic acid
SPLASH: splash10-0zfu-1950000000-e17ccf50735fd5171fc4
dv_has_:
  name_:
    af: Pantoteensuur
    ar: فيتامين بي5
