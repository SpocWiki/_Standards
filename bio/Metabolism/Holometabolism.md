...
dv_has_:
  name_:
    ar: تطور كامل
    az: Həşəratın inkişafı
    bg: Холометаболизъм
    bs: Kompletna metamorfoza
    ca: holometabolia
    da: holometabolisme
    en: holometabolism
    es: Holometabolismo
    et: Täismoone
    eu: Metamorfosi konplexu
    fa: همهدگردیسی
    fi: Täydellinen muodonvaihdos
    hu: teljes átalakulás
    id: Holometabolisme
    is: Fullkomin myndbreyting
    ja: 完全変態
    ko: 완전변태
    ms: Holometabolisme
    nl: Volledige gedaanteverwisseling
    nn: Holometaboli
    pl: Przeobrażenie zupełne owadów
    pt: holometabolismo
    ru: Голометаболия
    sl: holometabolizem
    yue: 完全變態
