...
icon: http://commons.wikimedia.org/wiki/Special:FilePath/Parasitic%20fungus.svg
...
> where one organism, the parasite, lives (at least some of the time) on or inside 
> another organism, the host, causing it some harm, 
