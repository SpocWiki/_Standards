...
- http://commons.wikimedia.org/wiki/Special:FilePath/Hawk%20eating%20prey.jpg
Commons_category: Predation
dv_has_:
  name_:
    af: Predasie
    an: depredación
...
> **Predation** is a biological interaction in which one organism, 
> the predator, kills and eats another organism, its prey. 
> 
> It is one of a family of common feeding behaviours 
> that includes parasitism and micropredation (which usually do not kill the host) 
> and parasitoidism (which always does, eventually). 
> 
