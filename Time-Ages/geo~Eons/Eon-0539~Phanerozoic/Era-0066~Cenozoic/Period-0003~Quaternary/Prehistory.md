...
- Ragistor
- rujenav
- sakbay ti pakasaritaan
- Sú-chêng
- Talohan'ny tantara
- Tarihten evel zamanları
- Tarihöncesi
- tenpo pi sitelen ala
- thời tiền sử
- Ur- und Friegschicht
- Urgeschichte
- Vertarix
...
studied_in:
- '[[_Standards/WikiData/WD~prehistoric_archaeology,2415966|WD~prehistoric_archaeology,2415966]]'
- '[[_Standards/WikiData/WD~prehistory_and_early_history,2310752|WD~prehistory_and_early_history,2310752]]'
subclass_of: '[[_Standards/WikiData/WD~archaeological_culture,465299|WD~archaeological_culture,465299]]'
topic_s_main_template: '[[_Standards/WikiData/WD~Q6187119,6187119|WD~Q6187119,6187119]]'
topic_s_main_Wikimedia_portal: '[[_Standards/WikiData/WD~Portal_Prehistory,7498415|WD~Portal_Prehistory,7498415]]'
...
dv_has_:
  name_:
    ...
    ast: Prehistoria
    avk: Abdiizva
    az: İbtidai-icma quruluşu
    azb: ایبتیدائی جامیعه قورولوشو
    ba: Тәүтормош йәмғиәте
    bar: Vor- und Frühgschicht
    bcl: Prehistorya
    be: прагісторыя
    be-tarask: першабытнае грамадзтва
    bg: Праистория
    bn: প্রাগৈতিহাস
    bo: ལོ་རྒྱུས་བྱུང་གོང་གི་དུས་མཚམས།
    br: Ragistor
    bs: Prahistorija
    bxr: Эртэ балар үе
    ca: prehistòria
    ...
    id: prasejarah
    ie: Prehistorie
    ilo: sakbay ti pakasaritaan
    inh: Хьалхара юкъарле
    io: prehistorio
    is: forsögulegur tími
    it: Preistoria
    ...
    mt: preistorja
    mwl: Pre-Stória
    my: သမိုင်းမတင်မီခေတ်
    myv: Васенце шкань ломантнень эрямост
    nan: Sú-chêng
    nb: forhistorisk tid
    nds: Prähistorie
    nds-nl: prehistorie
    ...
    pms: Preistòria
    pnb: تریخ توں پہلے
    ps: د تاریخ څخه پخوا دوران
    pt: pré-história
    pt-br: pré-história
    rm: Preistorgia
    ro: preistorie
    ru: доисторический период
    rue: Правік
    sah: Преистория
    sc: Preistòria
    scn: Preistoria
    sd: تاريخ کان اڳ جو دور
    se: ovdahistorjá
    sgs: Prīšistuorė
    sh: prahistorija
    shi: Azermezruy
    si: ප්රාග් ඓතිහාසික යුගය
    sk: pravek
    sl: prazgodovina
    sma: åvtehistovrije
    smj: åvddåhiståvrrå
    ...
    tl: Prehistorikong kasaysayan
    tok: tenpo pi sitelen ala
    tr: Tarihöncesi
    ts: Matimu yo sungula
    tt: тарихкача чор
    uk: преісторія
    ur: زمانہ قبل از تاریخ
    uz: Ibtidoiy jamiyat
    vec: preistòria
    vep: Istorijanedeline kund
    vi: thời tiền sử
    vls: Prehistorie
    vo: rujenav
    vro: Muistinõ aig
...
### #is_/same_as :: [[/_Standards/Time-Ages/geo~Eons/Eon-0539~Phanerozoic/Era-0066~Cenozoic/Period-0003~Quaternary/Prehistory|Prehistory]] 

### #is_/same_as :: [[/_public/Time-Ages/geo~Eons/Eon-0539~Phanerozoic/Era-0066~Cenozoic/Period-0003~Quaternary/Prehistory.public|Prehistory.public]] 

### #is_/same_as :: [[/_internal/Time-Ages/geo~Eons/Eon-0539~Phanerozoic/Era-0066~Cenozoic/Period-0003~Quaternary/Prehistory.internal|Prehistory.internal]] 

### #is_/same_as :: [[/_protect/Time-Ages/geo~Eons/Eon-0539~Phanerozoic/Era-0066~Cenozoic/Period-0003~Quaternary/Prehistory.protect|Prehistory.protect]] 

### #is_/same_as :: [[/_private/Time-Ages/geo~Eons/Eon-0539~Phanerozoic/Era-0066~Cenozoic/Period-0003~Quaternary/Prehistory.private|Prehistory.private]] 

### #is_/same_as :: [[/_personal/Time-Ages/geo~Eons/Eon-0539~Phanerozoic/Era-0066~Cenozoic/Period-0003~Quaternary/Prehistory.personal|Prehistory.personal]] 

### #is_/same_as :: [[/_secret/Time-Ages/geo~Eons/Eon-0539~Phanerozoic/Era-0066~Cenozoic/Period-0003~Quaternary/Prehistory.secret|Prehistory.secret]] 
