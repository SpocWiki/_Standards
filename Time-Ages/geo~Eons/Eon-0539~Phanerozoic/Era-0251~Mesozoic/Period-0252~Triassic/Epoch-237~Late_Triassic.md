...
dv_has_:
  ...
  name_:
    ...
    en: Late Triassic
    eo: Supra Triaso
    es: Triásico superior
    et: Hilis-Triias
    eu: Triasiko Berantiar
    fa: تریاس پسین
    fi: Myöhäistriaskausi
    fr: Trias supérieur
    ga: an Sealad Triasach Déanach
    gl: Triásico superior
    he: טריאס עליון
    hu: késő triász
    id: Trias Akhir
    it: Triassico superiore
    ja: 三畳紀後期
    ko: 트라이아스기 후기
    la: Triassicum superius
    lt: viršutinis triasas
    ms: Trias Akhir
    nl: Boven-Trias
    nn: øvre trias
    no: Sen trias
...
dv_is_:
  same_as:
  - '[[_Standards/WikiData/WD~Late_Triassic,917293]]'
...
#is_/same_as :: [[_Standards/WikiData/WD~Late_Triassic,917293]] 
