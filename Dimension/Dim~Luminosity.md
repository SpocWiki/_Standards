...
> and is synonymous with the radiant power emitted by a light-emitting object. 
> 
> In astronomy, luminosity is the total amount of electromagnetic energy emitted 
> per unit of time by a star, galaxy, or other astronomical objects.
>
...
> the absolute bolometric magnitude (Mbol) of an object is a logarithmic measure of its total energy emission rate, while absolute magnitude is a logarithmic measure of the luminosity within some specific wavelength range or filter band.
>
