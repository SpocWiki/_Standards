...
> wavelength-weighted by the luminosity function 
...
> 
> Luminous exitance is measured in lm/m² only, not lux. 
> In the CGS system, the unit of illuminance is the phot, which is equal to 10000 lux. 
...
> but this leads to confusion with other uses of the word, such as to mean luminance. 
> "Brightness" should never be used for quantitative description, 
> but only for nonquantitative references to physiological sensations and perceptions of light.
>
