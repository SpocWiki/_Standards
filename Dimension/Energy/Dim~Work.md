...
- мэханічная праца
- работа
- робота (фізично-механічна величина)
- уж
...
dv_has_:
  name_:
    ...
    ml: പ്രവൃത്തി
    mn: Aжил
    mr: कार्य (भौतिकशास्त्र)
    ms: Kerja
    my: အလုပ်
    nan: Kang
    nb: arbeid
    ne: कार्य (भौतिकशास्त्र)
    new: वेलै
    nl: arbeid
    nn: arbeid
    oc: Trabalh
    ...
    tt: механик эш
    udm: уж
    uk: робота (фізично-механічна величина)
    ur: آلاتی کام
    vi: công cơ học
    wo: Liggéey
    wuu: 功
