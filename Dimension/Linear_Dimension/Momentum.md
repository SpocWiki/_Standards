...
> more specifically linear momentum or translational momentum) 
...
> then the object's momentum p (from Latin pellere "push, drive") is: 
> p = m v
>
> In the International System of Units (SI), 
> the unit of measurement of momentum is the kilogram metre per second (kg⋅m/s), 
> which is dimensionally equivalent to the newton-second.
>
