...
- Гц
- Ҳтс
UN_CEFACT_Common_Code: HTZ
Wolfram_Language_unit_code: '"Hertz"'
IEV_number: 103-06-18
Unicode_character: ㎐
Wikidata_SPARQL_query_equivalent: wd:Q39369 p:P2370/psn:P2370 [wikibase:quantityAmount ?source; wikibase:quantityUnit ?base]. ?item p:P2370/psn:P2370 [wikibase:quantityAmount ?target; wikibase:quantityUnit ?base]. BIND(?source / ?target as ?value)
image: http://commons.wikimedia.org/wiki/Special:FilePath/FrequencyAnimationSymetric.gif
dv_has_:
  name_:
    af: Hertz
    ar: هرتز
