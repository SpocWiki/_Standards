...
dv_has_:
  name_:
    ...
    en: leap second
    eo: supersekundo
    es: segundo intercalar
    et: liigsekund
    eu: segundo gehigarri
    fa: ثانیه کبیسه
    fi: karkaussekunti
    ...
    ga: soicind bisigh
    he: דקה מעוברת
    hr: prijestupna sekunda
    hu: szökőmásodperc
    hy: կոորդինացիոն վայրկյան
    id: detik kabisat
    io: secondo ajuntada
    it: secondo intercalare
    ja: 閏秒
    ko: 윤초
    la: secundum intercalarium
    lfn: secondo ajuntada
    lv: liekā sekunde
    ml: ലീപ് സെക്കന്റ്
    ms: saat lompat
    nb: skuddsekund
    ...
    sk: priestupná sekunda
    sl: prestopna sekunda
    sr: prestupna sekunda
    sv: skottsekund
    ta: லீப் நொடி
    th: อธิกวินาที
    tr: artık saniye
    uk: високосна секунда
    ur: لیپ سیکنڈ
    vi: Giây nhuận
    wuu: 闰秒
    yue: 閏秒
