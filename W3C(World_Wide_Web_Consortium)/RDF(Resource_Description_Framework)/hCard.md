...
### #is_/same_as :: [hCard](/_Standards/W3C(World_Wide_Web_Consortium)/RDF(Resource_Description_Framework)/hCard.md) 

### #is_/same_as :: [hCard.public](/_public/W3C(World_Wide_Web_Consortium)/RDF(Resource_Description_Framework)/hCard.public.md) 

### #is_/same_as :: [hCard.internal](/_internal/W3C(World_Wide_Web_Consortium)/RDF(Resource_Description_Framework)/hCard.internal.md) 

### #is_/same_as :: [hCard.protect](/_protect/W3C(World_Wide_Web_Consortium)/RDF(Resource_Description_Framework)/hCard.protect.md) 

### #is_/same_as :: [hCard.private](/_private/W3C(World_Wide_Web_Consortium)/RDF(Resource_Description_Framework)/hCard.private.md) 

### #is_/same_as :: [hCard.personal](/_personal/W3C(World_Wide_Web_Consortium)/RDF(Resource_Description_Framework)/hCard.personal.md) 

### #is_/same_as :: [hCard.secret](/_secret/W3C(World_Wide_Web_Consortium)/RDF(Resource_Description_Framework)/hCard.secret.md)
