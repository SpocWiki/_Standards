...
Use it like this: 
- #has_/text_of_broadcast_timezone = `=this.dv_has_text_of_broadcast_timezone`  
- has_text_of_broadcast_timezone = `=this.dv_has_text_of_broadcast_timezone`  
