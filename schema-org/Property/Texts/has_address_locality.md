...
title: has_text_on_address_locality
linkTitle: has_text_on_address_locality
...
- address_locality
- addressLocality
- has_text_on_address_locality
---

Predicate to describe the Text of PostalAddress.

Use it like this: 
- [ #has_/text_/on_/address_locality :: Text ] or 
- [ has_text_on_address_locality :: Text ] 

The locality in which the street address is, and which is in the region. For example, Mountain View.

Predicated describes that: 
[ #has_/domain  :: PostalAddress ]
( #has_/name :: has_text_on_address_locality )
( #has_/range :: Text )
