...
title: has_text_of_membership_number
linkTitle: has_text_of_membership_number
...
- membership_number
- membershipNumber
- has_text_of_membership_number
---

Predicate to describe the Text of ProgramMembership.

Use it like this: 
- [ #has_/text_/of_/membership_number :: Text ] or 
- [ has_text_of_membership_number :: Text ] 

A unique identifier for the membership.

Predicated describes that: 
[ #has_/domain  :: ProgramMembership ]
( #has_/name :: has_text_of_membership_number )
( #has_/range :: Text )
