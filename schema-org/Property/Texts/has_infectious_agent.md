...
title: has_text_on_infectious_agent
linkTitle: has_text_on_infectious_agent
...
- infectious_agent
- infectiousAgent
- has_text_on_infectious_agent
---

Predicate to describe the Text of InfectiousDisease.

Use it like this: 
- [ #has_/text_/on_/infectious_agent :: Text ] or 
- [ has_text_on_infectious_agent :: Text ] 

The actual infectious agent, such as a specific bacterium.

Predicated describes that: 
[ #has_/domain  :: InfectiousDisease ]
( #has_/name :: has_text_on_infectious_agent )
( #has_/range :: Text )
