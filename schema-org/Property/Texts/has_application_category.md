...
Use it like this: 
- #has_/text_of_application_category = `=this.dv_has_text_of_application_category`  
- has_text_of_application_category = `=this.dv_has_text_of_application_category`  
