...
title: has_text_of_broadcast_channel_id
linkTitle: has_text_of_broadcast_channel_id
...
- broadcastChannelId
- has_text_of_broadcast_channel_id
---

Predicate to describe the Text of BroadcastChannel.

Use it like this: 
- [ #has_/text_/of_/broadcast_channel_id :: Text ] or 
- [ has_text_of_broadcast_channel_id :: Text ] 

The unique address by which the BroadcastService can be identified in a provider lineup. In US, this is typically a number.

Predicated describes that: 
[ #has_/domain  :: BroadcastChannel ]
( #has_/name :: has_text_of_broadcast_channel_id )
( #has_/range :: Text )
