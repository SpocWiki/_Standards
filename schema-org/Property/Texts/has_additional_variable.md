...
title: has_text_on_additional_variable
linkTitle: has_text_on_additional_variable
...
- additional_variable
- additionalVariable
- has_text_on_additional_variable
---

Predicate to describe the Text of ExercisePlan.

Use it like this: 
- [ #has_/text_/on_/additional_variable :: Text ] or 
- [ has_text_on_additional_variable :: Text ] 

Any additional component of the exercise prescription that may need to be articulated to the patient. This may include the order of exercises, the number of repetitions of movement, quantitative distance, progressions over time, etc.

Predicated describes that: 
[ #has_/domain  :: ExercisePlan ]
( #has_/name :: has_text_on_additional_variable )
( #has_/range :: Text )
