...
title: has_text_on_departure_terminal
linkTitle: has_text_on_departure_terminal
...
- departure_terminal
- departureTerminal
- has_text_on_departure_terminal
---

Predicate to describe the Text of Flight.

Use it like this: 
- [ #has_/text_/on_/departure_terminal :: Text ] or 
- [ has_text_on_departure_terminal :: Text ] 

Identifier of the flight"s departure terminal.

Predicated describes that: 
[ #has_/domain  :: Flight ]
( #has_/name :: has_text_on_departure_terminal )
( #has_/range :: Text )
