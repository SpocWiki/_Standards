...
title: has_text_of_reservation_id
linkTitle: has_text_of_reservation_id
...
- reservation_id
- reservationId
- has_text_of_reservation_id
---

Predicate to describe the Text of Reservation.

Use it like this: 
- [ #has_/text_/of_/reservation_id :: Text ] or 
- [ has_text_of_reservation_id :: Text ] 

A unique identifier for the reservation.

Predicated describes that: 
[ #has_/domain  :: Reservation ]
( #has_/name :: has_text_of_reservation_id )
( #has_/range :: Text )
