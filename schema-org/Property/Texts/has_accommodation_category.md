...
title: has_text_on_accommodation_category
linkTitle: has_text_on_accommodation_category
...
- has_text_on_accommodation_category
---
...
Use it like this: 
- [ #has_/text_/on_/accommodation_category :: Text ] or 
- [ has_text_on_accommodation_category :: Text ] 

Category of an [[Accommodation]], following real estate conventions, e.g. RESO (see [PropertySubType](https://ddwiki.reso.org/display/DDW17/PropertySubType+Field), and [PropertyType](https://ddwiki.reso.org/display/DDW17/PropertyType+Field) fields  for suggested values).

Predicated describes that: 
[ #has_/domain  :: Accommodation ]
( #has_/name :: has_text_on_accommodation_category )
( #has_/range :: Text )
