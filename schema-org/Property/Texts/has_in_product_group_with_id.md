...
title: has_text_on_in_product_group_with_id
linkTitle: has_text_on_in_product_group_with_id
...
- has_text_on_in_product_group_with_id
---
...
Use it like this: 
- [ #has_/text_/on_/in_product_group_with_id :: Text ] or 
- [ has_text_on_in_product_group_with_id :: Text ] 

Indicates the [[productGroupID]] for a [[ProductGroup]] that this product [[isVariantOf]].

Predicated describes that: 
[ #has_/domain  :: Product ]
( #has_/name :: has_text_on_in_product_group_with_id )
( #has_/range :: Text )
