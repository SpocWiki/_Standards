...
title: has_text_of_isrc_code
linkTitle: has_text_of_isrc_code
...
- isrc_code
- isrcCode
- has_text_of_isrc_code
---

Predicate to describe the Text of MusicRecording.

Use it like this: 
- [ #has_/text_/of_/isrc_code :: Text ] or 
- [ has_text_of_isrc_code :: Text ] 

The International Standard Recording Code for the recording.

Predicated describes that: 
[ #has_/domain  :: MusicRecording ]
( #has_/name :: has_text_of_isrc_code )
( #has_/range :: Text )
