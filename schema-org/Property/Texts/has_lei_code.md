...
title: has_text_of_lei_code
linkTitle: has_text_of_lei_code
...
- lei_code
- leiCode
- has_text_of_lei_code
---

Predicate to describe the Text of Organization.

Use it like this: 
- [ #has_/text_/of_/lei_code :: Text ] or 
- [ has_text_of_lei_code :: Text ] 

An organization identifier that uniquely identifies a legal entity as defined in ISO 17442.

Predicated describes that: 
[ #has_/domain  :: Organization ]
( #has_/name :: has_text_of_lei_code )
( #has_/range :: Text )
