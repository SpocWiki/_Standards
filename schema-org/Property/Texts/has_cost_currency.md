...
title: has_text_on_cost_currency
linkTitle: has_text_on_cost_currency
...
- cost_currency
- costCurrency
- has_text_on_cost_currency
---

Predicate to describe the Text of DrugCost.

Use it like this: 
- [ #has_/text_/on_/cost_currency :: Text ] or 
- [ has_text_on_cost_currency :: Text ] 

The currency (in 3-letter) of the drug cost. See: http://en.wikipedia.org/wiki/ISO_4217.

Predicated describes that: 
[ #has_/domain  :: DrugCost ]
( #has_/name :: has_text_on_cost_currency )
( #has_/range :: Text )
