...
title: has_text_on_transmission_method
linkTitle: has_text_on_transmission_method
...
- transmission_method
- transmissionMethod
- has_text_on_transmission_method
---

Predicate to describe the Text of InfectiousDisease.

Use it like this: 
- [ #has_/text_/on_/transmission_method :: Text ] or 
- [ has_text_on_transmission_method :: Text ] 

How the disease spreads, either as a route or vector, for example "direct contact", "Aedes aegypti", etc.

Predicated describes that: 
[ #has_/domain  :: InfectiousDisease ]
( #has_/name :: has_text_on_transmission_method )
( #has_/range :: Text )
