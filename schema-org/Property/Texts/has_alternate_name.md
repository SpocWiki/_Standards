...
title: has_text_of_alternate_name
linkTitle: has_text_of_alternate_name
...
- alternate_name
- alternateName
- has_text_of_alternate_name
---

Predicate to describe the Text of Thing.

Use it like this: 
- [ #has_/text_/of_/alternate_name :: Text ] or 
- [ has_text_of_alternate_name :: Text ] 

An alias for the item.

Predicated describes that: 
[ #has_/domain  :: [Thing](../../Class/Thing.md) ]
( #has_/name :: has_text_of_alternate_name )
( #has_/range :: Text )
