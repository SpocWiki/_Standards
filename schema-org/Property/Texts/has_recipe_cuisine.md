...
title: has_text_on_recipe_cuisine
linkTitle: has_text_on_recipe_cuisine
...
- recipe_cuisine
- recipeCuisine
- has_text_on_recipe_cuisine
---

Predicate to describe the Text of Recipe.

Use it like this: 
- [ #has_/text_/on_/recipe_cuisine :: Text ] or 
- [ has_text_on_recipe_cuisine :: Text ] 

The cuisine of the recipe (for example, French or Ethiopian).

Predicated describes that: 
[ #has_/domain  :: Recipe ]
( #has_/name :: has_text_on_recipe_cuisine )
( #has_/range :: Text )

## Confidential Links & Embeds: 
- [[../../../../_public/schema.org/Predicate/Texts/has_recipe_cuisine.md|has_recipe_cuisine]] 
