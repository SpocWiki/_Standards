...
title: has_text_on_strength_unit
linkTitle: has_text_on_strength_unit
...
- strength_unit
- strengthUnit
- has_text_on_strength_unit
---

Predicate to describe the Text of DrugStrength.

Use it like this: 
- [ #has_/text_/on_/strength_unit :: Text ] or 
- [ has_text_on_strength_unit :: Text ] 

The units of an active ingredient"s strength, e.g. mg.

Predicated describes that: 
[ #has_/domain  :: DrugStrength ]
( #has_/name :: has_text_on_strength_unit )
( #has_/range :: Text )
