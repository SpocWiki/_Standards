...
title: has_text_on_work_hours
linkTitle: has_text_on_work_hours
...
- work_hours
- workHours
- has_text_on_work_hours
---

Predicate to describe the Text of JobPosting.

Use it like this: 
- [ #has_/text_/on_/work_hours :: Text ] or 
- [ has_text_on_work_hours :: Text ] 

The typical working hours for this job (e.g. 1st shift, night shift, 8am-5pm).

Predicated describes that: 
[ #has_/domain  :: JobPosting ]
( #has_/name :: has_text_on_work_hours )
( #has_/range :: Text )
