...
title: has_text_on_passenger_sequence_number
linkTitle: has_text_on_passenger_sequence_number
...
- has_text_on_passenger_sequence_number
---

Predicate to describe the Text of FlightReservation.

Use it like this: 
- [ #has_/text_/on_/passenger_sequence_number :: Text ] or 
- [ has_text_on_passenger_sequence_number :: Text ] 

The passenger"s sequence number as assigned by the airline.

Predicated describes that: 
[ #has_/domain  :: FlightReservation ]
( #has_/name :: has_text_on_passenger_sequence_number )
( #has_/range :: Text )
