...
title: has_text_on_global_location_number
linkTitle: has_text_on_global_location_number
...
- has_text_on_global_location_number
---

Predicate to describe the Text of Organization, Person, Place.

Use it like this: 
- [ #has_/text_/on_/global_location_number :: Text ] or 
- [ has_text_on_global_location_number :: Text ] 

The [Global Location Number](http://www.gs1.org/gln) (GLN, sometimes also referred to as International Location Number or ILN) of the respective organization, person, or place. The GLN is a 13-digit number used to identify parties and physical locations.

Predicated describes that: 
[ #has_/domain  :: Organization, Person, Place ]
( #has_/name :: has_text_on_global_location_number )
( #has_/range :: Text )
