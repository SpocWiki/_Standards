...
dv_has_:
  value_for_:
    account_overdraft_limit: MonetaryAmount
  domain: BankAccount
dv_has_value_for_account_overdraft_limit: MonetaryAmount
dv_is_:
  part_of: "pending:"
  same_as:
    - "[[/_Standards/schema-org/Property/has_value_for/has_value_for_account_overdraft_limit|has_value_for_account_overdraft_limit]]"
...
Use it like this: 
- has_value_for_account_overdraft_limit = `=this.dv_has_value_for_account_overdraft_limit`  
- has_value_for_account_overdraft_limit = `=this.dv_has_value_for_account_overdraft_limit`  
