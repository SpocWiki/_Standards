...
together with [[has_place_longitude|longitude]] and [[has_value_for_elevation_in_meters|elevation]].
but not [[has_value_for_altitude_in_meters|altitude]], which is typically used for flying or diving Objects.
