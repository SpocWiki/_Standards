...
Use [[MonetaryAmount]] to specify a fixed restocking fee for product returns, or use[[../../Class/is_a_/data_type/number|number]]] to specify a percentage of the product price paid by the customer.
