...
dv_has_:
  time_started: P#Y#M#W#DT#H#M#s.fff
  time_:
    started: P#Y#M#W#DT#H#M#s.fff with the [ISO_8601-Date Format](../../../ISO/ISO_8601-Date_Time) .
  dual_:
    property:
      - "[[has_time_stopped]]"
      - "[[has_time_stopped]]"
...
dv_has_time_started:
  ...
  - P#Y#M#W#DT#H#M#s.fff with the [ISO_8601-Date Format](../../../ISO/ISO_8601-Date_Time) .
dv_is_same_as:
  - "#created"
  - "[[has_time_created]]"
  - "[[/_public/schema-org/Property/has_Date_Time/has_time_created.public|has_time_created.public]]"
