...
aliases:
  ...
  - has time of expected arrival until
confidential: public
cssclasses:
  - Predicate
  - Date_Time
...
Use it like this: 
- #has_/time_of_expected_arrival_until = `=this.dv_has_time_of_expected_arrival_until`  
- has_time_of_expected_arrival_until = `=this.dv_has_time_of_expected_arrival_until`  
