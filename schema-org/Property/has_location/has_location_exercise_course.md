...
dv_has_:
  location_:
    exercise_course: Place
  domain: ExerciseAction
dv_has_location_exercise_course: Place
dv_#has_:
  name: has_location_exercise_course
  range: Place
dv_is_:
...
dv_has_name: has_location_exercise_course
dv_has_range: Place
...
Use it like this: 
- has_location_exercise_course = `=this.dv_has_location_exercise_course`  
- has_location_exercise_course = `=this.dv_has_location_exercise_course`  
