...
dv_has_:
  location_:
    address_billing: PostalAddress
  domain: Order
dv_has_location_address_billing: PostalAddress
dv_#has_:
  name: has_location_address_billing
  range: PostalAddress
dv_is_:
  same_as:
...
dv_has_domain: Order
dv_has_name: has_location_address_billing
