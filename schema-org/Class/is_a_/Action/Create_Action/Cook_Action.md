...
dv_has_:
  ...
  properties: '[ actionStatus, additionalType, agent, alternateName, description,
    disambiguatingDescription, endTime, error, foodEstablishment, foodEvent, identifier,
    image, instrument, location, mainEntityOfPage, name, object, participant, potentialAction,
    provider, recipe, result, sameAs, startTime, subjectOf, target, url ]'
dv_has_parent_class:
  - "[[../CreateAction]]"
dv_has_properties:
  ...
  - "[[../../../../Relation/has/has_recipe|has_recipe]]"
