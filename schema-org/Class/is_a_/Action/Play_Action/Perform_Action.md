...
dv_has_:
  ...
  properties: '[ actionStatus, additionalType, agent, alternateName, audience, description,
    disambiguatingDescription, endTime, entertainmentBusiness, error, event, identifier,
    image, instrument, location, mainEntityOfPage, name, object, participant, potentialAction,
    provider, result, sameAs, startTime, subjectOf, target, url ]'
dv_has_parent_class:
  - "[[../PlayAction]]"
dv_has_properties:
  ...
  - "[[end_time|end_time]]"
  - "[[../../../../Relation/has/has_entertainment_business|has_entertainment_business]]"
