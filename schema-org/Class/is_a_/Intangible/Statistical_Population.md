...
- statistiikklaž populaatio
- statistiiklâš populaatio
- Statistikala toteso
- statistična populacija
- Subpopulacija
- tiomsú staitistiúil daonra
- Univers
- Základní soubor
- Základný súbor
- Üldkogum
...
- генэральная сукупнасьць
- Статистикийн популяци
- статистичка популациј
...
dv_has_:
  name_:
    ...
    ga: tiomsú staitistiúil daonra
    gl: poboación estatística
    he: אוכלוסייה (סטטיסטיקה)
    hi: सांख्यिकीय जनसंख्या
    hu: sokaság
    hy: Համախումբ
    id: Populasi
    io: Statistikala toteso
    is: Þýði
    it: popolazione statistica
    ja: 母集団
    jv: Populasi
    ko: 모집단
    la: collectivum (statistica)
    lt: Generalinė aibė
    mk: Статистичка популација
    mn: Статистикийн популяци
    ms: Populasi
    nb: Univers
    nl: populatie
    ...
    sh: Subpopulacija
    sk: Základný súbor
    sl: statistična populacija
    smn: statistiiklâš populaatio
    sms: statistiikklaž populaatio
    sq: Popullacioni statistikor
    sr: статистичка популациј
    su: Populasi statistik
    sv: population
    tl: Populasyong estadistikal
    tr: İstatistiksel yığın
    uk: генеральна сукупність
    vi: quần thể thống kê
    wuu: 总体
    yue: 總體
    zh: 总体
    zh_hans: 总体
...
### #is_/same_as :: [[/_Standards/schema-org/Class/is_a_/Intangible/Statistical_Population|Statistical_Population]] 

### #is_/same_as :: [[/_public/schema-org/Class/is_a_/Intangible/Statistical_Population.public|Statistical_Population.public]] 

### #is_/same_as :: [[/_internal/schema-org/Class/is_a_/Intangible/Statistical_Population.internal|Statistical_Population.internal]] 

### #is_/same_as :: [[/_protect/schema-org/Class/is_a_/Intangible/Statistical_Population.protect|Statistical_Population.protect]] 

### #is_/same_as :: [[/_private/schema-org/Class/is_a_/Intangible/Statistical_Population.private|Statistical_Population.private]] 

### #is_/same_as :: [[/_personal/schema-org/Class/is_a_/Intangible/Statistical_Population.personal|Statistical_Population.personal]] 

### #is_/same_as :: [[/_secret/schema-org/Class/is_a_/Intangible/Statistical_Population.secret|Statistical_Population.secret]] 
