...
type: Predi_Relation
dv_is_:
  expressed_in: AnatomicalStructure, AnatomicalSystem, BioChemEntity, DefinedTerm
  part_of: "pending:"
  same_as:
...
dv_is_expressed_in: AnatomicalStructure, AnatomicalSystem, BioChemEntity, DefinedTerm
dv_has_:
  domain: Gene
dv_#has_:
...
Use it like this: 
- is_expressed_in = `=this.dv_is_expressed_in`  
- is_expressed_in = `=this.dv_is_expressed_in`  
