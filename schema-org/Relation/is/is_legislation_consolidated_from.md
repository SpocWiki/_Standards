...
type: Predi_Relation
dv_is_:
  legislation_consolidated_from: Legislation
  part_of: "pending:"
  same_as:
...
dv_is_legislation_consolidated_from: Legislation
dv_has_:
  domain: Legislation
dv_#has_:
  name: is_legislation_consolidated_from
  range: Legislation
dv_is_part_of: "pending:"
dv_has_domain: Legislation
dv_has_name: is_legislation_consolidated_from
...
Use it like this: 
- is_legislation_consolidated_from = `=this.dv_is_legislation_consolidated_from`  
- is_legislation_consolidated_from = `=this.dv_is_legislation_consolidated_from`  
