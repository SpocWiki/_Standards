...
Use it like this: 
- #has_/associated_/media_review : : `=this.dv_has_range` 
- has_associated_media_review : : `=this.dv_has_range` 
- is_associated_media_review_of : : `=this.dv_has_domain` 
- #is_/associated_/media_review_of : : `=this.dv_has_domain` 
...
where a single activity is conducting both claim reviews and media reviews, 
