...
Use it like this: 
- #has_/action_accessibility_requirement = `=this.dv_has_action_accessibility_requirement`  
- has_action_accessibility_requirement = `=this.dv_has_action_accessibility_requirement`  
