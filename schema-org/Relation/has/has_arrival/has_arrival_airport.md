...
dv_has_:
  ...
  domain: Flight
  name: has_arrival_airport
  range: Airport
dv_has_arrival_airport: Airport
dv_is_:
  same_as:
    - "[[has_arrival_airport|has_arrival_airport]]"
...
dv_has_name: has_arrival_airport
...
Use it like this: 
- #has_/arrival_airport = `=this.dv_has_arrival_airport`  
- has_arrival_airport = `=this.dv_has_arrival_airport`  
