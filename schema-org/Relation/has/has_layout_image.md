...
type: Predi_Relation
dv_has_:
  layout_image: ImageObject, URL
  domain: FloorPlan
dv_has_layout_image: ImageObject, URL
dv_is_:
  part_of: "pending:"
  sub_property_of: image
  same_as:
    - "[[/_Standards/schema-org/Relation/has/has_layout_image|has_layout_image]]"
...
Use it like this: 
- has_layout_image = `=this.dv_has_layout_image`  
- has_layout_image = `=this.dv_has_layout_image`  
