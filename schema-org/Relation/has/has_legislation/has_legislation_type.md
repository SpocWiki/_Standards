...
dv_has_:
  inverse: "[[is_legislation_type_of]]"
  parent_:
    property: genre
  part_of: "pending:"
...
dv_has_inverse: "[[is_legislation_type_of]]"
dv_has_parent_property: genre
dv_has_part_of: "pending:"
dv_has_domain: "[[../../../../Society/Communication/Media/Creative_Work/Legislation|Legislation]]"
dv_has_name: has_legislation_type
dv_is_same_as:
  - "[[has_legislation_type]]"
  - "[[/_public/schema-org/Relation/has/has_legislation_type.public|has_legislation_type.public]]"
  - "[[/_internal/schema-org/Relation/has/has_legislation_type.internal|has_legislation_type.internal]]"
...
has_part_of = `=this.dv_has_part_of` 

Use it like this: 
- #has_/legislation_type : : `=this.dv_has_range`
- has_legislation_type : : `=this.dv_has_range` 
- is_legislation_type_of : :  `=this.dv_has_domain` 
- #is_/legislation_type_of : :  `=this.dv_has_domain` 

The type of the legislation. Examples of values are 
"law", "act", "directive", "decree", "regulation", "statutory instrument", "loi organique", "réglement grand-ducal", etc., 
