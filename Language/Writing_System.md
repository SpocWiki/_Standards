...
dv_has_:
  name_:
    af: skryfstelsel
    am: የዓለም ጽሕፈቶች
    an: sistema d'escritura
    anp: लिपि
    ar: نظام كتابة
    ary: سيستيم د لكتابة
    arz: سيستم كتابه
    as: লিখন পদ্ধতি
    ast: sistema d'escritura
    av: хъвавул система
    ay: qillqa
    az: yazı sistemi
    azb: یازی سیستمی
    ...
    et: kiri
    eu: idazkera sistema
    ext: sistema d'escreviúra
    fa: خط
    fi: kirjoitusjärjestelmä
    fr: système d’écriture
    frr: skraft
    fy: skrift
    ga: córas scríofa
    gd: siostam sgrìobhaidh
    gl: sistema de escrita
    gsw: Schrift
    gu: લિપિ
    gv: corys screeuee
    he: כתב
    ...
    lb: Schrëft
    lfn: sistemes de scrive
    li: sjrifsysteem
    lld: scritura
    lmo: sistema de scritura
    lt: rašto sistema
    ltg: roksts
    lv: rakstība
    lzh: 文字
    ...
    olo: kirjutussistiemu
    or: ଲିପି
    os: фыссынад
    pa: ਲਿਪੀ
    pam: sistema ning pámaniúlat
    pcd: sistème d'écriture
    pl: system pisma
    pnb: لپی
    ps: ليک
    ...
    ru: письменность
    rue: Письмова система
    sa: लिपयः
    sah: сурук-бичик
    sat: ᱚᱞ ᱦᱚᱨᱟ
    scn: sistema di scrittura
    sco: writin seestem
    sd: لکت سرشتو
    se: čállinvuohki
    sgs: Rašta sėstema
    ...
    ur: رسم خط
    uz: yozuv
    vec: sistèma de scritura
    vi: hệ chữ viết
    war: sistema hin panurat
    wuu: 文字
    xmf: ჭარალუა
    yi: שריפֿט
    yue: 文字
