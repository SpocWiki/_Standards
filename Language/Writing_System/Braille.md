...
dv_has_:
  name_:
    ...
    ru: шрифт Брайля
    rw: Inyandiko y'abafite ubumuga bwo kutabona(Braille)
    sco: braille
    se: čuokkesčála
    sh: Brajeva azbuka
    sk: Braillovo písmo
