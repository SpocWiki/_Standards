...
- Gjuhët dravidiane
- hizkuntza drabidikoak
- Hệ ngôn ngữ Dravidian
- Ieithoedd drafidaidd
- języki drawidyjskie
- kulupu toki Tawita
...
has_grammatical_case: '[[_Standards/WikiData/WD~antessive_case,4771446|WD~antessive_case,4771446]]'
IETF_language_tag: dra
indigenous_to: '[[_Standards/WikiData/WD~Dravidian_peoples,69798|WD~Dravidian_peoples,69798]]'
...
studied_in: '[[_Standards/WikiData/WD~Dravidian_studies,1128227|WD~Dravidian_studies,1128227]]'
subclass_of: '[[_Standards/WikiData/WD~human_language,20162172|WD~human_language,20162172]]'
tags:
- Lang_Family
topic_s_main_template: '[[_Standards/WikiData/WD~Template_Dravidian_languages,10520572|WD~Template_Dravidian_languages,10520572]]'
type: LangFamily
WALS_family_code: dravidian
writing_system: '[[_Standards/WikiData/WD~Brahmic_scripts,467037|WD~Brahmic_scripts,467037]]'
dv_has_:
  name_:
    af: Drawidiese tale
    ...
    cdo: Dravida-ngṳ̄-hiê
    ckb: زمانە دراڤیدییەکان
    cs: drávidské jazyky
    cy: Ieithoedd drafidaidd
    da: dravidiske sprog
    de: Dravidisch
    dsb: Drawidske rěcy
    ...
    es: lenguas drávidas
    et: draviidi keeled
    eu: hizkuntza drabidikoak
    ext: lenguas dravídicas
    fa: زبانهای دراویدی
    fi: dravidakielet
    fr: langues dravidiennes
    frr: Drawiidisk Spriaken
    gl: Linguas dravídicas
    gv: Çhengaghyn Dravidagh
    hak: Tha̍t-lò-phî-thû Ngî-hì
    he: שפות דראווידיות
    ...
    hy: Դրավիդյան լեզուներ
    id: Dravida
    ig: Dravidian
    io: Dravidana linguaro
    is: Dravidísk tungumál
    it: lingue dravidiche
    ja: ドラヴィダ語族
    ka: დრავიდული ენები
    kge: Rumpun Bahasa Dravida
    kn: ದ್ರಾವಿಡ ಭಾಷೆಗಳು
    ko: 드라비다어족
    ky: Дравид тилдери
    la: Linguae Dravidicae
    lfn: linguas dravidica
    lij: Lengue elamo-dravidiche
    lt: dravidų kalbos
    lv: dravīdu valodas
    mag: द्राबिडीयभाषा
    mg: Fianakaviam-piteny dravidiana
    mk: дравидски јазици
    ml: ദ്രാവിഡഭാഷകൾ
    mr: द्राविड भाषासमूह
    ...
    ne: द्रविड भाषा परिवार
    new: द्रविड भाषा परिवार
    nl: Dravidische talen
    nn: dravidiske språk
    oc: Lengas dravidas
    os: дравидиаг æвзæгтæ
    pa: ਦਰਾਵੜੀ ਭਾਸ਼ਾਵਾਂ
    ...
    uz: Dravid tillari
    vec: łéngue dràvide
    vi: Hệ ngôn ngữ Dravidian
    wuu: 达罗毗荼语系
    xmf: დრავიდული ნინეფი
    yue: 南印語系
...
> The **Dravidian languages** are a family of languages spoken by 250 million people, 
> mainly in South India, north-east Sri Lanka, and south-west Pakistan, with pockets elsewhere in South Asia.
>
