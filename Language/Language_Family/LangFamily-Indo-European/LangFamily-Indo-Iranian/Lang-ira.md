...
dv_has_:
  name_:
    ...
    br: yezhoù iranek
    bs: Iranski jezici
    ca: llengües iràniques
    ckb: زمانە ئێرانییەکان
    cs: íránské jazyky
    cv: Иран чĕлхисем
    cy: Ieithoedd Iranaidd
    da: Iranske sprog
    de: Iranisch
    diq: Zıwanê İranki
    dsb: Irańske rěcy
    ...
    es: lenguas iranias
    et: Iraani keeled
    eu: Irandar hizkuntzak
    fa: زبانهای ایرانی
    fi: iranilaiset kielet
    fr: langues iraniennes
    frr: Iraansk spriaken
    ga: teangacha Iaránacha
    gl: linguas iranias
    glk: ایرانی زوانؤن
    ha: Iranian languages
    he: שפות איראניות
    hi: ईरानी भाषा परिवार
    hif: Iranian bhasa
    hr: iranski jezici
    hsb: Iranske rěče
    hu: iráni nyelvek
    hy: Իրանական լեզուներ
    ia: linguas iranic
    id: rumpun bahasa Iran
    ig: Iranian
    io: Irana lingui
    is: Írönsk tungumál
    it: lingue iraniche
    ...
    ml: ഇറാനിയൻ ഭാഷകൾ
    mr: इराणी भाषासमूह
    ms: Bahasa-bahasa Iran
    mzn: ایرانی زوونون
    nb: iranske språk
    ne: इरानेली भाषा परिवार
    new: इरानियन भाय्पुचः
    nl: Iraanse talen
    nn: iranske språk
    nov: Irani lingues
    oc: Lengas iranianas
...
#is_/same_as :: [[_Standards/WikiData/WD~Iranian,33527|WD~Iranian,33527]] 
**
