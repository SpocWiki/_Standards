...
- '[[_Standards/WikiData/WD~Chuukic,7847646|WD~Chuukic,7847646]]'
...
has_list: '[[_Standards/WikiData/WD~list_of_Turkic_languages,27661143|WD~list_of_Turkic_languages,27661143]]'
has_part_s_:
- '[[_Standards/WikiData/WD~Common_Turkic,1126028|WD~Common_Turkic,1126028]]'
- '[[_Standards/WikiData/WD~Oghuric,1422731|WD~Oghuric,1422731]]'
...
tags:
- Lang_Family
topic_s_main_template: '[[_Standards/WikiData/WD~Template_Turkic_languages,8084949|WD~Template_Turkic_languages,8084949]]'
type: LangFamily
dv_has_:
  name_:
    ab: Атиурк бызшәақәа
    ...
    et: turgi keeled
    eu: Turkiar hizkuntzak
    fa: زبانهای ترکی
    fi: turkkilaiset kielet
    fr: langues turciques
    frr: Turkspriaken
    fy: Turkske talen
    ga: teangacha Tuircice
    gag: Türk dilleri
    gl: linguas turcas
    hak: Thu̍t-khet Ngî-chhu̍k
    he: שפות טורקיות
    ...
    it: lingue turciche
    ja: テュルク諸語
    jv: Kulawarga basa Turk
    ka: თურქული ენები
    kab: Tutlayin titurkiyin
    kge: Rumpun Bahasa Turkik
    kk: Түркі тілдері
    ko: 튀르크어족
    krj: manga Tinurkiko nga pulong
    ks: تُرکِک زَبانہٕ
    ku: Zimanên tirkî
    ...
    lv: tjurku valodas
    mdf: тюркань кяльхне
    mg: Fianakaviam-piteny torkika
    mhr: Тӱрк йылме-влак
    mk: туркиски јазици
    ml: തുർക്കിക് ഭാഷകൾ
    mn: Түрэг хэлний бүлэг
    mr: तुर्की भाषासमूह
    ms: Bahasa-bahasa Turkik
    mzn: تورکی
    nb: tyrkiske språk
    nl: Turkse talen
    nn: Tyrkiske språk
