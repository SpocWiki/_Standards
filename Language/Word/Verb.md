...
- vb.
- vrb.
OmegaWiki_Defined_Meaning: 6100
Dewey_Decimal_Classification: 415.6
pronunciation_audio:
- http://commons.wikimedia.org/wiki/Special:FilePath/LL-Q9610%20%28ben%29-Titodutta-%E0%A6%95%E0%A7%8D%E0%A6%B0%E0%A6%BF%E0%A6%AF%E0%A6%BC%E0%A6%BE%E0%A6%AA%E0%A6%A6.wav
- http://commons.wikimedia.org/wiki/Special:FilePath/De-starken%20Verb2.ogg
label_in_sign_language: http://commons.wikimedia.org/wiki/Special:FilePath/LSF%20Vocab%20verbe.ogv
exact_match:
...
- http://www.lexinfo.net/ontology/2.0/lexinfo#Verb
- http://www.lexinfo.net/ontology/3.0/lexinfo#Verb
Stack_Exchange_tag: https://linguistics.stackexchange.com/tags/verbs
Krugosvet_article_archived_: gumanitarnye_nauki/lingvistika/GLAGOL.html
PhilPapers_topic: verbs
Commons_category: Verbs
dv_has_:
  name_:
    af: werkwoord
    am: ግስ
...
> A **Verb** is a word that generally conveys an action (bring, read, walk, run, learn), 
...
> to encode tense, aspect, mood, and voice. 
> 
> A verb may also agree with the person, gender or number of some of its arguments, 
> such as its subject, or object. 
> 
> In English, three tenses exist: 
> - present, to indicate that an action is being carried out; 
> - past, to indicate that an action has been done; and 
> - future, to indicate that an action will be done, expressed with the auxiliary verb will or shall.
>
> Every language discovered so far makes some form of noun-verb distinction, 
> possibly because of the **graph-like** nature of communicated meaning by humans, 
> i.e. nouns being the "entities" and verbs being the "links" between them. 
> 
