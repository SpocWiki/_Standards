...
- lập luận quy nạp
- Metodo induktibo
- Okulambika ebirowoozo(Inductive reasoning)
- penalaran induktif
- raciocínio indutivo
...
- Rũcũra rwa ngũngũĩro (inductive reasoning)
- Tilleiðsla
- Tümevarım
- İnduksiya
- επαγωγή
...
PhilPapers_topic: induction
Commons_category: Inductive reasoning
dv_has_:
  name_:
    ar: استقراء
    az: İnduksiya
    ...
    hu: induktív érvelés
    hy: Մակածություն
    id: penalaran induktif
    is: Tilleiðsla
    it: induzione
    ja: 帰納
    ki: Rũcũra rwa ngũngũĩro (inductive reasoning)
    kk: Индуктивті логика
    ko: 귀납
    lg: Okulambika ebirowoozo(Inductive reasoning)
    lt: indukcija
    lv: Indukcija
    mk: Индукција (логика)
    mn: Индукци
