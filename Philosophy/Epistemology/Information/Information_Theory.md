...
- Umchachiso wokwaziswa
- θεωρία πληροφορίας
- ақпарат теориясы
- Информациянын жалпы теориясы
- мэдээллийн онол
- мәгълүмат теориясе
- мәғлүмәт теорияһы
- назарияи иттилоот
...
dv_has_:
  name_:
    af: inligtingsteorie
    ar: نظرية المعلومات
    ast: teoría de la información
    az: informasiya nəzəriyyəsi
    ...
    ckb: تیۆریی زانیاری
    cs: teorie informace
    cy: damcaniaeth gwybodaeth
    da: informationsteori
    ...
    eu: Informazio-teoria
    fa: نظریه اطلاعات
    fi: informaatioteoria
    fr: théorie de l'information
    ga: teoiric na faisnéise
    gl: teoría da información
    he: תורת האינפורמציה
    hr: teorija informacije
    hu: információelmélet
    hy: ինֆորմացիայի տեսություն
    ia: theoria del information
    id: teori informasi
    io: informo-teorio
    ...
    lt: informacijos teorija
    lv: informācijas teorija
    mk: теорија на информациите
    ml: വിവര സിദ്ധാന്തം
    mn: мэдээллийн онол
    ms: teori maklumat
    mwl: teorie de l'anformaçon
    my: သတင်းအချက်အလက် သီအိုရီ
    nb: informasjonsteori
    nl: informatietheorie
    nn: informasjonsteori
    oc: teoria de l'informacion
    ...
    th: ทฤษฎีสารสนเทศ
    tl: teorya ng impormasyon
    tr: bilgi kuramı
    tt: мәгълүмат теориясе
    uk: теорія інформації
    ur: نظریۂ اطلاعات
    uz: informatsiya nazariyasi
    vec: teoria de l'informasion
