...
dv_has_:
  name_:
    ...
    ca: religió comparada
    cs: srovnávací religionistika
    da: komparativ religion
    de: Religionssystematik
    el: Συγκριτική θρησκειολογία
    en: comparative religion
    eo: komparo inter religioj
    es: religión comparada
    eu: erlijio konparatu
    fa: دینشناسی تطبیقی
    fr: religion comparée
    ga: reiligiún comparáideach
    gl: Relixión comparada
    he: דתות משוות
    hr: Usporedna religija
    hu: összehasonlító vallástudomány
    hy: Համեմատական կրոնագիտություն
    id: Ilmu Perbandingan Agama
    inh: дустара дидовзар
    it: religione comparata
    ja: 比較宗教学
    ko: 비교종교학
    mk: споредбена веронаука
    ml: മതതാരതമ്യപഠനം
    ms: Ilmu perbandingan agama
    nan: Pí-kàu chong-kàu-ha̍k
    nb: komparativ religion
    nl: vergelijkende godsdienstwetenschap
    oc: Religion comparada
    pa: ਤੁਲਨਾਤਮਕ ਧਰਮ
    pnb: تقابل ادیان
    pt: religião comparada
    ru: сравнительное религиоведение
    sl: primerjalna religiologija
    sr: Uporedna religija
    sv: komparativ religion
    th: ศาสนาเปรียบเทียบ
    tl: Hambingang pangrelihiyon
    tr: Karşılaştırmalı dinler
    uk: порівняльне релігієзнавство
    ur: تقابل ادیان
