...
dv_has_:
  name_:
    ar: إبريق راسل
    az: Rasselin çaydanı
    bar: Teekandl vom Russell
    be: Імбрык Расэла
    bg: Чайникът на Ръсел
    bn: রাসেলের চায়ের কেতলি
    br: Pod-te Russell
    bs: Russellov čajnik
    ca: tetera de Russell
    ckb: قۆریەکەی ڕەسڵ
    cs: Russellova čajová konvice
    da: Russells tepotte
    ...
    fa: قوری چای راسل
    fi: Russellin teekannu
    fr: Théière de Russell
    gl: Teteira de Russell
    he: קנקן התה של ראסל
    hi: रसल की चायदानी
    hr: Russellov čajnik
    hu: Russell teáskannája
    hy: Ռասելի թեյնիկ
    id: Teko teh Russell
    is: Teketill Russells
    it: Teiera di Russell
    ja: ラッセルのティーポット
    ko: 러셀의 찻주전자
    lt: Raselo arbatinukas
    lzh: 羅素之壺
    ml: റസ്സലിന്റെ ചായക്കപ്പ്
    nl: Russells theepot
    pa: ਰਸਲ ਦੀ ਚਾਹਦਾਨੀ
    pfl: Russells Teekanne
    pl: Czajniczek Russella
    pt: Bule de chá de Russell
    ro: Ceainicul lui Russell
    ru: Чайник Рассела
    sh: Russellov čajnik
    si: රසල්ගේ තේ පෝච්චිය
    sq: Russells Teekanne
    sr: Раселов чајник
    sv: Russells tekanna
    ta: ரசலின் தேனீர் கேத்தல்
    th: กาน้ำชาของรัสเซลล์
    tr: Russell'in çaydanlığı
    uk: Чайник Рассела
    uz: Russell choynagi
    zh: 羅素的茶壺
    zh_hans: 罗素的茶壶
...
> to illustrate that the philosophic burden of proof 
> lies upon a person making empirically unfalsifiable claims, 
...
> that a teapot, too small to be seen by telescopes, 
> orbits the Sun somewhere in space between the Earth and Mars, 
...
> 
> Russell's teapot has given rise to similar analogies as well as being used in parodies of religion like [[../Monotheism/Pastafari|Pastafari]] and [[../Monotheism/Dudeism|Dudeism]]. 
>
