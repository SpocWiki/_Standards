...
subclass_of:
- '[[_Standards/WikiData/WD~political_opposition,192852|WD~political_opposition,192852]]'
- '[[_Standards/WikiData/WD~opposition,3884233|WD~opposition,3884233]]'
opposite_of: '[[_Standards/WikiData/WD~clericalism,747439|WD~clericalism,747439]]'
...
dv_has_:
  name_:
    ...
    bxr: Антиклерикализм
    ca: anticlericalisme
    cs: Antiklerikalismus
    cy: Gwrthglerigiaeth
    da: Anti-klerikalisme
    de: Antiklerikalismus
    el: Αντικληρικαλισμός
    en: anti-clericalism
    eo: Antiklerikalismo
    es: anticlericalismo
    eu: Antiklerikalismo
    ...
    fr: anticléricalisme
    ga: frithchléireachas
    gl: anticlericalismo
    he: אנטי-קלריקליזם
    hr: antiklerikalizam
    hu: antiklerikalizmus
    hy: Հակակղերականություն
    id: Anti-rohaniwan
    it: anticlericalismo
    ja: 反教権主義
    kk: Антиклерикализм
    ko: 반교권주의
    la: Anticlericalismus
    lb: Antiklerikalismus
    lt: antiklerikalizmas
    mk: антиклерикализам
    nb: anti-klerikalisme
    nl: antiklerikalisme
    pl: antyklerykalizm
    pt: anticlericalismo
    ro: anticlericalism
    ru: антиклерикализм
    sk: Antiklerikalizmus
    sl: antiklerikalizem
    sq: Antiklerikalizmi
    sr: анти-клерикализам
    sv: Antiklerikalism
    tg: зидрӯҳонигарӣ
    th: ต่อต้านลัทธิพระสงฆ์
    tr: Anti-klerikalizm
    uk: антиклерикалізм
    uz: Antiklerikalizm
