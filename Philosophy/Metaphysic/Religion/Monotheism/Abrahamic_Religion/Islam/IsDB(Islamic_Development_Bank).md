...
- Bancu Islámicu de Desenvolvimientu
...
- Islama Disvolviĝa Banko
- Islamiar Garapeneko Bankua
...
short_name: BID
locator_map_image: http://commons.wikimedia.org/wiki/Special:FilePath/Islamic%20Development%20Bank%20Members.svg
official_website: http://www.isdb.org/
ISNI:
- 0000000119576008
- 0000000405172936
X_Twitter_username: isdb_group
Instagram_username: isdb_stories
Facebook_username: isdbgroup
Commons_category: Islamic Development Bank
official_name: البنك الإسلامي للتنمية
dv_has_:
  name_:
    ar: البنك الإسلامي للتنمية
    ast: Bancu Islámicu de Desenvolvimientu
    ...
    de: Islamische Entwicklungsbank
    en: Islamic Development Bank
    eo: Islama Disvolviĝa Banko
    es: Banco Islámico de Desarrollo
    eu: Islamiar Garapeneko Bankua
    fa: بانک توسعه اسلامی
    fi: Islamilainen kehityspankki
    fr: Banque islamique de développement
    he: הבנק האסלאמי לפיתוח
    hi: इस्लामिक विकास बैंक
    hr: Islamska razvojna banka
    hy: Իսլամական զարգացման բանկ
    id: Bank Pembangunan Islam
    it: Banca islamica per lo sviluppo
    ja: イスラム開発銀行
    ka: ისლამური განვითარების ბანკი
    kk: Ислам даму банкі
    ko: 이슬람 개발 은행
    lt: Islamo plėtros bankas
    ms: Bank Pembangunan Islam
    nb: Den islamske utviklingsbank
    nl: Islamitische Ontwikkelingsbank
    pl: Islamski Bank Rozwoju
    pt: Banco Islâmico de Desenvolvimento
    ru: Исламский банк развития
    sr: Islamska razvojna banka
    sv: Islamiska utvecklingsbanken
    sw: Benki ya Kiislamu ya Maendeleo
    ta: இசுலாமிய வளர்ச்சி வங்கி
    tg: Бонки тавсеъаи исломӣ
    tr: İslam Kalkınma Bankası
    uk: Ісламський банк розвитку
    ur: اسلامی ترقیاتی بینک
    uz: Islom Taraqqiyot Banki
    vi: Ngân hàng Phát triển Hồi giáo
    yue: 伊斯蘭開發銀行
    zh: 伊斯蘭開發銀行
---
...
#is_/same_as :: [[_Standards/WikiData/WD~Islamic_Development_Bank,41230|WD~Islamic_Development_Bank,41230]] 
