...
Commons_category: Islamic philosophy
Krugosvet_article_archived_: kultura_i_obrazovanie/religiya/ARABSKAYA_FILOSOFIYA.html
dv_has_:
  name_:
    ar: فلسفة إسلامية
    arz: فلسفه اسلاميه
    as: ইছলামিক দৰ্শন
    ast: Filosofía islámica
    az: islam fəlsəfəsi
    azb: ایسلام فلسفهسی
    ba: Ислам фәлсәфәһе
    ...
    btm: Filsafat Islam
    ca: pensament islàmic
    ckb: فەلسەفەی ئیسلامی
    cs: islámská filozofie
    da: islamisk filosofi
    de: islamische Philosophie
    diq: Felsefeyê İslami
    dv: އިސްލާމީ ފަލްސަފާ
    el: Ισλαμική φιλοσοφία
    en: Islamic philosophy
    en-us: Islamic philosophy
    eo: Islama filozofio
    es: filosofía islámica
    eu: Filosofia islamiko
    fa: فلسفه اسلامی
    fi: Islamilainen filosofia
    fr: philosophie islamique
    gcr: Filozofi islamik
    gl: Filosofía islámica
    he: פילוסופיה אסלאמית
    hi: इस्लामी दर्शन
    hr: Islamska filozofija
    hu: arab filozófia
    hy: Իսլամական փիլիսոփայություն
    id: Filsafat Islam
    it: filosofia islamica
    ja: イスラーム哲学
    ...
    mk: исламска филозофија
    ms: Falsafah Islam
    nb: Islamsk filosofi
    nl: Islamitische filosofie
    pa: ਇਸਲਾਮੀ ਫ਼ਲਸਫ਼ਾ
    pl: Filozofia świata islamu
    pms: Filosofìa islàmica
    ps: اسلامي فلسفه
    pt: Filosofia islâmica
    ro: Curente ale gândirii filosofice arabo-islamice
    ru: исламская философия
    sd: اسلامي فلسفو
    sh: Islamska filozofija
    sk: islamská filozofia
    ...
    tg: фалсафаи исломӣ
    tk: Filosofiýa arap
    tl: Pilosopiya ng Islam
    tr: İslam felsefesi
    tt: ислам фәлсәфәсе
    uk: ісламська філософія
    ur: اسلامی فلسفہ
    uz: Islom falsafasi
    vi: Triết học Hồi giáo
    yue: 伊斯蘭哲學
...
#is_/same_as :: [[_Standards/WikiData/WD~Islamic_philosophy,193104|WD~Islamic_philosophy,193104]] 

## #has_/text_of_/abstract 

> Islamic philosophy is philosophy that emerges from the Islamic tradition. 
> Two terms traditionally used in the Islamic world are sometimes translated as 
> - falsafa ('philosophy'), which refers to philosophy as well as logic, mathematics, and physics; 
> - and kalam (lit. 'speech'), which refers to a rationalist form of Scholastic Islamic theology which includes the schools of Ash'arism, Maturidism and Mu'tazilism.
>
> Early Islamic philosophy began with al-Kindi in the 2nd century of the Islamic calendar (early 9th century CE) and ended with Ibn Rushd (Averroes) in the 6th century AH (late 12th century CE), broadly coinciding with the period known as the Golden Age of Islam. The death of Ibn Rushd effectively marked the end of a specific discipline of Islamic philosophy usually called the Islamic peripatetic school, and philosophical activity declined significantly in the west of the Islamic world, including al-Andalus and the Maghreb.
>
