...
dv_has_:
  name_:
    ...
    id: dewa pencipta
    ig: chineke
    it: divinità della creazione
    ja: 創造神
    ko: 창조신
    la: Aedificator mundi
    lt: dievas kūrėjas
    lv: radīšanas dievība
    mg: Andriamanitra mpamorona
    mk: Творец
    ml: സ്രഷ്ടാവ്
    mul: creator deity
    nl: scheppersgod
