---
has_id_wikidata: Q3859459
dv_has_:
  name_:
    af: Mesopotamiese mitologie
    ar: ديانة بلاد ما بين النهرين
    ...
    ca: mitologia mesopotàmica
    cs: mezopotamská mytologie
    de: Mesopotamische Mythologie
    el: Μεσοποταμιακή μυθολογία
    en: Mesopotamian mythology
    eo: Mezopotamia mitologio
    es: mitología mesopotámica
    et: Mesopotaamia mütoloogia
    eu: Mesopotamiako mitologia
    fa: افسانههای میانرودان
    fi: Mesopotamian mytologia
    fr: mythologie mésopotamienne
    ga: miotaseolaíocht na Measpatáime
    gl: Mitoloxía mesopotámica
    he: מיתולוגיה מסופוטמית
    hi: mesopotamia ki sabhayata
    hr: Mezopotamska mitologija
    hu: mezopotámiai mitológia
    hy: միջագետքյան առասպելաբանություն
    id: Mitologi Mesopotamia
    it: mitologia della Mesopotamia
    ja: メソポタミア神話
    ko: 메소포타미아 신화
    ku: Mîtolojiya Mezopotamyayê
    lt: Mesopotamijos mitologija
    mk: Месопотамска митологија
    ms: Mitologi Mesopotamia
    my: မက်ဆိုပိုတေးမီးယားဒဏ္ဍာရီ
    nb: mesopotamisk mytologi
    ...
    sl: mezopotamska mitologija
    sq: Mitologjia e Mesopotamisë
    sr: Mesopotamska mitologija
    sv: mesopotamisk mytologi
    th: ประมวลเรื่องปรัมปราเมโสโปเตเมีย
    tl: Relihiyon sa Mesopotamia
...
> Mesopotamian mythology refers to the myths, religious texts, 
> and other literature that comes from the region of ancient Mesopotamia 
> which is a historical region of Western Asia, 
> situated within the Tigris–Euphrates river system 
> that occupies the area of present-day Iraq. 
> 
> In particular the societies of Sumer, Akkad, and Assyria, 
> all of which existed shortly after 3000 BCE and were mostly gone by 400 CE. 
> 
> These works were primarily preserved on stone or clay tablets 
> and were written in cuneiform by scribes. 
> 
> Several lengthy pieces have survived erosion and time, 
