...
- hamskiftar
- ilchruthach
- istota zmiennokształtna
- kabulgan
- Menjanje oblika
- metamorfose
- metamorfosi en la ficció
- muodonmuuttaja
- mutaforma
- mythische gedaanteverwisselaar
- métamorphe
- měňavec
- qabılgan
- schimbarea formei
...
- http://commons.wikimedia.org/wiki/Special:FilePath/Kuniyoshi%20Kuzunoha.jpg
IMDb_keyword: shapeshifter
Commons_category: Shapeshifting
dv_has_:
  name_:
    ar: مغير الشكل الأسطوري
    az: qabılgan
    ba: Әүермән
    be: пярэварацень
    be_tarask: ваўкалак
    ...
    mk: преобразник
    nb: hamløper
    nl: mythische gedaanteverwisselaar
    nn: hamskiftar
    pl: istota zmiennokształtna
    pt: transmorfo
    ro: schimbarea formei
    ru: оборотень
    sd: تحويل صورت
    sl: spreminjevalec oblike
    sr: Menjanje oblika
    sv: hamnskiftare
    tr: kabulgan
    uk: перевертень
...
> In mythology, folklore and speculative fiction, shapeshifting is 
> the ability to physically transform oneself through unnatural means. 
> 
> The idea of shapeshifting is found in the oldest forms of totemism and shamanism, 
> as well as the oldest existent literature and epic poems such as 
> the Epic of Gilgamesh and the Iliad. 
> 
> The concept remains a common literary device in modern fantasy, 
> children's literature and popular culture. 
> 
> Examples of shape-shifters include changelings, jinns, kitsunes, vampires, 
> and werewolves, along with deities such as Loki and Vertumnus.
>
