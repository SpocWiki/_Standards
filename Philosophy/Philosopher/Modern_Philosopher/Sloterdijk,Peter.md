...
dv_has_:
  name_:
    ...
    ar: بيتر سلوتردايك
    arz: بيتر سلوتردايك
    ast: Peter Sloterdijk
    bar: Peter Sloterdijk
    bg: Петер Слотердайк
    bs: Peter Sloterdijk
    ca: Peter Sloterdijk
    cs: Peter Sloterdijk
    da: Peter Sloterdijk
    dag: Peter Sloterdijk
    de: Peter Sloterdijk
    en: Peter Sloterdijk
    eo: Peter Sloterdijk
    es: Peter Sloterdijk
    ...
    ja: ペーター・スローターダイク
    ko: 페터 슬로터다이크
    lfn: Peter Sloterdijk
    li: Peter Sloterdijk
    lt: Peter Sloterdijk
    mk: Петер Слотердајк
    mul: Peter Sloterdijk
    nb: Peter Sloterdijk
    nds: Peter Sloterdijk
    nl: Peter Sloterdijk
    nn: Peter Sloterdijk
    oc: Peter Sloterdijk
    pl: Peter Sloterdijk
...
> **Peter Sloterdijk** (; German: [ˈsloːtɐˌdaɪk]; born 26 June 1947) 
> is a German philosopher and cultural theorist. 
> 
> He is a professor of philosophy and media theory 
