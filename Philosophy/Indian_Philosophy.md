...
different_from: '[[_Standards/WikiData/WD~Hindu_philosophy,1079293|WD~Hindu_philosophy,1079293]]'
topic_has_template:
- '[[_Standards/WikiData/WD~Q10556983,10556983|WD~Q10556983,10556983]]'
- '[[_Standards/WikiData/WD~Template_Indian_philosophy,11266359|WD~Template_Indian_philosophy,11266359]]'
...
dv_has_:
  name_:
    ...
    cs: indická filozofie
    cy: athroniaeth Indiaidd
    da: Indisk filosofi
    ...
    ga: fealsúnacht na hIndia
    gcr: Filozofi endyenn
    gl: Filosofía india
    gu: ભારતીય તત્વજ્ઞાન
    he: פילוסופיה הודית
    hi: भारतीय दर्शन
    hif: Bharatiya darshan
    hu: ind filozófia
    hy: Հնդկաստանի փիլիսոփայություն
    id: Filsafat India
    ...
    ko: 인도 철학
    ks: بَہارتی فٕلاسفی
    ky: Индус философиясы
    la: philosophia indica
    lt: Indijos filosofija
    lv: indiešu filozofija
    mag: भारतीय दर्शन
    ...
    pms: Filosofìa indian-a
    ps: هندي فلسفه
    pt: filosofia indiana
    ru: индийская философия
    sa: भारतीयदर्शनशास्त्रम्
    sh: Indijska filozofija
    sk: Indická filozofia
    sl: indijska filozofija
    sr: индијска филозофија
    sv: indisk filosofi
    ta: இந்திய மெய்யியல்
    th: ปรัชญาอินเดีย
    tr: Hint felsefesi
    uk: Індійська філософія
    ur: ہندوستانی فلسفہ
    vi: triết học Ấn Độ
    yue: 印度哲學
...
> The philosophies are often called darśana, meaning "to see" or "looking at."  
> Ānvīkṣikī means “critical inquiry” or “investigation."  
> Unlike darśana, ānvīkṣikī was used to refer to Indian philosophies 
> by classical Indian philosophers, such as Chanakya in the Arthaśāstra.
>
