...
- فلسفه زبان
- فەلسەفەی زمان
- لىينگۆىيستىيكالىق فىيلوسوفىييا
- भाषा दर्शन
- ভাষার দর্শন
- ਭਾਸ਼ਾ ਦਾ ਦਰਸ਼ਨ
- மொழி மெய்யியல்
...
Stack_Exchange_tag:
- https://linguistics.stackexchange.com/tags/philosophy-of-language
- https://philosophy.stackexchange.com/tags/philosophy-of-language
Provenio_UUID: a7bfa726-1597-4338-8b89-92b1ef26fcab
Krugosvet_article_archived_: gumanitarnye_nauki/lingvistika/YAZIK_I_FILOSOFIYA.html
Commons_category: Philosophy of language
PhilPapers_topic: philosophy-of-language
dv_has_:
  name_:
    af: taalfilosofie
    ar: فلسفة اللغة
    ast: filosofía del llinguaxe
    az: dil fəlsəfəsi
    ba: тел философияһы
    be: філасофія мовы
    ...
    et: keelefilosoofia
    eu: hizkuntzaren filosofia
    fa: فلسفه زبان
    fi: kielifilosofia
    fr: philosophie du langage
    ga: fealsúnacht teanga
    gl: filosofía da linguaxe
    he: פילוסופיה של הלשון
    hi: भाषा दर्शन
    hr: filozofija jezika
    ht: filozofi langaj
    hu: nyelvfilozófia
    hy: լեզվի փիլիսոփայություն
    id: filsafat bahasa
    io: linguo-filozofio
    is: málspeki
    ...
    lt: kalbos filosofija
    lv: Valodas filozofija
    mg: Filôzôfian' ny fiteny
    mk: филозофија на јазикот
    ms: falsafah bahasa
    nb: språkfilosofi
    nl: taalfilosofie
    nn: språkfilosofi
    oc: filosofia del lengatge
    os: æвзаджы философи
    pa: ਭਾਸ਼ਾ ਦਾ ਦਰਸ਼ਨ
    pl: filozofia języka
    ...
    se: giellafilosofiija
    sh: filozofija jezika
    sk: filozofia jazyka
    sl: filozofija jezika
    smn: kielâfilosofia
    sms: ǩiõllfilosofia
    ...
    ta: மொழி மெய்யியல்
    tg: фалсафаи забон
    tl: pilosopiya ng wika
    tr: dil felsefesi
    tt: тел фәлсәфәсе
    uk: філософія мови
    uz: til falsafasi
    vi: triết học ngôn ngữ
    wuu: 语言哲学
    yue: 語言哲學
    zh: 语言哲学
    zh-hans: 语言哲学
...
> Philosophy of language is the philosophical study of the nature of language. 
> It investigates the relationship between language, language users, and the world. 
> Investigations may include inquiry into the nature of meaning, intentionality, 
> reference, the constitution of sentences, concepts, learning, and thought.
>
> Gottlob Frege and Bertrand Russell were pivotal figures 
> in analytic philosophy's "linguistic turn". 
> 
> These writers were followed by Ludwig Wittgenstein (Tractatus Logico-Philosophicus), 
> the Vienna Circle, logical positivists, and Willard Van Orman Quine.
>
