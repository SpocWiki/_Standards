...
follows: '[[_Standards/WikiData/WD~Renaissance_philosophy,917440|WD~Renaissance_philosophy,917440]]'
different_from: '[[_Standards/WikiData/WD~contemporary_philosophy,943303|WD~contemporary_philosophy,943303]]'
...
dv_has_:
  name_:
    ...
    cs: novověká filozofie
    de: Philosophie der Neuzeit
    el: Φιλοσοφία των Νεότερων Χρόνων
    en: modern philosophy
    eo: moderna filozofio
    es: filosofía moderna
    et: Uusaja filosoofia
    eu: Filosofia moderno
    fa: فلسفه جدید
    fr: philosophie moderne
    gl: Filosofía moderna
    hi: आधुनिक दर्शन
    hr: Moderna filozofija
    hu: modern filozófia
    hy: Նոր ժամանակների փիլիսոփայություն
    id: Filsafat Modern
    it: filosofia moderna
    ja: 近世哲学
    kk: Жаңа Заман философиясы
    ko: 근대철학
    la: Philosophia recens
    lv: jauno laiku filozofija
    mk: Модерна филозофија
    nb: moderne filosofi
    nl: moderne filosofie
    pl: Filozofia nowożytna
    pms: Filosofìa moderna
    ps: معاصره فلسفه
    pt: filosofia moderna
    ro: filosofie modernă
    ru: философия Нового времени
    sh: Moderna filozofija
    sk: Novoveká filozofia
    sl: moderna filozofija
    sr: модерна филозофија
    tr: modern felsefe
    uk: філософія Нового часу
