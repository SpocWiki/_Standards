...
topic_s_main_category: '[[_Standards/WikiData/WD~Category_Vices,6328058]]'
different_from: '[[_Standards/WikiData/WD~bad_habit,17004554]]'
subclass_of: '[[_Standards/WikiData/WD~moral_quality,31172650]]'
depicted_by: '[[_Standards/WikiData/WD~Jupiter_striking_down_vices,131823355]]'
has_characteristic: '[[_Standards/WikiData/WD~sin,60227]]'
...
dv_has_:
  name_:
    ...
    mk: порок
    nl: zwakte
    pi: "\U00011005\U00011013\U0001103C\U00011032\U0001102E"
    pl: wada
    pt: vício
    ro: viciu
    ru: порок
...
| ---------------- | ---------- | ---: | ---------- | --------------------------------------------------- |
| Alcohol abuse    | Substance  |  5.1 | WHO        | Harmful or dependent alcohol consumption            |
| Tobacco smoking  | Substance  | 22.3 | WHO        | Combustible nicotine use                            |
| Illicit drug use | Substance  |  5.5 | UNODC      | Non-medical psychoactive substance use              |
| drug misuse      | Substance  |  4.7 | CDC        | Non-prescribed or excessive medical drug use        |
| Caffeine         | Substance  |  9.8 | EFSA       | Excessive stimulant intake with withdrawal symptoms |
...
> A **Vice** is a practice, behaviour, habit or item 
> generally considered morally wrong in the associated society. 
> 
> In more minor usage, vice can refer to a fault, a negative character trait, 
> a defect, an infirmity, or a bad or unhealthy habit. 
> 
> Vices are usually associated with a fault in a person's character or temperament 
