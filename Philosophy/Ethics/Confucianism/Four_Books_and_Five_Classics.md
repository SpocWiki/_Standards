...
dv_has_:
  name_:
    ...
    cs: Devět klasických knih
    en: Four Books and Five Classics
    eo: Kvar Libroj kaj Kvin Klasikaĵoj
    es: Cuatro Libros y Cinco Clásicos
    eu: Lau Liburuak eta Bost Klasikoak
    fa: چهار کتاب و پنج کلاسیک
    fr: Quatre Livres et Cinq Classiques
    gl: Catro libros e cinco clásicos
    he: ארבעת הספרים וחמש הקלאסיקות
    hu: Négy könyv és öt klasszikus
    id: Empat Kitab dan Lima Klasik
    ja: 四書五経
    ko: 사서오경
    la: Quattuor libri
    lzh: 四書
    mk: Четири книги и пет класици
    ms: Empat Buku dan Lima Kitab
    nan: Sù-su Ngó͘-keng
    nb: De fire bøker og fem klassikere
    oc: Quatre Libres e Cinc Classics
    pt: Quatro Livros e Cinco Clássicos
    ru: Четыре книги и пять классиков
    sk: Deväť klasických kníh
    sl: štiri knjige in pet klasikov
    sr: Konfučijanski kanon
    sv: Fyra böcker och fem klassiker
    ta: ஐந்து செவ்வியல் இலக்கியங்கள்
    tr: Dört Kitap
    uk: Чотири книги і п'ятеро класиків
    wuu: 四书五经
    yue: 四書五經
    za: Seiqsaw Nguxging
    zh: 四書五經
