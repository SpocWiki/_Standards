...
- Inkandeco-lampo
- Inkiandesent lait bolb
- izzólámpa
- kaitrinė lemputė
- kvēlspuldze
- lampa gealbhruthach
- Lampa incandescente
- Lampada invernighenta
- Lampadin-a a incandessensa
- lampadina
- lampe à incandescence
- lampu pijar
- lanp enekandesans
- Lanpadina da incandesensa
- ljósapera
...
- http://commons.wikimedia.org/wiki/Special:FilePath/Christ%20Church%20NYC%20117.jpg
schematic: http://commons.wikimedia.org/wiki/Special:FilePath/Incandescent%20light%20bulb.svg
video: http://commons.wikimedia.org/wiki/Special:FilePath/Latarnie-morskie-w-Polsce-01.webm
3D_model: http://commons.wikimedia.org/wiki/Special:FilePath/Lightbulb%2001%204k%20-%20Model%20%28Josh%20Dean%20via%20Poly%20Haven%29.stl
...
dv_has_:
  name_:
    ...
    hsb: žehlawka
    ht: lanp enekandesans
    hu: izzólámpa
    hy: Շիկացման լամպ
    ia: Lampa incandescente
    id: lampu pijar
    ii: ꄆꄒ
    io: Inkandeco-lampo
    is: ljósapera
    ...
    li: Gleujlamp
    lmo: Lampada invernighenta
    lt: kaitrinė lemputė
    lv: kvēlspuldze
    mk: светилка
    ml: വൈദ്യുതവിളക്ക്
    mn: Улайсдаг гэрлийн чийдэн
    ms: mentol lampu
    nan: Tian-kiû
    nb: glødelampe
    ne: बिजुली बत्ती
    ...
    pa: ਬਲਬ
    pl: żarówka
    pms: Lampadin-a a incandessensa
    pnb: بلب
    ...
    sd: برق ڏيئو
    sgs: alektrėnė lėmpele
    sh: električna sijalica
    si: තැවිදිලි පහන
    sk: žiarovka
    sl: žarnica
    sn: bhoni
    ...
    uk: лампа розжарення
    ur: برقی قمقمہ
    uz: choʻgʻlanma lampa
    vec: Lanpadina da incandesensa
    vi: đèn sợi đốt
    war: bumbilya
    wuu: 白炽灯
    yue: 電燈膽
...
> 
> They require no external regulating equipment, have low manufacturing costs, 
> and work equally well on either alternating current or direct current. 
> As a result, the incandescent bulb became widely used in household and commercial lighting, 
...
> Less than 5% of the energy they consume is converted into visible light; the rest is released as heat. 
> 
> The luminous efficacy of a typical incandescent bulb for 120 V operation 
> is 16 lumens per watt (lm/W), compared 
> to 60 lm/W for a compact fluorescent bulb 
> or 100 lm/W for typical white LED lamps.
>
> The heat produced by filaments is used in some applications, such as 
> heat lamps in incubators, lava lamps, Edison effect bulbs, and the Easy-Bake Oven toy. 
> Quartz envelope halogen infrared heaters are used for industrial processes 
> such as paint curing and space heating.
>
> Incandescent bulbs typically have shorter lifetimes compared to other types of lighting; 
> around 1,000 hours for home light bulbs versus 
> typically 10,000 hours for compact fluorescents 
> and 20,000–30,000 hours for lighting LEDs. 
> 
> Most incandescent bulbs can be replaced by fluorescent lamps, 
> high-intensity discharge lamps, and light-emitting diode lamps (LED). 
> 
> Some governments have begun a phase-out of incandescent light bulbs to reduce energy consumption.
>
