...
dv_has_:
  name_:
    ...
    gl: tecnoloxía nuclear
    he: טכנולוגיה גרעינית
    hi: नाभिकीय प्रौद्योगिकी
    hr: Nuklearna tehnologija
    hu: nukleáris technológia
    hy: միջուկային տեխնոլոգիա
    ia: technologia nuclear
    id: teknologi nuklir
    it: tecnologia nucleare
    ja: 核技術
    jam: nyuuklier teknalaji
    kn: ಅಣು ತಂತ್ರಜ್ಞಾನ
    ko: 핵기술
    ...
    pms: Tecnologìa nuclear
    ro: tehnică nucleară
    ru: ядерные технологии
    si: න්යෂ්ටික තාක්ෂණය
    sl: jedrska tehnika
    smn: váimusfyysiik
    sq: Teknologjia bërthamore
    sr: Nuklearna tehnologija
    sv: kärnteknik
    ta: அணுக்கருத் தொழில்நுட்பம்
    th: เทคโนโลยีนิวเคลียร์
    tr: nükleer teknoloji
    uk: ядерні технології
    ur: نویاتی طرزیات
    uz: yadro texnikasi
