...
pronunciation_audio: http://commons.wikimedia.org/wiki/Special:FilePath/De-Geschirrsp%C3%BClmaschine.ogg
Amazon_com_browse_node: 3741271
video: http://commons.wikimedia.org/wiki/Special:FilePath/A%20small%20Dishwasher%20f%C3%B6r%20the%20small%20household%20washes%20dirty%20dishes%20clean.webm
icon: http://commons.wikimedia.org/wiki/Special:FilePath/Iconoir%20dishwasher.svg
exact_match:
- http://wordnet-rdf.princeton.edu/wn30/03207941-n
- http://wordnet-rdf.princeton.edu/wn31/103193054-n
GS1_GPC_code: 10001964
Commons_category: Dishwashers
dv_has_:
  name_:
    an: lavador
    ar: غسالة صحون
    ...
    hsb: wopłokowadło
    hu: mosogatógép
    hy: Սպասք լվացող մեքենա
    id: Mesin cuci piring
    is: uppþvottavél
    it: lavastoviglie
    ja: 食器洗い機
