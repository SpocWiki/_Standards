...
> Especially in residential buildings, it often is used as a utility space for a building, 
> where such items as the furnace, water heater, breaker panel or fuse box, car park, 
> and air-conditioning system are located; 
> so also are amenities such as the electrical system and cable television distribution point. 
> In cities with high property prices, such as London, 
> basements are often fitted out to a high standard and used as living space.
>
> In British English, the word basement is usually used 
> for underground floors of, for example, department stores. 
> 
> The word is usually used with buildings when the space below the ground floor is habitable 
> and with (usually) its own access. 
...
### #is_/same_as :: [Basement](Basement.md) 
