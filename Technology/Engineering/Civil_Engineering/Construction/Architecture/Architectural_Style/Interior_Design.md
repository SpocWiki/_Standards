---
aliases:
- architetura de interni
- Barne-diseinua
- binnendoararsjitektuer
- Binneversiering
- dearadh intí
- deseño interior
- design d'intérieur
...
dv_has_:
  name_:
    ...
    fy: binnendoararsjitektuer
    ga: dearadh intí
    gl: deseño interior
    ha: Zane na ciki
    he: עיצוב פנים
    hi: आंतरिक डिज़ाइन
    hsb: nutřkowna architektura
    hu: lakberendezés
    hy: Ինտերիերի դիզայն
    id: Rancangan dalam ruangan
    it: design di interni
    ja: インテリア・デザイン
    ko: 인테리어 디자인
    lt: interjero dizainas
    lv: Interjera dizains
    mk: внатрешно уредување
    ml: ഇന്റ്രിഒർ ദെസിഗ്നെർ
    mn: Интерьер дизайн
    mr: गृहशोभन
    ...
    te: ఇంటీరియర్ డిజైనింగ్
    tg: Тарроҳии дохилӣ
    th: มัณฑนศิลป์
    tl: Disenyong panloob
    tr: iç mimari
    uk: дизайн інтер'єру
    ur: داخلی طرحبندی
    uz: Interyer dizayni
    vec: architetura de interni
