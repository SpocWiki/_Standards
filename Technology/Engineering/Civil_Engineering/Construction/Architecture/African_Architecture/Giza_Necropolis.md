...
has_part_s_:
- '[[_Standards/WikiData/WD~The_Great_Sphinx,130958|WD~The_Great_Sphinx,130958]]'
...
instance_of: '[[_Standards/WikiData/WD~Ancient_Egyptian_necropolis,125866682|WD~Ancient_Egyptian_necropolis,125866682]]'
...
dv_has_:
  name_:
    af: Dodeakker van Giza
    am: ጊዛ ሜዳ
    an: Necropoli de Chiza
    ar: أهرامات الجيزة
    arz: جبانه اهرام الجيزه
    ...
    fr: nécropole de Gizeh
    gl: Pirámides de Gizeh
    gn: Gísa tyvytyguasu
    gsw: Nekropole von Gizeh
    ha: Giza Necropolis
    he: הפירמידות בגיזה
    hi: गीज़ा क़ब्रिस्तान
    hif: Pyramids of Giza
    hr: Nekropola u Gizi
    ia: Necropole de Giza
    id: Nekropolis Giza
    is: Grafhýsin í Gísa
    it: necropoli di Giza
    ja: メンフィスとその墓地遺跡
    jv: Piramidha Giza
    ka: გიზის ნეკროპოლისი
    kab: Tizumag n Ǧiza
    kk: Гиза некрополі
    ko: 기자 네크로폴리스
    kw: Ynkleudhva Giza
    la: Necropolis Gizensis
    lb: Nekropol vu Gizeh
    lt: Gizos nekropolis
    lv: Gīzas nekropole
    ml: ഗിസ നെക്രൊപൊളിസ്
    ms: Nekropolis Giza
    my: ဂိုင်ဇာဂူသင်္ချိုင်း
    nb: Giza nekropolis
    nds: Nekropool van Gizeh
    ne: गिजा कब्रिस्तान
    nl: Necropolis van Gizeh
    nn: Giza nekropolis
    oc: Necropòli de Giza
    pa: ਗੀਜ਼ਾ ਨੈਕਰੋਪੋਲਿਸ
    ...
    sh: Nekropola u Gizi
    sk: Nekropola pri Gíze
    sl: nekropola v Gizi
    smn: Giza pyramideh
    sq: Nekropoli i Gizës
    sr: Некропола у Гизи
    sv: Gizaplatån
    sw: Piramidi za Giza
    ta: கீசா நெக்ரோபொலிசு
    th: เมมฟิสและสุสานโบราณ
    tl: Nekropolis ng Giza
    tok: kulupu tomo Kisa
    tr: Gize Nekropolü
    tt: Гиза некрополе
    udm: египет пирамидъёс
    uk: Некрополь Ґізи
    vi: Khu lăng mộ Giza
    war: Necropolis han Giza
    wuu: 孟菲斯搭渠墓地金字塔
    yi: נעקראפאל פון גיזע
    yue: 吉薩金字塔群
    zh: 吉萨的墓地
---
...
### #is_/same_as :: [[/_Standards/Technology/Engineering/Civil_Engineering/Construction/Architecture/African_Architecture/Giza_Necropolis|Giza_Necropolis]] 

### #is_/same_as :: [[/_public/Technology/Engineering/Civil_Engineering/Construction/Architecture/African_Architecture/Giza_Necropolis.public|Giza_Necropolis.public]] 

### #is_/same_as :: [[/_internal/Technology/Engineering/Civil_Engineering/Construction/Architecture/African_Architecture/Giza_Necropolis.internal|Giza_Necropolis.internal]] 

### #is_/same_as :: [[/_protect/Technology/Engineering/Civil_Engineering/Construction/Architecture/African_Architecture/Giza_Necropolis.protect|Giza_Necropolis.protect]] 

### #is_/same_as :: [[/_private/Technology/Engineering/Civil_Engineering/Construction/Architecture/African_Architecture/Giza_Necropolis.private|Giza_Necropolis.private]] 

### #is_/same_as :: [[/_personal/Technology/Engineering/Civil_Engineering/Construction/Architecture/African_Architecture/Giza_Necropolis.personal|Giza_Necropolis.personal]] 

### #is_/same_as :: [[/_secret/Technology/Engineering/Civil_Engineering/Construction/Architecture/African_Architecture/Giza_Necropolis.secret|Giza_Necropolis.secret]] 
