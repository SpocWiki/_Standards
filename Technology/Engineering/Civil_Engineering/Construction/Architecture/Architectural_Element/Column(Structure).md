...
name_in_kana: はしら
OpenStreetMap_tag: man_made=column
dv_has_:
  name_:
    an: Columna
    ar: عمود
...
> A **Column** or pillar in architecture and structural engineering 
...
> A small wooden or metal support is typically called a post. 
...
> because of the similar stress conditions. 
> 
> Columns are frequently used 
> to support beams or arches on which the upper parts of walls or ceilings rest. 
> 
> In architecture, "column" refers to such a structural element that 
> also has certain proportional and decorative features. 
> 
> These beautiful columns are available in a broad selection of styles and designs 
> in round tapered, round straight, or square shaft styles. 
> 
