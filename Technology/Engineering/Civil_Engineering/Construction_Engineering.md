...
dv_has_:
  name_:
    ...
    de: Baukonstruktionswesen
    el: Κατασκευαστική τεχνολογία
    en: construction engineering
    es: ingeniería de la construcción
    eu: Eraikuntza ingeniaritza
    fa: مهندسی و مدیریت ساخت
    fi: rakennustekniikka
    fr: construction engineers
    id: Teknik konstruksi
    it: ingegneria delle costruzioni
    ja: 建設工学
    ko: 토목시공학
    la: Ingeniaria constructionis
    mr: बांधकाम अभियांत्रिकी
    ms: Kejuruteraan pembinaan
    nb: bygningsteknikk
    pl: Inżynieria produkcji budowlanej i zarządzania
    pt: engenharia da construção
    ro: ingineria construcțiilor
    ru: строительная инженерия
    si: තැනුම් ඉංජිනේරු විද් යාව
    sk: Strojníctvo
    sl: gradbeno inženirstvo
    sr: Građevinsko inženjerstvo
    sv: byggteknik
    ta: கட்டுமானப் பொறியியல்
    th: วิศวกรรมก่อสร้าง
    tl: Inhinyerong konstruksyon
    tr: inşaat mühendisliği
    uk: будівельна інженерія
    ur: تعمیری ہندسیات
