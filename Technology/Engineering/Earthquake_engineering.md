...
- ingeniaritza sismiko
- ingeniería sísmica
- inginerie seismică
- Inhenyeriya panlinog
- Inxeniería sísmica
...
dv_has_:
  name_:
    ...
    cs: seismické inženýrství
    de: Erdbebensicheres Bauen
    el: αντισεισμικές κατασκευές
    en: earthquake engineering
    eo: tertrema inĝenierio
    es: ingeniería sísmica
    eu: ingeniaritza sismiko
    fa: مهندسی زمینلرزه
    fr: génie parasismique
    gl: enxeñaría sísmica
    he: הנדסת רעידות אדמה
    hr: potresno inženjerstvo
    id: rekayasa gempa
    it: ingegneria sismica
    ja: 地震工学
    ko: 지진공학
    la: Ingeniaria terrae motuum
    mr: भूकंप अभियांत्रिकी
    ms: kejuruteraan gempa bumi
    pl: zapobieganie skutkom trzęsień ziemi
    ps: د رېږدلې انجنيري
    pt: engenharia sísmica
    ro: inginerie seismică
    ru: сейсмостойкое строительство
    sl: potresno inženirstvo
    sr: antiseizmičko inženjerstvo
    ta: நிலநடுக்க பொறியியல்
    th: วิศวกรรมแผ่นดินไหว
    tk: Ýer titreme inženerligi
    tr: deprem mühendisliği
    uk: антисейсмічне будівництво
    ur: ارتھ کوئیک انجینئرنگ
    war: Inhenyeriya panlinog
    wuu: 地震工程
    yue: 地震工程
    zh: 地震工程
    zh_hans: 地震工程
