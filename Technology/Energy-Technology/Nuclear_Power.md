...
- énerji nikléyèr
- Özek energiyası
- łéétsoh bee atsiniltłʼish álʼį́
- πυρηνική ενέργεια
- јадрена енергија
- атом дыкужым
- атом өнеркәсібі
...
dv_has_:
  name_:
    ...
    frr: Atoomstruum
    fy: Kearnenerzjy
    ga: fuinneamh núicléach
    gan: 核能
    gcr: énerji nikléyèr
    gl: enerxía nuclear
    gn: tumingue'a mbaretekue
    gsw: Chernenergi
    ha: makamashin nukiliya
    he: אנרגיה גרעינית
    hi: नाभिकीय ऊर्जा
    hif: nuclear power
    ...
    ja: 原子力
    jam: nyuuklier powa
    ka: ატომური ენერგეტიკა
    kk: атом өнеркәсібі
    kn: ಪರಮಾಣು ಶಕ್ತಿ
    ko: 원자력
    ky: ядролук энергетика
    la: energia nuclearis
    lad: enerjiya nuklear
    lb: Atomenergie
    lmo: energia nucleara
    lt: branduolinė energetika
    lv: kodolenerģija
    lzh: 核能
    mg: angovo nokleary
    mhr: атомный энергий
    ...
    nl: kernenergie
    nn: kjerneenergi
    nv: łéétsoh bee atsiniltłʼish álʼį́
    oc: energia nucleara
    om: atoomii
    pa: ਪਰਮਾਣੂ ਸ਼ਕਤੀ
    ...
    rue: ядерна енерґетіка
    sco: nuclear pouer
    sd: ائٽمي طاقت
    se: váimmusfápmu
    sgs: kondoulėnė energėjė
    ...
    sv: kärnkraft
    sw: nishati ya nyuklia
    ta: அணுக்கரு ஆற்றல்
    te: అణు విద్యుత్
    th: พลังงานนิวเคลียร์
    tl: enerhiyang nuklear
    tr: nükleer enerji
    tt: атом-төш энергиясе
    udm: атом дыкужым
    ug: يادرو ئېنېرگىيىسى
    uk: ядерна енергетика
    ur: نویاتی توانائی
    uz: atom energiyasi
    vec: enerzia nucleare
