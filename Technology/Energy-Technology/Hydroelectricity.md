...
- vodní energie
- Wasserkraft
- waterkracht-elektricteit
- yaku pinchikillachana
...
Krugosvet_article_archived_: nauka_i_tehnika/tehnologiya_i_promyshlennost/GIDROENERGETIKA.html
dv_has_:
  name_:
    af: hidroëlektrisiteit
    ar: طاقة كهرمائية
    as: জলবিদ্যুৎ
    ast: enerxía hidrollétrico
    ...
    eu: hidroelektrizitate
    fa: نیروی برقآبی
    fi: vesivoima
    fr: énergie hydroélectrique
    ga: fuinneamh agus cumhacht hidrileictreach
    gcr: énerji idrolik
    gd: dealan-uisge
    gl: hidroelectricidade
    gv: pooar ushtey-lectragh
    he: תחנת כוח הידרואלקטרית
    hi: जलविद्युत ऊर्जा
    hr: hidroelektrana
    hu: hidroelektromosság
    hy: հիդրոէներգետիկա
    ...
    lo: ໄຟຟ້າພະລັງນໍ້າ
    lt: hidroenergija
    lv: hidroelektroenerģija
    mk: хидроенергетика
    ml: ജലവൈദ്യുതി
    mn: усны эрчим хүч
    mr: जलविद्युत
    ms: hidroelektrik
    my: ရေအားလျှပ်စစ်စက်ရုံ
    nan: chúi-le̍k hoat-tiān
    nb: vannkraft
    ne: जलविद्युत उर्जा
    new: जलविद्युत उर्जा
    nl: waterkracht-elektricteit
    or: ଜଳବିଦ୍ୟୁତ
    pa: ਪਣ ਬਿਜਲੀ
    pl: hydroenergetyka
    pms: Idroeletricità
    pnb: پن بجلی
    ps: د اوبو برېښنا
    pt: hidroeletricidade
    qu: yaku pinchikillachana
    ro: hidroelectricitate
    ru: гидроэнергетика
    sco: hydroelectricity
    sd: پن بجلي
    se: čáhcefápmu
    sh: hidroelektrična energija
    si: ජලවිදුලිය
    sl: hidroelektrika
    smn: čäcivyeimi
    sq: hidrocentralet
    ...
    tr: hidroelektrik enerji
    uk: гідроенергетика
    ur: پن بجلی
    uz: gidro elektr energiya
    vi: thủy điện
    war: hidroelektrisidad
    wuu: 水力发电
    yi: היידרא-קראפט
    yue: 水力發電
    zh: 水力發電
...
> **Hydroelectricity**, or hydroelectric power, is electricity generated from water power. 
> Hydropower supplies 15% of the world's electricity, almost 4,210 TWh in 2023, 
> which is more than all other renewable sources combined 
> and also more than nuclear power. 
> 
> Hydropower can provide large amounts of low-carbon electricity on demand, 
> making it a key element for creating secure and clean electricity supply systems. 
> 
> A hydroelectric power station that has a dam and reservoir is a flexible source, since the amount of electricity produced can be increased or decreased in seconds or minutes in response to varying electricity demand. Once a hydroelectric complex is constructed, it produces no direct waste, and almost always emits considerably less greenhouse gas than fossil fuel-powered energy plants. However, when constructed in lowland rainforest areas, where part of the forest is inundated, substantial amounts of greenhouse gases may be emitted.
>
