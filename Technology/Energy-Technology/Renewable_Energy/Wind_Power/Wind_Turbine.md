...
- aeroxerador
- bieggaturbiidna
- Béésh náábałí atsiniltłʼish ííłʼínígíí
- crann-gaoithe
- Eoliana
- Eolyèn
- Haize-sorgailu
...
audio: http://commons.wikimedia.org/wiki/Special:FilePath/WWS%20Windturbine.ogg
Commons_category: Wind turbines
image:
- http://commons.wikimedia.org/wiki/Special:FilePath/2019%2007%2026%20Trampe%20Windkraftanlagen%20DJI%200041.jpg
- http://commons.wikimedia.org/wiki/Special:FilePath/Windgenerator%20antarktis%20hg.jpg
video:
- http://commons.wikimedia.org/wiki/Special:FilePath/Drone%20video%20of%20wind%20turbine%20near%20Kunda%20in%20Estonia.webm
- http://commons.wikimedia.org/wiki/Special:FilePath/Wandmillen%20Koxhausen.ogv
3D_model: http://commons.wikimedia.org/wiki/Special:FilePath/Wind%20Turbine.stl
schematic: http://commons.wikimedia.org/wiki/Special:FilePath/Wind%20turbine%20int.svg
Common_Procurement_Vocabulary_code: 31121320
IEV_number: 415-01-01
Wolfram_Language_entity_code: Entity["Concept", "WindTurbine::s4yt6"]
short_name: ВЭУ
OpenStreetMap_tag:
- generator:method=wind_turbine
- generator:source=wind
Dewey_Decimal_Classification: 621.45
dv_has_:
  name_:
    af: Windkragaanleg
    an: Aerochenerador
    ...
    ka: ქარის გენერატორი
    ko: 풍력 터빈
    la: Mola pneumatica electricitati gignendae
    lb: Wandenergieanlag
    li: Windjturbien
    lt: vėjo jėgainė
    lv: vēja turbīna
    ...
    oc: Eoliana
    pap: turbina di bientu
    pap-aw: turbina di biento
    pl: turbina wiatrowa
    pms: Turbin-a eòlica
    ps: بادي توربین
    pt: aerogerador
