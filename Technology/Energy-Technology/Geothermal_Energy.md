...
- Geothermal_Energy
- Geothermie
- Geuotermėnė energėjė
- Géotérmal
- Jarðhiti
- Jeotermal enerji
- Joto kutoka ardhi
- Năng lượng địa nhiệt
- Ter-varmesal energio
- Ynni geothermol
...
- http://commons.wikimedia.org/wiki/Special:FilePath/Icon%20geothermal%20power.svg
pronunciation_audio: http://commons.wikimedia.org/wiki/Special:FilePath/De-Geothermie.ogg
exact_match: http://purl.obolibrary.org/obo/ENVO_2000034
UMLS_CUI: C3178764
Commons_category: Geothermal energy
MeSH_tree_code: N06.230.132.644.186
dv_has_:
  name_:
    af: geotermiese energie
    ar: طاقة حرارية جوفية
    ast: enerxía xeotérmico
    ...
    hy: Երկրաջերմային էներգիա
    id: Energi panas bumi
    io: Ter-varmesal energio
    is: Jarðhiti
    it: energia geotermica
    ja: 地熱エネルギー
    jv: Énérgi panas bumi
    kk: Геотермалдық энергетика
    kn: ಭೂಶಾಖದ ಶಕ್ತಿ
    ko: 지열 발전
    ku: Enerjiya jeotermal
    la: Energia geothermalis
    lt: Geoterminė energija
    lv: Ģeotermālā enerģija
    mk: геотермална енергија
    ml: ഭൂതാപ ഊർജ്ജം
    mn: Геотерм
    ms: Geoterma
    mwl: Einergie geotérmica
    nb: geotermisk energi
    nl: aardwarmte
    nn: Geotermisk energi
    pa: ਭੂਮਿਕਲ ਊਰਜਾ
    pl: Energia geotermalna
    pms: Energìa geotèrmica
    ps: جیوترمل انرژي
    pt: Energia geotérmica
    rm: Energia geotermica
    ro: energie geotermică
    ru: геотермальная энергетика
    sd: ڌرتي جي حرارتي توانائي
    se: geotermihkalaš energiija
    sgs: Geuotermėnė energėjė
    sh: Geotermalna energija
    ...
    te: Geothermal energy
    th: พลังงานความร้อนใต้พิภพ
    tl: Enerhiyang heotermal
    tr: Jeotermal enerji
    uk: геотермальна енергетика
    uz: Geotermal energiya
    vi: Năng lượng địa nhiệt
    war: Enerhiya heyotermika
    wuu: 地热能
    yue: 地熱能
    zh: 地熱能
    zh_cn: 地热能
...
> has been used for bathing since Paleolithic times and for space heating since Roman times. 
...
### #is_/same_as :: [[/_Standards/Technology/Energy-Technology/Geothermal_Energy|Geothermal_Energy]] 

### #is_/same_as :: [[/_public/Technology/Energy-Technology/Geothermal_Energy.public|Geothermal_Energy.public]] 

### #is_/same_as :: [[/_internal/Technology/Energy-Technology/Geothermal_Energy.internal|Geothermal_Energy.internal]] 

### #is_/same_as :: [[/_protect/Technology/Energy-Technology/Geothermal_Energy.protect|Geothermal_Energy.protect]] 

### #is_/same_as :: [[/_private/Technology/Energy-Technology/Geothermal_Energy.private|Geothermal_Energy.private]] 

### #is_/same_as :: [[/_personal/Technology/Energy-Technology/Geothermal_Energy.personal|Geothermal_Energy.personal]] 

### #is_/same_as :: [[/_secret/Technology/Energy-Technology/Geothermal_Energy.secret|Geothermal_Energy.secret]] 
