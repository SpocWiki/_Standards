...
> by analogy to a seaport for ships or an airport for aircraft. 
> 
> The word spaceport—and even more so cosmodrome—
> has traditionally referred to sites capable of launching spacecraft 
> into Earth's orbit or on interplanetary trajectories. 
> 
> However, rocket launch sites for sub-orbital spaceflights are also sometimes called spaceports, 
> especially as new and proposed facilities for suborbital commercial spaceflight are often branded as "spaceports". Space stations and proposed future lunar bases are also sometimes referred to as spaceports, particularly when envisioned as nodes for further interplanetary travel.
>
