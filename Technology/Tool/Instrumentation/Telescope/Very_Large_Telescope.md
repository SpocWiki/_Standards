...
dv_has_:
  name_:
    af: Baie Groot Teleskoop
    ar: المقراب الكبير جدا
    ast: Very Large Telescope
    be-tarask: Вельмі вялікі тэлескоп
    bg: Very Large Telescope
    ca: Very Large Telescope
    ckb: تەلیسکۆپی زۆر گەورە
    cs: Very Large Telescope
    da: Very Large Telescope
    de: Very Large Telescope
    el: Πολύ Μεγάλο Τηλεσκόπιο
    en: Very Large Telescope
    en-ca: Very Large Telescope
    en-gb: Very Large Telescope
    eo: Tre Granda Teleskopo
    es: Very Large Telescope
    et: Väga Suur Teleskoop
    eu: Very Large Telescope
    fa: تلسکوپ ویالتی
    fi: Very Large Telescope
    fr: Très Grand Télescope
    ga: an Teileascóp Ollmhór
    he: הטלסקופ הגדול מאוד
    hr: Vrlo veliki teleskop
    hu: Very Large Telescope
    hy: Շատ մեծ աստղադիտակ
    id: Very Large Telescope
    it: Very Large Telescope
    ja: 超大型望遠鏡
    ko: 초거대 망원경
    lb: Paranal-Observatoire
    lv: Ļoti lielais teleskops
    mk: Многу голем телескоп
    ms: Very Large Telescope
    nb: Very Large Telescope
    nl: Very Large Telescope
    nn: Very Large Telescope
    oc: Very Large Telescope
    pl: Very Large Telescope
    pt: Very Large Telescope
    pt-br: Very Large Telescope
    ro: Very Large Telescope
    ru: Very Large Telescope
    sh: Vrlo veliki teleskop
    sk: Very Large Telescope
    sl: Zelo velik teleskop
    sr: Веома велики телескоп
    sr-ec: Веома велики телескоп
    sv: Very Large Telescope
    th: เวรีลาร์จเทลิสโกป
    tr: Very Large Telescope
    tt: Very Large Telescope
    uk: Дуже великий телескоп
    vi: Very Large Telescope
    yue: 超大型望遠鏡
    zh: 甚大望远镜
---
