...
dv_has_:
  name_:
    ar: أداة كتابة
    be: пісьмовая прылада
    bn: লেখনী
    ca: instrument d'escriptura
    cs: psací potřeba
    da: skriveredskab
    de: Schreibgerät
    el: μέσο γραφής
    ...
    eo: skribilo
    es: instrumento de escritura
    eu: idazteko tresna
    fi: kirjoitustyökalu
    fr: matériel d'écriture
    he: כלי כתיבה
    hsb: pisanski grat
    hu: írószer
    id: alat tulis
    ...
    nan: Siá-jī ke-si
    nb: skriveredskap
    nl: schrijfinstrument
    nn: skrivereiskap
    pl: przyrząd pisarski
    pt: instrumento de escrita
    qu: Qillqana
    ro: instrument de scris
    ru: письменная принадлежность
    sl: pisalo
    sr: писаћи прибор
    sr-ec: писаћи прибор
    sr-el: pisaći pribor
    ...
    tok: ilo sitelen
    tr: yazı aleti
    tt: язма кирәк-яраклары
    tt-cyrl: язма кирәк-яраклары
    uk: письмове приладдя
    vi: dụng cụ viết
    yo: Ikọwe
    zh: 书写工具
    zh-cn: 书写工具
