...
has_part_s_: '[[_Standards/WikiData/WD~electric_motor,72313|WD~electric_motor,72313]]'
subclass_of:
...
dv_has_:
  name_:
    ...
    ja: 衣類乾燥機
    ko: 빨래 건조기
    la: Machina siccatoria volubilis
    lb: Trockner
    lt: džiovyklė
    mk: сушална за алишта
    nb: tørketrommel
    nds: Dröger
    nl: wasdroger
    pl: Suszarka do ubrań
    pms: Suvadris
    pt: secadora de roupas
    ro: uscător de haine
    ru: сушильная машина
    se: bivttasgoikadanmašiidna
    sl: sušilnik za perilo
    sr: Машина за сушење веша
    sv: torktumlare
    ta: துணி உலர்த்தி
    tr: Çamaşır kurutucusu
    uk: сушильна машина
    ur: آلہ خشکاری
    vi: máy sấy quần áo
    war: Panpamara panapton
    yue: 乾衣機
    zh: 乾衣機
    zh-hans: 烘干机
    zh-hant: 烘乾機
