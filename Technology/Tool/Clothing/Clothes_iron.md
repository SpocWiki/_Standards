...
- '[[_Standards/WikiData/WD~small_appliance,3558289|WD~small_appliance,3558289]]'
- '[[_Standards/WikiData/WD~iron,125492307|WD~iron,125492307]]'
has_use: '[[_Standards/WikiData/WD~ironing,1650142|WD~ironing,1650142]]'
described_by_source:
...
- '[[_Standards/WikiData/WD~coal,24489|WD~coal,24489]]'
...
audio: http://commons.wikimedia.org/wiki/Special:FilePath/WWS%20SteamIron.ogg
exact_match:
- http://wordnet-rdf.princeton.edu/wn30/03584829-n
...
> A clothes iron (also flatiron, smoothing iron, dry iron, steam iron or simply iron) 
> is a small appliance that, when heated, is used to press clothes 
> to remove wrinkles and unwanted creases. 
> 
> Domestic irons generally range in operating temperature from 121 °C (250 °F) to 182 °C (360 °F). 
> It is named for the metal (iron) of which the device was historically made, 
> and the use of it is generally called ironing, the final step in the process of laundering clothes. 
>
