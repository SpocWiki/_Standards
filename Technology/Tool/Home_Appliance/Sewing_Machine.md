...
- 衣車
- 재봉틀
has_id_wikidata: Q49013
time_of_discovery_or_invention: 1790-01-01T00:00:00Z
subclass_of: '[[_Standards/WikiData/WD~home_appliance,212920|WD~home_appliance,212920]]'
described_by_source:
...
has_use: '[[_Standards/WikiData/WD~machine_sewing,66364432|WD~machine_sewing,66364432]]'
discoverer_or_inventor: '[[_Standards/WikiData/WD~Thomas_Saint,130495495|WD~Thomas_Saint,130495495]]'
made_from_material: '[[_Standards/WikiData/WD~steel,11427|WD~steel,11427]]'
Nomenclature_for_Museum_Cataloging: 6822
Commons_category: Sewing machines
Common_Procurement_Vocabulary_code: 42715000
image: http://commons.wikimedia.org/wiki/Special:FilePath/Starlet%20Singer%20-%204.jpg
icon: http://commons.wikimedia.org/wiki/Special:FilePath/Toicon-icon-blueprint-sew.svg
exact_match:
- http://wordnet-rdf.princeton.edu/wn30/04179913-n
- http://wordnet-rdf.princeton.edu/wn31/104122652-n
U_S_National_Archives_Identifier: 10665381
UNSPSC_Code: 23121614
Iconclass_notation: 41D4413
Commons_gallery: Sewing machine
dv_has_:
  name_:
    af: Naaimasjien
    ak: Adepam afidie
    ...
    ar: آلة الخياطة
    arz: مكنة الخياطه
    ast: Máquina de coser
    az: Tikiş maşını
    be: швейная машына
    be-tarask: швейная машына
    bg: Шевна машина
    bn: সেলাই মেশিন
    bs: Šivaća mašina
    ca: màquina de cosir
    ...
    ckb: ئامێری درومان
    cs: šicí stroj
    csb: Maszina do szëcô
    cy: Peiriant gwnïo
    da: symaskine
    de: Nähmaschine
    el: ραπτομηχανή
    en: sewing machine
    en-ca: Sewing machine
    en-gb: sewing machine
    eo: kudromaŝino
    es: máquina de coser
    et: õmblusmasin
    eu: Josteko makina
    ...
    jv: Mesin jait
    ka: საკერავი მანქანა
    kbp: N̄ɩɣyʋʋ kɩn̄ɛyʋʋ
    kk: тігін машинасы
    kk-latn: tigin maşïnası
    kn: ಹೊಲಿಗೆಯಂತ್ರ
    ko: 재봉틀
    krc: Тикген машина
    ks: سلائی مِشیٖن
    ...
    ur: سلائی مشین
    uz: Tikuv mashinasi
    vec: Màchina da cuzir
    vi: máy khâu
    war: Makina hin panahi
    wuu: 缝纫机
    yi: ניי מאשין
    yue: 衣車
    zh: 縫紉機
...
> to decrease the amount of manual sewing work performed in clothing companies. 
> 
> Since the invention of the first sewing machine, 
> generally considered to have been the work of Englishman Thomas Saint in 1790, 
> the sewing machine has greatly improved the efficiency and productivity of the clothing industry.
>
