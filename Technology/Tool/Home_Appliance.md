...
dv_has_:
  name_:
    ...
    ar: جهاز منزلي
    arz: جهاز منزلى
    ast: electrodomésticu
    az: məişət texnikası
    be: бытавая тэхніка
    be-tarask: побытавая тэхніка
    bg: Битова техника
    bn: গৃহপযগী সামগ্রী
    ca: electrodomèstic
    cs: domácí spotřebič
    cy: offeryn ar gyfer y cartref
    da: hvidevarer
    de: Haushaltsgerät
    el: οικιακή συσκευή
    en: home appliance
    ...
    ga: fearas baile
    gl: electrodoméstico
    he: מכשירי חשמל ביתיים
    hi: गृहोपयोगी सामान
    hr: kućni uređaji
    hsb: domjacnostny nastroj
    hu: háztartási készülék
    ...
    kk-arab: تۇرمىستىق تەحنىيكا
    kk-cn: تۇرمىستىق تەحنىيكا
    kk-cyrl: Тұрмыстық техника
    kk-kz: Тұрмыстық техника
    kk-latn: turmıstıq texnïka
    kk-tr: Turmıstıq texnïka
    ko: 가전제품
    lv: sadzīves tehnika
    mk: домашен уред
    mo: Electrocasnice
    ...
    ro: electrocasnic
    ru: бытовая техника
    scn: elettrudumèsticu
    sco: home appliance
    sh: kućni aparat
    sl: gospodinjski aparat
    smn: päikkimaašin
    sms: domm-mašina
    so: Xamaan
    sq: Pajisja shtëpiake
    sr: кућни апарат
    sr-ec: кућни апарат
    sr-el: kućni aparat
    sv: hushållsapparat
    ta: இல்லப் பயன்பொருள்கள்
    te: గృహోపకరణాలు
    th: เครื่องใช้ไฟฟ้า
    tr: beyaz eşya
    uk: побутова техніка
...
#is_/same_as :: [[_Standards/WikiData/WD~Home_appliance,212920|WD~Home_appliance,212920]] 
