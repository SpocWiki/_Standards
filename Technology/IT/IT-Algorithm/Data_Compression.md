...
dv_has_:
  name_:
    ...
    ga: comhbhrú sonraí
    gl: compresión de datos
    gsw: Datenkompression
    he: דחיסת נתונים
    hi: आंकड़ा संपीडन
    hr: sažimanje podataka
    hu: adattömörítés
    hy: Տվյալների սեղմում
    id: kompresi data
    ...
    km: data compression
    ko: 데이터 압축
    ku: kompresyona daneyê
    ky: Берилиштерди кысуу
    la: compressio datorum
    lt: glaudinimas
    lv: datu saspiešana
    mk: стиснување на податоци
    ms: mampatan data
    nb: datakompresjon
    nl: datacompressie
    nn: datakomprimering
    ...
    sk: kompresia dát
    sl: stiskanje podatkov
    sq: ngjeshja e të dhënave
    sr: компресија података
    sv: datakompression
    sw: ugandamuzi data
    ta: தரவு இறுக்கம்
    th: การบีบอัดข้อมูล
