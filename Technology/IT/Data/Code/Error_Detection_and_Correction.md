...
aliases:
- code correcteur
- Deprehensio et correctio mendorum
- detecció d'errors
...
uses: '[[_Standards/WikiData/WD~redundancy,122192|WD~redundancy,122192]]'
subclass_of:
- '[[_Standards/WikiData/WD~computing,179310|WD~computing,179310]]'
- '[[_Standards/WikiData/WD~redundancy,1204361|WD~redundancy,1204361]]'
- '[[_Standards/WikiData/WD~telecommunications,418|WD~telecommunications,418]]'
different_from: '[[_Standards/WikiData/WD~exception_handling,471748|WD~exception_handling,471748]]'
instance_of:
...
has_goal:
- '[[_Standards/WikiData/WD~prevention,1717246|WD~prevention,1717246]]'
- '[[_Standards/WikiData/WD~reliability,_availability_and_serviceability,7310984|WD~reliability,_availability_and_serviceability,7310984]]'
facet_of:
- '[[_Standards/WikiData/WD~fault_tolerance,3140932|WD~fault_tolerance,3140932]]'
- '[[_Standards/WikiData/WD~quality_engineering,7268732|WD~quality_engineering,7268732]]'
...
dv_has_:
  name_:
    ...
    el: Ανίχνευση και διόρθωση σφαλμάτων
    en: error detection and correction
    eo: trovo kaj korekto de eraroj
    es: detección y corrección de errores
    eu: errore-detekzio
    fa: کد تشخیص خطا
    fi: virheen havaitseminen ja korjaaminen
    fr: code correcteur
    he: איתור ותיקון שגיאות
    hi: त्रुटि संसूचन और सुधार
    hu: hibajavítás
    it: rivelazione e correzione d'errore
    ja: 誤り検出訂正
    ko: 오류 검출 정정
    la: Deprehensio et correctio mendorum
    lv: Kļūdu kontrole
    nb: feildeteksjon og korrigering
    nl: foutdetectie en -correctie
    nn: feildeteksjon og korreksjon
    pl: kodowanie korekcyjne
    pms: Rilevament e coression eror
    pt: detecção e correcção de erros
    ro: detectarea și corectarea erorilor
    ru: обнаружение и исправление ошибок
    sl: prepoznavanje in popravljanje napak
    sr: Detekcija i korekcija grešaka
    sv: felkorrigering
    sw: Ugunduzi na usahihishaji wa makosa
    th: การตรวจหาและแก้ความผิดพลาด
    tr: hata bulma ve düzeltme
    uk: виявлення і виправлення помилок
