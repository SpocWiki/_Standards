...
| **Name / Title**                    | `name`               | `<name>`              | `rdfs:label`                  | `name`                  | `dc:title` <br>`foaf:name`       | name:            | Name             |     12 | https://dublincore.org/specifications/dublin-core/dces/ |
...
| **Parent / Child Relationship**     | `parent`, `children` | `<parent>`, `<child>` | `foaf:familyName` links       | `parent` <br>`children` | `rel:parentOf` <br>`rel:childOf` | parent:          | Parent           |     24 | http://purl.org/vocab/relationship/                     |
