...
- programa informatic
- programa informàtego
- programa informàtic
- programa informático
- programa informáticu
...
- Tiān-náu thêng-sek
- Tëriinuw nosukaay
- Vilayizgo vya mrangura
- Wakichi
- πρόγραμμα υπολογιστή
- барномаи роёнаӣ
- камп'ютарная праграма
- комп'ютерна програма
- компьютер программаһы
- Компьютер программи
- компьютер програмы
- компьютеран программа
- Компьютердик програм
- Компьютерийн програм
- Компьютерлік бағдарлама
- компьютерная программа
- Компьютеронь программась
...
has_cause: '[[_Standards/WikiData/WD~source_code,128751|WD~source_code,128751]]'
different_from: '[[_Standards/WikiData/WD~process,205663|WD~process,205663]]'
part_of:
- '[[_Standards/WikiData/WD~software_suite,1143070|WD~software_suite,1143070]]'
- '[[_Standards/WikiData/WD~vampire,56822593|WD~vampire,56822593]]'
- '[[_Standards/WikiData/WD~software,7397|WD~software,7397]]'
subclass_of:
- '[[_Standards/WikiData/WD~program,4303335|WD~program,4303335]]'
- '[[_Standards/WikiData/WD~routine,11491547|WD~routine,11491547]]'
has_characteristic:
- '[[_Standards/WikiData/WD~application_domain,5289798|WD~application_domain,5289798]]'
- '[[_Standards/WikiData/WD~program_lifecycle_phase,7248421|WD~program_lifecycle_phase,7248421]]'
- '[[_Standards/WikiData/WD~programming_language,9143|WD~programming_language,9143]]'
topic_has_template: '[[_Standards/WikiData/WD~Template_Infobox_software,5621231|WD~Template_Infobox_software,5621231]]'
permanent_duplicated_item: '[[_Standards/WikiData/WD~computer_program,134875415|WD~computer_program,134875415]]'
manifestation_of: '[[_Standards/WikiData/WD~software,7397|WD~software,7397]]'
field_of_work: '[[_Standards/WikiData/WD~information_technology,11661|WD~information_technology,11661]]'
uses: '[[_Standards/WikiData/WD~machine_code,55813|WD~machine_code,55813]]'
...
dv_has_:
  name_:
    ...
    cdo: Diêng-nō̤ tiàng-sê̤ṳ
    ce: компьютеран программа
    ckb: بەرنامەى كۆمپيوتەر
    cs: počítačový program
    cv: Компьютер программи
    cy: rhaglen gyfrifiadurol
    da: computerprogram
    dag: Computer program
    de: Computerprogramm
    ...
    ht: program enfòmatik
    hu: számítógépes program
    hy: Համակարգչային ծրագիր
    ia: programma de computator
    id: Program komputer
    ...
    lb: Computerprogramm
    lo: ໂປແກມ ຄອມພິວເຕີ
    lt: kompiuterinė programa
    lv: datorprogramma
    lzh: 電腦程式
    mag: क्रमादेश
    mdf: Компьютеронь программась
    mg: Fandaharana
    mhr: программе
    mk: сметачки програм
    ...
    nan-hant: 電腦程式
    nb: dataprogram
    ne: कम्प्युटर प्रोग्राम
    new: प्रोग्राम
    nl: computerprogramma
    nn: dataprogram
    oc: programa informatic
    or: କମ୍ପ୍ୟୁଟର ପ୍ରୋଗ୍ରାମ
    pdc: Computer-Programm
    ...
    smn: tiätturohjelm
    sms: teâttmašinaprogramm
    sq: program kompjuterik
    sr: рачунарски програм
    sv: datorprogram
    sw: Programu ya kompyuta
    ta: செய்நிரல்
    te: కంప్యూటర్ ప్రోగ్రామ్
    tg: барномаи роёнаӣ
    ...
    vec: programa informàtego
    vep: kompjuterprogramm
...
#is_/same_as :: [[../../../WikiData/WD~Computer_program,40056|WD~Computer_program,40056]] 
