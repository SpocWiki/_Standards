...
- sistema operativo
- sistema operativu
- Sistema ouperacional
- Sistema ti panangpaandar
- Sistema uperatif
- sisteme operatîf
- Sistemi operativ
- sistemo operatif
...
- Операционнӧй система
- операциялык тутум
- Операциялыыр система
- Операциялық жүйелер
- операчна сістема
- Системаи амалӣ
- Үйлдлийн систем
...
dv_has_:
  name_:
    ...
    ang: weorcendebyrdness
    ar: نظام تشغيل
    ary: سيستيم د التخدام
    arz: نظام تشغيل
    as: অপাৰেটিং চিষ্টেম
    ...
    bxr: Үйлэдэлэй системэ
    ca: sistema operatiu
    cdo: Chŏ̤-cáuk hiê-tūng
    ce: операционни система
    ckb: سیستمی بەکارخەری
    co: sistema operativu
    crh: operatsiya sisteması
    cs: operační systém
    ...
    fy: bestjoeringssysteem
    ga: córas oibriúcháin
    gl: sistema operativo
    glk: سیستم عامیل
    gn: apopyvusu oku'éva
    gsw: Betriebssystem
    hak: Chok-ngia̍p hì-thúng
    he: מערכת הפעלה
    hi: संचालन प्रणाली
    hif: operating system
    ...
    kaa: operacion sistema
    kab: Anagraw n wammud
    ...
    kv: Операционнӧй система
    ky: операциялык тутум
    la: Systema administrativum computatrale
    lb: Betribssystem
    lbe: операционная система
    lfn: Sistem de opera
    lij: Scistema òperativo
    ...
    sc: Sistema operativu
    sco: operatin seestem
    se: operatiivavuogádat
    sg: Système d’exploitation
    sgs: Uoperacėnė sėstema
    sh: Operativni sistem
    shn: ပိူင်သၢင်ႈ ၶွမ်းပျူတႃႇ
    ...
    ur: اشتغالی نظام
    uz: Ishlatuv tizimi
    vec: sistema oparativo
    vi: hệ điều hành
    vro: Opõrats'oonisüstem
    wa: Sistinme d' operance
    war: Sistema operatibo
    wo: Nosteg doxiin
    wuu: 操作系统
    xmf: ოპერაციული სისტემა
    yi: אפערירן סיסטעם
