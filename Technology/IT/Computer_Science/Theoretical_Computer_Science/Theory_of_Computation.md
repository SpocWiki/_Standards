...
> what problems can be solved on a model of computation using an algorithm, 
> how efficiently they can be solved and to what degree (e.g., approximate versus precise solutions).  
> 
