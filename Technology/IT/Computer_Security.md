...
dv_has_:
  name_:
    ...
    ceb: Seguridad sa kompyuter
    ckb: ئاسایشی کۆمپیوتەر
    cs: počítačová bezpečnost
    da: it-sikkerhed
    de: Computersicherheit
    el: Κυβερνοασφάλεια
    en: computer security
    eo: komputila sekureco
    es: seguridad informática
    et: küberturvalisus
    eu: Segurtasun informatiko
    fa: امنیت رایانهای
    fi: kyberturvallisuus
    fr: sécurité des systèmes d'information
    ga: slándáil ríomhaireachta
    gl: seguridade informática
    glk: کامپيۊتري سؤني
    gu: કમ્પ્યુટર સુરક્ષા
    ha: Cyber security
    he: אבטחת מחשב אישי ברשת
    hi: कंप्यूटर सुरक्षा
    hr: Računalna sigurnost
    hu: számítógép-biztonság
    hy: համակարգչային անվտանգություն
    id: Keamanan komputer
    is: Tölvuöryggi
    it: sicurezza informatica
    ja: コンピューター・セキュリティ
    ka: კიბერუსაფრთხოება
    kaa: Kompyuter qáwipsizligi
    kk: Компьютерлік қауіпсіздік
    ko: 컴퓨터 보안
    ky: Копмүтердик коопсуздук
    lmo: Sicurezza informatega
    lv: datordrošība
    min: Kaâmanan komputer
    mk: сметачка безбедност
    ml: കമ്പ്യൂട്ടർ സുരക്ഷ
    mn: Кибер аюулгүй байдал/Cybersecurity/
    mr: संगणक सुरक्षा
    ms: Keselamatan komputer
    nan: Tiān-náu an-choân
    nb: datasikkerhet
    ne: कम्प्युटर सुरक्षा
    ...
    sl: računalniška varnost
    sq: Computer security
    sr: рачунарска безбједност
    sv: datasäkerhet
    sw: Usalama wa mtandao
    syl: ꠇꠝ꠆ꠙꠥꠐꠣꠞ ꠍꠤꠇꠥꠞꠤꠐꠤ
    te: కంప్యూటర్ భద్రత
    tg: Амнияти роёна
    th: ความมั่นคงคอมพิวเตอร์
    tr: bilgisayar güvenliği
    uk: комп'ютерна безпека
    ur: کمپیوٹر سیکیوریٹی
    uz: Kompyuter xavfsizligi
    vec: seguresa informàtega
    vi: bảo mật máy tính
    wuu: 计算机安全
    yue: 電腦保安
    zh: 计算机安全
