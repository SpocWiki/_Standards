...
dv_has_:
  name_:
    ...
    hu: monitor
    hy: Մոնիտոր
    ia: Monitor de computator
    id: monitor komputer
    is: tölvuskjár
    it: schermo di computer
    ja: ディスプレイ
    jv: Monitor
    ka: მონიტორი
    kaa: kompyuter monitorı
    kk: монитор
    km: ម៉ូនីទ័រកុំព្យូទ័រ
    ko: 컴퓨터 모니터
    ku: dîmender
    kv: Монитор
    ky: дисплей
    la: monitorium
    lb: Computerbildschierm
    lmo: Monitor
    ln: emɔ́nisi
    lo: ໜ້າຈໍ
    lt: Monitorius
    ...
    ms: alat awas komputer
    nan: Tiān-náu êng-bō͘
    nb: dataskjerm
    nds: Bildschirm
    ne: कम्प्युटर मनिटर
    new: मोनिटर
    nia: bolosaga komputer
    nl: computerbeeldscherm
    nn: dataskjerm
    or: କମ୍ପ୍ୟୁଟର ମନିଟର
    pa: ਕੰਪਿਊਟਰ ਮਾਨੀਟਰ
    ...
    ro: Monitor
    ru: монитор
    sat: ᱠᱚᱢᱯᱭᱩᱴᱚᱨ ᱢᱚᱱᱤᱴᱚᱨ
    sc: Schermu de elaboradori
    sco: computer monitor
    se: šearbma
    sg: Écran
    sh: Monitor
    si: පරිගණක මොනිටරය
