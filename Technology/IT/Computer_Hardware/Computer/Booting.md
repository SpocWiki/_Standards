...
has_part_s_:
- '[[_Standards/WikiData/WD~power_on_self_test,277541|WD~power_on_self_test,277541]]'
uses:
- '[[_Standards/WikiData/WD~bootloader,836795|WD~bootloader,836795]]'
- '[[_Standards/WikiData/WD~computer_firmware,102676349|WD~computer_firmware,102676349]]'
subclass_of:
- '[[_Standards/WikiData/WD~bootstrapping,1195936|WD~bootstrapping,1195936]]'
...
- '[[_Standards/WikiData/WD~starting_up,125517441|WD~starting_up,125517441]]'
Stack_Exchange_tag:
...
dv_has_:
  name_:
    ...
    tl: Pagbu-boot
    tr: Önyükleme
    uk: завантаження операційної системи
