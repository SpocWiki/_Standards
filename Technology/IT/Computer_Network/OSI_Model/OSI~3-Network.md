...
- लेयर 3
- નેટવર્ક સ્તર
- ජාලකරණයේ ක්රම - පුළුල් ප්රදේශ ජාලය
- ネットワーク層
- 網絡層
- 網路層
- 网络层
- 네트워크 계층
has_id_wikidata: Q208074
part_of: '[[_Standards/WikiData/WD~OSI_model,93312|WD~OSI_model,93312]]'
follows: '[[_Standards/WikiData/WD~data_link_layer,194134|WD~data_link_layer,194134]]'
followed_by: '[[_Standards/WikiData/WD~transport_layer,209372|WD~transport_layer,209372]]'
partially_coincident_with: '[[_Standards/WikiData/WD~Internet_layer,2910948|WD~Internet_layer,2910948]]'
...
official_website: https://www.iso.org/ics/35.100.30.html
image: http://commons.wikimedia.org/wiki/Special:FilePath/Comparaison%20des%20mod%C3%A8les%20OSI%20et%20TCP%20IP.png
Stack_Exchange_tag: https://networkengineering.stackexchange.com/tags/layer3
Commons_category: Network layer
described_at_URL:
- https://www.ibm.com/docs/en/zos-basic-skills?topic=terminology-network-layers
...
dv_has_:
  name_:
    ar: طبقة الشبكة
    az: Şəbəkə səviyyəsi
    be: Пратаколы сеціўнага ўзроўню
    bg: Мрежов слой
    bs: mrežni sloj
    ca: capa de xarxa
    cs: síťová vrstva
    ...
    gl: Capa de rede
    gu: નેટવર્ક સ્તર
    he: שכבת הרשת של מודל ה-OSI
    hi: लेयर 3
    hu: hálózati réteg
    id: lapisan jaringan
    it: livello di rete
    ja: ネットワーク層
    kk: Интернет желісінің хаттамасы
    ko: 네트워크 계층
    lmo: Nivell de red
    lv: tīkla slānis
    mn: network layer
    ms: lapisan rangkaian
    nb: nettverkslaget
    nl: netwerklaag
    nn: nettverkslaget
    pl: warstwa sieciowa
