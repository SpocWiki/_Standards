...
dv_has_:
  name_:
    ...
    fr: couche présentation
    gu: પ્રસ્તુતિ સ્તર
    he: שכבת הייצוג של מודל ה-OSI
    hu: megjelenítési réteg
    ...
    lv: pasniegšanas slānis
    mk: Презентациски слој OSI
    ms: lapisan persembahan
    nb: presentasjonslaget
    nl: presentatielaag
