...
dv_has_:
  name_:
    ...
    gl: TCP
    gu: પ્રસારણ નિયંત્રણ શિષ્ટાચાર
    he: TCP
    hi: ट्रांसमिशन कंट्रोल प्रोटोकॉल
    hr: TCP
    hu: Transmission Control Protocol
    hy: TCP
    id: Protokol Kendali Transmisi
    is: TCP
    ...
    lmo: Transmission Control Protocol
    lt: TCP
    lv: TCP
    mk: TCP
    ml: ട്രാൻസ്മിഷൻ കൺട്രോൾ പ്രോട്ടോകോൾ.
    mn: Transmission Control Protocol
    ms: Protokol Kawalan Penghantaran
    nan: Transmission Control Protocol
    nb: Transmission Control Protocol
    nl: Transmission Control Protocol
    nn: Transmission Control Protocol
    oc: Transmission Contraròtle Protocòl
    pa: ਟਰਾਂਸਮਿਸ਼ਨ ਕੰਟਰੋਲ ਪ੍ਰੋਟੋਕੋਲ
...
- TCP
- TCP protokolu
- Transmission Contraròtle Protocòl
...
> 
> It originated in the initial network implementation 
...
>
> TCP is connection-oriented, meaning that sender and receiver 
> firstly need to establish a connection based on agreed parameters; 
> they do this through a three-way handshake procedure. 
> 
> The server must be listening (passive open) for connection requests from clients 
> before a connection is established. 
> 
> Three-way handshake (active open), retransmission, 
...
> may use the User Datagram Protocol (UDP) instead, 
