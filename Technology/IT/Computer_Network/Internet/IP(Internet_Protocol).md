...
- چەپکە پرۆتۆکۆڵی ئینتەرنێت
- इंटरनेट प्रोटोकाल सूट
- इंटरनेट प्रोटोकॉल सुइट
- इन्टरनेट प्रोटोकल समूह
...
dv_has_:
  name_:
    ...
    et: Internetiprotokollistik
    eu: TCP/IP eredu
    fa: مجموعه پروتکل اینترنت
    fi: TCP/IP
    ...
    he: TCP/IP
    hi: इंटरनेट प्रोटोकॉल सुइट
    hr: TCP/IP
    hu: TCP/IP
    hy: TCP/IP
    ia: Suite de protocollo Internet
    id: suit protokol internet
    is: TCP/IP
    it: suite di protocolli Internet
    ja: インターネット・プロトコル・スイート
    ka: TCP/IP
    kk: Интернет желісінің хаттамасы
    ko: 인터넷 프로토콜 스위트
    ku: TCP/IP
    ky: ПРОТОКОЛ TCP/IP
    lb: TCP/IP-Protokollstapel
    lt: TCP/IP
    lv: TCP/IP
    mhr: TCP/IP
    mk: TCP/IP
    ...
    mn: TCP/IP
    ms: Suit protokol Internet
    nb: TCP/IP
    ne: इन्टरनेट प्रोटोकल समूह
    nl: TCP/IP
    nn: Internett-protokollfamilien
    pl: model TCP/IP
    pms: Suite ëd protocòj Internet
    pt: TCP/IP
    ro: TCP/IP
    ru: TCP/IP
    sh: TCP/IP
