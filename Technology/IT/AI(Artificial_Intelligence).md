...
- Intelihensiya artipisyal
- intelixencia artificial
- Intellegentia artificialis
- Intelligence artificiel
- intelligence artificielle
- intelligensa artifiçiale
...
- Kacerdhasan gawéyan
- Kapchisqa yachay
- Kategoryjo:Sztuczno inteligencyjo
- kecerdasan buatan
- keunstklookte
...
- Künstlike Intelligenz
- mesterséges intelligencia
- mākslīgais intelekts
- naouegezh artifisiel
- ntilliggenza artificiali
- Nunyɛn gbɛtɔ ɖɔhun tɔn
- parbo a saririt
- Pemintar tiru
- rutni menli
- Suniy zekâ
...
dv_has_:
  name_:
    ...
    ext: Enteligencia artificial
    fa: هوش مصنوعی
    fi: tekoäly
    fo: vitlíki
    fon: Nunyɛn gbɛtɔ ɖɔhun tɔn
    fr: intelligence artificielle
    frr: Konstelk inteligens
    fur: Inteligjence artificiâl
    ga: intleacht shaorga
    gan: 人工智能
    gcr: Entélijans artifisyèl
    gd: Tuigse inntealta
    gl: intelixencia artificial
    gn: Ava japopyre arandu
    gom: कृत्रिम बुध्दी
    gsw: Künstliche Intelligenz
    gv: Far-inçhynaght
    ha: Kirkirar Basira (Artificial Intelligence)
    he: בינה מלאכותית
    hi: कृत्रिम बुद्धिमत्ता
    hif: artificial intelligence
    hr: umjetna inteligencija
    ht: Entèlijans atifisyèl
    hu: mesterséges intelligencia
    hy: արհեստական բանականություն
    hyw: Արհեստական Բանականութիւն
    ia: Intelligentia artificial
    iba: Pemintar tiru
    id: kecerdasan buatan
    ie: Inteligentie artificial
    ig: Ọgụgụ isi
    ilo: parbo a saririt
    ...
    ja: 人工知能
    jam: Aatifishal intelijens
    jbo: rutni menli
    jv: Kacerdhasan gawéyan
    ka: ხელოვნური ინტელექტი
    kaa: jasalma intellekt
    ki: Ũũgĩ wa Kanyonde
    ...
    lfn: inteleto artifis
    li: Kónsmaesige intelligentie
    lij: intelligensa artifiçiale
    lmo: Intelligenza artificiala
    lo: ປັນຍາປະດິດ
    lt: dirbtinis intelektas
    lv: mākslīgais intelekts
    lzh: 人工智能
    mad: Kecerdasan buatan
    mg: Haranita-tsaina voatrolombelona
    min: Kecerdasan buatan
    ...
    nso: Bohlale bja Maitirelo
    oc: Intelligéncia artificiala
    or: କୃତ୍ରିମ ବୁଦ୍ଧିମତ୍ତା
    pa: ਬਣਾਉਟੀ ਮਸ਼ੀਨੀ ਬੁੱਧੀ
    pcd: Intérligince artificielle
    pl: sztuczna inteligencja
    pms: Inteligensa Artifissial
    pnb: بنائی گئی ذہانت
    ps: مصنوعي ځيرکتیا
    ...
    rue: Умела інтеліґенція
    sa: कृत्रिमबुद्धिमत्ता
    sah: Оҥоһуу интеллект
    sat: ᱵᱮᱱᱟᱣᱟᱜ ᱜᱮᱭᱟᱱ
    scn: ntilliggenza artificiali
    sco: airtifeecial intelligence
    sd: ھٿرادو ذھانت
    se: dahkujierbmi
    sg: Artificial intelligence
    sgs: Dėrbtėns intelekts
    ...
    sw: Akili bandia
    syl: ꠀꠉ꠆ꠟꠣ ꠀꠇꠟꠖꠣꠞ
    szl: Kategoryjo:Sztuczno inteligencyjo
    ...
    vi: trí tuệ nhân tạo
    vro: Kunstmõistus
    wa: Sûtisté éndjolike
    war: Artipisyal nga intelihensya
    wuu: 人工智能
    xmf: ხელუანური ინტელექტი
