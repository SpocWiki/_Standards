...
- rekenaarnetwerk
- ret informatica
- rete de computatores
- rete di computer
- rete informàtega
- reticulum computatrale
...
connects_with:
- '[[_Standards/WikiData/WD~network_host,829281|WD~network_host,829281]]'
subclass_of:
...
different_from:
- '[[_Standards/WikiData/WD~distributed_system,3962217|WD~distributed_system,3962217]]'
has_part_s_:
- '[[_Standards/WikiData/WD~heterogeneous_network,5747224|WD~heterogeneous_network,5747224]]'
has_use:
- '[[_Standards/WikiData/WD~upload,7126699|WD~upload,7126699]]'
- '[[_Standards/WikiData/WD~download,7126717|WD~download,7126717]]'
depicted_by: '[[_Standards/WikiData/WD~spatial_network,7574076|WD~spatial_network,7574076]]'
studied_by:
- '[[_Standards/WikiData/WD~computer_networking,10336440|WD~computer_networking,10336440]]'
said_to_be_the_same_as: '[[_Standards/WikiData/WD~Network,12828494|WD~Network,12828494]]'
IAB_code: 600
subreddit:
- networking
image:
...
dv_has_:
  name_:
    ...
    br: rouedad stlennegel
    bs: računarska mreža
    ca: xarxa informàtica
    ckb: تۆڕی کۆمپیوتەری
    cs: počítačová síť
    cy: rhwydwaith cyfrifiadurol
    da: datanet
    de: Rechnernetz
    diq: gırey xetan
    el: δίκτυο υπολογιστών
    en: computer network
    eo: komputila reto
    es: red de computadoras
    et: arvutivõrk
    eu: konputagailu-sare
    fa: شبکه رایانهای
    fi: tietokoneverkko
    fr: réseau informatique
    ga: líonra ríomhaireachta
    gl: rede de computadores
    glk: کامپيۊتري شبکه
    gu: કમ્પ્યુટર નેટવર્ક
    guc: kusu
    he: רשת מחשבים
    hi: संगणक नेटवर्क
    hr: računalna mreža
    hu: számítógép-hálózat
    hy: Համակարգչային ցանցեր
    ...
    ja: コンピューター・ネットワーク
    ka: გამოთვლითი ქსელი
    kaa: Kompyuter tarmaǵı
    kk: компьютерлік желі
    kl: computer network
    ko: 컴퓨터 네트워크
    ku: tor
    ky: компьютердик тармак
    la: reticulum computatrale
    lb: Computernetzwierk
    li: Computernètwerk
    lmo: кed di computer
    lt: kompiuterių tinklas
    lv: datortīkls
    mhr: компьютер вапш
    min: jaringan komputer
    mk: сметачка мрежа
    ...
    myv: ловиця сёксть
    nan: tiān-náu bāng-lō͘
    nb: datanett
    nds: Reeknernettwark
    ne: कम्प्युटर नेटवर्क
    nl: computernetwerk
    nn: datanett
    oc: ret informatica
    om: cimdaa kompiyuuteraa
    pa: ਕੰਪਿਊਟਰ ਨੈੱਟਵਰਕ
    pl: sieć komputerowa
    pms: rej ëd computer
    pnb: کمپیوٹر نیٹ ورک
    ...
    sat: ᱠᱚᱢᱯᱤᱭᱩᱴᱟᱨ ᱱᱮᱴᱣᱟᱨᱠ
    sco: computer network
    sh: računalne mreže
    si: පරිගණක ජාල
    sk: počítačová sieť
    sl: računalniško omrežje
    sq: rrjet kompjuterik
    sr: рачунарска мрежа
    sv: datornätverk
    sw: mtandao wa kompyuta
    szy: tingnaw wanglu
    ta: கணினி வலையமைப்பு
    te: కంప్యూటర్ నెట్వర్క్
    tg: шабакаи компютерӣ
    ...
    ur: کمپیوٹر نیٹ ورک
    uz: kompyuter tarmogʻi
    vec: rete informàtega
    vi: mạng máy tính
    wuu: 计算机网络
