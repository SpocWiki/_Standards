...
dv_has_:
  name_:
    ...
    da: luftfartens historie
    de: Geschichte der Luftfahrt
    el: ιστορία της αεροπορίας
    en: history of aviation
    eo: historio de aviado
    es: historia de la aviación
    et: Lennunduse ajalugu
    eu: Hegazkintzaren historia
    fi: ilmailun historia
    fr: histoire de l'aviation
    gl: historia da aviación
    he: היסטוריה של התעופה
    hi: उड्डयन का इतिहास
    hu: a repülés története
    it: storia dell'aviazione
    ja: 飛行機の歴史
    kk: Авиация тарихы
    kn: ವಿಮಾನಯಾನದ ಇತಿಹಾಸ
    ko: 항공의 역사
    lv: aviācijas vēsture
    mk: Историја на воздухопловството
    ms: Sejarah penerbangan
    nl: geschiedenis van de luchtvaart
    ps: د هوايي چلند تاریخچه
    pt: história da aviação
    ro: istoria aviației
    ru: история авиации
    sh: historija avijacije
    sk: dejiny letectva
    sl: zgodovina letalstva
    sq: Historia e aviacionit
    sr: Istorija avijacije
    th: ประวัติศาสตร์การเดินอากาศ
    tr: Havacılık tarihi
    uk: історія розвитку авіації
    uz: Aviatsiya tarixi
    vec: istòria de l'aviasion
