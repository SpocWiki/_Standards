...
- Enjin jet
- Esoreattore
- Gāzes strūklas dzinējs
- Havo-reaktiv dvigatel
- Isilumbamdiki somtshazo
- jet engine
- jet ingine
- Jet injin
- Jet motoru
...
dv_has_:
  name_:
    ...
    ko: 제트 엔진
    ku: Motora jet
    la: Machina pyraulocinetica
    li: Sjtraolmotor
    lt: reaktyvinis variklis
    ...
    th: เครื่องยนต์ไอพ่น
    tr: Jet motoru
    uk: реактивний двигун
    ur: نفاثہ محرکیہ
    uz: Havo-reaktiv dvigatel
    vi: Động cơ phản lực không khí
    war: Jet engine
    wuu: 喷气发动机
    yue: 噴射引擎
    zh: 喷气发动机
...
#is_/same_as :: [[_Standards/WikiData/WD~Jet_engine,178777|WD~Jet_engine,178777]] 
