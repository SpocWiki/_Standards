...
- technologia informationaria
- technologie de l'information
- Tecnolochías d'a Información y a Comunicación
...
- Информациятне технологиятне
- Маалыматтар техноложиси
...
dv_has_:
  name_:
    ...
    ar: تقانة المعلومات
    ary: طيكنولوجيا د لمعلومات
    arz: تكنولوجيا المعلومات
    as: তথ্য প্ৰযুক্তি
    ast: teunoloxíes de la información y la comunicación
    az: informasiya texnologiyaları
    ...
    ca: tecnologia de la informació
    ckb: تەکنۆلۆژیای زانیاری
    crh: Malümat tehnologiyası
    ...
    et: infotehnoloogia
    eu: Informazio teknologia
    fa: فناوری اطلاعات
    fi: informaatioteknologia
    fr: technologie de l'information
    ga: teicneolaíocht faisnéise
    gan: IT
    gcr: Teknoloji di enformasyon é di kominikasyon
    gl: tecnoloxías da información
    glk: اطلاعاتˇ تکنؤلؤژي
    gsw: Informationstechnik
    gu: ઇન્ફર્મેશન ટેક્નૉલોજિ
    gv: Çhaghnoaylleeaght-fysseree
    ha: Fasahar bayanai
    he: טכנולוגיית מידע
    hi: सूचना प्रौद्योगिकी
    hif: Information Technology
    hr: Informatička tehnologija
    hu: információs technológia
    hy: տեղեկատվական տեխնոլոգիա
    id: teknologi informasi
    inh: хоамий технологеш
    io: Informatikala teknologio
    is: Upplýsingatækni
    it: tecnologia dell'informazione
    ja: 情報技術
    jam: Infamieshan teknalaji
    jv: Tèknologi informasi
    ka: საინფორმაციო ტექნოლოგია
    kaa: Informaciyalıq texnologiya
    kk: Ақпараттық технология
    km: ព័ត៌មានវិទ្យា
    kn: ಮಾಹಿತಿ ತಂತ್ರಜ್ಞಾನ
    ko: 정보기술
    ky: Маалыматтар техноложиси
    la: technologia informationaria
    lfn: infotecnolojia
    li: Informatietechnologie
    lo: ເຕັກໂນໂລຊີຂໍ້ມູນຂ່າວສານ
    lt: informacinės technologijos
    lv: informācijas tehnoloģijas
    mai: सूचना प्रविधि
    mdf: Информациятне технологиятне
    mhr: Увераҥар технологий
    mi: Hangarau mōhiohio
    min: Teknologi informasi
    mk: информатичка технологија
    ...
    nds: Informatschoonstechnik
    ne: सूचना प्रविधि
    new: सूचना प्रविधि
    nl: informatietechnologie
    nn: informasjonsteknologi
    oc: Tecnologias de l'informacion
    olo: Tiedotehniekku
    or: ସୂଚନା ପ୍ରଦ୍ୟୋଗିକି
    os: информацион технологитæ
    pa: ਸੰਚਾਰ ਤਕਨੀਕੀ
    pl: technologia informacyjna
    pms: Tecnologìa dl'anformassion
    ...
    sco: information technology
    sd: انفارميشن ٽيڪنالوجي
    se: diehtoteknihkka
    sh: Informaciona tehnologija
    si: තොරතුරු තාක්ෂණය
    sk: Informačná technológia
    sl: informacijska tehnologija
    sma: bïevneseteknologije
    smj: diehtoteknologija
    smn: tiätutekniik
    sms: teâtt-teknikk
    ...
    tt: мәгълүмат технологияләре
    udm: иворлыко технологиос
    uk: інформаційні технології
    ur: اطلاعاتی طرزیات
    uz: Axborot texnologiyalari
    vec: tecnołozie de l'informasion
    vi: công nghệ thông tin
    war: Impormasyon Teknolohiya
    wo: Xaralay xibaar ak jokkoo
    wuu: 信息技术
