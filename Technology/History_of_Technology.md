...
dv_has_:
  name_:
    af: geskiedenis van tegnologie
    ar: تاريخ التقانة
    as: প্ৰযুক্তিৰ ইতিহাস
    ...
    cs: dějiny techniky
    da: teknologihistorie
    de: Technikgeschichte
    el: ιστορία της τεχνολογίας
    en: history of technology
    eo: historio de teĥniko
    es: historia de la tecnología
    eu: Teknologiaren historia
    fa: تاریخ فناوری
    fi: tekniikan historia
    fr: histoire des techniques
    ga: stair na teicneolaíochta
    gan: 技術嗰歷史
    gan-hans: 技术嗰历史
    gan-hant: 技術嗰歷史
    gcr: Istwè dé tèknik
    gl: historia da tecnoloxía
    gsw: Gschicht vo der Technik
    he: היסטוריה של הטכנולוגיה
    hi: प्रौद्योगिकी का इतिहास
    hr: povijest tehnologije
    hu: technikatörténet
    hy: տեխնոլոգիայի պատմություն
    ia: Historia del technologia
    id: sejarah teknologi
    is: Tæknisaga
    it: storia della tecnologia
    ja: テクノロジー史
    jam: Ischri a teknalaji
    ko: 기술의 역사
    lv: tehnoloģijas vēsture
    ml: സാങ്കേതികവിദ്യാചരിത്രം
    nb: teknologihistorie
    nl: geschiedenis van de technologie
    nn: teknologihistorie
    pl: historia techniki
    ps: د تېکنالوژۍ تاریخچه
    pt: história da tecnologia
    ro: istoria tehnologiei
    ru: история технологии
    se: teknologiija historjá
    sh: Historija tehnologije
    sk: dejiny techniky
    sl: zgodovina tehnike
    smn: teknologia historjá
    sms: teknologia historia
    sr: Istorija tehnologije
    sv: teknikhistoria
    sw: Historia ya teknolojia
    ta: தொழில்நுட்ப வரலாறு
    th: ประวัติศาสตร์เทคโนโลยี
    tl: Kasaysayan ng teknolohiya
    tr: Teknoloji tarihi
    uk: історія технологій
    uz: Texnologiyalar tarixi
    vi: lịch sử công nghệ
