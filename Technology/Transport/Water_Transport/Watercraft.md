...
exact_match: http://purl.obolibrary.org/obo/ENVO_01000613
EntitySchema_for_this_class: E151
GS1_GPC_code: 10001887
Colon_Classification: MD525
Commons_gallery: Watercraft
Commons_category: Watercraft
dv_has_:
  name_:
    af: watervaartuig
    ar: مركبة مائية
    ast: embarcación
    be-tarask: плывучы сродак
    bg: Плавателен съд
    bn: নৌযান
    ca: embarcació
    ckb: ئامێری ئاوی
    ...
    lb: Waassergefier
    lfn: Veculo acual
    lt: Vandens transporto priemonė
    mg: Barca
    mk: пловило
    mnc: ᠵᠠᡥᡡᡩᠠᡳ
    my: ရေယာဉ်
    ...
    sr-el: plovilo
    sv: vattenfarkost
    sw: Chombo cha usafiri kwenye maji
    ta: நீரூர்தி
    th: พาหนะทางน้ำ
    tr: Su taşıtı
    uk: плавний засіб
...
> A **Watercraft** or waterborne vessel is any vehicle designed 
