...
- røyrlegging
- sıhhi tesisat
- Tehnica instalației de apă
- vodoinštalaterstvo
- víz-gáz szerelés
- вадаправодная сыстэма
- водаправодная сістэма
- водоводне инсталације
- водопровід та водовідведення
...
dv_has_:
  name_:
    ar: سباكة
    as: অসমীয়া ৱিকিপিডিয়া
    ast: Fontanería
    be: водаправодная сістэма
    be-tarask: вадаправодная сыстэма
    bg: Тръбни инсталации
    ca: lampisteria
    cs: instalatérství
    en: plumbing
    es: fontanería
    ...
    nn: røyrlegging
    pt: Encanamento
    ro: Tehnica instalației de apă
    ru: водопроводная система
    sl: vodoinštalaterstvo
    sr: водоводне инсталације
    ta: குழாய்வேலை
    te: ప్లంబింగ్
    tl: Pagtutubero
    tr: sıhhi tesisat
    uk: водопровід та водовідведення
