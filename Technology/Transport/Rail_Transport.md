...
- rautatieliikenne
- rela transporto
- ruovdegeaidnojohtolat
- rêyahesinî ya veguhastinê
- Schienenverkehr
- Schinevercheer
- Schinnentransport
- spoorwegvervoer
...
history_of_topic: '[[/_Standards/WikiData/WD~history_of_rail_transport,477862|WD~history_of_rail_transport,477862]]'
described_by_source:
...
has_characteristic:
- '[[/_Standards/WikiData/WD~train_noise,1414021|WD~train_noise,1414021]]'
- '[[/_Standards/WikiData/WD~train_and_rail_category,16858238|WD~train_and_rail_category,16858238]]'
practiced_by: '[[/_Standards/WikiData/WD~station_master,2962020|WD~station_master,2962020]]'
Wikimedia_outline: '[[/_Standards/WikiData/WD~outline_of_rail_transport,7112713|WD~outline_of_rail_transport,7112713]]'
topic_has_template: '[[/_Standards/WikiData/WD~Q20692110,20692110|WD~Q20692110,20692110]]'
industry: '[[/_Standards/WikiData/WD~rail_transport_industry,136688018|WD~rail_transport_industry,136688018]]'
part_of:
- '[[/_Standards/WikiData/WD~rail_transport_industry,136688018|WD~rail_transport_industry,136688018]]'
...
dv_has_:
  name_:
    ...
    arz: سكه حديد
    ast: ferrocarril
    az: dəmiryol nəqliyyatı
    ba: тимер юл транспорты
    be: чыгуначны транспарт
    be-tarask: чыгуначны транспарт
    bg: железопътен транспорт
    bho: रेल परिवहन
    bn: রেল পরিবহন
    ca: transport ferroviari
    ckb: گواستنەوەی ئاسنین
    cs: železniční doprava
    cy: cludiant (rheilffordd)
    da: jernbanetransport
    de: Schienenverkehr
    el: σιδηροδρομικό δίκτυο
    en: rail transport
    en-gb: rail transport
    eo: rela transporto
    es: transporte ferroviario
    et: raudteetransport
    eu: trenbideko garraio
    fa: ترابری ریلی
    fi: rautatieliikenne
    ...
    hy: Երկաթուղի
    id: transportasi rel
    io: fervoyala transportado
    is: lestarsamgöngur
    it: trasporto ferroviario
    ja: 鉄道輸送
    ka: რკინიგზის ტრანსპორტი
    kaa: temir jol kóligi
    kk: темір жол көлігі
    kn: ರೈಲುಸಾರಿಗೆ
    ko: 철도운송
    ku: rêyahesinî ya veguhastinê
    ky: темир жол
    lb: Schinnentransport
    lt: geležinkelių transportas
    lv: dzelzceļa transports
    mhr: кÿртньыгорно транспорт
    ...
    ms: pengangkutan rel
    nan: thih-lō͘ ūn-su
    nb: jernbanetransport
    ne: रेल यातायात
    new: रेल लं
    nl: spoorwegvervoer
    pa: ਰੇਲ ਟ੍ਰਾਂਸਪੋਰਟ
    pl: transport kolejowy
    pms: Traspòrt feroviari
    pnb: ریل آوا جائی
    ps: د ریل ګاډي ټرانسپورټ
    pt: transporte ferroviário
    ro: transport feroviar
    ru: железнодорожный транспорт
    sah: тимир суол транспорта
    scn: trasportu firruviariu
    sco: rail transport
    sd: ريل ٽرانسپورٽ
    se: ruovdegeaidnojohtolat
    sh: željeznički saobraćaj
    sk: železničná doprava
    sl: železniški promet
    sq: transporti hekurudhor
    sr: железнички превоз
    sr-el: željeznički saobraćaj
    sv: järnvägstransport
    ta: தொடர்வண்டிப் போக்குவரத்து
    tcy: ರೈಲ್
    th: การขนส่งระบบราง
    tl: biyaheng daambakal
    tr: demiryolu ulaşımı
    tt: тимер юл транспорты
    tyv: демир-орук
    uk: залізничний транспорт
    ur: پٹری نقل و حمل
    uz: temir yoʻl transporti
    vi: giao thông đường sắt
    wuu: 铁路运输
    xmf: რკინაშარაშ ტრანსპორტი
    yi: באן טראנספארט
    yue: 鐵路
    zh: 鐵路運輸
    zh-cn: 铁路运输
