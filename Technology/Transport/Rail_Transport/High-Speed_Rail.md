...
- Greitasis traukinys
- heich-speed rail
- Hekurudha me shpejtësi të lartë
- high-speed rail
- hitra železnica
- Hochgeschwindigkeitsverkehr
- hogesnelheidstreinverkeer
- hoëspoed-spoor
- Háhraðalest
...
- Yuqori tezlikdagi temir yoʻl
- Yüksek hızlı demiryolu
- ātrvilcienu dzelzceļš
- Đường sắt cao tốc
...
dv_has_:
  name_:
    af: hoëspoed-spoor
    ang: Hēahflyhtetrǣg
    ar: سكك حديد فائقة السرعة
    arz: السكه الحديد فايقة السرعه
    az: Sürət Qatarı
    be-tarask: хуткасная чыгунка
    bg: високоскоростен железопътен транспорт
    bjn: Karita bakahancapan tinggi
    bn: উচ্চ-গতির রেল
    bs: Voz velike brzine
    ca: alta velocitat ferroviària
    cs: vysokorychlostní trať
    da: højhastighedstog
    de: Hochgeschwindigkeitsverkehr
    de-ch: Hochgeschwindigkeitsverkehr
    el: σιδηρόδρομος υψηλής ταχύτητας
    en: high-speed rail
    en-ca: high-speed rail
    en-gb: high-speed rail
    eo: altrapida fervojo
    es: alta velocidad ferroviaria
    eu: Abiadura handiko tren
    fa: قطار سریعالسیر
    fi: Suurnopeusjuna
    fr: grande vitesse ferroviaire
    hak: Kô-suk thiet-lu
    he: רכבת מהירה
    hi: तीव्र गति रेल
    hr: Vlak velikih brzina
    hu: nagysebességű vasút
    id: kereta kecepatan tinggi
    is: Háhraðalest
    it: alta velocità ferroviaria
    ja: 高速鉄道
    kn: ಅತಿವೇಗ ರೈಲು
    ko: 고속철도
    ku: Trêna lezgîn
    ku-arab: ترێنا لەزگین
    ku-latn: Trêna lezgîn
    kw: Tren Tooth Bras
    lad: Treno de alto prestor
    lmo: Alta velocità ferroviaria
    lt: Greitasis traukinys
    lv: ātrvilcienu dzelzceļš
    lzh: 高速鐵道
    mk: брза железница
    ml: അതിവേഗതീവണ്ടികൾ
    mr: द्रुतगती रेल्वे
    nan: Ko-sok thih-lō͘
    nb: høyhastighetsbane
    ne: उच्च गति रेल
    nl: hogesnelheidstreinverkeer
    nn: høgfartstog
    pl: kolej dużych prędkości
    pms: Treno a àuta velocità
    pt: alta velocidade ferroviária
    ro: cale ferată de mare viteză
    ru: скоростная железная дорога
    sah: Сыыдам суксурҕа
    sco: heich-speed rail
    sk: vysokorýchlostná železnica
    sl: hitra železnica
    sq: Hekurudha me shpejtësi të lartë
    sr: воз велике брзине
    sr-ec: воз велике брзине
    sv: höghastighetsjärnväg
    th: รถไฟความเร็วสูง
    tr: Yüksek hızlı demiryolu
    uk: швидкісна залізниця
    uz: Yuqori tezlikdagi temir yoʻl
