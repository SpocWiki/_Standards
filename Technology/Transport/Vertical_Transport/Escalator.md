...
dv_has_:
  name_:
    ...
    et: eskalaator
    eu: eskailera mekaniko
    fa: پله برقی
    fi: liukuportaat
    fr: escalier mécanique
    ga: staighre creasa
    gl: escaleira mecánica
    he: דרגנוע
    hi: चलसोपान
    hr: pokretne stepenice
    hu: mozgólépcső
    hy: շարժասանդուղք
    id: eskalator
    is: rúllustigi
    ...
    pnb: ٹردی پوڑی
    pt: escada rolante
    pt-br: escada rolante
    ro: escalator
    ru: эскалатор
    sah: эскалатор
    se: jorritráhpat
    sh: pokretne stepenice
    si: පේගැටැදිය
    sk: eskalátor
    sl: tekoče stopnice
    smn: rulláporthááh
    so: escalator
    sr: покретне степенице
    sv: rulltrappa
    ta: நகர்படி
    te: కదిలేమట్లు
    th: บันไดเลื่อน
