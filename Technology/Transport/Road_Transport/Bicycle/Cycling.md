...
prerequisite: '[[_Standards/WikiData/WD~motor_coordination,852401|WD~motor_coordination,852401]]'
described_by_source: '[[_Standards/WikiData/WD~Encyclopædia_Britannica_11th_edition,867541|WD~Encyclopædia_Britannica_11th_edition,867541]]'
practiced_by: '[[_Standards/WikiData/WD~cyclist,2125610|WD~cyclist,2125610]]'
different_from: '[[_Standards/WikiData/WD~cycle_sport,2215841|WD~cycle_sport,2215841]]'
history_of_topic: '[[_Standards/WikiData/WD~history_of_cycling,5867718|WD~history_of_cycling,5867718]]'
topic_has_template: '[[_Standards/WikiData/WD~Template_Cycling,7745571|WD~Template_Cycling,7745571]]'
maintained_by_WikiProject: '[[_Standards/WikiData/WD~WikiProject_Cycling,11755824|WD~WikiProject_Cycling,11755824]]'
source_of_energy: '[[_Standards/WikiData/WD~human_energy,20984829|WD~human_energy,20984829]]'
uses: '[[_Standards/WikiData/WD~bicycle,11442|WD~bicycle,11442]]'
IAB_code: 492
...
dv_has_:
  name_:
    ...
    an: Ciclismo
    ang: Hwēolrinnung
    ar: ركوب الدراجات الهوائية
    ast: ciclismu
    az: velosiped idmanı
    be: язда на веласіпедзе
    be-tarask: язда на ровары
    bg: Колоездене
    bjn: Basapida
    bn: সাইকেল চালনা
    br: marc'hhouarnerezh
    bs: Biciklizam
    ca: ciclisme
    cs: cyklistika
    cy: seiclo
    ...
    mt: ċikliżmu
    my: စက်ဘီးစီးခြင်း
    nah: Ōmmalacapayīnaliztli
    nan: kha-ta̍h-chhia ūn-tōng
    nb: sykling
    nl: fietsen
    nn: sykling
    oc: ciclisme
    ...
    sr-el: biciklizam
    sv: cykling
    sw: Mashindano ya baiskeli
    th: การปั่นจักรยาน
    tk: Welosiped bäsleşigi
    tr: bisiklete binme
    ug: ۋېلىسىپىت تەنھەرىكىتى
    uk: їзда на велосипеді
    ur: سائیکلنگ
    vec: ciclismo
    vi: đạp xe
    wa: Ciclisse
