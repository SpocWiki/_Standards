...
- аварыйнае кіраваньне
- гадәттән тыш хәлләр идарәсе
...
- ദുരന്ത നിവാരണം
- ව් යසන කළමනාකරණය
- အရေးပေါ်အခြေအနေ စီမံခန့်ခွဲမှု
- 应急管理
- 災害管理
- 灾害管理
- 防災
- 비상 관리
has_id_wikidata: Q1460420
dv_has_:
  name_:
    ar: إدارة الطوارئ
    ...
    de-at: Katastrophenschutz
    el: διαχείριση κρίσεων
    en: emergency management
    eo: kriza mastrumado
    es: administración de desastres
    fa: مدیریت شرایط اضطراری
    fr: plan d'urgence
    ga: bainistiú éigeandála
    gl: xestión de emerxencias
    gu: આપત્તિ સજ્જતા
    he: ניהול חירום
    hi: आपदा तत्परता
    hr: upravljanje u kriznim situacijama
    hu: katasztrófavédelem
    id: Persiapan bencana
    it: gestione delle emergenze
    ja: 防災
    kn: ವಿಪತ್ತು ಸನ್ನದ್ಧತೆ
    ko: 비상 관리
    ...
    si: ව් යසන කළමනාකරණය
    sl: obvladovanje izrednih razmer
    ta: பேரிடர் மேலாண்மை
    te: విపత్తు సంసిద్ధత
    tr: acil durum yönetimi
    tt: гадәттән тыш хәлләр идарәсе
...
> **Emergency management** (also disaster management or emergency preparedness) 
> is a science and a system charged with creating the framework within which 
> communities reduce vulnerability to hazards and cope with disasters. 
> 
> Emergency management, despite its name, 
> does not actually focus on the management of emergencies; 
> emergencies can be understood as minor events with limited impacts 
