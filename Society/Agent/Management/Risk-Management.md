...
dv_has_:
  name_:
    ...
    da: risikostyring
    de: Risikomanagement
    el: Διαχείριση Κινδύνου
    en: risk management
    eo: administro de risko
    es: gestión de riesgos
    et: Riskijuhtimine
    eu: Arriskuen kudeaketa
    fa: مدیریت ریسک
    fi: riskienhallinta
    fr: gestion du risque
    ga: bainistíocht riosca
    gl: xestión de risco
    he: ניהול סיכונים
    hi: जोखिम प्रबंधन
    hu: kockázatkezelés
    hy: ռիսկերի կառավարում
    id: Manajemen risiko
    is: Áhættustýring
