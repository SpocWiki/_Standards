...
- '[[_Standards/WikiData/WD~maternal_death,1339474|WD~maternal_death,1339474]]'
- '[[_Standards/WikiData/WD~orphanhood,12152973|WD~orphanhood,12152973]]'
- '[[_Standards/WikiData/WD~child_mortality,61559|WD~child_mortality,61559]]'
facet_of:
- '[[_Standards/WikiData/WD~human_trafficking,181784|WD~human_trafficking,181784]]'
...
- '[[_Standards/WikiData/WD~unavailability_of_the_human_body,4936611|WD~unavailability_of_the_human_body,4936611]]'
- "[[_Standards/WikiData/WD~women's_health,8031191|WD~women's_health,8031191]]"
- '[[_Standards/WikiData/WD~availability_of_the_human_body,110360786|WD~availability_of_the_human_body,110360786]]'
subclass_of: '[[_Standards/WikiData/WD~third_party_reproduction,7784739|WD~third_party_reproduction,7784739]]'
has_part_s_:
- '[[_Standards/WikiData/WD~surrogate_mother,16547118|WD~surrogate_mother,16547118]]'
- '[[_Standards/WikiData/WD~assisted_reproductive_technology,25862|WD~assisted_reproductive_technology,25862]]'
...
OmegaWiki_Defined_Meaning: 1237302
image: http://commons.wikimedia.org/wiki/Special:FilePath/Surrogate%20parents%20attending%20birth.jpg
Commons_category: Surrogacy
PhilPapers_topic: surrogate-motherhood
Dewey_Decimal_Classification: 306.8743
dv_has_:
  name_:
    af: surrogaatmoederskap
    ar: تأجير الرحم
    as: ছাৰোগেছি
    az: Surroqat analıq
    ...
    et: surrogaatemadus
    eu: Haurduntza subrogatu
    fa: رحم اجارهای
    fi: sijaissynnytys
    fr: gestation pour autrui
    ga: máthairionadaíocht
    gl: xestación por substitución
    he: פונדקאות
    hi: स्थानापन्न मात्रत्व
    hr: surogatno majčinstvo
    hu: béranyaság
    hy: Սուրոգատ մայրություն
    id: Surogasi
    it: gestazione per altri
    ja: 代理母出産
    ko: 대리모출산
    ku: Ducaniya cîgir
    la: Graviditas surrogata
    lmo: gestazion per alter
    lt: surogatinė motinystė
    lv: surogātisms
    mk: сурогатно мајчинство
    ml: സറഗസി
    ms: Ibu tumpang
    nb: surrogati
    ne: सरोगेसी
    ...
    sk: náhradné materstvo
    sl: nadomestno materinstvo
    sq: Nëna surrogate
    sr: Surogat majčinstvo
...
#is_/same_as :: [[../../../../../../WikiData/WD~Surrogacy,334645|WD~Surrogacy,334645]]  

## #has_/text_of_/abstract 

> **Surrogacy** is an arrangement whereby a woman gets pregnant and gives birth on behalf of 
> another person or couple who will become the child's legal parents after birth. 
> 
> People pursue surrogacy for a variety of reasons such as infertility, 
> dangers or undesirable factors of pregnancy, or when pregnancy is a medical impossibility. 
> Surrogacy is highly controversial and only legal in twelve countries.
>
