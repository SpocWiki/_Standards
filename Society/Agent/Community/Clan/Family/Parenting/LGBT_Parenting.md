...
- Rodzicielstwo LGBT
- sateenkaariperhe
- Status liberorum parentum eiusdem sexus
- аднаполая сям'я
- Истополно родитељство
- ЛГБТ родителство
- ЛГБТ-сям’я
- одностатеві сім'ї
- радужная семья
...
dv_has_:
  name_:
    ...
    eu: LGBT gurasotasun
    fa: فرزندآوری دگرباشان جنسی
    fi: sateenkaariperhe
    fr: Parentalité LGBT
    gl: familia homoparental
    he: הורות הומו-לסבית
    hr: LGBT-ovsko roditeljstvo
    hu: azonos nemű párok gyermekvállalása
    id: Pengasuhan LGBT
    it: omoparentalità
    ja: LGBTの子育て
    ko: 성소수자의 자녀 양육
    ku: Malbatên keskesorê
    la: Status liberorum parentum eiusdem sexus
    ...
    sl: mavrično starševstvo
    smn: arvetävgipeerâ
    sq: Prindërimi LGBT
    sr: Истополно родитељство
    sv: regnbågsfamilj
    tr: LGBT evlat edinme
    uk: одностатеві сім'ї
