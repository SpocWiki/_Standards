...
Dewey_Decimal_Classification: 378
Archive_of_Our_Own_tag: University
Wolfram_Language_entity_type: University
Colon_Classification: T4
OmegaWiki_Defined_Meaning: 355808
IMDb_keyword: university
Iconclass_notation: 49B4
image: http://commons.wikimedia.org/wiki/Special:FilePath/Raffael%20058.jpg
pronunciation_audio: http://commons.wikimedia.org/wiki/Special:FilePath/%CE%A0%CE%B1%CE%BD%CE%B5%CF%80%CE%B9%CF%83%CF%84%CE%AE%CE%BC%CE%B9%CE%BF.ogg
label_in_sign_language: http://commons.wikimedia.org/wiki/Special:FilePath/Csc-universitat-spreadthesign.ogv
icon: http://commons.wikimedia.org/wiki/Special:FilePath/University%20hat%20icon.svg
WordLift_URL: http://data.wordlift.io/wl01714/entity/university.html
equivalent_class:
- http://dbpedia.org/ontology/University
- http://pcp-on-web.de/ontology#University
- http://swrc.ontoware.org/ontology#University
UMLS_CUI: C0041740
MeSH_tree_code:
- I02.783.830
- J03.832.830
IPTC_NewsCode: mediatopic/20000407
GeoNames_feature_code: S.UNIV
Commons_category: Universities and colleges
Baidu_Tieba_name: 大学
OpenStreetMap_tag:
- amenity=university
...
dv_has_:
  name_:
    ...
    lo: ມະຫາວິທະຍາໄລ
    lt: universitetas
    lua: Kalasa ka tufulu tua masanka
    lv: universitāte
    lzh: 大學堂
    mdf: университетсь
    mg: oniversite
...
> A **University** (from Latin  universitas 'a whole') is an institution of tertiary education 
> and research which awards academic degrees in several academic disciplines. 
> 
...
> The University of Bologna (Università di Bologna), Italy, 
> which was founded in 1088, is the first university in the sense of:
...
>   and issuing secular as well as non-secular degrees 
>   (with teaching conducted by both clergy and non-clergy): grammar, rhetoric, logic, theology, canon law and notarial law.
>
