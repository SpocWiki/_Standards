...
- àgbájọ aláìjẹ́-tìèrè
- æнæкоммерцион организации
- òganizasyon san pwofi
- μη κερδοσκοπικός οργανισμός
- ашгийн бус байгууллага
- коммерце йоаца организаци
- коммерциялык эмес уюм
- коммерциялық емес ұйым
- коммерцияға ҡарамаған ойошма
- некамерцыйная арганізацыя
- некамэрцыйная арганізацыя
- некоммерческая организация
- неприбуткова організація
- непрофитна организација
- нон-профит
- организация с нестопанска цел
- пайда басьтӥсьтэм огазеяськон
- табышсыз оешма
- ոչ առեւտրային կազմակերպութիւն
- ոչ առևտրային կազմակերպություն
- מוסד ללא כוונת רווח
- سازمان ناسودبر
- سازمان چي اړین ټکی يې ګټه نده
- غیر منافع بخش تنظیم
- كوممەرتسىييالىق ەمەس ۇيىم
- منظمة غير ربحية
- منظمه غير ربحيه
- مونضامة لاربحية
- ڕێکخراوەی سوودنەخواز
- ڤرتوبوهن بوکن اونتوڠ
- गैह्रनाफामुखी संस्था
- लाभ निरपेक्ष संस्था
- विना-नफा संस्था
- অলাভজনক সংগঠন
- অলাভজনক সংস্থা
...
- '[[_Standards/WikiData/WD~Lebenshilfe_Deutschland,20533|WD~Lebenshilfe_Deutschland,20533]]'
instance_of:
...
different_from:
- '[[_Standards/WikiData/WD~NPO,361647|WD~NPO,361647]]'
- '[[_Standards/WikiData/WD~voluntary_association,48204|WD~voluntary_association,48204]]'
studied_by: '[[_Standards/WikiData/WD~nonprofit_management,975065|WD~nonprofit_management,975065]]'
industry: '[[_Standards/WikiData/WD~voluntary_sector,1063076|WD~voluntary_sector,1063076]]'
opposite_of:
- '[[_Standards/WikiData/WD~for_profit_charity,5466627|WD~for_profit_charity,5466627]]'
- '[[_Standards/WikiData/WD~commercial_organization,21980538|WD~commercial_organization,21980538]]'
topic_has_template: '[[_Standards/WikiData/WD~Template_Infobox_non_profit,5622928|WD~Template_Infobox_non_profit,5622928]]'
...
dv_has_:
  name_:
    af: nie-winsgewende organisasie
    ar: منظمة غير ربحية
    ary: مونضامة لاربحية
    arz: منظمه غير ربحيه
    as: অলাভজনক সংস্থা
    ast: organización ensin ánimu d'arriquecimientu
    ...
    bs: neprofitna organizacija
    ca: organització sense ànim de lucre
    ckb: ڕێکخراوەی سوودنەخواز
    ...
    et: mittetulundusühendus
    eu: irabazteko asmorik gabeko erakunde
    fa: سازمان ناسودبر
    fi: yleishyödyllinen yhteisö
    fr: organisation à but non lucratif
    frr: Nonprofit-iinrachtang
    fy: Non-profit
    ga: eagraíocht neamhbhrabúis
    gl: organización sen ánimo de lucro
    gsw: Non-Profit-Organisation
    hak: fî-yàng-li chû-chṳt
    he: מוסד ללא כוונת רווח
    hi: लाभ निरपेक्ष संस्था
    hr: neprofitna organizacija
    ht: òganizasyon san pwofi
    hu: nonprofit szervezet
    hy: ոչ առևտրային կազմակերպություն
    hyw: ոչ առեւտրային կազմակերպութիւն
    id: organisasi nirlaba
    inh: коммерце йоаца организаци
    io: Ne-profitema organizuro
    ...
    lt: ne pelno organizacija
    lv: bezpeļņas organizācija
    mad: Organisasi nirlaba
    min: organisasi nirlaba
    ...
    nn: ideell organisasjon
    oc: organizacion sens tòca de lucre
    os: æнæкоммерцион организации
    pa: ਗੈਰ-ਲਾਭਕਾਰੀ ਸੰਸਥਾ
    ...
    sah: нон-профит
    sat: ᱵᱮᱼᱞᱟᱵᱷ ᱟᱱᱟᱜ ᱜᱚᱱᱚᱴᱷᱚᱱ
    sco: nan-profit organisation
    sh: neprofitna organizacija
    si: ලාභ නොපතන සංවිධාන
    ...
    te: లాభాపేక్ష రహిత సంస్థ
    th: องค์การไม่แสวงหาผลกำไร
    tl: samahang hindi pangkalakalan
    tr: kâr amacı gütmeyen kuruluş
    tt: табышсыз оешма
    udm: пайда басьтӥсьтэм огазеяськон
    uk: неприбуткова організація
    ur: غیر منافع بخش تنظیم
    uz: notijorat tashkiloti
    vec: organizasion sensa fini de lucro
    vi: tổ chức phi lợi nhuận
    vro: mittetulosaamisütisüs
...
#is_/same_as :: [[_Standards/WikiData/WD~Nonprofit_organization,163740|WD~Nonprofit_organization,163740]] 
