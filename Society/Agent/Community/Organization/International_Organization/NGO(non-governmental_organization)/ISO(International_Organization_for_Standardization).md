...
- Organizzazione 'Ndernazionale pe le Standardizzaziune
...
- Tekorãty Hetatetãgua Hekopegua
- Tổ chức tiêu chuẩn hóa quốc tế
- Umbutho waMazwe ngaMazwe woLungiso
...
- Халкъалдагьоркьосеб роценалъул гӀуцӀцӀи
- Халыкара Стандартлау Оешмасы
- Халықаралық стандарттау мекемесі
- Халыҡ-ара стандартлаштырыу ойошмаһы
...
- د معيار نړيوال تنظيم
- سازمان بینالمللی استانداردسازی
- سانچو:ISO standards
- منظمة ايزو
- ڕێکخراوەی نێونەتەوەییی ستانداردسازی
- अंतरराष्ट्रीय मानकीकरण संगठन
- अंतर्राष्ट्रीय मानकीकरण संस्था
- अन्तर्राष्ट्रिय मानकीकरण सङ्गठन
- आंतरराष्ट्रीय मानकीकरण संघटना
- আন্তর্জাতিক মান সংস্থা
- আন্তৰ্জাতিক মান সংস্থা
- ਅੰਤਰਾਸ਼ਟਰੀ ਮਿਆਰੀਕਰਣ ਸੰਘ
- சீர்தரத்துக்கான அனைத்துலக நிறுவனம்
- ಐಎಸ್ಓ
- ഇന്റർനാഷണൽ ഓർഗനൈസേഷൻ ഫോർ സ്റ്റാൻഡേർഡൈസേഷൻ
- ප්රමිතිකරණය සඳහා වූ අන්තර්ජාතික සංවිධානය
- องค์การระหว่างประเทศว่าด้วยการมาตรฐาน
- အပြည်ပြည်ဆိုင်ရာစံချိန်စံညွှန်းအဖွဲ့
- სტანდარტიზაციაშ საირქიანო ორგანიზაცია
...
official_website:
- https://www.iso.org/
- https://www.iso.org/fr/
- https://www.iso.org/ru/
official_list_URL: https://www.iso.org/members.html
short_name: ISO
...
search_formatter_URL: https://www.iso.org/search.html?PROD_isoorg_en[query]=has_time_started: 1947-02-23 
aliases:
  - International Organization for Standardization
  - ISO
  - Organisation internationale de normalisation
...
dv_has_:
  name_:
    ...
    ast: Organización Internacional de Normalización
    ...
    ckb: ڕێکخراوەی نێونەتەوەییی ستانداردسازی
    cs: Mezinárodní organizace pro normalizaci
    cy: Sefydliad Rhyngwladol er Safoni
    ...
    frr: Internatsionaal Organisatsion för Standardisiarang
    fy: Ynternasjonale Organisaasje foar Standerdisaasje
    ga: Eagraíocht Idirnáisiúnta na gCaighdeán
    gd: International Organization for Standardization
    gl: Organización Internacional para a Estandarización
    gn: Tekorãty Hetatetãgua Hekopegua
    he: ארגון התקינה הבין־לאומי
    ...
    ilo: Gunglo ti Sangalubongan para iti Panagalagad
    io: Internacionala Organizuro por Normizado
    ...
    lv: Starptautiskā standartizācijas organizācija
    mk: Меѓународна организација за стандардизација
    ml: ഇന്റർനാഷണൽ ഓർഗനൈസേഷൻ ഫോർ സ്റ്റാൻഡേർഡൈസേഷൻ
    mn: Олон Улсын Стандартжуулалтын Байгууллага
    mr: आंतरराष्ट्रीय मानकीकरण संघटना
    ms: Pertubuhan Pemiawaian Antarabangsa
    mul: ISO
    my: အပြည်ပြည်ဆိုင်ရာစံချိန်စံညွှန်းအဖွဲ့
    nb: Den internasjonale standardiseringsorganisasjonen
    nds: Internatschonale Organisatschoon för Normen
    ne: अन्तर्राष्ट्रिय मानकीकरण सङ्गठन
    nl: Internationale Organisatie voor Standaardisatie
    nn: Den internasjonale standardiseringsorganisasjonen
    oc: Organizacion Internacionala de Normalizacion
    pa: ਅੰਤਰਾਸ਼ਟਰੀ ਮਿਆਰੀਕਰਣ ਸੰਘ
    pl: Międzynarodowa Organizacja Normalizacyjna
    pnb: بین الاقوامی تنظیم برائے معیاریت
    ps: د معيار نړيوال تنظيم
    pt: Organização Internacional para Normalização
    ...
    wuu: 国际标准化组织
    xh: Umbutho waMazwe ngaMazwe woLungiso
    xmf: სტანდარტიზაციაშ საირქიანო ორგანიზაცია
...
> (ISO ; French: Organisation internationale de normalisation; 
> Russian: Международная организация по стандартизации) 
> is an independent, non-governmental, international standard development organization 
...
> and (as of July 2024) it has published over 25,000 international standards 
> covering almost all aspects of technology and manufacturing. 
> It has over 800 technical committees (TCs) and subcommittees (SCs) 
> to take care of standards development.
>
> The organization develops and publishes international 
> standards in technical and nontechnical fields, 
> including everything from manufactured products 
> and technology to food safety, transport, IT, agriculture, and healthcare. 
> 
> More specialized topics like electrical and electronic engineering 
> are instead handled by the International Electrotechnical Commission. 
