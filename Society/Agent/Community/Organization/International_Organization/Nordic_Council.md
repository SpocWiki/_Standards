...
dv_has_:
  name_:
    ...
    de: Nordischer Rat
    dsb: Nordiska rada
    el: Νορδικό Συμβούλιο
    en: Nordic Council
    eo: Nordia Konsilistaro
    es: Consejo Nórdico
    et: Põhjamaade Nõukogu
    eu: Iparraldeko Kontseilua
    fa: شورای نوردیک
    fi: Pohjoismaiden neuvosto
    fo: Norðurlandaráðið
    fr: Conseil nordique
    fy: Noardske Ried
    ga: An Chomhairle Nordach
    gl: Consello Nórdico
    he: המועצה הנורדית
    hi: नार्डिक परिषद
    hr: Nordijsko vijeće
    hu: Északi Tanács
    hy: Հյուսիսային Խորհուրդ
    id: Dewan Nordik
    is: Norðurlandaráð
    it: Consiglio nordico
    ja: 北欧理事会
    ka: ჩრდილოეთის საბჭო
    ...
    ru: Северный совет
    sco: Nordic Cooncil
    se: Davviriikkaid ráđđi
    sk: Severská rada
    sl: Nordijski svet
    smn: Tave-enâmij rääđi
