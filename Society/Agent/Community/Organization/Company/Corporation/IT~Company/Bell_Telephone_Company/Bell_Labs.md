...
dv_has_:
  name_:
    ...
    fr: Laboratoires Bell
    ga: Saotharlanna Bell
    gl: Bell Labs
    he: מעבדות נוקיה בל
    hi: बेल प्रयोगशाला
    hr: Bell Labs
    hu: Bell Labs
    hy: Բելլի լաբորատորիա
    id: Bell Labs
    ig: Ụlọ ọrụ Bell Labs
    it: Bell Labs
    ja: ベル研究所
    ka: Bell Labs
    ko: 벨 연구소
    ku: Bell Labs
    lv: Bell Labs
    mk: Белови лаборатории
    ml: ബെൽ ലാബ്സ്
    mr: बेल प्रयोगशाळा
    ms: Bell Labs
    mul: Bell Labs
    nan: Bell Si̍t-giām-só͘
    nb: Bell Labs
    nl: Bell Labs
    oc: Bell Labs
    pl: Bell Labs
    pt: Bell Labs
    ro: Bell Labs
    ru: Лаборатории Белла
    sah: Лаборатория Белла
    sh: Bell Labs
    sk: Bell Labs
    sl: Bellovi laboratoriji
    sr: Белове лабораторије
    sv: Bell Labs
    ta: பெல் ஆய்வுக்கூடங்கள்
    te: బెల్ ల్యాబ్స్
    tg: Озмоишгоҳҳои Белл
    tr: Bell Labs
    uk: Bell Laboratories
    uz: Bell laboratoriyasi
    vi: Bell Labs
    wuu: 贝尔实验室
