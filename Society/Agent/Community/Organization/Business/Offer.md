...
- an offer to sell tickets to an event, 
- to rent the DVD of a movie, 
- to stream a TV show over the internet, 
- to repair a motorcycle, or 
- to loan a book.

Note: As the [[../../../../../schema-org/Enumeration/Business_Function|Business_Function]] property, which identifies the form of offer (e.g. sell, lease, repair, dispose), 
defaults to http://purl.org/goodrelations/v1#Sell; 
an Offer without a defined businessFunction value can be assumed to be an offer to sell.
...
#has_/child_/class :: [[Offer/Aggregate_Offer|Aggregate_Offer]], [[Offer/Offer_for_Lease|Offer_for_Lease]], [[Offer/Offer_for_Purchase|Offer_for_Purchase]] 
