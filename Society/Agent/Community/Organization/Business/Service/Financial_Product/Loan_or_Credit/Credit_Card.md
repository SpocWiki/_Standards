...
dv_has_:
  name_:
    ...
    ko: 신용카드
    krj: kard pangkredito
    ky: насыя картасы
    la: tabella tributaria
    lad: טארשיטה די קרֽידִיטו
    lt: kredito kortelė
    lv: kredītkarte
    min: Kartu kredit
