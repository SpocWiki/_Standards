...
- Setatsiyun radhio
- stacja radiowa
- stasion aradiofonega
- stasiun radio
- station de radio
- stazione radiofonica
- stazione radiufonica
...
dv_has_:
  name_:
    ...
    bs: radiostanica
    ca: emissora de ràdio
    co: stazione radiufonica
    cs: rozhlasová stanice
    cy: gorsaf radio
    da: radiostation
    de: Hörfunksender
    diq: i̇stasyonê radyoy
    ...
    ha: tashar radio
    he: תחנת רדיו
    hsb: rozhłosowy sćelak
    ht: radyo
    hu: rádióállomás
    hy: ռադիոկայան
    id: stasiun radio
    io: emesilo* di radio
    it: stazione radiofonica
    ja: ラジオ放送局
    jv: Setatsiyun radhio
    ka: რადიოსადგური
    ko: 라디오 방송국
    ky: радиостанция
    lb: Radiosstatioun
...
#is_/same_as :: [[../../../../../../WikiData/WD~Radio_station,14350|WD~Radio_station,14350]]
