...
The general [[ProfessionalService]] type for local businesses was deprecated due to confusion with [[../Service|Service]]. For reference, the types that it included were: [[Dentist]],
		[[AccountingService]], [[Legal_Service/Attorney|Attorney]], [[Legal_Service/Notary|Notary]], as well as types for several kinds of [[HomeAndConstructionBusiness]]: [[Home_and_Construction_Business/Electrician|Electrician]], [[GeneralContractor]],
		[[HousePainter]], [[Home_and_Construction_Business/Locksmith|Locksmith]], [[Home_and_Construction_Business/Plumber|Plumber]], [[RoofingContractor]]. [[LegalService]] was introduced as a more inclusive supertype of [[Legal_Service/Attorney|Attorney]].
