...
- дифоъ аз муҳити зист
- енвайронменталізм
- енвиронментализам
- природозаштита
- рух за навакольнае асяродзьдзе
- энвайранменталізм
- סביבתנות
- بيئوية
- محیط زیستگرایی
...
history_of_topic: '[[_Standards/WikiData/WD~timeline_of_history_of_environmentalism,186956|WD~timeline_of_history_of_environmentalism,186956]]'
subclass_of:
- '[[_Standards/WikiData/WD~activism,203764|WD~activism,203764]]'
- '[[_Standards/WikiData/WD~ecology,7150|WD~ecology,7150]]'
has_part_s_:
- '[[_Standards/WikiData/WD~free_market_environmentalism,795002|WD~free_market_environmentalism,795002]]'
...
- '[[_Standards/WikiData/WD~bright_green_environmentalism,4967505|WD~bright_green_environmentalism,4967505]]'
- '[[_Standards/WikiData/WD~Evangelical_environmentalism,5415771|WD~Evangelical_environmentalism,5415771]]'
different_from: '[[_Standards/WikiData/WD~conservation_movement,1088777|WD~conservation_movement,1088777]]'
filmography: '[[_Standards/WikiData/WD~list_of_environmental_films,3072144|WD~list_of_environmental_films,3072144]]'
practiced_by: '[[_Standards/WikiData/WD~environmentalist,3578589|WD~environmentalist,3578589]]'
opposite_of: '[[_Standards/WikiData/WD~anti_environmentalism,4774354|WD~anti_environmentalism,4774354]]'
Wikimedia_outline: '[[_Standards/WikiData/WD~outline_of_environmentalism,7112622|WD~outline_of_environmentalism,7112622]]'
instance_of:
- '[[_Standards/WikiData/WD~political_ideology,12909644|WD~political_ideology,12909644]]'
- '[[_Standards/WikiData/WD~philosophy_of_life,99541875|WD~philosophy_of_life,99541875]]'
...
main_subject:
- '[[_Standards/WikiData/WD~climate,7937|WD~climate,7937]]'
...
in_opposition_to: '[[_Standards/WikiData/WD~pollution,58734|WD~pollution,58734]]'
...
dv_has_:
  name_:
    ...
    gl: ecoloxismo
    gsw: Ökologismus
    gv: çhymmyltaghtoilys
    he: סביבתנות
    hi: पर्यावरणवाद
    hu: ökologizmus
    ia: ecologismo
    id: pelestarian lingkungan hidup
    ig: gburugburu ebe obibi
    it: ambientalismo
    ja: 環境主義
    jam: invairamentalizim
    ka: გარემოს დაცვა
    ko: 생태주의
    kw: kerghynedhieth
    la: Oecologismus
    ...
    lfn: Ambientisme
    lmo: ambientalism
    lt: environmentalizmas
    lv: envaironmentālisms
    mk: природозаштита
    mr: पर्यावरणवाद
    ms: environmentalisme
    nb: økologisme
    nl: ecologisme
    oc: ecologisme
    pl: ekologizm
    ...
    sd: وڻن جو عاشق
    se: environmentalisma
    sh: ekološka svest
    sk: ekologizmus
    sl: okoljevarstvo
    smn: environmentalism
    sms: environmentalismm
    sq: mjedis natyrore
    sr: енвиронментализам
    sv: ekologism
    sw: utunzaji wa mazingira
    ta: சூழலியம்
    tg: дифоъ аз муҳити зист
    th: คตินิยมสิ่งแวดล้อม
    tr: çevrecilik
    uk: енвайронменталізм
    uz: environmentalizm
    vec: ecołozismo
    vi: chủ nghĩa môi trường
