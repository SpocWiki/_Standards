...
dv_has_:
  name_:
    ...
    ckb: خوێندنی سەرەتایی
    cs: primární vzdělávání
    cv: Пуçламăш вĕреневлĕх
    da: grundskole
    de: Grundschulbildung
    dtp: Pondidikan tosiriba
    ...
    ga: bunoideachas
    gd: Bun-sgoil
    gl: educación primaria
    he: חינוך יסודי
    hi: प्रारंभिक शिक्षा
    hu: alapfokú oktatás
    hy: տարրական կրթություն
    id: pendidikan dasar
    it: istruzione primaria
    ja: 初等教育
    jv: pendhidhikan dhasar
    kn: ಪ್ರಾಥಮಿಕ ಶಿಕ್ಷಣ
    ko: 초등교육
    lt: pradinis išsilavinimas
    lv: pamatizglītība
    mi: kura tuatahi
    mk: основно образование
    ml: പ്രാഥമിക വിദ്യാഭ്യാസം
    mr: प्राथमिक शिक्षण
    ...
    se: vuođđoskuvla
    si: ප්රාථමික අධ්යාපනය
    sl: primarno izobraževanje
    smn: vuáđuškovlâ
    sms: vuâđđškooul
    sq: arsim fillor
