...
part_of:
- '[[_Standards/WikiData/WD~chemical_industry,207652|WD~chemical_industry,207652]]'
- '[[_Standards/WikiData/WD~petroleum_industry,862571|WD~petroleum_industry,862571]]'
different_from:
- '[[_Standards/WikiData/WD~oil_refining,214261|WD~oil_refining,214261]]'
- '[[_Standards/WikiData/WD~refinery,1867977|WD~refinery,1867977]]'
subclass_of:
- '[[_Standards/WikiData/WD~refinery,1867977|WD~refinery,1867977]]'
- '[[_Standards/WikiData/WD~separation_machine,135900101|WD~separation_machine,135900101]]'
...
dv_has_:
  name_:
    ...
    id: kilang minyak
    is: Olíuhreinsistöð
    it: raffineria di petrolio
    ja: 製油所
    jv: Kilang lenga
    ko: 정유공장
    li: Raffinaderij
    min: Kilang minyak
    mk: нафтена рафинерија
    mn: Газрын тос боловсруулах үйлдвэр
    mr: तेल शुद्धीकरण प्रकल्प
    ms: loji penapis minyak
    nan: Liān-iû-chhiúⁿ
    nb: oljeraffineri
    nl: aardolieraffinaderij
    nn: Oljeraffineri
    oc: rafinariá de petròli
    ...
    sh: rafinerija nafte
    sl: naftna rafinerija
    sq: Rafineria e naftës
    sr: рафинерија нафте
    sv: oljeraffinaderi
    sw: Kiwanda cha kusafisha mafuta
    ta: பாறை எண்ணெய் சுத்திகரிப்பு ஆலை
    th: โรงกลั่นน้ำมัน
