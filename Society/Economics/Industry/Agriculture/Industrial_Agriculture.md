...
dv_has_:
  name_:
    ...
    he: חקלאות תעשייתית
    hy: Ագրոարդյունաբերական համալիր
    id: Agroindustri
    ja: 工業型農業
    ...
    nl: Industriële landbouw
    nn: Landbruksindustri
    ps: صنعتي کرنه
    pt: Agricultura industrial
    ro: agricultură industrială
    ru: агропромышленный комплекс
    sl: industrijska agrikultura
    sr: Industrijska poljoprivreda
    sv: Mekaniserat jordbruk
    sw: kilimo cha viwanda
    tr: Endüstriyel tarım
    uk: агропромисловий комплекс
    uz: Agrosanoat majmui
    vi: Công nghiệp hóa nông nghiệp
    wuu: 工业化农业
    yue: 工業化農業
    zh: 工業化農業
---
