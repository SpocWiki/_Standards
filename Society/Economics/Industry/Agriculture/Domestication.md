...
different_from: '[[_Standards/WikiData/WD~Domestication_and_foreignization,5290237|WD~Domestication_and_foreignization,5290237]]'
...
partially_coincident_with: '[[_Standards/WikiData/WD~cultivation,357279|WD~cultivation,357279]]'
...
subclass_of: '[[_Standards/WikiData/WD~evolution,1063|WD~evolution,1063]]'
UMLS_CUI: C0175819
schematic:
...
dv_has_:
  name_:
    ...
    mn: гэршүүлэлт
    ms: pembelajinakan
    my: ယဉ်ပါးအောင် မွေးမြူခြင်း
    nan: ka-ióng-hoà
    nb: domestisering
    nds: Domestikatschoon
    new: गृहस्थिकरण
    nl: domesticatie
    nn: domestisering
    nqo: ߞߟߏߝߋ߲ߦߊ
