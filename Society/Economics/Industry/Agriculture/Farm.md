...
UMLS_CUI: C0557759
sRGB_color_hex_triplet: 9ACD32
image: http://commons.wikimedia.org/wiki/Special:FilePath/Betschdorf%20-Ferme%20%C3%A0%20colombages%282%29.jpg
pronunciation_audio: http://commons.wikimedia.org/wiki/Special:FilePath/De-Bauernhof.ogg
small_logo_or_icon: http://commons.wikimedia.org/wiki/Special:FilePath/Maki7-farm.svg
exact_match: http://purl.obolibrary.org/obo/ENVO_00000078
IMDb_keyword: farm
...
> A **Farm** (also called an agricultural holding) is an area of land 
> that is devoted primarily to agricultural processes 
> with the primary objective of producing food and other crops; 
> it is the basic facility in food production. 
> 
> The name is used for specialized units such as arable farms, vegetable farms, fruit farms, dairy, pig 
> and poultry farms, and land used for the production of natural fiber, biofuel, and other biobased products. 
> 
> It includes ranches, feedlots, orchards, plantations and estates, smallholdings, and hobby farms, 
> and includes the farmhouse and agricultural buildings as well as the land. 
> 
> In modern times, the term has been extended to 
> include such industrial operations as wind farms and fish farms.
>
