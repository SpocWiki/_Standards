---
aliases:
- agrarisch hulpmiddel
- agricultural tool
- attrezzo agricolo
- dij təsərufoti diləgon
- eina agrícola
- ferramenta agrícola
...
- селскостопански инструмент
- сельскагаспадарчая прылада
- сельскохозяйственные инструменты
- գյուղատնտեսական գործիք
- ציוד חקלאי
- أداة زراعية
- 农具
- 農具
has_id_wikidata: Q3629395
made_from_material:
- '[[_Standards/WikiData/WD~sheet_metal,211367|WD~sheet_metal,211367]]'
...
partially_coincident_with: '[[_Standards/WikiData/WD~garden_tool,1494647|WD~garden_tool,1494647]]'
used_by: '[[_Standards/WikiData/WD~agricultural_equipment_operator,107363752|WD~agricultural_equipment_operator,107363752]]'
instance_of: '[[_Standards/WikiData/WD~type_of_tool,123588392|WD~type_of_tool,123588392]]'
Nomenclature_for_Museum_Cataloging: 3177
U_S_National_Archives_Identifier: 10639999
Commons_category:
- Agricultural tools
- Agricultural equipment
image: http://commons.wikimedia.org/wiki/Special:FilePath/Agricultural%20tools%20in%20the%20Po%C5%99e%C5%BEany%20museum.jpg
Commons_gallery: Agricultural equipment
dv_has_:
  name_:
    ar: أداة زراعية
    ...
    cy: offeryn amaethyddol
    da: jordbrugsredskaber
    de: landwirtschaftliches Gerät
    el: γεωργικό εργαλείο
    en: agricultural tool
    es: herramienta agrícola
    et: põllumajandus tööriist
    fr: outil agricole
    ga: uirlis talmhaíochta
    gl: ferramenta agrícola
    he: ציוד חקלאי
    hu: mezőgazdasági eszköz
    hy: գյուղատնտեսական գործիք
    it: attrezzo agricolo
    ja: 農具
    lv: lauksaimniecības tehnika
    mk: земјоделско орудие
    nb: jordbrukredskap
    nl: agrarisch hulpmiddel
    nn: jordbruksreiskap
    ...
    sv: jordbruksredskap
    sw: Zana za kilimo
    tly: dij təsərufoti diləgon
    tr: Tarım Aletleri
    uk: сільськогосподарський інструмент
    yue: 農具
    zh: 农具
---
