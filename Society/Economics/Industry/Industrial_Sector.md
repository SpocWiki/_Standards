...
- sanayı
- Sanoat
- secondary sector is the economic sector
- Sekta ya viwanda
- Suliffissualerineq
- sənaye
- Tegimišt
...
dv_has_:
  name_:
    ...
    sah: Индустрия
    sc: Indùstria
    scn: rama d'innustria
    sco: industrie
    se: industriija
    sgs: Indostrėjė
    sh: industrija
    shn: ၵၢၼ်ႁဵတ်းဢွၵ်ႇၶူဝ်းၶွင်
    sk: priemysel
    sl: industrija
    smn: ráhtálâšvuotâ
    sms: industria
...
#is_/same_as :: [[_Standards/WikiData/WD~Industrial_sector,8148|WD~Industrial_sector,8148]] 

## #has_/text_of_/abstract 

> In economics, the secondary sector is the economic sector 
> which comprises manufacturing, encompassing 
