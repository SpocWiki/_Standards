...
dv_has_:
  name_:
    ...
    he: רובוט תעשייתי
    hi: औद्योगिक रोबोट
    hr: Industrijski robot
    hy: արդյունաբերական ռոբոտ
    id: robot industrial
    io: Industriala roboto
    it: robot industriale
    ja: 産業用ロボット
    kk: өнеркәсіптік роботтар
    ko: 산업용 로봇
    nb: industrirobot
    nn: industrirobot
    pl: robot przemysłowy
    pms: Robòt industrial
    pt: robô industrial
    ro: robot industrial
    ru: промышленный робот
    sgs: Ėšdėrbėma ruobuots
    sk: priemyselný robot
    sl: industrijski robot
    sq: Industrial robot
    sr: Индустријски робот
    sv: industrirobot
    sw: Roboti ya viwandani
    tr: Endüstriyel robot
    tt: сәнәгый робот
    uk: промисловий робот
...
#is_/same_as :: [[_Standards/WikiData/WD~Industrial_robot,1128980|WD~Industrial_robot,1128980]] 
