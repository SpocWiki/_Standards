...
- "\U0001F344\U0001F7EB"
- "\U0001F344"
label_in_sign_language: http://commons.wikimedia.org/wiki/Special:FilePath/Champignon%20Nm%201%201%201%20-%20Elix.webm
pronunciation_audio:
- http://commons.wikimedia.org/wiki/Special:FilePath/De-Pilz.ogg
...
#is_/same_as :: [[_Standards/WikiData/WD~Mushroom,83093|WD~Mushroom,83093]] 

## #has_/text_of_/abstract 

> A **Mushroom** is the fleshy, spore-bearing fruiting body of a fungus, 
> typically produced above ground on soil or another food source. 
...
> that have a stem (stipe), a cap (pileus), and gills (lamellae, sing. lamella) on the underside of the cap. 
> 
...
> such as "bolete", "truffle", "puffball", "stinkhorn", and "morel", 
> and gilled mushrooms themselves are often called "agarics" in reference to their similarity to Agaricus or their order Agaricales.
>
