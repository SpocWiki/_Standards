...
- Chiú
- Ciū
- defects of consumption of alcohol
- deoch mheisciúil
- Died alkoolek
- diod feddwol
- edari alkoholdun
...
- 641.21
- 663.1
different_from: '[[_Standards/WikiData/WD~alcohols,156|WD~alcohols,156]]'
FoodEx2_code: A03LZ
...
has_list: '[[_Standards/WikiData/WD~list_of_alcoholic_beverages,2468826|WD~list_of_alcoholic_beverages,2468826]]'
has_part_s_:
- '[[_Standards/WikiData/WD~ethanol,153|WD~ethanol,153]]'
IAB_code: 211
...
- J02.200.100
montage_image:
- http://commons.wikimedia.org/wiki/Special:FilePath/Alcoholic%20beverages%20montage.jpg
opposite_of: '[[_Standards/WikiData/WD~non-alcoholic_beverage,2647467|WD~non-alcoholic_beverage,2647467]]'
page_banner: http://commons.wikimedia.org/wiki/Special:FilePath/Beer%20banner.jpg
produced_by: '[[_Standards/WikiData/WD~alcohol_industry,3150593|WD~alcohol_industry,3150593]]'
Stack_Exchange_site_URL: https://alcohol.stackexchange.com
subclass_of:
- '[[_Standards/WikiData/WD~drink,40050|WD~drink,40050]]'
topic_s_main_template: '[[_Standards/WikiData/WD~Template_Infobox_alcoholic_beverage,10557691|WD~Template_Infobox_alcoholic_beverage,10557691]]'
topic_s_main_Wikimedia_portal: '[[_Standards/WikiData/WD~Portal_Alcoholic_drinks,61473108|WD~Portal_Alcoholic_drinks,61473108]]'
UMLS_CUI: C0001967
...
dv_has_:
  name_:
    af: alkoholiese drank
    an: Bebida alcoholica
    ar: مشروب كحولي
    ary: تصنيف:مشروبات د لكحول
    arz: خمور
    ...
    ga: deoch mheisciúil
    gan: 酒
    gl: bebida alcohólica
    gn: Jey'urã oporomonga'úva
    gu: મદ્યાર્ક યુક્ત પીણું
    he: משקה אלכוהולי
    hi: मादक पेय
    hr: alkoholno piće
    hsb: alkoholiski napoj
    hu: alkoholtartalmú ital
    hy: ալկոհոլային խմիչք
    id: Minuman beralkohol
    io: Alkohola drinkajo
    is: áfengi
    it: bevanda alcolica
    iu: ᐊᖓᔮᕐᓇᖅᑐᖅ
    ja: 酒
    jv: Ombènan ngandhut alkohol
    ka: ალკოჰოლური სასმელი
    kcg: a̱kan
    kk: Алкоголдік ішімдіктер
    kn: ಮದ್ಯಸಾರಯುಕ್ತ ಪಾನೀಯ
    ko: 술
    la: temetum
    lbe: ХӀан
    ln: Masanga
    lt: alkoholinis gėrimas
    lv: alkoholiskais dzēriens
    lzh: 酒
    mai: दारु
    mg: Alkôla
    mhr: спиртан йӱыш
    min: Minuman baālkohol
    mk: алкохолен пијалак
    ml: defects of consumption of alcohol
    mr: मद्य
    ms: Arak
    mwl: Bubida alcólica
    nah: Octli
    nan: Chiú
    nb: alkoholholdig drikke
    ne: मादक पदार्थ
    new: अल्कोहोलिक बेभरेज
    nl: alcoholische drank
    nn: alkoholhaldig drikke
    oc: bevenda alcolizada
    olo: Alkogoulijuomine
    or: ମଦ
    pa: ਸ਼ਰਾਬ
    pl: napój alkoholowy
    pt: bebida alcoólica
    ...
    tok: telo nasa
    tr: içki
    tt: алкогольле эчемлек
    uk: алкогольні напої
    ur: الکحلی مشروب
    uz: Alkogolli ichimliklar
    vec: bevida alcòłega
    vep: Alkogoližed jomad
    vi: đồ uống có cồn
    war: Makahurubog nga irimnon
    wuu: 酒
    xmf: ალკოჰოლური ოშუმალი
    yi: אלקאהאליש געטראנק
    yue: 酒
    za: Laeuj
    zh: 酒
    zh_hans: 酒
...
>
> Alcohol is classified as a group 1 carcinogen. In 2023, the World Health Organization declared that 'the risk to the drinker's health starts from the first drop of any alcoholic beverage.'
>
