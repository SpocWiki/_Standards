...
Library_of_Congress_Classification: K1241-K1287
Colon_Classification: X81
Iconclass_notation:
- 46B55
- 42E541
IMDb_keyword: insurance
hashtag_: insurance
UMLS_CUI: C0680870
Krugosvet_article_archived_: gumanitarnye_nauki/ekonomika_i_pravo/STRAHOVANIE.html
Commons_category: Insurance
subreddit: Insurance
IPTC_NewsCode: mediatopic/20000279
MeSH_tree_code: N03.219.521.576
dv_has_:
  name_:
    af: versekering
    ar: تأمين
...
> a party agrees to compensate another party in the event of a certain loss, damage, or injury. 
> It is a form of risk management, primarily used to protect against the risk of a contingent or uncertain loss.
>
...
> while a person or entity covered under the policy is called an insured. 
> 
> The insurance transaction involves the policyholder assuming a guaranteed, known, 
> and relatively small loss in the form of a payment to the insurer (a premium) 
> in exchange for the insurer's promise to compensate the insured 
> in the event of a covered loss. 
> 
> The loss may or may not be financial, but it must be reducible to financial terms. 
> Furthermore, it usually involves something in which the insured has an insurable interest 
