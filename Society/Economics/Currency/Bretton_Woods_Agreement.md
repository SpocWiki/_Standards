...
- Emglevioù Bretton Woods
- Hệ thống Bretton Woods
- Sistem Bretton Woods
- sistem iz Bretton Woodsa
- Sistemul Bretton Woods
- Sistinme Burtonbwès po les manoyes
...
dv_has_:
  name_:
    ar: بريتون وودز
    az: Bretton-Vuds razılaşması
    azb: برتون وودز سیستمی
    bg: Система Бретън Удс
    bn: ব্রেটন উডস সিস্টেম
    br: Emglevioù Bretton Woods
    bs: Sporazum iz Bretton Woodsa
    ca: Acords de Bretton Woods
    cs: brettonwoodský systém
    cv: Бреттон-Вудс системи
    da: Bretton Woods-systemet
    de: Bretton-Woods-System
    el: Σύστημα ισοτιμιών Μπρέτον Γουντς
    en: Bretton Woods system
    eo: Ekonomia Modelo de Bretton Woods
    es: acuerdos de Bretton Woods
    et: Bretton Woodsi institutsioonid
    eu: Bretton Woodseko batzarra
    fa: سیستم برتون وودز
    fi: Bretton Woodsin järjestelmä
    fr: accords de Bretton Woods
    ga: Córas Bretton Woods
    gl: acordos de Bretton Woods
    gsw: Bretton-Woods-System
    he: הסכם ברטון-וודס
    hr: Sustav iz Bretton Woodsa
    hu: Bretton Woods-i rendszer
    hy: Բրետոն-Վուդսյան համակարգ
    id: Sistem Bretton Woods
    is: Bretton Woods-kerfið
    it: Accordi di Bretton Woods
    ja: ブレトン・ウッズ協定
    ka: ბრეტონ-ვუდსის სისტემა
    kk: Бреттон-Вудс Жүйесі
    ko: 브레튼 우즈 체제
    lt: Bretton Woods sistema
    lv: Bretonvudsas sistēma
    mk: Бретонвудски систем
    ms: Sistem Bretton Woods
    nb: Bretton Woods-systemet
    nl: Systeem van Bretton Woods
    nn: Bretton Woods-systemet
    oc: Acòrdis de Bretton Woods
    pl: System z Bretton Woods
    pt: Acordos de Bretton Woods
    ro: Sistemul Bretton Woods
    ru: Бреттон-Вудская система
    sh: Bretton Woods
    sk: Brettonwoodská menová sústava
    sl: sistem iz Bretton Woodsa
    sr: Бретонвудски споразум
    sv: Bretton Woodssystemet
    ta: பிரெட்டன் வுட்சு முறைமை
    te: బ్రెట్టన్ వుడ్స్ వ్యవస్థ
    th: ระบบเบรตตันวูดส์
...
1982 [[../../Agent/Community/Organization/Company/Corporation/IT~Company/AT&T|AT&T]] was the last [[../Monopoly|Monopoly]] broken up and in the meantime it has re-merged to 3 Companies: [[Verizon]], [[Lumen_Tech]] and [[../../../../IT/IT~Companies/AT&T|AT&T]] 
