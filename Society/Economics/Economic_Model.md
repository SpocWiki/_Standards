...
dv_has_:
  name_:
    ...
    eu: Eredu ekonomiko
    fa: مدل اقتصادی
    fi: taloudellinen malli
    fr: modèle économique
    ga: samhail eacnamaíochta
    he: מודל כלכלי
    hi: आर्थिक मॉडल
    hy: Տնտեսական մոդել
    id: Model ekonomi
    it: modello economico
    ja: 経済モデル
    kn: ಆರ್ಥಿಕ ಮಾದರಿಗಳು
    ko: 경제 모형
    lfn: Model economial
...
#is_/same_as :: [[_Standards/WikiData/WD~Economic_model,2180497|WD~Economic_model,2180497]]
