...
dv_has_:
  name_:
    ...
    ko: 피사계 심도
    lt: Ryškumo gylis
    mk: длабинска острина
    ml: ദൃശ്യത്തിന്റെ ആഴം
    nb: dybdeskarphet
    nl: scherptediepte
    nn: djupneskarpleik
    pl: głębia ostrości
    ...
    th: ช่วงความชัด
    tr: Netlik derinliği
    uk: Глибина різко зображуваного простору
...
> that are in acceptably sharp focus in an image captured with a camera. 
> See also the closely related depth of focus.
>
