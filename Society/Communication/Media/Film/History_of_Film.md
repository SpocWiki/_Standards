...
dv_has_:
  name_:
    af: geskiedenis van film
    ar: تاريخ السينما
    ast: Historia del cine
    az: Kino tarixi
    ...
    da: filmhistorie
    de: Filmgeschichte
    el: Ιστορία του κινηματογράφου
    en: history of film
    eo: historio de kino
    es: historia del cine
    et: filmi ajalugu
    eu: Zinemaren historia
    fa: تاریخ سینما
    fi: elokuvan historia
    fr: histoire du cinéma
    gl: historia do cinema
    he: היסטוריה של הקולנוע
    hi: film ka itihas
    hr: povijest filma
    hu: filmtörténet
    hy: Կինեմատոգրաֆիայի պատմություն
    id: Sejarah film
    ...
    lt: kino istorija
    lv: kinovēsture
    mk: Историја на филмот
    mn: Кино урлагийн түүх
    nb: filmhistorie
    nds: Filmhistorie
    nl: geschiedenis van de film
    pa: ਫ਼ਿਲਮ ਦਾ ਇਤਿਹਾਸ
    pl: historia filmu
    pnb: سنیما دی تریخ
    ps: د فلم تاريخ
    pt: história do cinema
    rm: Istorgia dal film
    ru: история кино
    se: filbmahistorjá
    sh: historija filma
    si: චිත්රපට ඉතිහාසය
