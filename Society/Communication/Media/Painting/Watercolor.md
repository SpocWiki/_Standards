...
- '[[_Standards/WikiData/WD~gum_arabic_solution,3046705|WD~gum_arabic_solution,3046705]]'
- '[[_Standards/WikiData/WD~watercolor_paint,3374389|WD~watercolor_paint,3374389]]'
described_by_source:
...
- '[[_Standards/WikiData/WD~Diccionario_de_materias_y_técnicas_(II),24090568|WD~Diccionario_de_materias_y_técnicas_(II),24090568]]'
- '[[_Standards/WikiData/WD~The_Domestic_Encyclopædia;_Or,_A_Dictionary_Of_Facts,_And_Useful_Knowledge,56441911|WD~The_Domestic_Encyclopædia;_Or,_A_Dictionary_Of_Facts,_And_Useful_Knowledge,56441911]]'
instance_of:
- '[[_Standards/WikiData/WD~painting_technique,1231896|WD~painting_technique,1231896]]'
- '[[_Standards/WikiData/WD~painting_material,3300034|WD~painting_material,3300034]]'
subclass_of: '[[_Standards/WikiData/WD~art_of_drawing,2921001|WD~art_of_drawing,2921001]]'
different_from:
- '[[_Standards/WikiData/WD~watercolor_paint,3374389|WD~watercolor_paint,3374389]]'
- '[[_Standards/WikiData/WD~watercolor_painting,18761202|WD~watercolor_painting,18761202]]'
practiced_by: '[[_Standards/WikiData/WD~watercolorist,17505902|WD~watercolorist,17505902]]'
product_or_material_produced: '[[_Standards/WikiData/WD~watercolor_painting,18761202|WD~watercolor_painting,18761202]]'
...
dv_has_:
  name_:
    ...
    sv: akvarell
    ta: நீர்வர்ணம்
    te: నీటి వర్ణ చిత్రాలు
    tg: Акварел
    th: จิตรกรรมสีน้ำ
    tl: Pangulay na tinutubigan
    tr: sulu boya
    tt: акварель
    udm: акварель
    uk: акварель
...
> **Watercolor** (American English) or watercolour (Commonwealth English), also aquarelle 
> (French: [akwaʁɛl]; from Italian diminutive of Latin aqua 'water'), 
> is a painting method in which the paints are made of 
> pigments suspended in a water-based solution. 
> 
> Watercolor refers to both the medium and the resulting artwork. 
>
> The conventional and most common support—material to which the paint is applied—
> for watercolor paintings is paper, usually special types of watercolor paper. 
> 
> Other supports or substrates include stone, ivory, silk, reed, papyrus, 
> bark papers, plastics, vellum, leather, fabric, wood, and watercolor canvas 
> (coated with a gesso that is specially formulated for use with watercolors). 
> 
