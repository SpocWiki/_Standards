...
dv_has_:
  name_:
    ...
    hu: Pulitzer-díj
    hy: Պուլիցերյան մրցանակ
    id: Penghargaan Pulitzer
    ig: Ihe nrite Pulitzer
    ilo: Premio Pulitzer
    is: Pulitzer-verðlaunin
    it: Premio Pulitzer
    ja: ピューリッツァー賞
    ...
    mn: Пулитцерын шагнал
    mr: पुलित्झर पुरस्कार
    ms: Hadiah Pulitzer
    my: ပူလစ်ဇာဆု
    nan: Pulitzer Chióng
    nb: Pulitzerprisen
    ...
    sw: Tuzo ya Pulitzer
    ta: புலிட்சர் பரிசு
    te: పులిట్జర్ బహుమానం
    th: รางวัลพูลิตเซอร์
    tr: Pulitzer Ödülü
    uk: Пулітцерівська премія
    ur: پلٹزر انعام
    uz: Pulitser mukofoti
    vec: Prèmio Pulitzer
    vi: Giải Pulitzer
    wuu: 普利策奖
    xmf: პულიცერიშ პრემია
    yi: פוליצער פרייז
    yo: Ẹ̀bùn Pulitzer
    yue: 普立茲獎
    zh: 普利策奖
