...
dv_has_:
  name_:
    ar: وكالة أنباء
    arz: وكالة انباء
    ast: axencia de noticies
    az: Xəbər agentliyi
    azb: خبر آژانسی
    be: інфармацыйнае агенцтва
    bg: Информационна агенция
    bn: সংবাদ সংস্থা
    ca: agència de notícies
    ckb: ئاژانسی ھەواڵ
    cs: zpravodajská agentura
    cv: Хыпар агентстви
    cy: Asiantaeth newyddion
    da: nyhedsbureau
    de: Nachrichtenagentur
    el: ειδησεογραφικό πρακτορείο
    en: news agency
    eo: novaĵagentejo
    ...
    fr: agence de presse
    fy: Parseburo
    ga: gníomhaireacht nuachta
    gl: axencia de noticias
    he: סוכנות ידיעות
    hi: समाचार संस्था
    hr: agencijsko novinarstvo
    hsb: powěsćernja
    hu: hírügynökség
    hy: տեղեկատվական գործակալություն
    id: Agen berita
    it: agenzia di stampa
    ja: 通信社
    ka: საინფორმაციო სააგენტო
    kk: Ақпарат агенттігі
    km: ទីភ្នាក់ងារសារព័ត៌មាន
    ko: 뉴스 통신사
    lt: Naujienų agentūra
    mk: новинска агенција
    mr: वृत्तसंस्था
    ms: Agensi berita
    nb: nyhetsbyrå
    nl: persbureau
    pl: agencja prasowa
    pt: agência de notícias
    ro: agenție de știri
    ru: информационное агентство
    se: ođasdoaimmahat
    sh: novinska agencija
    sk: Spravodajská agentúra
    sl: novinarska agencija
    smn: uđâstoimâttâh
    sms: oođâskääzzkõs
...
> and sells them to subscribing news organizations, such as 
> - newspapers, 
> - magazines and 
> - radio and 
...
>
> News agencies can show media bias.
>
