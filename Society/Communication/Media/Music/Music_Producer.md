...
- olóòtú orin
- onye na-emeputa ihe ndeko
- pambuek rendo
- penerbit rakaman
- plateprodusent
- producent muzyczny
- producenti i muzikës
- producteur ou productrice de disques
- productor discografic
- productor discografico
- productor discographic
...
- produser rekaman
- produser ti rekord
- produtol discográficu
- produtor discogràfego
- produtor musical
- produtor(a) musical
- produttore discografico
- produttur tad-diski
- pruduttore discugraficu
- prudutturi discugràficu
- pwodiktè oswa pwodiktris disk
- pyevtitteijee
- record producer
- saothraiche chlàran
- Tagata Fai Musika
- tigpagula musika
- Umkhiqizi wesiqoshwa
- upptökustjóri
- zenei rendező
- μουσικός παραγωγός
- Музикален продуцент
...
dv_has_:
  name_:
    af: musiekprodusent
    an: productor discografico
    ar: منتج أغاني
    ary: مونتيج د أغاني
    arz: منتج تسجيلات
    ast: productor musical
    az: musiqi prodüseri
    azb: آلبوم یاپیمجیسی
    ...
    bn: রেকর্ড প্রযোজক
    br: produer sonerien
    bs: muzički producent
    ca: productor discogràfic
    ...
    eu: disko-ekoizle
    ext: produtol discográficu
    fa: تهیهکننده موسیقی
    fi: musiikkituottaja
    fr: producteur ou productrice de disques
    frr: musiik produsent
    fy: muzykprodusint
    ga: léiritheoir ceirníní
    gd: saothraiche chlàran
    gl: produtor musical
    gv: gienteyder recortys
    ha: mai tsara
    he: מפיק מוזיקלי
    hi: रिकार्ड निर्माता
    hr: glazbeni producent
    hsb: hudźbny producent
    ht: pwodiktè oswa pwodiktris disk
    hu: zenei rendező
    hy: երաժշտական պրոդյուսեր
    ia: productor discographic
    id: produser rekaman
    ig: onye na-emeputa ihe ndeko
    ilo: produser ti rekord
    io: Muzikifisto
    is: upptökustjóri
    it: produttore discografico
    ja: 音楽プロデューサー
    ka: მუსიკალური პროდიუსერი
    kaa: muzıka prodyuseri
    kk: Музыкалық продюсер
    kn: ಸಂಗೀತ ನಿರ್ಮಾಪಕ
    ko: 음악 프로듀서
    ks: رِکارڈ پروڈیوسَر
    ...
    lb: Museksproduzent
    lez: музыкадин продюсер
    lt: muzikos prodiuseris
    lv: mūzikas producents
    min: pambuek rendo
    mk: музички продуцент
    ms: penerbit rakaman
    mt: produttur tad-diski
    mzn: موسیقی تهیهکننده
    nb: plateprodusent
    nds: Musikproduzent
    ne: रेकर्ड निर्माता
    nl: muziekproducent
    nn: musikkprodusent
    oc: productor discografic
    os: музыкалон продюсер
    pa: ਰਿਕਾਰਡ ਨਿਰਮਾਤਾ
    ...
    sa: कलत्व उत्पादक
    scn: prudutturi discugràficu
    sco: record producer
    se: musihkkabuvttadeaddji
    sh: muzički producent
    sk: hudobný producent
    sl: glasbeni producent
    sm: Tagata Fai Musika
    smn: pyevtitteijee
    ...
    ur: میوزک پروڈیوسر
    uz: musiqiy prodyuser
    vec: produtor discogràfego
    vep: muzikprodüser
    vi: nhà sản xuất âm nhạc
    vo: musigijafädan
    wuu: 音乐制作人
    xmf: მუსიკალური პროდიუსერი
    yo: olóòtú orin
    yue: 音樂製作人
    zh: 音樂製作人
    zh_cn: 音乐制作人
