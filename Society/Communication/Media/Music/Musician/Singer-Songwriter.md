...
- canwr-gyfansoddwr
- cântăreț-compozitor
- dainininkas ir dainų rašytojas
- Deyrvac-Nuştekarê deyıran
- dziesminieks
- egile abeslari
- kaner-kanskrifer
- kaner-sonaozer
...
- mpihira sy mpanoratra hira
- myəllif-ifo kardəkəs
- müğənni-bəstəkar
- penyanyi-penggubah lagu
...
- sanger-liedskrywer
- sangster-sangwriter
- seinneadair is sgrìobhaiche
- Sicrijheu tchanteu compôzeu
- singer songwriter
- singer-songwriter
- sjonger-lietsjeskriuwer
- songar-låtskrivar
- stranbêj û strannivîs
- suorum carminum actor
- söngvari og lagahöfundur
- tekstshkrues
- yırlarını yazğan yırcı
- énekes-dalszerző
...
- موغني مؤلف
- گلو کار-گیت نگار
- گُلوکار - ریکارڈر لِکھٲرؠ
- گۆرانیبێژ-گۆرانینووس
- गायक-गीतकार
- गायिका-गीतकार
- কণ্ঠশিল্পী-গীতিকাৰ
- গায়ক-গীতিকার
...
- Singer-Songwriterin
- кантавторка
image: http://commons.wikimedia.org/wiki/Special:FilePath/Joan%20Baez%20Bob%20Dylan%20crop.jpg
IMDb_keyword: singer-songwriter
Commons_category: Singer-songwriters
dv_has_:
  name_:
    acm: مغني-كاتب اغاني
    af: sanger-liedskrywer
    an: Cantaire
    ar: مغن مؤلف
    ary: موغني مؤلف
    arz: مغنى-كاتب اغانى
    as: কণ্ঠশিল্পী-গীতিকাৰ
    ast: cantautor
    az: müğənni-bəstəkar
    be: аўтар-выканаўца
    ...
    gd: seinneadair is sgrìobhaiche
    gl: cantautor
    gn: puraheiapohára
    gsw: Singer-Songwriter
    gv: arraneyder as screeudeyr
    he: זמר-יוצר
    hi: गायक-गीतकार
    hr: kantautor
    hu: énekes-dalszerző
    hy: հեղինակ-կատարող
    hyw: Հեղինակ ու կատարող
    ia: Autor-compositor-interprete
    id: penyanyi-penulis lagu
    ilo: kumakanta-mannurat ti kanta
    is: söngvari og lagahöfundur
    it: cantautore
    ja: シンガーソングライター
    ka: მომღერალი და კომპოზიტორი
    kaa: Qosıqshı
    ko: 싱어송라이터
    ...
    lij: cantoutô
    lt: dainininkas ir dainų rašytojas
    lv: dziesminieks
    mg: mpihira sy mpanoratra hira
    mk: кантавтор
    mr: गायक-गीतकार
    ms: penyanyi-penggubah lagu
    mt: kantawtur
    my: အဆိုတော်-တေးရေးဆရာ
    mzn: شاعر خونشکر
    nb: sanger og låtskriver
    ne: गायिका-गीतकार
    nl: singer-songwriter
    nn: songar-låtskrivar
    oc: cantautor
    or: ଗାୟକ-ଗୀତିକାର
    os: автор-æххæстгæнæг
    pa: ਗਾਇਕ-ਗੀਤਕਾਰ
    ...
    se: lávlu-lávlladahkki
    sh: kantautor
    sk: pesničkár
    sl: kantavtor
    smn: lávloo-laavlârähtee
    ...
    uz: Qoʻshiqchi
    vec: cantautor
    vi: ca sĩ kiêm sáng tác nhạc
    wa: Sicrijheu tchanteu compôzeu
    yue: 唱作人
    zgh: ⴰⵎⵖⵏⵏⵊ ⴷ ⵓⵎⴳⴰⵢ
    zh: 創作歌手
    zh_cn: 创作歌手
...
> A **Singer-songwriter** is a musician who writes, composes, 
> and performs their own musical material, including lyrics and melodies. 
> 
> In the United States, the category is built on the folk-acoustic tradition with a guitar, 
> although this role has transmuted through different eras of popular music. 
> 
> Traditionally, these musicians would write and sing songs personal to them. 
> Singer-songwriters often provide the sole musical accompaniment to an entire song. 
> The piano is also an instrument of choice.
>
