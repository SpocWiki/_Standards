...
has_characteristic: '[[_Standards/WikiData/WD~missing_fundamental,1431822|WD~missing_fundamental,1431822]]'
used_by: '[[_Standards/WikiData/WD~timpanist,3528729|WD~timpanist,3528729]]'
subclass_of:
- '[[_Standards/WikiData/WD~directly_struck_membranophone,5280487|WD~directly_struck_membranophone,5280487]]'
- '[[_Standards/WikiData/WD~melodic_percussion_instrument,7198871|WD~melodic_percussion_instrument,7198871]]'
- '[[_Standards/WikiData/WD~separate_bowl_drums,55723166|WD~separate_bowl_drums,55723166]]'
...
> The **Timpani** (Italian pronunciation: [ˈtimpani]) or kettledrums (also informally called timps) 
> are musical instruments in the percussion family. 
> 
> A type of drum categorised as a hemispherical drum, they consist of a membrane called a head 
> stretched over a large bowl traditionally made of copper. 
> 
> Thus timpani are an example of kettledrums, also known as vessel drums and semispherical drums, whose body is similar to a section of a sphere whose cut conforms the head. 
> 
