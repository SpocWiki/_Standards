...
dv_has_:
  name_:
    ...
    da: Sequencer
    de: Musiksequenzer
    el: αναπαραγωγέας αλληλουχίας (σήκουενσερ)
    en: music sequencer
    eo: muzika sekvencilo
    es: secuenciador
    et: Sekventser
    eu: Sekuentziadore (musika)
    fi: sekvensseri
    fr: séquenceur musical
    gl: secuenciador
    he: סקוונסר
    hu: sequencer
    id: Music sequencer
    ...
    nl: muzieksequencer
    nn: Sequencer
    oc: sequenciador musical
    pl: sekwencer
    pt: sequenciador
    ro: Sequencer
    ru: секвенсор
    sco: muisic sequencer
    sk: Sekvencer
    sl: glasbeni sekvenčnik
    sr: Muzički sekvencer
    sv: sequencer
    th: ซีเควนเซอร์
    tr: Müzik sıralayıcı
    uk: Секвенсер
