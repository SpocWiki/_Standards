...
- dřevěný nástroj
- estrumentu de vientu-maera
- fafúvós hangszer
- gaothuirlisí adhmaid
- Holzblasinstrument
- Holzblosinstrument
- houtblaas instrument
- Houtblaasinstrument
- houtblaasynstrumint
- instrumen musik tiup kayu
...
- ξύλινο πνευστό μουσικό όργανο
- дерев'яні духові музичні інструменти
- деревянный духовой музыкальный инструмент
- драўляны духавы музычны інструмент
- драўляны духавы музычны інструмэнт
- дрвен дувачки инструмент
- дрвени дувачки инструмент
- Созҳои нафасии чӯбин
- փայտե փողային գործիք
- כלי נשיפה מעץ
- آلة نفخ خشبية
- ساز بادی چوبی
- सिंफय् बाजं
...
- 788.2
- 788.219
image: http://commons.wikimedia.org/wiki/Special:FilePath/Mandoura%20zhaleika%20chalumeau%20birbyne.jpg
Wolfram_Language_entity_code: Entity["Concept", "Woodwind::tgjy4"]
Commons_gallery: Woodwind instruments
Commons_category: Woodwind instruments
dv_has_:
  name_:
    af: Houtblaasinstrument
    ar: آلة نفخ خشبية
    ...
    cs: dřevěný nástroj
    cy: offeryn chwythbren
    da: træblæser
    de: Holzblasinstrument
    el: ξύλινο πνευστό μουσικό όργανο
    en: woodwind instrument
    eo: ligna blovinstrumento
    es: instrumento de viento-madera
    et: puupuhkpillid
    eu: Zurezko haize instrumentu
    ext: estrumentu de vientu-maera
    fa: ساز بادی چوبی
    fi: puupuhallin
    fr: bois
    fy: houtblaasynstrumint
    ga: gaothuirlisí adhmaid
    gl: instrumento de vento madeira
    gsw: Holzblasinstrument
    he: כלי נשיפה מעץ
    hr: drvena puhačka glazbala
    hu: fafúvós hangszer
    hy: փայտե փողային գործիք
    id: instrumen musik tiup kayu
    is: Tréblásturshljóðfæri
    it: legni
    ja: 木管楽器
    ko: 목관악기
    lb: Holzblosinstrument
    mk: дрвен дувачки инструмент
    ms: Alat tiup kayu
    nan: Phín-siau
    nb: treblåseinstrument
    new: सिंफय् बाजं
    nl: houtblaas instrument
    nn: treblåseinstrument
    pl: Instrument dęty drewniany
    pt: madeiras
    qu: Qiru phukuna waqachina
    ro: instrument de suflat din lemn
    ru: деревянный духовой музыкальный инструмент
    sco: widwind instrument
    se: muorraboson
    sh: Drvena puhačka glazbala
    sk: drevený dychový nástroj
    sl: pihala
    smn: muorâposonjâs
    ...
    th: เครื่องเป่าลมไม้
    tl: Instrumentong kahoy-hangin
    tr: Tahta nefesli çalgılar
    uk: дерев'яні духові музичні інструменти
    vi: nhạc cụ hơi bộ gỗ
    vls: Outbloazers
    wuu: 木管乐器
    yue: 木管樂器
    zh: 木管乐器
...
> within the greater category of wind instruments. 
>
