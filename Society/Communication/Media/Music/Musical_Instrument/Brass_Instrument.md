...
- instrumentong tanso
- instrumentu de vientu metal
- Koperblaasynstrumint
- Koperbloazers
- koperen blaasinstrument
- labrosone
- lata phukuna waqachina
...
dv_has_:
  name_:
    ...
    gsw: Blechblasinstrument
    he: כלי נשיפה ממתכת
    hr: limeni puhački instrumenti
    hu: tölcséres fúvókájú hangszerek
    hy: պղնձե փողային երաժշտական գործիքներ
    id: instrumen musik tiup logam
    is: málmblásturshljóðfæri
    it: aerofoni a bocchino
    ja: 金管楽器
    jbo: tabra
    ko: 금관악기
    lb: Blechblosinstrument
    mk: лимен дувачки инструмент
    mn: Гуулин үлээвэр хөгжмийн зэмсэг
    ms: alat muzik bras
    nb: messingblåseinstrument
    new: ली बाजं
    nl: koperen blaasinstrument
    nn: messingblåseinstrument
    oc: instrument de coire
    pl: instrument dęty blaszany
    pt: metais
    qu: lata phukuna waqachina
    ro: instrument de suflat din alamă
    ru: медные духовые музыкальные инструменты
    se: veaikeboson
    sh: limeni duvački instrumenti
