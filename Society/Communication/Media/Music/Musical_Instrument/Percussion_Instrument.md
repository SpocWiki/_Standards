...
- instrumento di perkushon
- Instrumentong pinapalo
- instrumentu de percusión
- Instrumint å bouxhaedje-dissu
- lyömäsoitin
- löökpillid
...
- Percussiounsinstrument
- Perkusi
- perkusio instrumentu
- perkusja
- Perkusjon
- Perkusyjne insztrumynty
- perküsyon
- Schlaginstrument
...
- ударны музычны інструмэнт
- ударный музыкальный инструмент
- ударныя музычныя інструменты
- Урма музыкалык аспаптар
- цæвгæ музыкалон инструмент
- Հարուածային գործիքներ
- հարվածային գործիք
- כלי הקשה
- آلة إيقاعية
- ئامێری کوتان
...
dv_has_:
  name_:
    ...
    bn: ঘাতযন্ত্র
    br: benveg-tosiñ
    ca: instrument de percussió
    ckb: ئامێری کوتان
    cs: bicí nástroje
    cy: offeryn taro
    da: slagtøj
    de: Schlaginstrument
    el: κρουστό μουσικό όργανο
    en: percussion instrument
    eo: frapinstrumento
    es: instrumento de percusión
    et: löökpillid
    eu: perkusio instrumentu
    ext: estrumentu de percusión
    fa: ساز کوبهای
    fi: lyömäsoitin
    fr: instrument de percussion
    fy: Slachynstrumint
    ga: cnaguirlis
    gd: beum-ionnsramaid
    gl: instrumento de percusión
    gsw: Schlaginstrument
    gv: greie bwoallee
    he: כלי הקשה
    hi: तबला वाद्य्
    hr: udaraljke
    hu: ütőhangszer
    hy: հարվածային գործիք
    hyw: Հարուածային գործիքներ
    id: instrumen musik perkusi
    is: Ásláttarhljóðfæri
    it: strumento a percussione
    ja: 打楽器
    ka: დასარტყმელი საკრავები
    kk: Соқпалы музыкалық аспаптар
    kn: ತಾಳವಾದ್ಯ ನುಡಿಸುವಿಕೆ
    ko: 타악기
    ky: Урма музыкалык аспаптар
    lb: Percussiounsinstrument
    lfn: Strumentos de percute
    lt: mušamieji instrumentai
    lv: sitamais instruments
    mg: Zavamaneno velezina
    mk: ударен инструмент
    ms: Alat perkusi
    mt: strument tal-perkussjoni
    mzn: کوتندنی ساز
    nb: slagverk
    nl: slaginstrument
    nn: Perkusjon
    oc: instrument de percussion
    os: цæвгæ музыкалон инструмент
    ...
    tg: сози зарбӣ
    th: เพอร์คัชชัน
    tl: Instrumentong pinapalo
    tr: perküsyon
    tt: бәрмә уен коралы
    uk: ударний музичний інструмент
    vec: instrumento de percusion
    vi: nhạc cụ gõ
    wa: Instrumint å bouxhaedje-dissu
    wuu: 打击乐器
...
> or scraped by a beater including attached or enclosed beaters or rattles struck, 
> scraped or rubbed by hand or struck against another similar instrument. Excluding zoomusicological instruments and the human voice, the percussion family is believed to include the oldest musical instruments. In spite of being a very common term to designate instruments, and to relate them to their players, the percussionists, percussion is not a systematic classificatory category of instruments, as described by the scientific field of organology. It is shown below that percussion instruments may belong to the organological classes of idiophone, membranophone, aerophone and chordophone.
>
