...
subclass_of:
- '[[_Standards/WikiData/WD~electrophone,105738|WD~electrophone,105738]]'
- '[[_Standards/WikiData/WD~electronic_instrument,876367|WD~electronic_instrument,876367]]'
...
> An electronic musical instrument or electrophone 
> is a musical instrument that produces sound using electronic circuitry. 
> Such an instrument sounds by outputting an electrical, electronic or digital audio signal 
> that ultimately is plugged into a power amplifier which drives a loudspeaker, 
> creating the sound heard by the performer and listener.
>
> An electronic instrument might include a user interface for controlling its sound, 
> often by adjusting the pitch, frequency, or duration of each note. 
> 
