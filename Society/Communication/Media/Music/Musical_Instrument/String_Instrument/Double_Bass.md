...
different_from: '[[_Standards/WikiData/WD~acoustic_bass_guitar,424017|WD~acoustic_bass_guitar,424017]]'
described_by_source:
...
used_by: '[[_Standards/WikiData/WD~double_bassist,1214796|WD~double_bassist,1214796]]'
part_of: '[[_Standards/WikiData/WD~violin_family,1365097|WD~violin_family,1365097]]'
lowest_note: '[[_Standards/WikiData/WD~D,1651121|WD~D,1651121]]'
award_received: '[[_Standards/WikiData/WD~Instrument_of_the_Year,48757486|WD~Instrument_of_the_Year,48757486]]'
subclass_of: '[[_Standards/WikiData/WD~necked_box_lutes_played_with_a_bow,57050725|WD~necked_box_lutes_played_with_a_bow,57050725]]'
...
> The double bass, also known as the upright bass, the acoustic bass, the bull fiddle, or simply bass, 
> is the largest and lowest-pitched chordophone in the modern symphony orchestra 
> (excluding rare additions such as the octobass). 
> It has four or five strings, and its construction is in between that of the gamba and the violin family.
>
> The bass is a standard member of the orchestra's string section, along with violins, violas, and cellos, 
> as well as the concert band, and is featured in concertos, solo, 
> and chamber music in Western classical music. 
> The bass is used in a range of other genres, such as jazz, blues, 
> rock and roll, rockabilly, country music, bluegrass, tango, folk music 
> and certain types of film and video game soundtracks.
>
> The instrument's exact lineage is still a matter of some debate, 
> with scholars divided on whether the bass is derived from the viol or the violin family.
>
> Being a transposing instrument, the bass is typically notated one octave higher than tuned 
...
> (like a bass guitar, viol, or the lowest-sounding four strings of a standard guitar), 
...
> or via a variety of extended techniques. 
...
> 
> Classical music and jazz use the natural sound produced acoustically by the instrument, 
> as does traditional bluegrass. 
