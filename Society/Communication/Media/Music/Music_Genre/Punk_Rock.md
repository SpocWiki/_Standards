...
equivalent_class: http://lemac.sgcb.mcu.es/Autoridades/LEMAC201228556/concept
Library_of_Congress_Classification: ML3534
Commons_category: Punk rock
DPLA_subject_term: Punk rock music
IMDb_keyword: punk-rock
native_label: Punk rock
dv_has_:
  name_:
    an: Punk
    ar: بانك
    ...
    scn: Punk rock
    sco: Punk rock
    se: punk rock -musihkka
    sh: Punk
    sk: punk rock
    sl: punk rock
    smn: punk rock -muusik
    sms: punk rock -musikk
    sq: Punk rock
    sr: панк рок
    sv: punkrock
    ta: பங்க்
...
#is_/same_as :: [[_Standards/WikiData/WD~Punk_rock,3071|WD~Punk_rock,3071]] 

## #has_/text_of_/abstract 

> Punk rock (also known as punk) is a subgenre of rock music 
> that emerged in the mid-1970s. 
> 
> Rooted in 1950s rock and roll and 1960s garage rock, 
> punk bands rejected the overproduction and corporate nature of mainstream rock music. Typically producing short, fast-paced songs with rough stripped-down vocals and instrumentation and an anti-establishment theme, artists embrace a DIY ethic with many bands self-producing and distributing recordings through independent labels.
>
