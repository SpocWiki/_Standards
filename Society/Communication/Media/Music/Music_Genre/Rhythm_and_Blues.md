...
U_S_National_Archives_Identifier: 10642544
inception: 1938-01-01T00:00:00Z
image: http://commons.wikimedia.org/wiki/Special:FilePath/John%20Lee%20Hooker%20two.jpg
equivalent_class: http://service.ddex.net/dd/DD-AVS-001/dd/ddex_RAndB
Commons_gallery: Rhythm and blues
Commons_category: Rhythm and blues
native_label: Rhythm and blues
dv_has_:
  name_:
    ar: ريذم أند بلوز
    arz: ريذم اند بلوز
    ast: Rhythm and blues
    az: ritm-n-blyuz
    azb: ریتم اند بلوز
    be: рытм-н-блюз
    ...
    nah: Rhythm & Blues
    nb: rhythm and blues
    new: रीदम एन्ड ब्लुज्
    nl: rhythm-and-blues
    nn: rhythm and blues
    oc: Rhythm and blues
    os: ритм-н-блюз
    pap: rhythm-and-blues
    pl: rhythm and blues
    pt: rhythm and blues
    ro: rhythm and blues
    ru: ритм-н-блюз
...
> Rhythm and blues, frequently abbreviated as R&B or R'n'B, is a genre of popular music 
> that originated within African American communities in the 1940s. 
> 
> The term was originally used by record companies 
> to describe recordings marketed predominantly to African Americans, 
> at a time when "rocking, jazz based music ... [with a] heavy, insistent beat" 
