...
has_time_stopped: 1400-01-01
aliases:
- cerddoriaeth ganoloesol
- Erdi Aroko musika
- gaskaáigásaš musihkka
- Keskaja muusika
- Keskiajan musiikki
- koskâáigásâš muusik
- középkori zene
...
- musique médiévale
- Muzik era pertengahan
- Muzyka w średniowieczu
- mużika Medjevali
- música de la Edá Media
- música medieval
- Müzica medievàla
- Orta əsr musiqisi
- Ortaçağ müziği
...
dv_has_:
  name_:
    ...
    ca: música medieval
    cs: středověká hudba
    cy: cerddoriaeth ganoloesol
    da: musik fra middelalderen
    de: Musik des Mittelalters
    el: Μεσαιωνική μουσική
    en: medieval music
    eo: mezepoka muziko
    es: música medieval
    et: Keskaja muusika
    eu: Erdi Aroko musika
    fa: موسیقی قرون وسطا
    fi: Keskiajan musiikki
    fr: musique médiévale
    gl: música medieval
    he: מוזיקת ימי הביניים
    hi: मध्यकालीन संगीत
    hu: középkori zene
    hy: միջնադարյան երաժշտություն
    id: Musik abad pertengahan
    it: musica medievale
    ja: 中世西洋音楽
    ka: შუა საუკუნეების მუსიკა
    ko: 중세의 서양 고전 음악
    la: musica mediaevalis
    li: Middeliewse meziek
    lmo: Müzica medievàla
    lt: Viduramžių muzika
    lv: viduslaiku mūzika
    mk: Средновековна музика
    ms: Muzik era pertengahan
    mt: mużika Medjevali
    nb: musikk i middelalderen
    nl: middeleeuwse muziek
    nn: Mellomaldermusikk
    oc: musica medievala
    pa: ਮੱਧਕਾਲੀ ਸੰਗੀਤ
    pl: Muzyka w średniowieczu
    pt: música medieval
    ru: музыка Средневековья
    se: gaskaáigásaš musihkka
    sh: Srednjovjekovna muzika
    si: මධ්ය කාලීන සංගීතය
    sk: Stredoveká hudba
    sl: srednjeveška glasba
    smn: koskâáigásâš muusik
    sr: Srednjovekovna muzika
    sv: medeltidens musik
    tr: Ortaçağ müziği
    uk: музика середньовіччя
    vi: âm nhạc trung cổ
    yue: 中世紀音樂
    zh: 中世紀音樂
---
...
#is_/same_as :: [[_Standards/WikiData/WD~Medieval_music,163775|WD~Medieval_music,163775]] 
