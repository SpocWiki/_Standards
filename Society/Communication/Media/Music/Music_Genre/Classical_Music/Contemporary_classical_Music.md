...
aliases:
- ceol clasaiceach comhaimseartha
- cerddoriaeth glasurol gyfoes
- contemporary classical music
- eigentijdse klassieke muziek
- kaasaegne klassikaline muusika
- kortárs komolyzene
- mizik kontanporen
...
- samtidsmusik
- samtidsmusikk
- Savremena klasična muzika
- sodobna klasična glasba
- soudobá vážná hudba
...
- сучасная клясычная музыка
- ժամանակակից դասական երաժշտություն
- מוזיקה קלאסית עכשווית
...
dv_has_:
  name_:
    ...
    da: samtidsmusik
    de: zeitgenössische klassische Musik
    el: σύγχρονη κλασσική μουσική
    en: contemporary classical music
    eo: nuntempa klasika muziko
    es: música académica contemporánea
    et: kaasaegne klassikaline muusika
    eu: musika klasiko garaikide
    fa: موسیقی کلاسیک معاصر
    fi: nykytaidemusiikki
    fr: musique contemporaine
    ga: ceol clasaiceach comhaimseartha
    gl: Música clásica contemporánea
    he: מוזיקה קלאסית עכשווית
    ht: mizik kontanporen
    hu: kortárs komolyzene
    hy: ժամանակակից դասական երաժշտություն
    ...
    pl: muzyka współczesna
    pt: música contemporânea
    ro: muzică clasică contemporană
    ru: современная классическая музыка
    sl: sodobna klasična glasba
    sr: Savremena klasična muzika
    sv: nutida konstmusik
    tr: çağdaş klasik müzik
