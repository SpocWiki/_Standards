...
- باركلي جيمس هارفست (فريق روك)
- バークリー・ジェイムズ・ハーヴェスト
- 巴克萊·詹姆斯·哈斯特
has_id_wikidata: Q807957
dv_has_:
  name_:
    an: Barclay James Harvest
    ar: باركلي جيمس هارفست (فريق روك)
    ast: Barclay James Harvest
    ca: Barclay James Harvest
    cs: Barclay James Harvest
    da: Barclay James Harvest
    de: Barclay James Harvest
    en: Barclay James Harvest
    es: Barclay James Harvest
    et: Barclay James Harvest
    eu: Barclay James Harvest
    fi: Barclay James Harvest
    fr: Barclay James Harvest
    gl: Barclay James Harvest
    hu: Barclay James Harvest
    it: Barclay James Harvest
    ja: バークリー・ジェイムズ・ハーヴェスト
    mul: Barclay James Harvest
    nb: Barclay James Harvest
    nl: Barclay James Harvest
    nn: Barclay James Harvest
    pl: Barclay James Harvest
    pt: Barclay James Harvest
    ro: Barclay James Harvest
    ru: Barclay James Harvest
    sv: Barclay James Harvest
    tr: Barclay James Harvest
