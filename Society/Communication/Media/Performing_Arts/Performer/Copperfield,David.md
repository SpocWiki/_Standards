...
name_in_native_language: David Copperfield
...
dv_has_:
  name_:
    ...
    gv: David Copperfield
    he: דייוויד קופרפילד
    hif: David Copperfield
    hr: David Copperfield (iluzionist)
    hu: David Copperfield
    hy: Դեյվիդ Կոպերֆիլդ
    id: David Copperfield
    it: David Copperfield
    ja: デビッド・カッパーフィールド
    ka: დევიდ კოპერფილდი
    kk: Дэвид Копперфильд
    ko: 데이비드 코퍼필드
    la: David Copperfield
    lt: David Copperfield
    lv: Deivids Koperfīlds
    mai: डेभिड कपरभिल्ड
    mg: David Copperfield
    mk: Дејвид Коперфилд
    ms: David Copperfield
    mul: David Copperfield
    nb: David Copperfield
    ne: डेभिड कपरभिल्ड
    nl: David Copperfield
    nn: David Copperfield
    oc: David Copperfield
    pa: ਡੇਵਿਡ ਕਾਪਰਫੀਲਡ
    ...
    uk: Девід Коперфілд
    ur: ڈیوڈ کاپر فیلڈ
    uz: David Copperfield
    vi: David Copperfield
    vls: David Copperfield
    wuu: 大卫·科波菲尔
    yue: 大衛·高帕菲
    zh: 大衛·考柏菲
    zh_cn: 大卫·科波菲尔
...
#is_/same_as :: [[../../../../../WikiData/WD~David_Copperfield,139637|WD~David_Copperfield,139637]] 

## #has_/text_of_/abstract 

> David Seth Kotkin (born September 16, 1956), known professionally as David Copperfield, 
> is an American stage magician and illusionist 
> described by Forbes as the most commercially successful magician in history.
>
> Copperfield's television specials have been nominated for 38 Emmy Awards, winning 21. 
> Known for his combination of storytelling and illusion, his performance, 
> in a career spanning more than 40 years, has earned 11 Guinness World Records, 
> a star on the Hollywood Walk of Fame and a knighthood by the French government. 
> He has been named a Living Legend by the US Library of Congress.
>
> His illusions have included 
> - the disappearance of a Learjet aircraft (1981), 
...
> - the disappearance of an Orient Express train dining car (1991) and 
...
>
> In 2006 he bought 11 resort islands in The Bahamas, which he renamed Musha Cay and the Islands of Copperfield Bay.
>
