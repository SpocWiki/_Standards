...
- Leikstjóri
- leurenner
- mai bada umurni na gidan wasan kwaykwayo
- metteur ou metteuse en scène
- onye nhazi ihe nkiri
- pengarah teater
- pozorišni režiser
- Regisseur
- regista teatrale
...
- تھیٹر ہدایت کارہ
- jiteatirejidan
Iconclass_notation: 48C821
image: http://commons.wikimedia.org/wiki/Special:FilePath/SarDrama%20%D0%A3%D1%80%D0%BE%D0%B4%20%D1%80%D0%B5%D0%BF%D0%B5%D1%82%D0%B8%D1%86%D0%B8%D0%B8%2001.JPG
equivalent_class: http://dbpedia.org/ontology/TheatreDirector
Provenio_UUID: 11d70a9f-9ed6-453c-9d7f-d230ab86af97
Commons_category: Theatre directors
Dewey_Decimal_Classification: 792.0233092
IMDb_keyword: theater-director
dv_has_:
  name_:
    af: teaterregisseur
    an: Director teatral
    ...
    et: teatrilavastaja
    eu: antzerki zuzendari
    fa: کارگردان تئاتر
    fi: teatteriohjaaja
    fr: metteur ou metteuse en scène
    ga: stiúrthóir drámaíochta
    gd: stiùiriche tèatair
    gl: director teatral
    gu: નાટ્ય દિગ્દર્શક
    gv: stiureyder theater
    ha: mai bada umurni na gidan wasan kwaykwayo
    he: במאי תיאטרון
    hi: नाटक दिग्दर्शक
    hr: kazališni redatelj
    hu: színházi rendező
    hy: թատերական ռեժիսոր
    id: sutradara teater
    ig: onye nhazi ihe nkiri
    ilo: direktor ti teatro
    is: Leikstjóri
    it: regista teatrale
    ja: 演出家
    ka: თეატრის რეჟისორი
    kaa: teatr rejissyorı
    ko: 연극연출가
    lb: Theaterregisseur
    lt: teatro režisierius
    lv: teātra režisors
    mdf: театрань тиись
    ...
    nl: toneelregisseur
    oc: Director de teatre
    os: театралон режиссёр
    pa: ਰੰਗ-ਮੰਚ ਨਿਰਦੇਸ਼ਕ
    ...
    se: teáhterbagadalli
    sh: teatarski režiser
    sk: divadelný režisér
    sl: gledališki režiser
    ...
    ta: நாடக இயக்குநர்
    tg: коргардони театр
    tl: direktor sa teatro
    tr: tiyatro yönetmeni
    tt: театр режиссеры
    uk: театральний режисер
    ur: تھیٹر ہدایت کار
    uz: teatr rejissyori
    vec: diretor de teatro
    vi: đạo diễn sân khấu
    vo: teatirejidan
    yue: 戲劇導演
    zh: 戏剧导演
    zh-cn: 戏剧导演
...
> A theatre director or stage director is a professional in the theatre field 
> who oversees and orchestrates the mounting of a theatre production 
> such as a play, opera, dance, drama, musical theatre performance, etc. 
> by unifying various endeavors and aspects of production. 
> 
> The director's function is to ensure the quality and completeness of theatre production 
> and to lead the members of the creative team into realizing their artistic vision for it. 
> 
> The director thereby collaborates with a team of creative individuals and other staff 
> to coordinate research and work on all the aspects of the production 
> which includes the Technical and the Performance aspects.
>
> The technical aspects include: stagecraft, costume design, theatrical properties (props), 
> lighting design, set design, and sound design for the production. 
> The performance aspects include: acting, dance, orchestra, chants, and stage combat.
>
> If the production is a new piece of writing or a (new) translation of a play, 
> the director may also work with the playwright or a translator. 
> 
> In contemporary theatre, after the playwright, the director is generally the principle visionary, 
> making decisions on the artistic conception and interpretation of the play and its staging. 
> 
> Different directors occupy different places of authority and responsibility, 
> depending on the structure and philosophy of individual theatre companies. 
