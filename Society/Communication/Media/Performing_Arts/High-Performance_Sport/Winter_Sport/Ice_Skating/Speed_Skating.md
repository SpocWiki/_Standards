...
dv_has_:
  name_:
    ...
    et: Kiiruisutamine
    eu: Izotz gaineko abiadura-patinaje
    fa: اسکیت سرعت
    fi: pikaluistelu
    fr: patinage de vitesse
    fy: kompetitive reedriden
    ga: luas-scátáil oighir
    gl: Patinaxe de velocidade sobre xeo
    gv: skyrraghtyn bieauid
    he: החלקה מהירה על הקרח
    hr: Brzo klizanje
    hu: gyorskorcsolya
    hy: Չմշկավազք
    ia: Patinage de velocitate
    id: seluncur cepat
    ...
    mn: Гүйлтийн тэшүүр
    ms: Luncur laju
    nb: hurtigløp på skøyter
    nl: wedstrijdschaatsen
    ...
    uz: Konkida yugurish sporti
    vi: Trượt băng tốc độ
    wuu: 速度滑冰
    yue: 速度溜冰
    zh: 競速滑冰
    zh_cn: 速度滑冰
