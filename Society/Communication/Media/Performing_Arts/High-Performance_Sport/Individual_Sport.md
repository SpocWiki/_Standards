...
- individuele sport
- individuell sport
- individuelle idrettsgreiner
- individuelle idrettsgrener
- individuála valáštallan
- individuální sport
- Miónkôrz
- olahraga individu
- sport a-unanoù
...
dv_has_:
  name_:
    af: individuele sport
    ar: رياضة فردية
    be: індывідуальны спорт
    br: sport a-unanoù
    ca: esport individual
    cs: individuální sport
    csb: Miónkôrz
    cy: chwaraeon unigolyn
    da: individuel sport
    de: Individualsport
    el: ατομικό άθλημα
    en: individual sport
    ...
    fr: sport individuel
    ga: spórt aonair
    gl: deporte infividual
    he: ספורט יחידים
    hr: individualni sport
    hu: egyéni sport
    hy: անհատական սպորտաձև
    id: olahraga individu
    is: Einstaklingsíþrótt
    it: sport individuale
    ja: 個人スポーツ
    ko: 개인 스포츠
    ku: Werzişa ferdî
    lb: Eenzelsport
    lt: individualus sportas
    mk: поединечен спорт
    nb: individuelle idrettsgrener
    nl: individuele sport
    ...
    sco: individual sport
    se: individuála valáštallan
    sl: individualni šport
    sq: Sporte individuale
    sr: појединачни спорт
    sv: individuell sport
    tr: bireysel spor
    uk: індивідуальний вид спорту
    ur: انفرادی کھیل
    vi: thể thao cá nhân
    yue: 個人運動
    zh: 個人運動
