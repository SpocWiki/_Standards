...
dv_has_:
  name_:
    ...
    hy: ձմեռային մարզաձև
    ia: sport hibernal
    id: Olahraga musim dingin
    ie: Sport hivernal
    is: vetraríþrótt
    it: sport invernali
    ja: ウィンタースポーツ
    kk: Қысқы спорт түрлері
    ko: 겨울 스포츠
    lb: Wantersport
    lt: žiemos sportas
    lv: ziemas sports
    mk: зимски спорт
    nan: Koâⁿ-lâng ūn-tōng
    nb: vinteridrett
    nl: wintersport
    nn: vinteridrett
    pl: sport zimowy
...
#is_/same_as :: [[_Standards/WikiData/WD~Winter_sport,204686|WD~Winter_sport,204686]] 
