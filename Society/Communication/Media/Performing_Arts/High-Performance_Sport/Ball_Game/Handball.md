...
subreddit: Handball
Commons_category: Handball
icon: http://commons.wikimedia.org/wiki/Special:FilePath/Handball%20pictogram.svg
...
> **Handball** (AKA team handball, European handball, Olympic handball, or indoor handball) 
> is a team sport in which two teams of seven players each 
> (six outcourt players and a goalkeeper) pass a ball using their hands 
> with the aim of throwing it into the goal of the opposing team. 
