...
dv_has_:
  name_:
    ...
    nl: speerwerpen
    nn: spydkast
    oc: Lançament de bigatana
    pa: ਜੈਵਲਿਨ ਥਰੋਅ
    pl: rzut oszczepem
    pt: lançamento de dardo
    ro: aruncarea suliței
    ru: метание копья
    sa: भल्लप्रक्षेपणक्रीडा
    scn: Tiru dû giavillottu
    sd: نيزو اڇلائڻ
    se: sáitebálkesteapmi
    sh: Bacanje koplja
    shi: asldhay n unsful
    si: හෙල්ලය විසිකිරීම
    sk: hod oštepom
    sl: met kopja
    smn: säittišlivgim
