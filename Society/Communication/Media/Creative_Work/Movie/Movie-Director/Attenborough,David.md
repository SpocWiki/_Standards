...
- 戴維·阿滕伯勒
- 데이비드 애튼버러
has_id_wikidata: Q183337
dv_has_:
  name_:
    af: David Attenborough
    an: David Attenborough
    ar: ديفيد أتينبارا
    arz: ديفيد اتينبرا
    as: ডেভিদ এটেনবৰো
    ast: David Attenborough
    az: Devid Attenboro
    ...
    bn: ডেভিড অ্যাটনবারা
    br: David Attenborough
    ca: David Attenborough
    ckb: دەیڤد ئاتنبۆرۆ
    co: David Attenborough
    cs: David Attenborough
    cv: Дэвид Аттенборо
    cy: David Attenborough
    ...
    eu: David Attenborough
    fa: دیوید اتنبرو
    fi: David Attenborough
    fr: David Attenborough
    frc: David Attenborough
    frp: David Attenborough
    fur: David Attenborough
    ga: David Attenborough
    gd: David Attenborough
    gl: David Attenborough
    gsw: David Attenborough
    ha: David Attenborough
    he: דייוויד אטנבורו
    hr: David Attenborough
    hu: David Attenborough
    ia: David Attenborough
    id: David Attenborough
    ie: David Attenborough
    ig: David Attenborough
    io: David Attenborough
    is: David Attenborough
    it: David Attenborough
    ja: デイビッド・アッテンボロー
    jam: David Attenborough
    jut: David Attenborough
    kab: David Attenborough
    kg: David Attenborough
    kn: ಡೇವಿಡ್ ಅಟೆನ್ಬರೋ
    ko: 데이비드 애튼버러
    ku: David Attenborough
    la: David Attenborough
    lb: David Attenborough
    li: David Attenborough
    lij: David Attenborough
    lt: David Attenborough
    lv: Deivids Atenboro
    mg: David Attenborough
    min: David Attenborough
    ml: ഡേവിഡ് ആറ്റൻബറോ
    ms: David Attenborough
    mul: David Attenborough
    my: ဒေးဗစ် အက်တန်ဘရော့ချ်
    nan: David Attenborough
    ...
    oc: David Attenborough
    pap: David Attenborough
    pcd: David Attenborough
    pl: David Attenborough
    pms: David Attenborough
    pnb: ڈیوڈ ایٹن برا
    ...
    ru: Дэвид Аттенборо
    sc: David Attenborough
    scn: David Attenborough
    sco: David Attenborough
    sh: David Attenborough
    sje: David Attenborough
    sk: David Attenborough
    ...
    ta: டேவிட் ஆட்டன்பரோ
    th: เดวิด แอตเทนบะระ
    tl: David Attenborough
    tr: David Attenborough
    tt: Дэвид Аттенборо
    uk: Девід Аттенборо
    ur: ڈیوڈ ایٹن برا
    uz: David Attenborough
    vec: David Attenborough
    vi: David Attenborough
    vls: David Attenborough
    vmf: David Attenborough
    vo: David Attenborough
    wa: David Attenborough
    war: David Attenborough
    wo: David Attenborough
    wuu: 大卫·阿滕伯勒
...
#has_/name_/family :: Attenborough 
#has_/name_/given :: David Frederick

#has_/sibling :: [[Attenborough,Richard]] 
...
>
> Attenborough was a senior manager at the BBC, having served as controller of BBC Two 
> and director of programming for BBC Television in the 1960s and 1970s. 
> 
> First becoming prominent as host of Zoo Quest in 1954, 
> his filmography as writer, presenter and narrator has spanned eight decades; 
> it includes Natural World, Wildlife on One, the Planet Earth franchise, The Blue Planet and its sequel. 
> He is the only person to have won BAFTA Awards in black and white, colour, high-definition, 3D and 4K resolution. 
> Over his life he has collected dozens of honorary degrees and awards, 
> including three Emmy Awards for Outstanding Narration.
>
...
### #is_/same_as :: [[Attenborough,David|Attenborough,David]] 
