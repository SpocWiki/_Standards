---
has_id_wikidata: Q595950
dv_has_:
  name_:
    ang: Mortal Engines
    ar: محركات قاتلة
    ast: Mortal Engines
    bg: Смъртоносни машини
    br: Mortal Engines
    bs: Smrtonosne mašine
    ca: Màquines mortals
    ceb: Mortal Engines
    cs: Smrtelné stroje
    cy: Mortal Engines
    da: De rullende byer
    de: Mortal Engines. Krieg der Städte
    el: Φονικές μηχανές
    en: Mortal Engines
    eo: Mortigaj motoroj
    es: Máquinas mortales
    et: Surelikud masinad
    fa: موتورهای مرگبار
    fi: Kävelevät koneet
    fr: Mécaniques fatales
    ga: Mortal Engines
    hr: Smrtonosni strojevi
    hu: Ragadozó városok
    hy: Մահացու մեքենաներ
    ia: Mortal Engines
    id: Mortal Engines
    it: Macchine mortali
    ja: 移動都市
    ...
    nb: Mortal Engines
    nl: Levende steden
    pl: Zabójcze maszyny (powieść)
    pt: Mortal Engines
    ro: Mașinării infernale
    ru: Смертные машины
    sco: Mortal Engines
    sv: De vandrande städerna
    uk: Смертні машини
    uz: Mortal Engines
    vi: Mortal Engines
    zh: 移動城市1：致命引擎
...
### #is_/same_as :: [[Mortal Engines|Mortal Engines]] 
