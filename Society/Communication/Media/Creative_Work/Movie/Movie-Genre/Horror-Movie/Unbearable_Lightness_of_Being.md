...
- Лиймашын чытыдыме куштылгылыкшо
...
- Турмуштун чыдай алгыс жеңилдиги
- Կեցության անտանելի թեթևությունը
- הקלות הבלתי-נסבלת של הקיום
- دي اَن بيئَرايبل لائيٽنيسِ آف بي اِنگ
...
dv_has_:
  name_:
    ar: وجود لا تحتمل خفته
    az: Varlığın dözülməz yüngüllüyü (roman)
    be: Невыносная лёгкасць быцця
    bg: Непосилната лекота на битието
    bs: Nepodnošljiva lahkoća postojanja
    ca: La insuportable lleugeresa de l'ésser
    da: Tilværelsens ulidelige lethed
    de: Die unerträgliche Leichtigkeit des Seins
    el: Η αβάσταχτη ελαφρότητα του είναι
    en: The Unbearable Lightness of Being
    eo: La netolerebla leĝero de estado
    es: La insoportable levedad del ser
    et: Olemise talumatu kergus
    eu: Izatearen arintasun jasanezina
    fa: سبکی تحملناپذیر هستی
    fi: Olemisen sietämätön keveys
    fr: L'Insoutenable Légèreté de l'être
    he: הקלות הבלתי-נסבלת של הקיום
    hr: Nepodnošljiva lakoća postojanja
    hy: Կեցության անտանելի թեթևությունը
    it: L'insostenibile leggerezza dell'essere
    ja: 存在の耐えられない軽さ
    ko: 참을 수 없는 존재의 가벼움
    ky: Турмуштун чыдай алгыс жеңилдиги
    lt: Nepakeliama būties lengvybė
    mhr: Лиймашын чытыдыме куштылгылыкшо
    mk: Неподносливата леснотија на постоењето
    ml: ഉയിരടയാളങ്ങൾ (നോവൽ)
    mul: Nesnesitelná lehkost bytí
    nb: Tilværelsens uutholdelige letthet
    pa: ਹੋਣ ਦਾ ਅਸਹਿ ਹਲਕਾਪਣ
    pl: Nieznośna lekkość bytu
    pt: A Insustentável Leveza do Ser
    ro: Insuportabila ușurătate a ființei
    ru: Невыносимая лёгкость бытия
    sd: دي اَن بيئَرايبل لائيٽنيسِ آف بي اِنگ
    sh: Nepodnošljiva lakoća postojanja
...
### #is_/same_as :: [[Unbearable_Lightness_of_Being|Unbearable_Lightness_of_Being]] 
