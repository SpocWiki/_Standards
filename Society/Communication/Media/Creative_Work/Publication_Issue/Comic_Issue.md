...
- sarjakuva
- sarjukoomiksu
- siq'isqa rikchasapa willakuy
- sornette en portraits
- strip
- stripi
- stripverhaal
- Stripverhaol
...
page_banner: http://commons.wikimedia.org/wiki/Special:FilePath/Gunston%20Street%20comic%20about%20collateral%20damage.png
...
For the sake of consistency, **even one-shot issues	belong to a series comprised of a single issue**. 
All comic issues can be uniquely identified by: 
- the combination of the name and volume number of the series to which the issue belongs; 
