...
- kompjûterspultsje
- kuompioterėnē žaidėmā
- kuyuq rikch'a puklla
- kōmputrowy szpil
- litámbwisi-masano
- ludus computatralis
- lîstika vîdyoyê
...
- ကွန်ပျူတာဂိမ်း
- ဗွီဒီယိုဂိမ်း
- პერსონალური კომპიუტერული თამაში
- コンピュータゲーム
- 电子游戏
- 電子遊戲
- 電視遊戲
...
dv_has_:
  name_:
    ...
    fo: telduspøl
    fr: jeu vidéo
    fy: kompjûterspultsje
    ga: físchluiche
    gan: 電子遊戲
    gcr: jé vidéo
    gl: videoxogo
    gn: ta’ãngamýi ñembosarái
    gsw: Computerspiel
    gv: gamman-feeshan
    ha: Wasan Bidiyo
    he: משחק וידאו
    ...
    jbo: samselkei
    jv: gim vidéo
    ka: პერსონალური კომპიუტერული თამაში
    kab: urar anvidyu
    ...
    sv: datorspel
    sw: mchezo wa video
    szl: kōmputrowy szpil
    ta: நிகழ்பட ஆட்டம்
    te: వీడియో ఆట
    tg: бозиҳои компутарӣ
    th: วิดีโอเกม
    tk: wideo oÿun
    tl: video game
    tok: musi ilo
...
#has_/parent_class :: [[../Game, SoftwareApplication|Game, SoftwareApplication]]  
