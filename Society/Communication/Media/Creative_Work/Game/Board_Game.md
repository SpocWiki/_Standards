...
- игра на табла
- игра на табли
- махсус тактадагы уен
- настольная гульня
- настольная игра с полем
- Үстел ойындары
- խաղեր տախտակի վրա
- משחק לוח
- بازیهای تختهای
...
dv_has_:
  name_:
    ...
    gan-hant: 棋
    gcr: Jé di sosyété
    gl: xogo de taboleiro
    gn: Mesa'i ñembosarái
    ha: Wasan Allo
    he: משחק לוח
    hi: बोर्ड गेम
    hr: Igre na ploči
    hsb: deskowa hra
    hu: táblás társasjáték
    hy: խաղեր տախտակի վրա
    id: Permainan papan
    ie: Tabul-lude
    io: Surtabla ludo
    is: borðspil
