...
Commons_category: Media studies
dv_has_:
  name_:
    ar: دراسات الإعلام
    be: медыязнаўства
    ...
    fr: étude des médias
    ga: staidéar ar na meáin
    gl: Estudos de medios
    he: לימודי תקשורת המונים
    hi: मीडिया अध्ययन
    hu: médiatudomány
    id: Ilmu media
    is: Fjölmiðlafræði
    it: studi sulla comunicazione di massa
    ja: メディア研究
    ko: 미디어 연구
    la: Scientia mediorum
    mi: te mātai arapāho
    mk: медиумски науки
    ms: Kajian media
    nb: medievitenskap
    ...
    sl: medijske študije
    smn: mediatutkâm
    sms: mediatuʹtǩǩummuš
    sq: Shkenca mediale
    sr: Studije medija
    sv: medie- och kommunikationsvetenskap
    tl: Araling pangmidya
    tr: medya çalışmaları
    uk: медіазнавство
    ur: میڈیا اسٹوڈیو
...
#is_/same_as :: [[_Standards/WikiData/WD~Media_studies,165650|WD~Media_studies,165650]] 

## #has_/text_of_/abstract 

> Media studies is a discipline and field of study 
> that deals with the content, history, and effects of various media; 
> in particular, the mass media. 
> 
> Media studies may draw on traditions from both the social sciences and the humanities, but it mostly draws from its core disciplines of mass communication, communication, communication sciences, and communication studies.
>
