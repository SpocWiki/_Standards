...
part_of: '[[_Standards/WikiData/WD~Western_literature,116476|WD~Western_literature,116476]]'
described_by_source:
...
different_from:
- '[[_Standards/WikiData/WD~Literature_of_Germany,16321587|WD~Literature_of_Germany,16321587]]'
- '[[_Standards/WikiData/WD~German_language_studies,109647876|WD~German_language_studies,109647876]]'
instance_of: '[[_Standards/WikiData/WD~sub_set_of_literature,109551565|WD~sub_set_of_literature,109551565]]'
studied_by: '[[_Standards/WikiData/WD~German_language_studies,109647876|WD~German_language_studies,109647876]]'
facet_of: '[[_Standards/WikiData/WD~German,188|WD~German,188]]'
...
Krugosvet_article: kultura_i_obrazovanie/literatura/NEMETSKAYA_LITERATURA.html
Library_of_Congress_Classification: PT1-4897
dv_has_:
  name_:
    af: Duitse letterkunde
    ar: أدب ألماني
    ...
    bpy: জার্মান সাহিত্য
    bs: Njemačka književnost
    ca: literatura alemanya
    cs: německá literatura
    da: tysk litteratur
    de: deutschsprachige Literatur
    el: Γερμανική λογοτεχνία
    en: German-language literature
    eo: germanlingva literaturo
    es: literatura en alemán
    et: Saksakeelne kirjandus
    eu: Alemanezko literatura
    fa: ادبیات آلمانی
    fi: saksankielinen kirjallisuus
    fr: littérature de langue allemande
    fy: Dútske literatuer
    gl: literatura en alemán
    he: ספרות גרמנית
    hi: जर्मन भाषा का साहित्य
    hr: Njemačka književnost
    hu: német irodalom
    hy: Գերմանական գրականություն
    id: Sastra Berbahasa Jerman
    ...
    ko: 독일 문학
    ku: Wêjeya almanî
    la: Litterae Theodiscae
    lb: Däitschsproocheg Literatur
    lfn: Leteratur deutx
    lld: Leteratura tudëscia
    mk: Германска литература
    my: ဂျာမန်စာပေ
    nb: tysk litteratur
    nl: Duitse literatuur
    nn: Tysk litteratur
    pa: ਜਰਮਨ ਸਾਹਿਤ
    pl: literatura niemieckojęzyczna
    pt: Literatura em alemão
    ro: literatură în limba germană
    ...
    tr: Alman edebiyatı
    uk: Німецька література
    ur: جرمن ادب
    uz: Nemis adabiyoti
    vi: văn học Đức
    war: Literatura Inaleman
    wuu: 德语文学
    yue: 德文文學
    zh: 德语文学
    zh_cn: 德语文学
