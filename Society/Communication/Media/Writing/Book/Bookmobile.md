...
- '[[_Standards/WikiData/WD~bus_type,56887437|WD~bus_type,56887437]]'
...
dv_has_:
  name_:
    ...
    hu: mozgókönyvtár
    hy: Շարժական գրադարան
    hyw: Շարժական Գրադարան
    ig: Obughari akwukwo
    it: biblioteca mobile
    ja: 移動図書館
    ko: 이동 도서관
    lb: Bicherbus
    mk: подвижна библиотека
    nb: bokbuss
    nl: bibliotheekbus
    nn: bokbuss
    pl: bibliobus
...
#has_/parent_class :: [[../../../../Agent/Community/Organization/Business/Local_Business/Library|Library]] 
