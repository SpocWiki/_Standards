...
subclass_of: '[[_Standards/WikiData/WD~performance_work,17538722|WD~performance_work,17538722]]'
...
dv_has_:
  name_:
    ...
    eo: mistereca dramo
    es: misterio
    et: Müsteerium (teater)
    eu: misterio
    fa: نمایش کرامات
    fi: Mysteerinäytelmä
    fr: mystère
    fy: Mystearjespul
    ga: dráma rúndiamhair
    gl: misterio
    he: הצגת מסתורין
    hr: Mirakul
    hu: misztériumjáték
    hy: միստերիա
    id: Sandiwara misteri
    it: mistero
    ja: 神秘劇
    ka: მისტერია
    kk: Мистерия
