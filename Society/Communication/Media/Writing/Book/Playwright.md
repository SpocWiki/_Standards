...
dv_has_:
  name_:
    ...
    eu: antzerkigile
    fa: نمایشنامهنویس
    fi: näytelmäkirjailija
    fo: sjónleikaskald
    fr: dramaturge
    frr: dramaatiker
    ga: drámadóir
    gd: sgrìobhaiche-dràma
    gl: dramaturgo
    gsw: Dramatiker
    gu: નાટ્યકાર
    gv: screeudeyr cloie
    ha: marubucin wasannin kwaykwayo
    he: מחזאי
    hi: नाटककार
    hr: dramski pisac
    hsb: dramatikar
    ...
    lv: dramaturgs
    mdf: драма сёрмадысь
    mg: mpanoratra tantara tsangana
    mhr: Драматург
    mk: драматург
    mr: नाटककार
    ms: pengarang lakon
