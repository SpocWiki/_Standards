---
aliases:
- Almanca yazan yazarlar listesi
- Anexo:Escritores en alemán
- Danh sách nhà văn tiếng Đức
- German writer
- German_Writer
- Lies van Duutsjtalige sjrievers
...
- liste over tyskspråklige forfattere
- listă de scriitori de limbă germană, după țară
- Listă de scriitori de limbă germană/A
- német nyelvű költők, írók listája
- Roll skrivagnerien alamanek
- Seznam nemških pisateljev
- Seznam německy píšících spisovatelů
- Vexala dem germanavaf suterotik
- Список немецкоязычных писателей и поэтов
- جرمن زبان کے مصنفین کی فہرست
- فهرست نویسندگان آلمانیزبان
- قائمة الكتاب الذين كتبوا باللغة الألمانية
- ドイツ語作家の一覧
has_id_wikidata: Q947728
dv_has_:
  name_:
    ar: قائمة الكتاب الذين كتبوا باللغة الألمانية
    avk: Vexala dem germanavaf suterotik
    br: Roll skrivagnerien alamanek
    cs: Seznam německy píšících spisovatelů
    de: Liste deutschsprachiger Schriftsteller
    en: list of German-language authors
    es: Anexo:Escritores en alemán
    fa: فهرست نویسندگان آلمانیزبان
    fr: liste d'écrivains de langue allemande par ordre chronologique
    hu: német nyelvű költők, írók listája
    ja: ドイツ語作家の一覧
    li: Lies van Duutsjtalige sjrievers
    mo: Listă de scriitori de limbă germană/A
    nb: liste over tyskspråklige forfattere
    nl: lijst van Duitstalige literaire schrijvers
    ro: listă de scriitori de limbă germană, după țară
    ru: Список немецкоязычных писателей и поэтов
    sl: Seznam nemških pisateljev
    sv: lista över tyskspråkiga författare
    tr: Almanca yazan yazarlar listesi
