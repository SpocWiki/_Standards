...
Dewey_Decimal_Classification: 686
history_of_topic: '[[_Standards/WikiData/WD~history_of_printing,257933|WD~history_of_printing,257933]]'
image:
...
industry: '[[_Standards/WikiData/WD~poligraphy,11892257|WD~poligraphy,11892257]]'
instance_of:
...
MeSH_tree_code: L01.737.787
montage_image: http://commons.wikimedia.org/wiki/Special:FilePath/Collage%20of%20printing.png
...
- '[[_Standards/WikiData/WD~pressman,108065006|WD~pressman,108065006]]'
product_material_or_service_produced_or_provided: '[[_Standards/WikiData/WD~printed_matter,1261026|WD~printed_matter,1261026]]'
said_to_be_the_same_as: '[[_Standards/WikiData/WD~Q10353573,10353573|WD~Q10353573,10353573]]'
subclass_of: '[[_Standards/WikiData/WD~printing_technique,3514338|WD~printing_technique,3514338]]'
topic_s_main_template: '[[_Standards/WikiData/WD~Template_Letterpress,17232646|WD~Template_Letterpress,17232646]]'
UMLS_CUI: C0033161
uses: '[[_Standards/WikiData/WD~printing_machine,12820205|WD~printing_machine,12820205]]'
...
> The earliest non-paper products involving printing include cylinder seals 
> and objects such as the Cyrus Cylinder and the Cylinders of Nabonidus. 
> 
> The earliest known form of printing evolved from ink rubbings made on paper or cloth 
> from texts on stone tablets, used during the sixth century. 
> 
> Printing by pressing an inked image onto paper (using woodblock printing) 
> appeared later that century. 
> 
> Later developments in printing technology include 
> the movable type invented by Bi Sheng around 1040 
> and the printing press invented by Johannes Gutenberg in the 15th century. 
> 
> The technology of printing played a key role in the development of the Renaissance 
> and the Scientific Revolution and laid the material basis 
