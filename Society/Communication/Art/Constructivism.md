...
dv_has_:
  name_:
    ...
    fy: konstruktivisme
    gl: construtivismo
    gsw: Konstruktivismus
    he: קונסטרוקטיביזם
    hr: Konstruktivizam
    hu: konstruktivista művészet
    hy: Կոնստրուկտիվիզմ
    it: costruttivismo
    ja: ロシア構成主義
    ka: კონსტრუქტივიზმი
    ...
    ko: 구성주의
    ky: Конструктивизм
    la: Constructivismus (ars)
    lt: Konstruktyvizmas
    mk: Конструктивизам (уметност)
    mr: रचनावाद
    ms: Konstruktivisme (seni)
    nb: konstruktivisme
    nl: constructivisme
    nn: konstruktivisme
    os: конструктивизм
    pl: konstruktywizm
    pt: construtivismo russo
    ro: constructivism
    ru: конструктивизм
    se: konstruktivisma
    sh: konstruktivizam
