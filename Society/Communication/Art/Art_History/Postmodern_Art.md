...
dv_has_:
  name_:
    ...
    da: postmoderne kunst
    el: Μεταμοντέρνα τέχνη
    en: postmodern art
    eo: Postmoderna arto
    es: Arte postmoderno
    eu: Arte postmoderno
    fa: هنر پسانوگرا
    fi: Postmoderni taide
    fr: art postmoderne
    gl: Arte posmoderna
    hu: posztmodern művészet
    hy: հետմոդեռն արվեստ
    ja: ポストモダン・アート
    lv: Postmodernisma māksla
    pl: Postmodernizm
    pt: arte pós-moderna
    ro: artă postmodernă
    ru: искусство постмодернизма
    sl: postmoderna umetnost
    sr: Postmoderna umetnost
    tr: Postmodern sanat
    uk: мистецтво постмодернізму
    uz: Postmodern sanʼati
