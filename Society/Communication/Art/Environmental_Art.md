...
- '[[_Standards/WikiData/WD~environmental_artwork,21042249|WD~environmental_artwork,21042249]]'
instance_of:
...
product_or_material_produced: '[[_Standards/WikiData/WD~environmental_artwork,21042249|WD~environmental_artwork,21042249]]'
practiced_by: '[[_Standards/WikiData/WD~environmental_artist,69320328|WD~environmental_artist,69320328]]'
...
dv_has_:
  name_:
    ...
    fr: art environnemental
    gsw: Environment
    he: אמנות סביבתית
    hu: environmental art
    hy: Էնվայրոնմենթ (արվեստ)
    id: Seni lingkungan
    it: arte ambientale
    ja: 環境アート
    ko: environmental art
    la: ars oecologica
    nl: environment
    pl: environment
    ru: Энвайронмент
    sh: pejzažna umetnost
    sl: okoljska umetnost
    sr: Пејзажна уметност
    sv: miljökonst
    ta: சூழல்சார் கலை
    uk: Енвайронмент
    vi: Nghệ thuật môi trường
    yue: 環境藝術
    zh: 環境藝術
---
