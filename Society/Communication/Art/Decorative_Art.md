...
dv_has_:
  name_:
    ...
    cy: Celfyddydau addurnol
    da: dekorativ kunst
    de: Kunstgewerbe
    el: Διακοσμητικές τέχνες
    en: decorative art
    eo: ornamarto
    ...
    fr: arts décoratifs
    ga: ealaíona maisithe
    gl: artes decorativas
    he: אמנות דקורטיבית
    hi: सजावटी कला
    hu: dekoratív művészet
    hy: դեկորատիվ-կիրառական արվեստ
    id: Seni dekoratif
    it: arti decorative
    ja: 装飾美術
    ka: დეკორატიული ხელოვნება
    ko: 장식 예술
    ky: Жасалга-колдонмо көркөм искусство
    lv: dekoratīvi lietišķā māksla
    mk: украсна уметност
    my: အလှဆင်ခြင်း အနုပညာ
    nb: dekorativ kunst
    nl: decoratieve kunst
    pl: zdobnictwo
    pt: artes decorativas
    ro: arte decorative
    ru: декоративное искусство
    se: hearvadáidda
    sl: dekorativna umetnost
    sr: Dekorativna umetnost
    sv: dekorativ konst
    sw: Pambo
    tr: Dekorativ sanat
