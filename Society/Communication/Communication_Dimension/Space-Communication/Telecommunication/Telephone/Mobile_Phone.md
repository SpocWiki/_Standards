...
- 손전화
- 휴대 전화
has_id_wikidata: Q17517
Commons_gallery: Mobile phone
Commons_category: Mobile phones
short_name:
- sel
- mobil
- Natel
...
hashtag: mobile
image:
- http://commons.wikimedia.org/wiki/Special:FilePath/Mobile%20phone%20PHS%20Japan%201997-2003.jpg
- http://commons.wikimedia.org/wiki/Special:FilePath/Android%20smartphones.jpg
time_of_discovery_or_invention: 1973-01-01T00:00:00Z
icon: http://commons.wikimedia.org/wiki/Special:FilePath/Gnome-phone.svg
pronunciation_audio: http://commons.wikimedia.org/wiki/Special:FilePath/LL-Q33578%20%28ibo%29-Deventus-Ekwenti.wav
...
Wolfram_Language_entity_code: Entity["Concept", "CellPhone::zx667"]
MeSH_tree_code: L01.462.500.847.698.300
dv_has_:
  name_:
    ace: hapé
    af: selfoon
    ...
    ca: telèfon mòbil
    cdo: chiū-gĭ
    ceb: telefonong selular
    ckb: مۆبایل
    co: telefonu cellulare
    cs: mobilní telefon
    csb: mòbilka
    cv: карасла телефон
    cy: ffôn symudol
    ...
    glk: گؤشي
    gu: મોબાઇલ ફોન
    guc: taleepana serulaalü
    gv: shooylagh
    ha: wayar hannu
    hak: hàng-thung thien-fa
    he: טלפון סלולרי
    hi: मोबाइल फ़ोन
    hil: telefono selular
    hr: mobilni telefon
    ht: telefòn mobil
    hu: mobiltelefon
    hy: բջջային հեռախոս
    ...
    ko-kp: 손전화
    krc: мобил телефон
    krj: telefono selular
    ks: موبائیل فون
    ku: telefona gerok
    ky: уюлдук телефон
    la: telephonum gestabile
    lad: telefón de haldiquera
    lb: Handy
    li: Hendie
    lld: mobile phone
    lmo: telefun celülar
    ...
    my: မိုဘိုင်းလ်ဖုန်း
    mzn: موایل
    nah: ehēcatlanōnōtzqui
    nan: hêng-tōng tiān-oē
    nb: mobiltelefon
    ne: मोबाइल फोन
    new: मोबाइल टेलेफोन
    nia: HP (telepon)
    ...
    tl: bitbiting telefono
    tn: founo ya selula
    tr: cep telefonu
    trv: djiyun qnawal baga
    tt: кесә телефоны
    uk: мобільний телефон
    ur: محمول
    uz: mobil telefon
    vec: telèfono selulare
    vi: điện thoại di động
    wa: telefone axhlåve
    war: selpon
    wo: astuces mobiles
    wuu: 手机
    xmf: მობილური ტელეფონი
    yi: צעלפֿאָן
    yo: foonu alagbeka
    yue: 手機
    za: soujgih
...
#is_/same_as :: [[_Standards/WikiData/WD~Mobile_phone,17517|WD~Mobile_phone,17517]] 
