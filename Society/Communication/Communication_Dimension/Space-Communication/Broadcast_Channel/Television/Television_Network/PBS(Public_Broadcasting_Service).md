---
has_time_started: 1969-11-03
aliases:
- Ministerium Emittendi Publicum
- PBS
- Public Broadcasting Service
- Public Broadcasting System
- بوبليك برودكاستنغ سيرفيس
- پی بی ئێس
- پی بی ایس
- پیبیاس
- পিবিএস
...
dv_has_:
  name_:
    ...
    ckb: پی بی ئێس
    cs: PBS
    da: Public Broadcasting Service
    de: PBS
    el: PBS
    en: PBS
    en_gb: PBS
    ...
    eu: PBS
    fa: پیبیاس
    fi: Public Broadcasting Service
    fr: PBS
    gl: Public Broadcasting Service
    gv: PBS
    he: PBS
    hr: Public Broadcasting Service
    hu: PBS
    hy: PBS
    id: Public Broadcasting Service
    it: PBS
    ja: 公共放送サービス
    ko: 미국 공영 방송망
    la: Ministerium Emittendi Publicum
    lfn: Public Broadcasting Service
    ms: Public Broadcasting Service
    mul: PBS
    nan: PBS
    nb: PBS
    nl: Public Broadcasting Service
    nn: Public Broadcasting Service
    pl: PBS
    pnb: پی بی ایس
    pt: PBS
    pt_br: PBS
    ...
    sq: PBS
    sr: PBS
    sv: Public Broadcasting System
    ta: பொது ஒளிபரப்புச் சேவை
    th: พีบีเอส
    tl: PBS
    tr: PBS
    uk: PBS
...
#is_/same_as :: [[_Standards/WikiData/WD~PBS,215616|WD~PBS,215616]] 
