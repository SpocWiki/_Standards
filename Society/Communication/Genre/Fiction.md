...
different_from:
- '[[_Standards/WikiData/WD~fiction,12311287|WD~fiction,12311287]]'
- '[[_Standards/WikiData/WD~fictional_creative_work,15306849|WD~fictional_creative_work,15306849]]'
...
hashtag:
- fiction
has_characteristic: '[[_Standards/WikiData/WD~fiction_genre,108465955|WD~fiction_genre,108465955]]'
has_part_s_:
- '[[_Standards/WikiData/WD~work_of_fiction,87482979|WD~work_of_fiction,87482979]]'
has_Template:
...
opposite_of: '[[_Standards/WikiData/WD~non-fiction,213051|WD~non-fiction,213051]]'
...
dv_has_:
  name_:
    ...
    ht: fiksyon
    hu: fikció
    hy: գեղարվեստական գրականություն
    hyw: գեղարուեստական գրականութիւն
    ia: fiction
    id: fiksi
    ig: akụkọ ifo
    ilo: binalabála
    ...
    jam: fikshan
    jv: rekan
    ka: გამოგონილი ისტორია
    kab: tasugna
    kk: ғылыми-көркем әдебиет
    kn: ಕಟ್ಟುಕಥೆ
    ko: 허구
    ...
    tr: kurgu
    tt: матур әдәбият
    udm: чеберлыко визьлобан
    uk: художній вимисел
    ur: فکشن
    uz: ilmiy-badiiy adabiyot
    vec: finsion
    vi: giả tưởng
    war: susmatanon
    wuu: 虚构作品
...
> 
> Fictional portrayals are thus inconsistent with plausibility, history, or fact. 
...
> 
> More broadly, however, fiction encompasses imaginary narratives 
> expressed in any medium, including not just writings 
> but also live theatrical performances, films, television programs, 
