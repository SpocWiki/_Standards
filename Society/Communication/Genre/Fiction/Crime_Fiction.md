...
- krimfikcio
- krimi
- kriminaalǩeerjlažvuõtt
- kriminalistička fantastika
...
dv_has_:
  name_:
    ...
    fr: genre policier
    fy: Misdiefiksje
    ga: ficsean coiriúlachta
    gl: xénero policíaco
    he: ספרות פשע
    hr: Žanr kriminalistike
    hu: krimi
    hy: քրեական գեղարվեստական գրականություն
    id: fiksi kriminal
    is: Glæpasaga
    it: giallo
    ja: 犯罪フィクション
    ...
    lb: Krimi
    lmo: sgiald
    lv: Kriminālliteratūra
    mk: криминалистичка белетристика
    ms: Jenayah
    nb: krim
    nl: krimi
    nn: krim
    os: криминалон жанр
    pl: fikcja kryminalna
    pt: Ficção policial
    ro: ficțiune polițistă
    ru: криминальный жанр
    sd: ڪرائيم فڪشن
    se: rihkusgirjjálašvuohta
    sh: Kriminalistički žanr
    sl: kriminalna fikcija
    smn: rikoskirjálâšvuotâ
    sms: kriminaalǩeerjlažvuõtt
    sr: kriminalistička fantastika
    sv: deckare
    ta: குற்றப்புனைவு
    th: นิยายสืบสวนสอบสวน
    tr: polisiye edebiyatı
    uk: кримінальний жанр
    ur: جرائم فکشن
