...
dv_has_:
  name_:
    af: fiktiewe karakter
    ar: شخصية خيالية
    ast: personaxe de ficción
    az: personaj
    ba: персонаж
    be: персанаж
    be-tarask: пэрсанаж
    ...
    br: tudenn faltazi
    bs: lik
    ca: personatge fictici
    ce: персонаж
    ceb: karakter
    ckb: کەسایەتیی خەیاڵی
    cs: fiktivní postava
    ...
    en: character
    eo: fikciulo
    es: personaje ficticio
    et: väljamõeldud tegelane
    eu: pertsonaia
    fa: شخصیت (فعالیتهای هنری)
    fi: kuvitteellinen hahmo
    fo: uppspunnin persónur
    fr: personnage de fiction
    fy: personaazje
    ga: carachtar ficseanúil
    gd: caractar ficseanail
    gl: personaxe
    he: דמות
    hi: पात्र
    hr: izmišljeni lik
    ht: pèsonaj fiksyon
    hu: kitalált szereplő
    hy: գեղարվեստական կերպար
    ia: personage ficticie
    id: karakter fiktif
    io: Fiktiva personego
    it: personaggio fittizio
    ja: 架空のキャラクター
    ka: პერსონაჟი
    kab: awudem n talalest
    kk: кейіпкер
    kn: ಪಾತ್ರ
    ko: 허구의 캐릭터
    ks: خَیٲلی شاہ زٲدؠ
    ...
    sk: fiktívna postava
    sl: fiktivni lik
    smn: fiktiivlâš huáđđoo
    sq: personazh imagjinar
    sr: измишљена личност
    sv: rollfigur
    sw: wahusika
    ta: கற்பனை கதாபாத்திரம்
    te: కాల్పనిక పాత్ర
    tg: персонаж
    th: ตัวละคร
    tl: tauhan
...
### #is_/same_as :: [[/_Standards/Society/Communication/Genre/Fiction/Fictional_Characters|Fictional_Characters]] 

### #is_/same_as :: [[/_public/Society/Communication/Genre/Fiction/Fictional_Characters.public|Fictional_Characters.public]] 

### #is_/same_as :: [[/_internal/Society/Communication/Genre/Fiction/Fictional_Characters.internal|Fictional_Characters.internal]] 

### #is_/same_as :: [[/_protect/Society/Communication/Genre/Fiction/Fictional_Characters.protect|Fictional_Characters.protect]] 

### #is_/same_as :: [[/_private/Society/Communication/Genre/Fiction/Fictional_Characters.private|Fictional_Characters.private]] 

### #is_/same_as :: [[/_personal/Society/Communication/Genre/Fiction/Fictional_Characters.personal|Fictional_Characters.personal]] 

### #is_/same_as :: [[/_secret/Society/Communication/Genre/Fiction/Fictional_Characters.secret|Fictional_Characters.secret]] 
