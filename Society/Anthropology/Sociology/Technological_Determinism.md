...
dv_has_:
  name_:
    ...
    de: Technikdeterminismus
    el: Τεχνολογικός ντετερμινισμός
    en: technological determinism
    eo: teĥnika determinismo
    es: Determinismo tecnológico
    eu: Determinismo teknologiko
    fa: جبرگرایی فناورانه
    fi: Teknologinen determinismi
    fr: déterminisme technologique
    ha: Ƙididdigar fasaha
    he: דטרמיניזם טכנולוגי
    hi: प्रौद्योगिकीय नियतत्ववाद
    id: Determinisme teknologi
    it: determinismo tecnologico
    ja: 技術決定論
    ko: 기술 결정론
    la: Determinismus technologicus
    lv: Tehnoloģiskais determinisms
    ms: technological determinism
    nb: teknologideterminisme
    pl: determinizm technologiczny
    pms: Determinism tecnològich
    pt: determinismo tecnológico
    ru: технологический детерминизм
    sk: Technologický determinizmus
    sl: Tehnološki determinizem
    sr: Tehnološki determinizam
    sv: Teknologisk determinism
    ta: தொழில்நுட்பத் துணிபுவாதம்
    tr: Teknolojik belirlenimcilik
    uk: технологічний детермінізм
    vi: Quyết định luận công nghệ
    yue: 技術決定論
    zh: 技术决定论
---
...
> Technological determinism is a reductionist theory in assuming that 
> a society's technology progresses by following its own internal logic of efficiency, 
> while determining the development of the social structure and cultural values. 
> 
> The term is believed to have originated from Thorstein Veblen (1857–1929), 
> an American sociologist and economist. 
> 
> The most radical technological determinist in the United States in the 20th century 
> was most likely Clarence Ayres who was a follower of Thorstein Veblen as well as John Dewey. 
> 
> William Ogburn was also known for his radical technological determinism 
> and his theory on cultural lag.
>
