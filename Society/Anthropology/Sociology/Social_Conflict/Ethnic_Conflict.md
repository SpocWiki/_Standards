...
dv_has_:
  name_:
    ...
    eu: gatazka etniko
    fa: درگیری قومی
    fi: etninen konflikti
    fr: guerre ethnique
    ga: coinbhleacht eitneach
    gl: conflito étnico
    he: סכסוך אתני
    hi: जातीय संघर्ष
    hu: etnikai konfliktus
    id: Konflik etnis
    io: Etnala konflikto
    it: conflitto etnico
    ja: 民族紛争
    kk: Ұлтаралық қақтығыс
    ko: 민족 분쟁
    kw: kas ethnek
    ky: Улуттар аралык конфликт
    lt: Etninis konfliktas
    mk: меѓуетнички судири
    my: လူမျိုးရေးအဓိကရုဏ်းများ
    nb: etnisk konflikt
    nl: etnisch conflict
    oc: Conflicte etnic
    pa: ਨਸਲੀ ਟਕਰਾਅ
