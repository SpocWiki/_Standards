...
- Opinber stjórnsýsla
- Pagdudumara panpubliko
- Pampublikong pangangasiwa
- pentadbiran awam
- pubblica amministrazione
- Public administration
- public policy
- Publiche ministrazion
...
- Vėišāsis valdims
- zjawne zarjadnistwo
- ëffentlech Verwaltung
- ìṣàkóso ìjọba
- õõlmâs vaaldâšm
- öffentlechi Verwaltig
...
- ಸಾರ್ವಜನಿಕ ಆಡಳಿತ
- การบริหารรัฐกิจ
- ပြည်သူ့ရေးရာ စီမံခန့်ခွဲမှု
- საჯარო მმართველობა
- 公共行政
- 公共行政学
- 行政
- 행정
has_id_wikidata: Q31728
has_part_s_:
- '[[_Standards/WikiData/WD~public_office,294414|WD~public_office,294414]]'
- '[[_Standards/WikiData/WD~statutory_corporation,699386|WD~statutory_corporation,699386]]'
- '[[_Standards/WikiData/WD~public_management,1519782|WD~public_management,1519782]]'
- '[[_Standards/WikiData/WD~government_administration,3754526|WD~government_administration,3754526]]'
...
studied_by:
- '[[_Standards/WikiData/WD~science_of_public_administration,2736989|WD~science_of_public_administration,2736989]]'
- '[[_Standards/WikiData/WD~sociology_of_public_administration,125461740|WD~sociology_of_public_administration,125461740]]'
instance_of: '[[_Standards/WikiData/WD~executive_department,11426375|WD~executive_department,11426375]]'
subclass_of: '[[_Standards/WikiData/WD~civil_service,11771944|WD~civil_service,11771944]]'
Dewey_Decimal_Classification: 350
All_Science_Journal_Classification_Codes: 3321
U_S_National_Archives_Identifier: 10643542
short_name: APU
Commons_category: Public administration
dv_has_:
  name_:
    af: openbare administrasie
    ar: إدارة عامة
    ...
    gsw: öffentlechi Verwaltig
    he: מינהל ציבורי
    hi: लोक प्रशासन
    hr: državna uprava
    hsb: zjawne zarjadnistwo
    ht: Administrasyon piblik
    hu: közigazgatás
    hy: Հանրային կառավարում
    ia: Administration public
    id: administrasi publik
    io: Administro
    is: Opinber stjórnsýsla
    it: pubblica amministrazione
    ja: 行政
    ka: საჯარო მმართველობა
    kk: мемлекеттік басқару
    kn: ಸಾರ್ವಜನಿಕ ಆಡಳಿತ
    ko: 행정
    ky: Мамлекеттик башкаруу
    lb: ëffentlech Verwaltung
    ...
    nl: openbaar bestuur
    nn: offentleg forvalting
    oc: administracion publica
    pa: ਲੋਕ ਪ੍ਰਸ਼ਾਸਨ
    ...
    sd: پبلڪ ايڊمنسٽريشن
    se: almmolaš hálddahus
    sgs: Vėišāsis valdims
    sh: Državna uprava
    sk: verejná správa
    sl: javna uprava
    smn: almoshaldâttâh
...
> Public administration, or public policy and administration refers to 
> "the management of public programs", or 
> the "translation of politics into the reality that citizens see every day", 
> and also to the academic discipline which studies how public policy is created and implemented.
>
> In an academic context, 
> public administration has been described as the study of government decision-making; 
> the analysis of policies and the various inputs that have produced them; 
> and the inputs necessary to produce alternative policies. 
> 
