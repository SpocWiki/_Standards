...
- I01.880.853.400
- N01.824.737
Commons_category: Social change
dv_has_:
  name_:
    ar: تغير اجتماعي
    as: সামাজিক পৰিৱৰ্তন
    ...
    eu: Gizarte aldaketa
    fa: دگرگونی اجتماعی
    fi: sosiaalinen muutos
    fr: changement social
    ga: athruithe sóisialta
    gl: mudanza social
    gu: સામાજિક પરિવર્તન
    he: התפתחות חברתית
    hi: सामाजिक परिवर्तन
    hu: szociális változás
    hy: սոցիալական փոփոխություն
    id: Perubahan sosial
    ig: Mgbanwe mmekọrịta
    io: Sociala chanjo
    it: cambiamento sociale
    ja: 社会変動論
    jv: Ewahan sosial
    ko: 사회 변천
    ks: سَمٲجی بَدلاو
    lv: sociālās pārmaiņas
    mad: Aobâna sosial
    mk: општествени промени
    ...
    nn: samfunnsendring
    os: социалон ивындзинæдтæ
    pa: ਸਮਾਜਕ ਪਰਿਵਰਤਨ
    pl: zmiana społeczna
    pt: mudança social
    ro: schimbare socială
    ru: социальные изменения
    se: Servodatrievdan
    sh: Socijalni razvoj
    sl: družbena sprememba
    sq: ndryshim shoqëror
    sr: Друштвене промене
    sv: samhällsförändring
    tr: toplumsal değişim
    ug: جەمئىيەت ئۆزگىرىشى
    uk: соціальна зміна
    vec: cànbio sociałe
    vi: biến đổi xã hội
    zh: 社会变迁
