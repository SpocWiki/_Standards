...
related_image: http://commons.wikimedia.org/wiki/Special:FilePath/Helsinki%20Pride%20Parade%20I%20%285897488480%29.jpg
UMLS_CUI: C0026192
MeSH_tree_code: I01.880.853.300
dv_has_:
  name_:
    ak: Nnipakuo nketoa
    ar: أقلية
    ...
    ht: Minorite
    hu: kisebbség
    hy: Փոքրամասնությունների խմբեր
    id: minoritas
    ig: Otú ndị Peri mpe
    io: Minoritatala grupo
    it: minoranza
    ja: 社会的少数者
    ka: უმცირესობათა ჯგუფები
    ko: 소수 집단
    ku: Hindikayî
    la: Minoritas
    lt: mažuma
    ...
    stq: Minnerhaide
    sv: minoritetsgrupp
    sw: Kundi la wachache
    ta: சிறுபான்மையினர்
    tg: Ақалият
    tr: azınlık
    tt: азчылык
    uk: меншина
    vec: grupo menoritàrio
    vi: Nhóm thiểu số
    wuu: 少数群体
    yue: 弱勢社群
    zh: 少数群体
...
> The term "minority group" has different meanings, depending on the context. 
