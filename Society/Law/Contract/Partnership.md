...
- 合夥企業
- 파트너십
has_id_wikidata: Q728646
opposite_of: '[[_Standards/WikiData/WD~corporation,167037|WD~corporation,167037]]'
different_from:
- '[[_Standards/WikiData/WD~intimate_relationship,736922|WD~intimate_relationship,736922]]'
- '[[_Standards/WikiData/WD~Q28382149,28382149|WD~Q28382149,28382149]]'
described_by_source:
...
subclass_of:
- '[[_Standards/WikiData/WD~privately_held_company,1589009|WD~privately_held_company,1589009]]'
- '[[_Standards/WikiData/WD~private_company,5621421|WD~private_company,5621421]]'
instance_of: '[[_Standards/WikiData/WD~legal_form,10541491|WD~legal_form,10541491]]'
U_S_National_Archives_Identifier: 10646148
...
dv_has_:
  name_:
    ...
    fr: partenariat
    ga: comhpháirtíocht ghnó
    gsw: Personengesellschaft
    gu: ભાગીદારી કરારનામું
    he: שותפות
    hi: भागीदारी
    hr: Društvo osoba
    hu: partnerség
    hy: Գործընկերություն (բիզնես)
    id: Kemitraan
    it: partenariato
    ja: パートナーシップ
    ka: პარტნიორობა
    kn: ಪಾಲುದಾರಿಕೆ ಸಂಸ್ಥೆಗಳು
    ko: 파트너십
    lt: Partnerystė
    lv: partnerība
    mk: партнерство
...
> 
> Organizations may partner to increase the likelihood of each achieving their mission 
> and to amplify their reach. 
> 
