...
has_effect: '[[_Standards/WikiData/WD~execution,3966286|WD~execution,3966286]]'
image:
...
instance_of: '[[_Standards/WikiData/WD~manner_of_death,2438541|WD~manner_of_death,2438541]]'
...
practiced_by: '[[_Standards/WikiData/WD~executioner,207651|WD~executioner,207651]]'
subclass_of:
...
dv_has_:
  name_:
    ...
    sc: pena de morte
    scn: pena di morti
    sco: caipital punishment
    se: jápminráŋggáštus
    sgs: smertėis bausmie
    sh: smrtna kazna
    si: මරණිය දණ්ඩනය
    sk: trest smrti
    sl: smrtna kazen
    smj: jábmemstráffa
    smn: jäämmimráŋgáštâs
    sms: jääʹmmemraŋstõs
    so: ciqaab dilka
    sq: dënimi me vdekje
    sr: смртна казна
...
> is the state-sanctioned killing of a person as punishment for actual or supposed misconduct. 
> 
> The sentence ordering that an offender be punished in such a manner is known as a death sentence, 
> and the act of carrying out the sentence is known as an execution. 
> 
> A prisoner who has been sentenced to death and awaits execution is condemned 
> and is commonly referred to as being "on death row". 
> 
> Etymologically, the term capital (lit. 'of the head', derived via the Latin capitalis from caput, "head") 
> refers to execution by beheading, but executions are carried out by many methods, 
> including hanging, shooting, lethal injection, stoning, electrocution, and gassing.
>
