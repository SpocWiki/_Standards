...
- 著作權
- 저작권
has_id_wikidata: Q1297822
facet_of: '[[_Standards/WikiData/WD~intellectual_property,131257|WD~intellectual_property,131257]]'
opposite_of: '[[_Standards/WikiData/WD~copyleft,133475|WD~copyleft,133475]]'
described_by_source:
...
instance_of:
- '[[_Standards/WikiData/WD~exclusive_right,1146011|WD~exclusive_right,1146011]]'
- '[[_Standards/WikiData/WD~legal_concept,2135465|WD~legal_concept,2135465]]'
has_part_s_:
- '[[_Standards/WikiData/WD~publication_right,1285253|WD~publication_right,1285253]]'
- '[[_Standards/WikiData/WD~reproduction_right,2857297|WD~reproduction_right,2857297]]'
- '[[_Standards/WikiData/WD~broadcasting_rights,12058576|WD~broadcasting_rights,12058576]]'
- '[[_Standards/WikiData/WD~adaptation_right,24808942|WD~adaptation_right,24808942]]'
- '[[_Standards/WikiData/WD~translation_rights,29562412|WD~translation_rights,29562412]]'
history_of_topic: '[[_Standards/WikiData/WD~history_of_copyright_law,1517530|WD~history_of_copyright_law,1517530]]'
has_characteristic: '[[_Standards/WikiData/WD~duration,2199864|WD~duration,2199864]]'
replaces: '[[_Standards/WikiData/WD~hanken,11569983|WD~hanken,11569983]]'
different_from:
- '[[_Standards/WikiData/WD~Copyright_symbol,17987556|WD~Copyright_symbol,17987556]]'
- "[[_Standards/WikiData/WD~author's_rights,38746|WD~author's_rights,38746]]"
subclass_of: '[[_Standards/WikiData/WD~intellectual_property_right,108855835|WD~intellectual_property_right,108855835]]'
...
depicted_by: '[[_Standards/WikiData/WD~_,11195|WD~_,11195]]'
part_of: "[[_Standards/WikiData/WD~author's_rights,38746|WD~author's_rights,38746]]"
U_S_National_Archives_Identifier: 10638318
Commons_gallery: Copyright
Commons_category: Copyright
OmegaWiki_Defined_Meaning: 855298
icon: http://commons.wikimedia.org/wiki/Special:FilePath/Copyright%20symbol.png
WordLift_URL: http://data.thenextweb.com/tnw/entity/copyright
described_at_URL: http://onlinebooks.library.upenn.edu/cce/firstperiod.html
Stack_Exchange_tag: https://anime.stackexchange.com/tags/copyright
ACM_Classification_Code_2012_: 10003464
UMLS_CUI: C0009993
MeSH_tree_code:
- I01.880.604.583.458.300
- L01.737.360
- N03.706.535.518.300
dv_has_:
  name_:
    ...
    bho: कॉपीराइट
    bn: স্বাত্বাধিকার
    bs: Kršenje autorskih prava
    ca: drets d'autor
    ceb: Pamalaod sa awtor
    ch: Direchun i mantituge'
    ckb: مافی لەبەرگرتنەوە
    cs: autorské právo
    cv: Автор тивĕç-ирĕкĕ
    cy: Hawlfraint
    da: ophavsret
    de: Urheberrecht
    ...
    ia: Derecto de autor
    id: hak cipta
    ilo: karbengan ti kopia
    io: Autor-yuro
    is: Höfundaréttur
    it: copyright
    ja: 著作権
    jbo: si'o fukzifypo'e
    jv: Hak cipta
    ka: საავტორო უფლება
    kk: Авторлық куәлік
    kn: ಕೃತಿಸ್ವಾಮ್ಯ
    ...
    sco: copyricht
    sd: حق۽ واسطا
    se: dahkkivuoigatvuohta
    sh: Autorsko pravo
    si: ප්රකාශන හිමිකම
    sk: Autorské právo
    sl: avtorske pravice
    sma: maadthdarjomereakta
    smj: dahkkerievtesvuohta
    smn: rähteevuoigâdvuotâ
...
> that gives its owner the exclusive legal right to copy, distribute, adapt, display, 
> and perform a creative work, usually for a limited time. 
> 
