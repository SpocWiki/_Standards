...
Wolfram_Language_entity_code: Entity["Concept", "Sexism::z5nw6"]
MeSH_tree_code:
- F01.145.813.550.750
- F01.145.813.629.750
- F01.829.595.750
IPTC_NewsCode: mediatopic/20000779
dv_has_:
  name_:
    af: seksisme
    anp: लिंगवाद
    ...
    mt: sessiżmu
    mwl: sexismo
    nan: sèng-pia̍t-chú-gī
    nb: kjønnsdiskriminering
    ne: लैंगिक विभेदता
    new: लिङ्गभेद
    nl: seksisme
    oc: sexisme
    ...
    ta: பாலின வாதம்
    tg: таъбизи ҷинсиятӣ
    th: ลัทธิกีดกันทางเพศ
    tl: seksismo
    tn: go tlhaola batho ka bong
    tr: cinsiyetçilik
    ts: xihlawuhlawu xa rimbewu
    uk: сексизм
    ur: جنسی امتیاز
    uz: gender kamsitish
    ve: tshitalula kha sia la zwa mbeu
    vi: phân biệt giới tính
    vro: seksism
    wuu: 性别歧视主义
    xal: сексизм
...
> It has been linked to gender roles and stereotypes, and may include 
...
> Discrimination in this context is defined as discrimination toward people 
> based on their gender identity or their gender or sex differences. 
> 
> Sexism refers to violation of equal opportunities (formal equality) based on gender or refers to violation of equality of outcomes based on gender, also called substantive equality. Sexism may arise from social or cultural customs and norms.
>
