...
- kulto ëd personalidad
- kultu king personalidad
- kultus individu
- Kultus personaliti
- Kò-jîn chông-pài
- lid ar bersonelezh
...
subclass_of: '[[_Standards/WikiData/WD~cult,756820|WD~cult,756820]]'
opposite_of: '[[_Standards/WikiData/WD~unperson,2713555|WD~unperson,2713555]]'
model_item: "[[_Standards/WikiData/WD~Joseph_Stalin's_cult_of_personality,4180510|WD~Joseph_Stalin's_cult_of_personality,4180510]]"
partially_coincident_with: '[[_Standards/WikiData/WD~personalismo,9058655|WD~personalismo,9058655]]'
has_list: '[[_Standards/WikiData/WD~list_of_cults_of_personality,19893128|WD~list_of_cults_of_personality,19893128]]'
...
dv_has_:
  name_:
    ...
    eo: kulto de personeco
    es: culto a la personalidad
    et: Isikukultus
    eu: pertsonaganako kultu
    fa: کیش شخصیت
    fi: henkilökultti
    fr: culte de la personnalité
    gl: culto á personalidade
    he: פולחן אישיות
    hi: व्यक्तित्व पूजा
    hil: kulto sa personalidad
    hr: Kult ličnosti
    hu: személyi kultusz
    hy: անձի պաշտամունք
    id: kultus individu
    ...
    lv: personības kults
    mk: Култ на личноста
    mn: Нэг хүнийг тахин шүтэх үзэл
    ms: Kultus personaliti
    nan: Kò-jîn chông-pài
    nb: Personkult
    nl: persoonsverheerlijking
    pa: ਸ਼ਖ਼ਸੀਅਤ ਪੂਜਾ
    pag: kulto ëd personalidad
    pam: kultu king personalidad
    pfl: Personenkult
    pl: kult jednostki
    pt: culto de personalidade
    ro: cultul personalității
    ru: культ личности
    sco: Cult o personality
    sh: Kult ličnosti
    sk: kult osobnosti
    sl: kult osebnosti
    sq: Kult i individit
