...
aliases:
- Chigaŵa chavisankho
- circonscripcion electorala
- circonscription électorale
- Circoscrision ełetorałe
- circoscrizione elettorale
- circulus comitialis
- circumscripció electoral
- circumscripție electorală
- circunscripción electoral
- circunscripción eleutoral
- constituency
- círculo eleitoral
- daerah pemilihan
- districto electoral
...
- '[[_Standards/WikiData/WD~electoral_college,1141323|WD~electoral_college,1141323]]'
has_characteristic:
- '[[_Standards/WikiData/WD~connectedness,253405|WD~connectedness,253405]]'
- '[[_Standards/WikiData/WD~equality,842346|WD~equality,842346]]'
partially_coincident_with: '[[_Standards/WikiData/WD~ward,596321|WD~ward,596321]]'
subclass_of:
...
different_from: '[[_Standards/WikiData/WD~electoral_unit,20755075|WD~electoral_unit,20755075]]'
Wikidata_property:
- electoral district
...
dv_has_:
  name_:
    ...
    ta: தேர்தல் தொகுதி
    te: నియోజక వర్గం
    tg: Ҳавзаи интихоботӣ
    th: เขตเลือกตั้ง
    tr: seçim çevresi
    tum: Chigaŵa chavisankho
    udm: быръён ёрос
    uk: виборчий округ
    ur: حلقہ انتخاب
    vec: Circoscrision ełetorałe
    vi: khu vực bầu cử
    wuu: 选区
    yue: 選區
    zh: 選區
