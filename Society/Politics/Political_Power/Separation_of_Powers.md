...
different_from:
- '[[_Standards/WikiData/WD~decentralization,188961|WD~decentralization,188961]]'
- '[[_Standards/WikiData/WD~balance_of_power,1125082|WD~balance_of_power,1125082]]'
...
- '[[_Standards/WikiData/WD~power_sharing,107969678|WD~power_sharing,107969678]]'
facet_of: '[[_Standards/WikiData/WD~risk_management,189447|WD~risk_management,189447]]'
opposite_of: '[[_Standards/WikiData/WD~fusion_of_powers,2093159|WD~fusion_of_powers,2093159]]'
topic_has_template: '[[_Standards/WikiData/WD~Template_Separation_of_powers,20727942|WD~Template_Separation_of_powers,20727942]]'
instance_of:
...
dv_has_:
  name_:
    ...
    et: Võimude lahusus
    eu: botereen banaketa
    fa: اصل تفکیک قوا
    fi: vallanjako-oppi
    fo: Valdstríbýti
    fr: séparation des pouvoirs
    ga: scaradh cumhachtaí
    ...
    hr: dioba vlasti
    ht: Pouvwa piblik
    hu: a hatalmi ágak szétválasztása
    hy: Իշխանությունների բաժանում
    id: pemisahan kekuasaan
    is: Skipting ríkisvaldsins
    it: separazione dei poteri
    ja: 権力分立
    jv: Pamisahan kakuwasan
    ka: ხელისუფლების დანაწილება
    kk: Биліктердің бөлінуі
    km: ការបែងចែកអំណាច
    ko: 권력 분립
    ky: Бийликтин бөлүнүү теориясы
    la: Trias politica
    lmo: Separazion di podè
    lo: ການແຍກໃຊ້ອຳນາດ
    lt: valdžių padalijimo principas
    lv: Valsts varas dalīšana
    mg: Fisaraham-pahefana
    mk: поделба на власта
    ml: അധികാര പൃഥക്കരണം
    mr: राज्यकारभाराच्या शाखा
    ms: Pembahagian kuasa
    nan: Hun-koân
    nb: maktfordelingsprinsippet
    ...
    ru: разделение власти
    sco: separation o pouers
    sh: Podjela vlasti
    si: බලතල බෙදීමේ න්යාය
    sk: Deľba moci
    sl: ločitev oblasti
    sr: Подјела власти
    sv: maktdelningsprincipen
    sw: Mgawanyo wa madaraka
    ta: அதிகாரங்களைப் பிரித்துவைத்தல்
    tg: Ҷудоии ҳокимиятҳо
    th: การแยกใช้อำนาจ
    tl: Paghihiwalay ng mga kapangyarihan
    tr: kuvvetler ayrılığı
    uk: розділення влади
    vec: Separasion dei poderi
    vi: tam quyền phân lập
    war: Pagbulagbulag han gahom
    wuu: 权力分立
