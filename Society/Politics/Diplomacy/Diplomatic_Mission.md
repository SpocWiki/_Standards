...
- Кылгудо
- Элчин сайдын яам
- Դիվանագիտական ներկայացուցչություն
- נציגות דיפלומטית
- باڵیۆزخانە
- بعثة دبلوماسية
- سفارت
...
page_banner: http://commons.wikimedia.org/wiki/Special:FilePath/Embassy%20banner.jpg
Commons_category: Diplomatic missions
OpenStreetMap_tag_or_key: Tag:office=diplomatic
dv_has_:
  name_:
    af: Diplomatieke sending
    ar: بعثة دبلوماسية
    ast: misión diplomática
    az: səfirlik
    ...
    hy: Դիվանագիտական ներկայացուցչություն
    id: Kedutaan besar
    is: Pólítísk sendiför
    it: missione diplomatica
    ja: 在外公館
    ka: დიპლომატიური წარმომადგენლობა
    ko: 외교 공관
    la: Missio diplomatica
    lad: Buró Diplomátiko
    lt: diplomatinė atstovybė
    lv: diplomātiskā pārstāvniecība
    mhr: Кылгудо
    ...
    ur: سفارتخانہ
    uz: Diplomatik vakillik
    vec: Agente diplomatego
