...
- '[[_Standards/WikiData/WD~environmental_risk,6108838|WD~environmental_risk,6108838]]'
...
- '[[_Standards/WikiData/WD~emergency,5070802|WD~emergency,5070802]]'
described_by_source:
...
dv_has_:
  name_:
    ...
    de: Ausnahmezustand
    diq: Halo normalser
    el: κατάσταση εκτάκτου ανάγκης
    en: state of emergency
    eo: krizostato
    es: estado de emergencia
    et: eriolukord
    eu: salbuespen egoera
    fa: وضعیت اضطراری
    fi: poikkeustila
    fr: état d'urgence
    ga: staid éigeandála
    gl: estado de emerxencia
    he: מצב חירום
    hr: Izvanredno stanje
    hu: szükségállapot
    hy: արտակարգ դրություն
    id: keadaan darurat
    it: stato di emergenza
    ja: 非常事態宣言
    ka: საგანგებო მდგომარეობა
    kn: ತುರ್ತು ಪರಿಸ್ಥಿತಿ
    ko: 비상사태
    ku: Rewşa awerte
    ky: Өзгөчө кырдаал
    lb: Ausnamzoustand
    lt: nepaprastoji padėtis
    lzh: 緊急之勢
    mk: Вонредна состојба
    ml: അടിയന്തിരാവസ്ഥ
    ms: darurat
    my: နိုင်ငံတော် အရေးပေါ်အခြေအနေ
    nb: unntakstilstand
    ne: सङ्कटकाल
    nl: noodtoestand
    nn: Unntakstilstand
...
> A state of emergency is a situation 
> in which a government is empowered to put through policies 
> that it would normally not be permitted to do, 
> for the safety and protection of its citizens. 
> 
> A government can declare such a state before, during, or after a 
> - natural disaster, 
> - civil unrest, 
> - armed conflict, 
> - medical pandemic or epidemic 
> - or other biosecurity risk.
>
