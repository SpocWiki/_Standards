...
- I-lāi-tē
- Landbūnes
- Listo pri nesuverena teritorii
- lãnh thổ phụ thuộc
- mendeko lurralde
- odvisno ozemlje
...
- Territorios dependients
- territoriu dependiente
- territorium obnoxium seu separatum
- territòri dependent
- território dependente
- terytorium zależne
- tiriogaeth ddibynnol
- Wewengkon depéndensi
- wilayah dependensi
- wilayah tanggungan
- wotwisny kraj
- zavisna teritorija
- závislé území
- εξαρτημένη περιοχή
- буйсындырылган территория
- Буйһонған территория
- Зависима територия
...
dv_has_:
  name_:
    af: afhanklike gebiede
    an: Territorios dependients
    ang: Landbūnes
    ar: تبعية
    arz: الاراضى التابعه
    ast: territoriu dependiente
    az: asılı ərazi
    ...
    ca: territori dependent
    cdo: Sṳ̆k-dê
    cs: závislé území
    cy: tiriogaeth ddibynnol
    da: afhængigt territorium
    de: abhängiges Gebiet
    diq: Cao beste
    el: εξαρτημένη περιοχή
    en: dependent territory
    eo: dependanta teritorio
    es: territorio dependiente
    et: sõltuv territoorium
    eu: mendeko lurralde
    fa: قلمروی وابسته
    fi: riippuvainen alue
    fo: Hjáland
    fr: territoire dépendant
    ga: spleáchríoch
    gl: territorio dependente
    hak: Hói-ngoi Liâng-thi
    he: טריטוריה תלויה
    hi: अधीन क्षेत्र
    hr: Popis zavisnih teritorija
    hsb: wotwisny kraj
    hu: függő terület
    hy: կախյալ տարածքներ
    ia: territorio dependente
    id: wilayah dependensi
    ilo: agkamkammatalek a teritorio
    io: Listo pri nesuverena teritorii
    is: Hjálenda
    it: territorio dipendente
    ja: 属領
    jv: Wilayah dependensi
    ka: დამოკიდებული ტერიტორიების სია
    kab: akal ugil
    kk: Тәуелді аймақ
    kn: ಆಶ್ರಿತ ರಾಜ್ಯಗಳು
    ko: 속령
    la: territorium obnoxium seu separatum
    li: Aafhenkelike gebejer
    lt: priklausanti teritorija
    lv: atkarīgā teritorija
    mk: зависна територија
    mn: Хараат нутаг дэвсгэр
    ms: wilayah tanggungan
    nan: I-lāi-tē
    nb: biland
    ne: आश्रित क्षेत्र
    nl: afhankelijk gebied
    nn: biland
    oc: territòri dependent
    pih: Dapendincii
    ...
    sah: тутулуктаах сир
    sco: Owerseas territories
    sd: منحصر علائقو
    sh: Popis zavisnih teritorija
    sl: odvisno ozemlje
    sq: territor i varur
    ...
    sw: Eneo tegemezi
    ta: சார்பு மண்டலம்
    th: ดินแดนในภาวะพึ่งพิง
    tl: Teritoryong panlabas
    tr: bağlı toprak
    tt: буйсындырылган территория
    uk: залежна територія
    ur: منحصر علاقہ
    vec: teritori dipendenti
    vi: lãnh thổ phụ thuộc
    wuu: 屬地
    xmf: დოჸუნელი ტერიტორია
    yue: 屬地
...
### #is_/same_as :: [[/_Standards/Society/Politics/Government/Colonialism/Dependent_Territory|Dependent_Territory]] 

### #is_/same_as :: [[/_public/Society/Politics/Government/Colonialism/Dependent_Territory.public|Dependent_Territory.public]] 

### #is_/same_as :: [[/_internal/Society/Politics/Government/Colonialism/Dependent_Territory.internal|Dependent_Territory.internal]] 

### #is_/same_as :: [[/_protect/Society/Politics/Government/Colonialism/Dependent_Territory.protect|Dependent_Territory.protect]] 

### #is_/same_as :: [[/_private/Society/Politics/Government/Colonialism/Dependent_Territory.private|Dependent_Territory.private]] 

### #is_/same_as :: [[/_personal/Society/Politics/Government/Colonialism/Dependent_Territory.personal|Dependent_Territory.personal]] 

### #is_/same_as :: [[/_secret/Society/Politics/Government/Colonialism/Dependent_Territory.secret|Dependent_Territory.secret]] 
