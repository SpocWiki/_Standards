...
- сувязі з грамадзкасьцю
- сувязі з грамадскасцю
- җәмәгәтьчелек белән элемтәләр
- հանրային կապեր
- հասարակաց կապեր
- יחסי ציבור
...
dv_has_:
  name_:
    ...
    ckb: پەیوەندییە گشتییەکان
    cs: public relations
    cy: Cysylltiadau cyhoeddus
    da: PR
    ...
    ga: caidreamh poiblí
    gl: relacións públicas
    he: יחסי ציבור
    hi: जनसंपर्क
    hr: Odnosi s javnošću
    hu: közönségkapcsolatok
    hy: հանրային կապեր
    hyw: հասարակաց կապեր
    ...
    nl: public relations
    nn: informasjonsarbeid
    pam: Ugnayang pangmalda
    pl: public relations
    ps: عامه اړیکې
    ...
    tr: halkla ilişkiler
    tt: җәмәгәтьчелек белән элемтәләр
    uk: зв’язки з громадськістю
    ur: تعلقات عامہ
    uz: PR
    vec: pùbleghe rełasion
...
#is_/same_as :: [[_Standards/WikiData/WD~Public_relations,133080|WD~Public_relations,133080]] 
