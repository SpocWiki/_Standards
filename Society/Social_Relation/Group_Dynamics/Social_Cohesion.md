...
MeSH_tree_code:
- F01.829.401.694.500
- I01.880.853.500.525.500
- N01.224.791.775.500
- N03.055.750.500
- N06.850.505.400.800.775.500
dv_has_:
  name_:
    ar: تماسك الجماعة
    ast: Cohesión social
    ...
    eu: Gizarte-kohesio
    fa: انسجام گروهی
    fi: sosiaalinen koheesio
    fr: cohésion sociale
    gl: Cohesión social
    he: לכידות קבוצתית
    hy: Խմբային միաբանվածություն
    id: Kohesivitas kelompok
    it: coesione sociale
    ja: 集団凝集性
    ko: 집단 응집성
    lv: sociālā salieētība
    nb: Sammenhengskraft
    nl: sociale cohesie
    pl: Spójność grupy
    pt: coesão social
    ro: coeziune socială
    ru: групповая сплочённость
    sah: Сомоҕолоһуу
...
> Group cohesiveness, also called group cohesion, social harmony or social cohesion, 
> is the degree or strength of bonds linking members of a social group to one another 
> and to the group as a whole. 
> 
> Although cohesion is a multi-faceted process, 
> it can be broken down into four main components: 
> - social relations, task relations, perceived unity, and emotions. 
> 
> Members of strongly cohesive groups are more inclined 
> to participate readily and to stay with the group.
>
