...
dv_has_:
  name_:
    ...
    bs: društveni pokret
    ca: moviment social
    ckb: بزاڤی کۆمەڵایەتی
    co: muvimentu sociale
    cs: sociální hnutí
    cy: mudiad cymdeithasol
    da: social bevægelse
    de: soziale Bewegung
    el: κοινωνικό κίνημα
    en: social movement
    ...
    fj: Veitosoyaki vakaveiwekani
    fr: mouvement social
    fy: sosjale beweging
    ga: gluaiseacht shóisialta
    gcr: Mouvman sosyal
    gl: movemento social
    ha: harkar zamantakewa
    he: תנועה חברתית
    hi: सामाजिक आन्दोलन
    hr: pokret
    hsb: socialne hibanje
    ht: Mouvman sosyal
    hu: társadalmi mozgalom
    hy: Սոցիալական շարժում
    id: Gerakan sosial
    io: Sociala movadi
    it: movimento
    ja: 社会運動
    jam: Suoshal muuvment
    ka: საზოგადოებრივი მოძრაობა
    kk: Қоғамдық қозғалыс
    kn: ಸಾಮಾಜಿಕ ಆಂದೋಲನ
    ko: 사회 운동
    ku: tevgera civakî
...
> A social movement is either a loosely or carefully organized effort 
> by a large group of people to achieve a particular goal, typically a social or political one. 
> 
