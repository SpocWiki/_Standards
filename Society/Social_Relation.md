...
- Interaksi sosial
- iğtimagyj mönäsäbätlär
- jámiyetlik múnásibetler
- quan hệ xã hội
- rapport social
- relació social
- relación social
...
- sociālās attiecības
- sosiaalinen suhde
- sosiaallâš koskâvuotâ
- sosiaalʼlaž kõskkvuõtt
- sosial relasjon
- sosial əlaqə
- sosiale verhouding
- sosiála gaskavuohta
...
- älewmettik qarım-qatınıstar
- əлеуметтік қарым-қатыныстар
- κοινωνικές σχέσεις
- велесядонь сюлмавомат
- друштвени однос
- друштвени односи
...
dv_has_:
  name_:
    ...
    hsb: socialny poćah
    hu: társas kapcsolat
    hy: Հասարակական հարաբերություններ
    id: Interaksi sosial
    io: Sociala relato
    it: relazione sociale
    ja: 社会関係
    ...
    lb: sozial Bezéiung
    lt: visuomeniniai santykiai
    lv: sociālās attiecības
    mk: општествен однос
