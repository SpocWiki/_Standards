...
dv_has_:
  name_:
    ...
    fr: avion militaire
    ga: aerárthach míleata
    gl: aeronave militar
    he: כלי טיס צבאי
    hr: vojna letjelica
    hu: katonai repülőgép
    hy: ռազմական օդանավ
    id: Pesawat militer
    io: Milital aviacilo
    it: aeromobile militare
    ja: 軍用機
    ka: საბრძოლო თვითმფრინავები
    kk: Әскери қызметтегі ұшақтар
    ko: 군용기
    lb: Militärfliger-Typen
    lt: Karinis orlaivis
    mk: воено летало
    ml: പോർവിമാനം
    ms: Pesawat tentera
    nb: militærfly
    nl: militair luchtvaartuig
    nn: militærfly
    oc: avion militar
    pl: samolot wojskowy
    pms: Avion militar
    pt: aeronave militar
    ro: avion militar
    ru: военно-воздушное судно
    sk: Vojenské lietadlo
    ...
    sw: Ndege ya kijeshi
    ta: போர் வானூர்தி
    th: อากาศยานทางการทหาร
    tr: askerî hava aracı
    uk: військовий літак
    ur: عسکری طیارہ
    vi: máy bay quân sự
    yue: 軍用飛行器
