...
subclass_of: '[[_Standards/WikiData/WD~strategy,185451|WD~strategy,185451]]'
is_part_of: '[[_Standards/WikiData/WD~military_art,2560087|WD~military_art,2560087]]'
...
dv_has_:
  name_:
    af: militêre strategie
    ar: إستراتيجية عسكرية
    ...
    bs: vojna strategija
    ca: estratègia militar
    ckb: ستراتیژیی سەربازی
    cs: vojenská strategie
    cy: strategaeth filwrol
    da: militærstrategi
    de: Militärstrategie
    el: στρατιωτική στρατηγική
    en: military strategy
    eo: milita strategio
    es: estrategia militar
    eu: estrategia militar
    fa: راهبرد نظامی
    fi: sodankäynnin strategia
    fr: stratégie militaire
    fy: oarlochfiering
    ga: straitéis mhíleata
    gl: estratexia militar
    he: אסטרטגיה צבאית
    hi: सैन्य रणनीति
    hr: vojna strategija
    hu: hadászat
    hy: Ռազմական ստրատեգիա
    id: strategi perang
    it: strategia militare
    ja: 軍事戦略
    ...
    li: kriegsveuring
    lt: strategija
    lv: militārā stratēģija
    mk: воена стратегија
    mn: цэргийн тактик
    ms: strategi ketenteraan
    mt: strateġija militari
    my: စစ်ရေးနည်းဗျူဟာ
    nb: strategisk nivå
    nl: militaire strategie
    nn: strategisk nivå
    pl: strategia wojskowa
    pt: estratégia militar
    ro: strategie militară
    ru: военная стратегия
    sh: strategija
    si: යුධෝපක්රම
    sk: vojenská stratégia
    ...
    tr: askeri strateji
    uk: військова стратегія
    uz: harbiy strategiya
