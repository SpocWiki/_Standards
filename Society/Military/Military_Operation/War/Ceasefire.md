...
different_from:
- '[[_Standards/WikiData/WD~armistice,107706|WD~armistice,107706]]'
- '[[_Standards/WikiData/WD~peace_treaty,625298|WD~peace_treaty,625298]]'
- '[[_Standards/WikiData/WD~debellatio,971076|WD~debellatio,971076]]'
subclass_of:
- '[[_Standards/WikiData/WD~agreement,2006324|WD~agreement,2006324]]'
- '[[_Standards/WikiData/WD~historical_event,13418847|WD~historical_event,13418847]]'
- '[[_Standards/WikiData/WD~pause,17562059|WD~pause,17562059]]'
facet_of: '[[_Standards/WikiData/WD~law_of_war,6833880|WD~law_of_war,6833880]]'
studied_by: '[[_Standards/WikiData/WD~war_termination,7968744|WD~war_termination,7968744]]'
...
> A **Ceasefire** (also known as a truce), also spelled cease-fire (the antonym of 'open fire'), 
> is a stoppage of a war in which each side agrees with the other to suspend aggressive actions, 
> often due to mediation by a third party. 
...
> They may occur via mediation or otherwise as part of a peace process 
> or be imposed by United Nations Security Council resolutions 
> via Chapter VII of the United Nations Charter. 
> 
> A ceasefire can be temporary with an intended end date 
> or may be intended to last indefinitely. 
> A ceasefire is distinct from an armistice in that 
> the armistice is a formal end to a war whereas a ceasefire may be a temporary stoppage.
>
