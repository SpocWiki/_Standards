...
Commons_category: Scorched earth (military)
dv_has_:
  name_:
    ...
    he: אדמה חרוכה
    hr: spaljena zemlja
    hu: felperzselt föld taktikája
    hy: Այրված հողի մարտավարություն
    id: Bumi hangus
    it: terra bruciata
    ja: 焦土作戦
    jv: Bumi branang
    ko: 초토화
    lt: Išdeginta žemė
    lv: izdedzinātās zemes taktika
    mk: изгорена земја
    ms: Bumi hangus
    nb: brent jords taktikk
    nl: tactiek van de verschroeide aarde
    nn: den brende jords taktikk
...
#is_/same_as :: [[_Standards/WikiData/WD~Scorched_earth,208485|WD~Scorched_earth,208485]] 

## #has_/text_of_/abstract 

> A scorched-earth policy is a military strategy of destroying anything 
> that allows an enemy military force to be able to fight a war, 
> including the deprivation and destruction of water, food, humans, animals, plants 
> and any kind of tools and infrastructure. 
> 
> Its use is possible by a retreating army to leave nothing of value worth taking, 
> to weaken the attacking force, or by an advancing army to fight against unconventional warfare.
>
> Scorched earth against non-combatants 
> has been banned under the 1977 Geneva Conventions.
>
