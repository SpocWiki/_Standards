...
- Entmilitariséiert Zon
- gedemilitariseerde zone
- gune desmilitarizatu
- Kawasan bebas tentera
- Khu phi quân sự
- senarmeigita zono
...
- Демилитаризатсияи қаламрав
- демилитаризирана зона
- демилитаризована зона
- демилитаризованная зона
- Демилитарландырылған аймақ
- дэмілітарызаваная зона
- Сэрэггүй бүһэ
- ապառազմականացված տարածք
- אזור מפורז
...
dv_has_:
  name_:
    ...
    bxr: Сэрэггүй бүһэ
    ca: zona desmilitaritzada
    cs: demilitarizované pásmo
    cy: cyn faes y gad
    ...
    eu: gune desmilitarizatu
    fa: منطقه غیرنظامی
    fi: demilitarisoitu alue
    fr: zone démilitarisée
    gl: Zona desmilitarizada
    he: אזור מפורז
    hr: Demilitarizirano područje
    hu: demilitarizált övezet
    hy: ապառազմականացված տարածք
    id: Zona demiliterisasi
    it: zona demilitarizzata
    ja: 非武装地帯
    kk: Демилитарландырылған аймақ
    ko: 비무장 지대
    la: Zona dearmata
    lb: Entmilitariséiert Zon
    lt: Demilitarizuota zona
    lv: Demilitarizēta zona
    mk: Демилитаризирана зона
    ms: Kawasan bebas tentera
    nb: demilitarisert sone
    nl: gedemilitariseerde zone
    nn: demilitarisert sone
    oc: Zòna desmilitarizada
    pl: strefa zdemilitaryzowana
    pt: zona desmilitarizada
    ru: демилитаризованная зона
    ...
    th: เขตปลอดทหาร
    tr: askerden arındırılmış bölge
    uk: демілітаризована зона
    ur: غیر فوجی علاقہ
    vi: Khu phi quân sự
