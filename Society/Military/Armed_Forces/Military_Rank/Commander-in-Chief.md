...
dv_has_:
  name_:
    ang: Hēafodcampealdor
    ar: رئيس أركان
    ast: Comandante en Xefe
    az: Ali Baş Komandan
    ba: баш командующий
    ...
    ga: ardcheannasaí
    gd: àrd-chomandair
    gl: Comandante en xefe
    grc: στρατηγὸς αὐτοκράτωρ
    gv: ard-anneyder
    he: מפקד עליון
    hi: प्रधान सेनापति
    hr: Vrhovni zapovjednik
    hu: főparancsnok
    hy: Գերագույն գլխավոր հրամանատար
    ia: commandante in chef
    id: panglima tertinggi
    it: comandante in capo
    ja: 最高指揮官
    ka: მხედართმთავარი
    kk: Жоғарғы Бас Қолбасшы
    kn: ಮಹಾದಂಡನಾಯಕ
    ko: 총사령관
    ku: serfermandar
    ...
    lv: Virspavēlnieks
    lzh: 將帥
    mk: врховен заповедник
    ms: Panglima Tertinggi
    my: စစ်ဦးစီးချုပ်
    nb: øverstkommanderende
    ne: कमान्डर-इन-चिफ
    nl: opperbevelhebber
    nn: øvstkommanderande
    oc: Comandant en cap
    os: сæйрагкъамандыгæнæг
    pa: ਕਮਾਂਡਰ-ਇਨ-ਚੀਫ਼
    pl: głównodowodzący
    ps: د پوځي قوماندانانو مشر
    pt: comandante em chefe
    ro: comandant suprem
    ru: главнокомандующий
    sa: सेनापतिः
    sco: commander-in-chief
    se: allahoavda
    sh: Vrhovni komandant
    sl: vrhovni poveljnik
    smn: pajehovdâ
    sms: pâʹjjšuurmõs
    sq: Komandanti i përgjithshëm
    sr: врховни заповедник
    sv: överbefälhavare
    sw: Amirijeshi mkuu
    tg: фармондеҳи кулл
    th: จอมทัพ
    tl: commander-in-chief
    tr: Başkomutan
    tt: баш командующий
...
> A **Commander-in-chief** or supreme commander (supreme commander-in-chief) 
> is the person who exercises supreme command and control over an armed force or a military branch. 
> 
> As a technical term, it refers to military competencies that reside in a country's executive leadership, 
> a head of state, head of government, or other designated government official.
>
> While often used interchangeably, the title of Supreme Commander–in–Chief is technically different, 
> since the two titles can be in use simultaneously. 
> 
> For example, in the case of the Armed Forces of Ukraine, 
> the supreme commander-in-chief is the president of Ukraine, 
> while the commander-in-chief is its professional head.
>
