...
- paramiłitare
- paravojaška organizacija
- paravojna formacija
- paravojna organizacija
- paravojna postrojba
- puolisotilaallinen järjestö
- reagheydys fo-hidooragh
- rêxistina paramîlîter
...
dv_has_:
  name_:
    ...
    bs: paravojna organizacija
    ca: organització paramilitar
    ckb: نیمچە سەربازی
    cs: paramilitantní jednotka
    cy: sefydliad parafilwrol
    da: Paramilitær
    de: Paramilitär
    ...
    eu: Paramilitar
    fa: نظامینما
    fi: puolisotilaallinen järjestö
    fr: paramilitaire
    ga: paraimíleatach
    gl: organización paramilitar
    gv: reagheydys fo-hidooragh
    he: כוח צבאי-למחצה
    hi: अर्धसैनिक बल
    hr: paravojna postrojba
    hu: félkatonai szervezet
    hy: ռազմական կազմակերպություն
    id: paramiliter
    it: organizzazione paramilitare
    ja: 準軍事組織
    ...
    ml: പാരാമിലിട്ടറി
    ms: Separa tentera
    my: လက်နက်ကိုင် အဖွဲ့အစည်း
    mzn: شبهه نظامی سازمان
    nb: paramilitær
    nl: paramilitair
    nn: paramilitær
    oc: Paramilitar
    pl: organizacja paramilitarna
    pt: força paramilitar
    ro: organizație paramilitară
    ru: военизированная организация
    scn: Paramilitari
    sh: paravojna formacija
    si: පැරාමිලිටරි
    ...
    th: กำลังกึ่งทหาร
    tr: paramiliter kuvvet
    uk: напіввійськова організація
    ur: نیم فوج
    vec: paramiłitare
