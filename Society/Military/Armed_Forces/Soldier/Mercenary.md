...
category_for_eponymous_categories: '[[_Standards/WikiData/WD~Q59522212,59522212|WD~Q59522212,59522212]]'
part_of: '[[_Standards/WikiData/WD~mercenary_organization,59662559|WD~mercenary_organization,59662559]]'
instance_of: '[[_Standards/WikiData/WD~profession,28640|WD~profession,28640]]'
field_of_this_occupation: '[[_Standards/WikiData/WD~war,198|WD~war,198]]'
...
- платеник
- mercenário
Commons_category: Mercenaries
image: http://commons.wikimedia.org/wiki/Special:FilePath/MacKenzieSlcu.jpg
Wolfram_Language_entity_code: Entity["Concept", "Mercenary::fpnh8"]
dv_has_:
  name_:
    af: Huursoldaat
    ar: مرتزق
    ...
    ja: 傭兵
    jv: Tentara Bayaran
    ka: დაქირავებული ჯარი
    ko: 용병
    krj: mersenaryo
    ky: Жалданма аскер
    la: Miles conducticius
    lij: merçenâio
    lt: samdinys
    lv: algotnis
    mg: Mpikarama an' ady
