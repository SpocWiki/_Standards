...
- импровизовани експлозивни уређај
- самаробная выбухная прылада
- самаробная выбуховая прылада
- самоделна избувна направа
- самодельное взрывное устройство
- саморобний вибуховий пристрій
- Шеш йина лелхаран хӀуманаш
- үзе ясаган шартлаткыч
- מטען צד
- ئامێری تەقینەوە
...
dv_has_:
  name_:
    ...
    ce: Шеш йина лелхаран хӀуманаш
    ckb: ئامێری تەقینەوە
    cs: improvizované výbušné zařízení
    da: improviseret sprængladning
    de: unkonventionelle Spreng- und Brandvorrichtung
    el: Αυτοσχέδιος εκρηκτικός μηχανισμός
    en: improvised explosive device
    eo: improviza eksploda aparato
    es: artefacto explosivo improvisado
    eu: Lehergailu inprobisatu
    fa: دستگاه انفجاری ابداعی
    fi: tienvarsipommi
    fr: engin explosif improvisé
    gl: artefacto explosivo improvisado
    he: מטען צד
    hi: सुधारे हुए विस्फोटक उपकरण
    hu: házi készítésű robbanóeszköz
    id: Alat peledak improvisasi
    it: ordigno esplosivo improvvisato
    ja: 即席爆発装置
    kn: ಸುಧಾರಿತ ಸ್ಫೋಟಕ ಸಾಧನ
    ko: 급조폭발물
    mk: самоделна избувна направа
    ml: ഐ.ഇ.ഡി
    ms: Alat letupan reka ganti
    nb: improvisert bombe
    nl: geïmproviseerde bom
    nn: improvisert bombe
    oc: Engenh explosiu improvisat
    pl: improwizowany ładunek wybuchowy
    pms: Ordegn esplosiv improvisà
    ps: تعبیه شوی چاودیدونکی وسیله
    pt: artefato explosivo improvisado
    ro: dispozitiv exploziv improvizat
    ru: самодельное взрывное устройство
    ...
    tr: El yapımı patlayıcı
    tt: үзе ясаган шартлаткыч
    uk: саморобний вибуховий пристрій
...
#is_/same_as :: [[_Standards/WikiData/WD~Improvised_explosive_device,1249453|WD~Improvised_explosive_device,1249453]] 
