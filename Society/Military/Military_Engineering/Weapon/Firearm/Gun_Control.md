...
dv_has_:
  name_:
    ...
    ga: rialú gunnaí
    gl: control de armas de fogo
    gv: gurneilys gunney
    he: תקנות כלי ירייה
    id: pengendalian senjata api
    ja: 銃規制
    ko: 총기 규제
    nb: våpenkontroll
    nl: wapencontrole
    pt: controle de armas de fogo
    ro: Regimul armelor
    ru: контроль за оборотом оружия
    sl: nadzor strelnega orožja
    sq: Kontrolli i armëve
    sr: контрола оружја
    sv: vapenbegränsningar
    uk: контроль за обігом зброї
    vi: kiểm soát súng
    yue: 槍械管制
    zh: 槍枝管制
    zh_cn: 枪支管控
...
- Waffenkontrolle
- wapencontrole
- кантроль за абарачэньнем зброі
- кантроль за абаротам зброі
- контрола оружја
- контроль за обігом зброї
