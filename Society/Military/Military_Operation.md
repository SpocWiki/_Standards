...
dv_has_:
  name_:
    ...
    br: oberiadur brezel
    bs: vojna operacija
    bxr: Сэрэгэй даалгабари
    ca: operació militar
    ceb: operasyong militar
    ckb: ئۆپەراسیۆنی سەربازی
    cs: vojenská operace
    ...
    fr: opération militaire
    ga: oibríocht mhíleata
    gl: operación militar
    gv: obbreeaght chaggee
    he: מבצע צבאי
    hi: सैन्य अभियान
    hr: vojna operacija
    hsb: wojerska operacija
    hu: hadművelet
    hy: Օպերացիա
    id: operasi militer
    it: operazione militare
    ja: 軍事作戦
    ka: სამხედრო ოპერაცია
    kk: Операция
    ko: 군사작전
    ku: operasyona leşkerî
    lt: karinė operacija
    lv: militāra operācija
    mk: воена операција
    ms: operasi ketenteraan
    my: စစ်ဆင်ရေး
    nan: Chok-chiàn
    nb: militær operasjon
    nl: militaire operatie
    nqo: ߣߊ߲߬ߕߌ߰ ߘߐߓߛߏߟߌ
    oc: Operacion militara
    os: хæстон операци
    ...
    te: సైనిక చర్య
    tg: Амалиёти Ҳарбӣ
    th: ปฏิบัติการทางกองทัพ
    tr: askerî harekât
    tt: хәрби гамәлият
    uk: військова операція
    ur: عسکری کارروائیاں
    uz: Harbiy operatsiya
    vec: oparasion miłitar
...
> A military operation (op) is the coordinated military actions of a state, or a non-state actor, 
> in response to a developing situation. 
> 
> These actions are designed as a military plan to resolve the situation in the state or actor's favor. 
> 
> Operations may be of a combat or non-combat nature 
> and may be referred to by a code name for the purpose of national security. 
> 
> Military operations are often known for their more generally accepted common usage names 
> than their actual operational objectives.
>
