...
- সামরিক প্রকৌশল
- படைசார் பொறியியல்
- စစ်ဘက်ဆိုင်ရာ အင်ဂျင်နီယာလုပ်ငန်း
- 工兵
- 軍事工学
- 軍事工程
- 군사공학
...
field_of_work: '[[_Standards/WikiData/WD~engineering,11023|WD~engineering,11023]]'
...
- '[[_Standards/WikiData/WD~sapper,1324245|WD~sapper,1324245]]'
- '[[_Standards/WikiData/WD~combat_engineer,101497855|WD~combat_engineer,101497855]]'
said_to_be_the_same_as: '[[_Standards/WikiData/WD~Ingenieurkorps,1421548|WD~Ingenieurkorps,1421548]]'
subclass_of: '[[_Standards/WikiData/WD~engineering,11023|WD~engineering,11023]]'
U_S_National_Archives_Identifier: 10643231
dv_has_:
  name_:
    af: militêre ingenieurswese
    ar: هندسة عسكرية
    ...
    ckb: ئەندازیاریی سەربازی
    cs: ženijní vojsko
    cy: Peirianneg filwrol
    da: ingeniørtropper
    de: Genietruppe
    el: Όπλο Μηχανικού
    en: military engineering
    eo: milita inĝenierio
    es: ingeniería militar
    et: pioneeriteenistus
    eu: Ingeniaritza militar
    fa: مهندسی جنگ
    fi: pioneeritoiminta
    fr: génie militaire
    gl: enxeñaría militar
    he: הנדסה צבאית
    hi: सैन्य अभियान्त्रिकी
    hr: Inženjerija
    hy: ինժեներական զորքեր
    id: zeni
    io: Jenio
    it: genio militare
    ja: 軍事工学
    kk: Инженерлік әскерлер
    ko: 군사공학
    la: Ingeniaria militaris
    mk: воена инженерија
    ms: Kejuruteraan tentera
    my: စစ်ဘက်ဆိုင်ရာ အင်ဂျင်နီယာလုပ်ငန်း
    nb: Ingeniørtropper
    nl: genie
    nn: Ingeniørstyrkar
    oc: Engèni militar
    pl: wojska inżynieryjne
    pms: Ingegnerìa militar
    ...
    tk: Harby güýçler inženerligi
    tr: askerî mühendislik
    tt: мөһәндис гаскәрләре
    uk: інженерні війська
    uz: Harbiy muhandislik
    vi: Công binh
