---
aliases:
- Balaod nga mosyon mga planeta ha Kepler
- D Gsetz vom Kepler
...
- Kepler's laws
- Kepler's laws o planetary motion
...
- केप्लरके ग्रहीय गतिके नियम
- केप्लरचे ग्रहांच्या गतीचे नियम
- কেপলারের গ্রহীয় গতিসূত্র
- ਗ੍ਰਹਿ ਮੋਸ਼ਨ ਦੇ ਕੈਪਲਰ ਦੇ ਕਾਨੂੰਨ
...
has_part_s_:
- "[[_Standards/WikiData/WD~Kepler's_first_law,122928282|WD~Kepler's_first_law,122928282]]"
- "[[_Standards/WikiData/WD~Kepler's_second_law,122928303|WD~Kepler's_second_law,122928303]]"
- "[[_Standards/WikiData/WD~Kepler's_third_law,122928319|WD~Kepler's_third_law,122928319]]"
named_after: '[[_Standards/WikiData/WD~Johannes_Kepler,8963|WD~Johannes_Kepler,8963]]'
image:
...
- http://commons.wikimedia.org/wiki/Special:FilePath/Ellipitical%20orbit%20of%20planet%20with%20an%20eccentricty%20of%200.5.gif
- http://commons.wikimedia.org/wiki/Special:FilePath/Ellipitical%20orbit%20of%20planet%20with%20an%20eccentricty%20of%200.8.gif
...
dv_is_:
  same_as:
  - "[[../../WikiData/WD~Kepler's_laws_of_planetary_motion,83219|WD~Kepler's_laws_of_planetary_motion,83219]]"
...
dv_has_:
  name_:
    ...
    kk: Кеплер заңдары
    ko: 케플러의 행성운동법칙
    ky: Кеплер мыйзамдары
    la: Leges Keplerianae
    lb: Gesetzer vum Kepler
    lt: Keplerio dėsniai
    lv: Keplera likumi
    mag: केप्लरके ग्रहीय गतिके नियम
    mk: Кеплерови закони
    ml: ഗ്രഹചലനനിയമങ്ങൾ
    mn: Гаригийн хөдөлгөөний Кеплерийн хуулиуд
    mnw: သၞောဝ်ကေပ်လေရ် မဆေင်ကဵု ဂြိုဟ်တာရာယတ္တ
    mr: केप्लरचे ग्रहांच्या गतीचे नियम
    ms: Hukum gerakan planet Kepler
    nb: Keplers lover for planetenes bevegelser
    nl: Wetten van Kepler
    nn: Kepler-lovene
    oc: Leis de Kepler
    os: Кеплеры закъæттæ
    pa: ਗ੍ਰਹਿ ਮੋਸ਼ਨ ਦੇ ਕੈਪਲਰ ਦੇ ਕਾਨੂੰਨ
    pl: prawa Keplera
    pms: Laj ëd Kepler
    pt: Leis de Kepler
    ...
    scn: Liggi di Kepleru
    sco: Kepler's laws o planetary motion
    sh: Keplerovi zakoni
    sk: Keplerove zákony
    ...
    te: కెప్లర్ గ్రహ గమన నియమాలు
    th: กฎการเคลื่อนที่ของดาวเคราะห์
    tl: Mga batas mosyon ng mga planeta ni Kepler
    tr: Kepler'in gezegensel hareket yasaları
    tt: Кеплер кануннары
    uk: Закони Кеплера
    ur: Kepler's laws of planetary motion
    uz: Kepler qonunlari
    vi: Những định luật của Kepler về chuyển động thiên thể
    war: Balaod nga mosyon mga planeta ha Kepler
    wuu: 开普勒定律
    yi: קעפלער'ס געזעצן
    yue: 開普勒定律
    zh: 开普勒定律
...
> In astronomy, Kepler's laws of planetary motion, published by Johannes Kepler in 1609 
> (except the third law, which was fully published in 1619), 
> describe the orbits of planets around the Sun. 
> 
> These laws replaced circular orbits and epicycles in the heliocentric theory of Nicolaus Copernicus 
> with elliptical orbits and explained how planetary velocities vary. 
> The three laws state that:
> - The orbit of a planet is an ellipse with the Sun at one of the two foci.
> - A line segment joining a planet and the Sun sweeps out equal areas during equal intervals of time.
> - The square of a planet's orbital period 
>   is proportional to the cube of the length of the semi-major axis of its orbit.
>
> The elliptical orbits of planets were indicated by calculations of the orbit of Mars. 
> From this, Kepler inferred that other bodies in the Solar System, 
> including those farther away from the Sun, also have elliptical orbits. 
> 
> The second law establishes that when a planet is closer to the Sun, it travels faster. 
...
>
> A more precise historical approach is found in Astronomia nova, Harmonice Mundi 
> and Epitome Astronomiae Copernicanae.
>
