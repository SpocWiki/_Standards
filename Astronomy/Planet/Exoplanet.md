...
dv_has_:
  name_:
    ...
    ko: 외계 행성
    kv: Экзопланет
    la: planeta extrasolaris
    lb: Exoplanéit
    lfn: Planetas estrasolal
    li: Exoplaneet
    lt: Egzoplaneta
    lv: citplanēta
    min: Planet lua surya
    mk: вонсончева планета
    ml: സൗരയൂഥേതരഗ്രഹം
    mn: Экзопланет
    mr: परग्रह
    ms: Planet luar suria
    my: နေစကြာဝဠာပြင်ပဂြိုဟ်
    nb: eksoplanet
    nds: Exoplanet
    nl: exoplaneet
    nn: ekstrasolar planet
    oc: Exoplaneta
    om: Lafjoo Sirna biiftuun Alaa
    os: экзопланетæ
    pa: ਗ਼ੈਰ-ਸੌਰੀ ਗ੍ਰਹਿ
    ...
    ur: بیرونی سیارہ
    uz: Ekzosayyora
    vec: pianeta extrasołare
    vi: ngoại hành tinh
    war: Planeta extrasolar
    wuu: 太阳系外行星
    yue: 太陽系外行星
    zh: 太陽系外行星
    zu: Umzulendle
