...
- pianeta tirrestri
- pianét terèster
- pilaaneetota (lafjo) qabiyyee dhagaa qaban
- pjaneta terrestri
- planaid ooirragh
- planet bumian
- planet kabumian
...
dv_has_:
  name_:
    ...
    fy: terrestryske planeet
    ga: pláinéad domhanda
    gl: planeta terrestre
    gn: mbyjajere itaembo
    gsw: erdähnlicher Planet
    gv: planaid ooirragh
    he: כוכב לכת ארצי
    hi: स्थलीय ग्रह
    hif: terrestrial planet
    hr: terestrički planet
    hu: föld-típusú bolygó
    hy: երկրային խմբի մոլորակներ
    ia: planeta terrestre
    id: planet terestrial
    it: pianeta terrestre
    ja: 地球型惑星
    jv: planit jero
    ka: დედამიწის ჯგუფის პლანეტები
    kab: amtiweg anamur
    ko: 지구형 행성
    la: planeta terrestris
    lb: Äerdähnlech Planéiten
    lmo: pianét terèster
    lt: Žemės grupės planetos
    lv: Zemes grupas planētas
    min: planet kabumian
    ...
    oc: planeta tellurica
    om: pilaaneetota (lafjo) qabiyyee dhagaa qaban
    pl: planeta skalista
    pms: pianeta rocos
    ...
    sco: terrestrial planet
    sh: terestrička planeta
    si: භෞමික ග්රහලෝක
    ...
    tl: mga planetang terestrial
    tr: yerbenzeri gezegen
    tt: җирсыман планеталар
    uk: землеподібна планета
    ur: زمینی سیارہ
    uz: ichki sayyoralar
    vec: pianeta terestre
    vi: hành tinh kiểu Trái Đất
    war: planeta terrestre
    wuu: 类地行星
    yi: ערדישער פלאנעט
    yue: 類地行星
    zh: 类地行星
...
> 
> It may instead be known as a tellurian planet, telluric planet, or rocky planet. 
> Within the Solar System, the terrestrial planets accepted by the International Astronomical Union are the inner planets closest to the Sun: Mercury, Venus, Earth and Mars. 
> 
> Among astronomers who use the geophysical definition of a planet, two or three planetary-mass satellites – Earth's Moon, Io, and sometimes Europa – may also be considered terrestrial planets. The large rocky asteroids Pallas and Vesta are sometimes included as well, albeit rarely. The terms "terrestrial planet" and "telluric planet" are derived from Latin words for Earth (Terra and Tellus), as these planets are, in terms of structure, Earth-like. Terrestrial planets are generally studied by geologists, astronomers, and geophysicists.
>
