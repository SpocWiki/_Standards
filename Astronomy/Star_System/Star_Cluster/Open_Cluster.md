...
- padrikasis spiečius
- pundok nagsasasarang
- rasejano zvezdano jato
- roi deschis
...
dv_has_:
  name_:
    ...
    hr: otvoreni skup
    hu: nyílthalmaz
    hy: Ցրված աստղային կուտակումներ
    id: gugus terbuka
    it: ammasso aperto
    ja: 散開星団
    kk: Тарқақ үйіржұлдыз
    ko: 산개 성단
    la: cumulus stellarum apertus
    lb: Oppene Stärekoup
    lt: padrikasis spiečius
    lv: vaļējā zvaigžņu kopa
    mk: расеано ѕвездено јато
    ml: തുറന്ന താരവ്യൂഹം
    ms: kelompok terbuka
    nan: Sòaⁿ-khui chheⁿ-thoân
    nb: åpen stjernehop
    nds: Apen Steernkluuster
    nl: open sterhoop
    nn: open stjernehop
    oc: amàs dubèrt
    pa: ਖੁੱਲੇ ਤਾਰਾਗੁੱਛੇ
