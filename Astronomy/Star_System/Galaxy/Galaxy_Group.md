...
dv_has_:
  name_:
    ...
    fr: groupe de galaxies
    ga: grúpa réaltraí
    gl: grupo de galaxias
    he: קבוצת גלקסיות
    hi: मंदाकिनी समूह
    hr: Galaktička skupina
    hy: գալակտիկաների խումբ
    id: Grup galaksi
    it: gruppo di galassie
    ja: 銀河群
    ko: 은하군
    lb: Galaxiëgrupp
    lt: Galaktikų grupė
    ...
    nan: Gîn-hô-kûn
    nb: galaksegruppe
    nl: groep van sterrenstelsels
    nn: galaksegruppe
    oc: Grop de galaxias
    pl: Grupa galaktyk
    pt: grupo de galáxias
    ro: Grup de galaxii
    ru: группа галактик
    scn: gruppu di galassî
    sk: Skupina galaxií
    sl: skupina galaksij
    sr: Galaksna grupa
    sv: galaxgrupp
