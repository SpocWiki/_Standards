...
- Galaeth Triangulum
- Galaksi Triangulum
- Galaksienn an Tric'horn
- Galaksija v Trikotniku
- Galaksiya Triangulum
- Galaktyka Trójkąta
- Galassia del Triangolo
- Galaxa del Triángulu
- Galaxia del Triángulo
- Galaxia do Triángulo
...
right_ascension_component_of_proper_motion: 0.707
declination_component_of_proper_motion: 0.827
galaxy_morphological_type: SA(s)cd
catalog_code:
- M 33
- 1ES 0131+30.3
...
- Z 0131.0+3024
- Z 502-110
image: http://commons.wikimedia.org/wiki/Special:FilePath/M33.jpg
Commons_gallery: Messier 33
...
dv_has_:
  name_:
    af: Driehoek-sterrestelsel
    ar: مجرة المثلث
    ast: Galaxa del Triángulu
    ...
    bs: Trokut
    ca: galàxia del Triangle
    co: M33
    cs: Galaxie v Trojúhelníku
    cy: Galaeth Triangulum
    da: Trekantgalaksen
    de: Dreiecksnebel
    el: Γαλαξίας του Τριγώνου
    en: Triangulum Galaxy
    en-us: Triangulum Galaxy
    eo: M33
    es: Galaxia del Triángulo
    et: M33
    eu: Triangeluko galaxia
    fa: کهکشان مثلث
    fi: Kolmion galaksi
    fr: galaxie du Triangle
    ga: Bís an Triantáin
    gl: Galaxia do Triángulo
    he: גלקסיית המשולש
    hi: ट्राऐन्गुलम गैलेक्सी
    hr: Messier 33
    hu: Triangulum-galaxis
    hy: Եռանկյունու գալակտիկա
    id: Galaksi Triangulum
    it: Galassia del Triangolo
    ja: さんかく座銀河
    ko: 삼각형자리 은하
    la: Nebula Trianguli
    lb: Messier 33
    lt: Trikampio galaktika
    lv: Trijstūra galaktika
    mg: Messier 33
    mk: Триаголник
    ml: മെസ്സിയർ 33
    mo: Triangulum
    ms: Galaksi Triangulum
    mul: NGC 598
    my: ထရိုင်ဂူလယ် ဂယ်လက်ဆီ
    mzn: مسیه ۳۳
    nan: Messier 33
    nb: Triangelgalaksen
    nl: Driehoeknevel
    nn: Triangelgalaksen
    oc: Messier 33
    pl: Galaktyka Trójkąta
    pt: Galáxia do Triângulo
    ro: Messier 33
    ...
    tr: Üçgen Galaksisi
    uk: Галактика Трикутника
    ur: مثلثی کہکشاں
    vi: Thiên hà Tam Giác
    war: Galaksiya Triangulum
    wuu: 三角座星系
    yue: 三角座星系
    zh: 三角座星系
    zh-tw: 三角座星系
...
> The Triangulum Galaxy is a spiral galaxy 2.73 million light-years (ly) from Earth 
> in the constellation Triangulum. 
> 
> It is catalogued as Messier 33 or NGC 598. 
> With the D25 isophotal diameter of 18.74 kiloparsecs (61,100 light-years), 
> the Triangulum Galaxy is the third-largest member of the Local Group of galaxies, 
> behind the Andromeda Galaxy and the Milky Way.
>
> The galaxy is the second-smallest spiral galaxy in the Local Group 
> after the Large Magellanic Cloud, which is a Magellanic-type spiral galaxy. 
> 
> It is believed to be a satellite of the Andromeda Galaxy 
> or on its rebound into the latter due to their interactions, velocities, 
> and proximity to one another in the night sky. 
> 
