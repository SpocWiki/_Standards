...
- kääpiögalaksi
- Mitti Gallaktika
- Modra kompaktna patuljasta galaktika
- nana galaksio
...
dv_has_:
  name_:
    ...
    he: גלקסיה ננסית
    hi: बौनी गैलेक्सी
    hr: Modra kompaktna patuljasta galaktika
    hu: törpegalaxis
    hy: թզուկ գալակտիկա
    id: Galaksi katai
    it: galassia nana
    ja: 矮小銀河
    jv: Galaksi katé
    kab: Amazellaw agezlan
    ko: 왜소은하
    lb: Zwerggalaxie
    mk: џуџеста галаксија
    ms: Galaksi kerdil
    my: ဂလက်ဆီပု
    nan: É-sió gîn-hô
    nb: dverggalakse
    nl: dwergsterrenstelsel
    nn: dverggalakse
    oc: Galaxia nana
    pa: ਬੌਣੀ ਆਕਾਸ਼ਗੰਗਾ
    pl: galaktyka karłowata
    pnb: نکا تارہ سمندر
    pt: galáxia anã
    ro: galaxie pitică
    ru: карликовая галактика
    sh: Patuljasta galaksija
