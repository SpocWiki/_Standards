...
- nastanjivi pojas
- obyvatelná zóna
- obzvezdno naseljivo območje
- obývateľná zóna
- parth cyfanheddol cylchol
- Sek-ki-tài
...
- zone habitable
- Zòna abitabla
- ĉirkaŭstela enloĝebla zono
- ζώνη κατοικισιμότητας
- животопогоден појас
- Зона
- зона обитаемости
- зона придатна для життя
- зона прыдатная да жыцьця
- настањиви појас
- Обитаема зона
...
dv_has_:
  name_:
    ...
    fa: دامنه زندگی
    fi: tähteä ympäröivä elämänvyöhyke
    fr: zone habitable
    gl: Zona de habitabilidade
    he: אזור ישיב
    hi: वासयोग्य क्षेत्र
    hr: Nastanjiva zona
    hu: lakható övezet
    hy: Բնակելիության գոտի
    ia: Zona habitabile
    id: zona layak huni
    it: zona abitabile
    ja: ハビタブルゾーン
    ...
    lb: Habitabel Zon
    lt: Gyvybės zona
    mk: животопогоден појас
    ml: ഗോൾഡിലോക്ക് സോൺ
    mr: वास्तव्ययोग्य क्षेत्र
    ms: Zon kehidupan
    my: ဂိုလ်းဒီလော့ဇုန်
    nan: Sek-ki-tài
    nb: beboelig sone
    ...
    th: เขตอาศัยได้
    tr: yaşanabilir bölge
    tt: Яшәү өлкәсе
    uk: зона придатна для життя
    vi: khu vực có thể sống được
    wuu: 适居带
    yue: 可住帶
    zh: 適居帶
    zh-cn: 适居带
