...
instance_of: '[[_Standards/WikiData/WD~supernova_remnant,207436|WD~supernova_remnant,207436]]'
discoverer_or_inventor: '[[_Standards/WikiData/WD~John_Bevis,437582|WD~John_Bevis,437582]]'
different_from: '[[_Standards/WikiData/WD~Q19843709,19843709|WD~Q19843709,19843709]]'
...
has_cause: '[[_Standards/WikiData/WD~SN_1054,32037|WD~SN_1054,32037]]'
...
dv_has_:
  ...
  name_:
    ...
    ga: Réaltnéal an Phortáin
    gl: nebulosa do Cangrexo
    he: ערפילית הסרטן
    hi: कर्क नीहारिका
    hr: Messier 1
    hu: Rák-köd
    ia: Nebulosa del Crabba
    id: Nebula Kepiting
    io: Kankro-nebuloso
    is: Krabbaþokan
    it: nebulosa del Granchio
    ja: かに星雲
    ka: კიბორჩხალსახის ნისლეული
    kn: ಕ್ರ್ಯಾಬ್ ನಿಹಾರಿಕೆ
    ko: 게 성운
    lb: Messier 1
    lt: Krabo ūkas
    lv: Krabja miglājs
    mk: Раковидна Маглина
    ml: ക്രാബ് നെബുല
    ms: Nebula Ketam
    mul: NGC 1952
    my: ကဏန်း နက်ဗျူလာ
    ...
    sv: Krabbnebulosan
    sw: Nebula ya Kaa
    ta: நண்டு வடிவ நெபுலா
    th: เนบิวลาปู
    tr: Yengeç Bulutsusu
    uk: Крабоподібна туманність
    uz: Qisqichbaqasimon tumanlik
    vi: Tinh vân Con Cua
    wuu: 蟹状星云
    yue: 蟹狀星雲
    zh: 蟹狀星雲
...
### #is_/same_as :: [[/_Standards/Astronomy/Star/Star~Class/Stellar_Evolution/Supernova/Crab_Nebula|Crab_Nebula]] 

### #is_/same_as :: [[/_public/Astronomy/Star/Star~Class/Stellar_Evolution/Supernova/Crab_Nebula.public|Crab_Nebula.public]] 

### #is_/same_as :: [[/_internal/Astronomy/Star/Star~Class/Stellar_Evolution/Supernova/Crab_Nebula.internal|Crab_Nebula.internal]] 

### #is_/same_as :: [[/_protect/Astronomy/Star/Star~Class/Stellar_Evolution/Supernova/Crab_Nebula.protect|Crab_Nebula.protect]] 

### #is_/same_as :: [[/_private/Astronomy/Star/Star~Class/Stellar_Evolution/Supernova/Crab_Nebula.private|Crab_Nebula.private]] 

### #is_/same_as :: [[/_personal/Astronomy/Star/Star~Class/Stellar_Evolution/Supernova/Crab_Nebula.personal|Crab_Nebula.personal]] 

### #is_/same_as :: [[/_secret/Astronomy/Star/Star~Class/Stellar_Evolution/Supernova/Crab_Nebula.secret|Crab_Nebula.secret]] 
