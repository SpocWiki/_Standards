...
dv_has_:
  name_:
    af: neutronster
    an: estrela de neutrons
    anp: न्यूट्रॉन तारा
    ar: نجم نيوتروني
    as: নিউট্ৰন তৰা
    ast: estrella de neutrones
    az: neytron ulduzu
    azb: نوترون اولدوزو
    be: нейтронная зорка
    ...
    ckb: ئەستێرەی نیوترۆنی
    cs: neutronová hvězda
    csb: neùtronowô gwiôzda
    cy: seren niwtron
    da: neutronstjerne
    de: Neutronenstern
    ...
    tr: nötron yıldızı
    tt: нейтрон йолдыз
    tum: Nyenyezi ya nyutironi
    uk: нейтронна зоря
    uz: neytron yulduzlar
    vi: sao neutron
    wuu: 中子星
    yue: 中子星
    zh: 中子星
