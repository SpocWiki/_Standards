...
dv_has_:
  name_:
    ...
    fa: نردبان فاصله کیهانی
    fi: Kosmiset etäisyystikapuut
    fr: mesure des distances en astronomie
    he: נר תקני
    hr: Standardna svijeća
    it: Scala delle distanze cosmiche
    ja: 宇宙の距離梯子
    ko: 우주 거리 사다리
    lt: kosminių atstumų skalė
    mk: скала на вселенски растојанија
    ms: Tangga jarak kosmos
    nb: Kosmisk avstandsstige
    ...
    sr: Склада удаљености у астрономији
    sv: kosmisk avståndsstege
    th: บันไดระยะห่างของจักรวาล
    uk: шкала космічних відстаней
    wuu: 宇宙距离尺度
    yue: 宇宙距離階梯
    zh: 宇宙距離尺度
    zh_hans: 宇宙距离尺度
