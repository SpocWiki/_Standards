...
subclass_of: '[[_Standards/WikiData/WD~equator,23538|WD~equator,23538]]'
declination: 0
...
dv_has_:
  name_:
    af: Hemelewenaar
    ar: خط الاستواء السماوي
    arz: خط الاستوا السماوى
    ast: Ecuador celeste
    az: Göy ekvatoru
    be: Нябесны экватар
    ...
    bs: Nebeski ekvator
    ca: equador celeste
    ckb: ھێڵی یەکسانیی ئاسمانیی
    cs: nebeský rovník
    cy: cyhydedd wybrennol
    da: Himlens ækvator
    de: Himmelsäquator
    el: Ουράνιος ισημερινός
    ...
    eu: zeru-ekuatore
    fa: استوای آسمانی
    fi: taivaanekvaattori
    fr: équateur céleste
    ga: meánchiorcal neamhaí
    gl: Ecuador celeste
    he: קו המשווה השמימי
    hi: खगोलीय मध्य रेखा
    hr: Nebeski ekvator
    hu: égi egyenlítő
    hy: Երկնային հասարակած
    id: Ekuator langit
    ig: Equator nke eluigwe
    is: Miðbaugur himins
    it: equatore celeste
    ja: 天の赤道
    ...
    mk: Небесен екватор
    ml: ഖഗോളമദ്ധ്യരേഖ
    mr: खगोलीय विषुववृत्त
    ms: Khatulistiwa samawi
    nb: Himmelekvator
    nl: hemelevenaar
    nn: Himmelekvator
    oc: Eqüator celèst
...
> The celestial equator is the great circle of the imaginary celestial sphere 
> on the same plane as the equator of Earth. 
> By extension, it is also a plane of reference in the equatorial coordinate system. 
> Due to the Earth's axial tilt, the celestial equator is currently inclined by about 23.44° 
> with respect to the ecliptic (the plane of Earth's orbit), but has varied from about 22.0° to 24.5° over the past 5 million years due to Milankovitch cycles and perturbation from other planets.
>
