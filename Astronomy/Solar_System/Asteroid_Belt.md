...
- Gourizad asteroidennoù
- Haaptasteroidenceinture
- hlavní pás
- kisbolygóöv
- Lingkaran asteroid
- Mbyjaveve Ku'asã
- Paha hin mga asteroyd
- pas planetoid
- planetoïdengordel
- pásmo planétok
- Rūmstāngyrdel
...
- Главный пас астероидох
- камарбанди сайёракҳо
- Негізгі белдеу
- пояс астероїдів
- пояс астероидов
- Пояс астэроідаў
...
P8189: 987007579234005100
Commons_category: Main Belt asteroids
dv_is_:
  same_as:
  - '[[../../WikiData/WD~Asteroid_belt,2179|WD~Asteroid_belt,2179]]'
  - '[[/_Standards/Astronomy/Solar_System/Asteroid_Belt|Asteroid_Belt]]'
  - '[[/_public/Astronomy/Solar_System/Asteroid_Belt.public|Asteroid_Belt.public]]'
  - '[[/_internal/Astronomy/Solar_System/Asteroid_Belt.internal|Asteroid_Belt.internal]]'
  - '[[/_protect/Astronomy/Solar_System/Asteroid_Belt.protect|Asteroid_Belt.protect]]'
  - '[[/_private/Astronomy/Solar_System/Asteroid_Belt.private|Asteroid_Belt.private]]'
  - '[[/_personal/Astronomy/Solar_System/Asteroid_Belt.personal|Asteroid_Belt.personal]]'
  - '[[/_secret/Astronomy/Solar_System/Asteroid_Belt.secret|Asteroid_Belt.secret]]'
dv_is_same_as:
- '[[../../WikiData/WD~Asteroid_belt,2179|WD~Asteroid_belt,2179]]'
- '[[/_Standards/Astronomy/Solar_System/Asteroid_Belt|Asteroid_Belt]]'
- '[[/_public/Astronomy/Solar_System/Asteroid_Belt.public|Asteroid_Belt.public]]'
...
dv_has_:
  name_:
    ...
    bho: एस्टेरॉइड बेल्ट
    bn: গ্রহাণু বেষ্টনী
    br: Gourizad asteroidennoù
    bs: Asteroidni pojas
    ca: cinturó d'asteroides
    ce: астероидийн аса
    ckb: کەمەربەندی ئەستێرەیی
    cs: hlavní pás
    ...
    gcr: Sentir di astéroïd
    gl: cinto de asteroides
    gn: Mbyjaveve Ku'asã
    gsw: Asteroidegürtel
    gv: y chryss roltageagh
    he: חגורת האסטרואידים
    hi: क्षुद्रग्रह घेरा
    hif: asteroid belt
    hr: Asteroidni pojas
    hu: kisbolygóöv
    hy: աստերոիդների գոտի
    id: Sabuk asteroid
    io: Asteroido-zono
    ...
    lb: Haaptasteroidenceinture
    lfn: Sintur de asteroides
    lmo: Fasa Principala
    lt: Asteroidų žiedas
    lv: asteroīdu josla
    lzh: 小行星帶
    ...
    my: ပင်မ ဥက္ကာ ခါးပတ်
    nan: Sió-he̍k-chheⁿ-toà
    nb: asteroidebeltet
    nds: Asteroidengördel
    nl: planetoïdengordel
    nn: asteroidebeltet
    oc: cencha principala
    pl: pas planetoid
    pnb: نکے پاندھی پیٹی
    ...
    scn: cintura di l'astiroidi
    sco: asteroid belt
    sh: Asteroidni pojas
    si: අභ්යවකාශ විද්යාව-ග්රහක පටිය
    sk: pásmo planétok
    sl: asteroidni pas
    sq: Brezi asteroidal
    ...
    tg: камарбанди сайёракҳо
    th: แถบดาวเคราะห์น้อย
    tl: Sinturon ng asteroyd
    tr: Asteroit kuşağı
    tt: Астероидлар билбавы
    uk: пояс астероїдів
    uz: Asteroid kamari
    vec: fasa prinsipałe
    vi: vành đai các tiểu hành tinh
    war: Paha hin mga asteroyd
    wuu: 主小行星带
    xmf: ასტეროიდეფიშ ორტყაფუ
