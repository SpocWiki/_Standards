...
subclass_of:
- '[[_Standards/WikiData/WD~eclipse,141022|WD~eclipse,141022]]'
- '[[_Standards/WikiData/WD~astronomical_phenomenon,751989|WD~astronomical_phenomenon,751989]]'
has_part_s_:
- "[[_Standards/WikiData/WD~Baily's_beads,803878|WD~Baily's_beads,803878]]"
- '[[_Standards/WikiData/WD~diamond_ring_effect,2721914|WD~diamond_ring_effect,2721914]]'
described_by_source:
...
topic_has_template:
- '[[_Standards/WikiData/WD~Template_Solar_eclipses,8085187|WD~Template_Solar_eclipses,8085187]]'
- '[[_Standards/WikiData/WD~Template_Infobox_solar_eclipse,14338309|WD~Template_Infobox_solar_eclipse,14338309]]'
said_to_be_the_same_as: '[[_Standards/WikiData/WD~Q10939157,10939157|WD~Q10939157,10939157]]'
disjoint_union_of: '[[_Standards/WikiData/WD~list_of_values_as_qualifiers,23766486|WD~list_of_values_as_qualifiers,23766486]]'
different_from: '[[_Standards/WikiData/WD~lunar_eclipse,44235|WD~lunar_eclipse,44235]]'
...
subject_named_as: Sonnenfinsternis
Dewey_Decimal_Classification: 523.78
page_banner: http://commons.wikimedia.org/wiki/Special:FilePath/Eclipse%20banner.jpg
video: http://commons.wikimedia.org/wiki/Special:FilePath/Ecl1-11-08-1999.ogv
schematic: http://commons.wikimedia.org/wiki/Special:FilePath/Eclipses%20solares.en.svg
pronunciation_audio: http://commons.wikimedia.org/wiki/Special:FilePath/LL-Q9610%20%28ben%29-Tahmid-%E0%A6%B8%E0%A7%82%E0%A6%B0%E0%A7%8D%E0%A6%AF%E0%A6%97%E0%A7%8D%E0%A6%B0%E0%A6%B9%E0%A6%A3.wav
spoken_text_audio: http://commons.wikimedia.org/wiki/Special:FilePath/Solar%20eclipse%20Part%201.ogg
equivalent_class: http://dbpedia.org/ontology/SolarEclipse
Iconclass_notation: 24A3
...
dv_has_:
  name_:
    ...
    ckb: ڕۆژگیران
    cs: zatmění Slunce
    csb: Zacmienié Słuńca
    cy: Diffyg ar yr haul
    da: solformørkelse
    de: Sonnenfinsternis
    diq: Gırewtena Roci
    dtp: Gerhana matahari
    el: Έκλειψη Ηλίου
    en: solar eclipse
    eo: Suna eklipso
    es: eclipse solar
    ...
    hyw: Արեւու խաւարում
    ia: Eclipse solar
    iba: Keleman matahari
    id: gerhana matahari
    is: sólmyrkvi
    it: eclissi solare
    iu: ᓯᕿᓃᖅᓯᖅᑐᖅ
    ja: 日食
    jv: Grahana srengéngé
    ka: მზის დაბნელება
    km: សូរ្យគ្រាស
    kn: ಸೂರ್ಯ ಗ್ರಹಣ
    ko: 일식
    ...
    lzh: 日食
    mag: सूर्यग्रहण
    mg: fanakona-masoandro
    mi: āraitanga kōmaru
    min: Gerhana matahari
    mk: затемнување на Сонцето
    ml: സൂര്യഗ്രഹണം
    mn: Нар хиртэлт
    mnc: ᡧᡠᠨ ᠵᡝᠮᠪᡳ
    mr: सूर्यग्रहण
    ...
    rue: Сонячноє затменя
    sat: ᱥᱤᱧ ᱪᱟᱱᱫᱚ ᱜᱟᱱᱦᱟᱣ
    sd: سج گرهڻ
    ...
    sk: Zatmenie Slnka
    sl: Sončev mrk
    smn: piäiváásiävŋánem
    sms: peiʹvvpårrjummuš
    sn: Kudzikatidzwa kwezuva
    so: Qorax madoobaad
    ...
    th: สุริยุปราคา
    tl: Eklipse ng araw
    tok: weka suno lon kon
    tr: Güneş tutulması
    tt: Кояш тотылу
    udm: Шунды ӵоктаськон
    ug: قۇياش تۇتۇلۇشى
...
> thereby obscuring the view of the Sun from a small part of Earth, totally or partially. 
> 
> Such an alignment occurs approximately every six months, 
> during the eclipse season in its new moon phase, 
> when the Moon's orbital plane is closest to the plane of Earth's orbit. 
> 
...
> Unlike a lunar eclipse, which may be viewed from anywhere on the night side of Earth, 
> a solar eclipse can only be viewed from a relatively small area of the world. As such, although total solar eclipses occur somewhere on Earth every 18 months on average, they recur at any given place only once every 360 to 410 years.
>
...
>
> [Wikipedia](https://en.wikipedia.org/wiki/Solar%20eclipse) 
