...
dv_has_:
  name_:
    ...
    de: Umlaufzeit
    el: Περίοδος περιφοράς
    en: orbital period
    eo: orbita periodo
    es: período orbital
    et: Sideeriline periood
    eu: Orbita-periodo
    fa: تناوب مداری
    fi: Kiertoaika
    fr: période orbitale
    ga: tréimhse fhithiseach
    gl: período orbital
    gsw: Siderische Periode
    he: זמן הקפה
    hi: कक्षीय अवधि
    hr: Ophodno vrijeme
    hu: keringési idő
    hy: Սիդերիկ պարբերություն
    id: Periode orbit
    ig: Oge Orbital
    it: periodo di rivoluzione
    ja: 公転周期
    ka: სინოდური პერიოდი
    kab: Tallit tamezzayt
    ko: 공전 주기
    ky: Сидерикалык мезгил
    la: Periodus orbitalis
    lb: Ëmlafzäit
    ...
    mr: परिभ्रमण काळ
    ms: Tempoh orbit
    mt: perijodu orbitali
    nb: omløpstid
    nds: Ümlooptiet
    nl: omlooptijd
    nn: Baneperiode
    oc: Periòde de revolucion
    pl: okres orbitalny
    pt: período orbital
    ro: perioadă orbitală
    ru: орбитальный период
    scn: Piriudu di rivuluzzioni
    sh: Orbitalni period
    si: කක්ෂීය කාලාවර්තය
    sk: doba obehu
    sl: orbitalna perioda
    sq: Periudha orbitale
    sr: орбитални период
    sv: Siderisk omloppstid
    sw: Kipindi cha njiamzingo
    szl: Ôkres ôrbitalny
    ta: சுற்றுக்காலம்
    te: కక్ష్యా వ్యవధి
    th: คาบดาราคติ
...
>
> Its reciprocal is the orbital frequency, a kind of revolution frequency, in units of hertz.
>
