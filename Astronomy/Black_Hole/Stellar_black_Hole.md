...
dv_is_:
  same_as:
  - '[[../../WikiData/WD~Stellar_black_hole,1047034|WD~Stellar_black_hole,1047034]]'
  - '[[/_Standards/Astronomy/Black_Hole/Stellar_black_Hole|Stellar_black_Hole]]'
  - '[[/_public/Astronomy/Black_Hole/Stellar_black_Hole.public|Stellar_black_Hole.public]]'
  - '[[/_internal/Astronomy/Black_Hole/Stellar_black_Hole.internal|Stellar_black_Hole.internal]]'
  - '[[/_protect/Astronomy/Black_Hole/Stellar_black_Hole.protect|Stellar_black_Hole.protect]]'
  - '[[/_private/Astronomy/Black_Hole/Stellar_black_Hole.private|Stellar_black_Hole.private]]'
  - '[[/_personal/Astronomy/Black_Hole/Stellar_black_Hole.personal|Stellar_black_Hole.personal]]'
  - '[[/_secret/Astronomy/Black_Hole/Stellar_black_Hole.secret|Stellar_black_Hole.secret]]'
dv_is_same_as:
- '[[../../WikiData/WD~Stellar_black_hole,1047034|WD~Stellar_black_hole,1047034]]'
- '[[/_Standards/Astronomy/Black_Hole/Stellar_black_Hole|Stellar_black_Hole]]'
- '[[/_public/Astronomy/Black_Hole/Stellar_black_Hole.public|Stellar_black_Hole.public]]'
...
dv_has_:
  name_:
    ...
    de: stellares schwarzes Loch
    el: αστρική μαύρη τρύπα
    en: stellar black hole
    eo: stela nigra truo
    es: Agujero negro estelar
    eu: Zulo beltz estelar
    fa: سیاهچاله ستارهوار
    fi: Stellaarinen musta aukko
    fr: trou noir stellaire
    gl: Burato negro estelar
    he: חור שחור כוכבי
    hy: Աստղային զանգվածի սև խոռոչ
    id: lubang hitam bintang
    it: buco nero stellare
    ja: 恒星ブラックホール
    ko: 항성 블랙홀
    mk: Ѕвездена црна дупка
    ms: Lohong hitam najam
    nl: stellair zwart gat
    ...
    th: หลุมดำของดาวฤกษ์
    tr: Yıldız Kaynaklı Kara Delikler
    uk: Чорна діра зоряної маси
    vi: Lỗ đen sao
    yue: 恆星黑洞
    zh: 恆星黑洞
    zh_hans: 恒星黑洞
...
> A stellar black hole (or stellar-mass black hole) 
> is a black hole formed by the gravitational collapse of a star. 
> 
> They have masses ranging from about 5 to several tens of solar masses. 
> They are the remnants of supernova explosions, 
> which may be observed as a type of gamma ray burst. 
