...
dv_is_:
  same_as:
  - '[[../../WikiData/WD~Molecular_cloud,272447|WD~Molecular_cloud,272447]]'
...
dv_has_:
  name_:
    ...
    he: ענן מולקולרי
    hi: आणविक बादल
    hr: molekularni oblak
    hy: Մոլեկուլային ամպ
    id: awan molekul
    it: nube molecolare
    ja: 分子雲
    jv: awan molekul
    ka: მოლეკულური ღრუბელი
    kab: asignew axeclawan
    ko: 분자운
    lb: Moleküllewollek
    lt: molekulinis debesis
    mk: молекуларен облак
    ml: തന്മാത്രാ മേഘം
    mn: молекулын үүл
    ms: awan molekul
    nb: molekylsky
    ...
    sh: gigantski molekulski oblaci
    si: අණුක වලා
    sk: molekulárny mrak
    sl: molekulski oblak
    smn: molekyylpolvâ
