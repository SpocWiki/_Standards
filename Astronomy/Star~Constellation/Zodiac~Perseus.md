...
- astro/Zodiac
type: Zodiac
named_after: '[[_Standards/WikiData/WD~Perseus,130832|WD~Perseus,130832]]'
described_by_source:
...
- '[[_Standards/WikiData/WD~Perseus,105199906|WD~Perseus,105199906]]'
part_of: '[[_Standards/WikiData/WD~Northern_celestial_hemisphere,1998069|WD~Northern_celestial_hemisphere,1998069]]'
topic_has_template:
- '[[_Standards/WikiData/WD~Q10729095,10729095|WD~Q10729095,10729095]]'
- '[[_Standards/WikiData/WD~Template_Stars_of_Perseus,11117327|WD~Template_Stars_of_Perseus,11117327]]'
shares_border_with:
...
image: http://commons.wikimedia.org/wiki/Special:FilePath/PerseusCC.jpg
Commons_category: Perseus (constellation)
short_name: Per
...
dv_has_:
  name_:
    ...
    es: Perseus
    et: Perseus
    eu: Perseus (konstelazioa)
    fa: برساووش
    fi: Perseus
    fr: Persée
    frr: Perseus (stäärbil)
    ga: Peirséas
    gl: Perseus
    gv: y Whing
    hak: Yîn-siên-chho
    ...
    hi: ययाति तारामंडल
    hr: Perzej
    hu: Perseus csillagkép
    hy: Պերսևս
    hyw: Պերսեւս (համաստեղութիւն)
    id: Perseus
    is: Perseifur (stjörnumerki)
    it: Perseo
    ja: ペルセウス座
    jv: Perseus
    ka: პერსევსი
    kk: Персей шоқжұлдызы
    kn: ಪರ್ಸಿಯಸ್
    ko: 페르세우스자리
    kw: Perseus (ranneves)
    ky: Персей
    ...
    nb: Persevs
    nl: Perseus
    nn: Stjernebiletet Persevs
    or: ଯଯାତି ତାରାମଣ୍ଡଳ
    os: Персей (стъалыгуппар)
    pl: gwiazdozbiór Perseusza
    pnb: پورس تارہ چرمٹ
    pt: Perseus
    ro: Perseu
    ru: Персей
    ...
    th: กลุ่มดาวเพอร์ซิอัส
    tl: Konstelasyong Perseus
    tr: Perseus
    tt: Персей йолдызлыгы
    udm: Персей
    uk: Персей
    ur: حامل راس الغول
    uz: Persey
...
dv_is_:
  same_as:
  - '[[../../WikiData/WD~Perseus,10511|WD~Perseus,10511]]'
  - '[[/_Standards/Astronomy/Star~Constellation/Zodiac~Perseus|Zodiac~Perseus]]'
  - '[[/_public/Astronomy/Star~Constellation/Zodiac~Perseus.public|Zodiac~Perseus.public]]'
  - '[[/_internal/Astronomy/Star~Constellation/Zodiac~Perseus.internal|Zodiac~Perseus.internal]]'
  - '[[/_protect/Astronomy/Star~Constellation/Zodiac~Perseus.protect|Zodiac~Perseus.protect]]'
  - '[[/_private/Astronomy/Star~Constellation/Zodiac~Perseus.private|Zodiac~Perseus.private]]'
...
dv_has_name_la: Perseus
dv_has_name_la_genitive: Persei
dv_has_name_de: Perseus
dv_is_same_as:
- '[[../../WikiData/WD~Perseus,10511|WD~Perseus,10511]]'
- '[[/_Standards/Astronomy/Star~Constellation/Zodiac~Perseus|Zodiac~Perseus]]'
- '[[/_public/Astronomy/Star~Constellation/Zodiac~Perseus.public|Zodiac~Perseus.public]]'
