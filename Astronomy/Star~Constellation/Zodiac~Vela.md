...
- กลุ่มดาวใบเรือ
- ဗီလာ
- იალქნების თანავარსკვლავედი
- ほ座
- 船帆座
- 돛자리
has_id_wikidata: Q10521
confidential: public
isDeleted: false
isReadOnly: false
tags:
...
- '[[_Standards/WikiData/WD~sail,25999|WD~sail,25999]]'
part_of:
...
topic_has_template:
- '[[_Standards/WikiData/WD~Q10729097,10729097|WD~Q10729097,10729097]]'
- '[[_Standards/WikiData/WD~Template_Vela_(constellation),10857918|WD~Template_Vela_(constellation),10857918]]'
described_by_source:
...
locator_map_image: http://commons.wikimedia.org/wiki/Special:FilePath/Vela%20constellation%20map.svg
astronomic_symbol_image: http://commons.wikimedia.org/wiki/Special:FilePath/Vela%20symbol%20%28Moskowitz%2C%20variable%20width%29.svg
...
dv_has_:
  name_:
    ...
    hi: पाल तारामंडल
    hr: Jedro
    hu: Vitorla csillagkép
    hy: Առագաստ
    id: Vela
    ig: Vela (ìgwè kpakpando)
    is: Seglið
    it: Vele
    ja: ほ座
    jv: Vela
    ka: იალქნების თანავარსკვლავედი
    ko: 돛자리
    kw: Vela (ranneves)
    la: Vela
    la_:
