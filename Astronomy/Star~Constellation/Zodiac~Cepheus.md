...
- Ceiféas
- Cepheus
- Cepheus (constellacion)
- Cepheus (ranneves)
- Cepheus (stäärbil)
- Cepheus (ìgwè kpakpando)
- Cepheus Chō
- Cepheus csillagkép
- Céphée
- Gwiazdozbiór Cefeusza
- Kefeifur (stjörnumerki)
- Kefej
- Kefeus
- Kepheus
- Kifausi
...
- കൈകവസ്
- กลุ่มดาวซีฟิอัส
- དྲང་སྲོང་རྒྱལ་པོའི་སྐར་ཚོམ་
- စီဖျူး
- ცეფევსის თანავარსკვლავედი
- ケフェウス座
- 仙王座
- 세페우스자리
...
named_after: '[[_Standards/WikiData/WD~Cepheus,_King_of_Aethiopia,858116|WD~Cepheus,_King_of_Aethiopia,858116]]'
topic_has_template: '[[_Standards/WikiData/WD~Template_Stars_of_Cepheus,10729010|WD~Template_Stars_of_Cepheus,10729010]]'
shares_border_with:
...
locator_map_image: http://commons.wikimedia.org/wiki/Special:FilePath/Cepheus%20constellation%20map.svg
astronomic_symbol_image: http://commons.wikimedia.org/wiki/Special:FilePath/Cepheus%20symbol%20%28Moskowitz%2C%20variable%20width%29.svg
...
dv_has_:
  name_:
    ...
    fr: Céphée
    frr: Cepheus (stäärbil)
    ga: Ceiféas
    gl: Cepheus
    gv: Cepheus
    hak: Siên-vòng-chho
    he: קפאוס
    hi: वृषपर्वा तारामंडल
    hr: Kefej
    hu: Cepheus csillagkép
    hy: Ցեֆեոս
    id: Cepheus
    ig: Cepheus (ìgwè kpakpando)
    is: Kefeifur (stjörnumerki)
    it: Cefeo
    ja: ケフェウス座
    jv: Cepheus
    ka: ცეფევსის თანავარსკვლავედი
    kk: Цефей
    ko: 세페우스자리
    kw: Cepheus (ranneves)
    la: Cepheus
    ...
    nb: Kefeus
    nl: Cepheus
    nn: Stjernebiletet Kefeus
    oc: Cepheus (constellacion)
    os: Цефей (стъалыгуппар)
    pl: Gwiazdozbiór Cefeusza
    pt: Cepheus
    ro: Cefeu
    ru: Цефей
    sah: Цефей
...
> Cepheus is a constellation in the deep northern sky, 
> named after Cepheus, a king of Aethiopia in Greek mythology.  
> It is one of the 48 constellations listed by the second century astronomer Ptolemy, 
> and it remains one of the 88 constellations in the modern times.
>
> The constellation's brightest star is Alderamin (Alpha Cephei), with an apparent magnitude of 2.5. 
> Delta Cephei is the prototype of an important class of star known as a Cepheid variable. 
> RW Cephei, an orange hypergiant, together with the red supergiants Mu Cephei, 
> MY Cephei, VV Cephei, V381 Cephei, and V354 Cephei are among the largest stars known. 
> 
> In addition, Cepheus also has the hyperluminous quasar S5 0014+81, 
> which hosts an ultramassive black hole in its core, reported at 40 billion solar masses, 
