...
dv_has_:
  name_:
    ...
    et: Hüdra
    eu: Hydra
    fa: مار باریک (صورت فلکی)
    fi: Vesikäärme
    fr: Hydre
    frr: Weederslaang (stäärbil)
    ga: an Phéist Uisce
    gl: Hydra
    gv: y Pheisht Ushtey
    hak: Chhòng-sà-chho
...
#is_/same_as :: [[_Standards/WikiData/WD~Hydra,10578|WD~Hydra,10578]] 
