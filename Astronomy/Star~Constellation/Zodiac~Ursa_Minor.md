...
- ခုနှစ်စင်ကြယ် အသေး
- လၢဝ်ၸမ်ႈ
- პატარა დათვის თანავარსკვლავედი
- こぐま座
- 小熊座
- 작은곰자리
has_id_wikidata: Q10478
confidential: public
isDeleted: false
isReadOnly: false
tags:
...
- '[[_Standards/WikiData/WD~Ursa_Minor,105082316|WD~Ursa_Minor,105082316]]'
...
- '[[_Standards/WikiData/WD~Curved_Array,7254772|WD~Curved_Array,7254772]]'
- '[[_Standards/WikiData/WD~Celestial_Bed,10939549|WD~Celestial_Bed,10939549]]'
- '[[_Standards/WikiData/WD~Royal_Secretary,17024875|WD~Royal_Secretary,17024875]]'
- '[[_Standards/WikiData/WD~Polaris,12980|WD~Polaris,12980]]'
topic_has_template: '[[_Standards/WikiData/WD~Template_Stars_of_Ursa_Minor,10857910|WD~Template_Stars_of_Ursa_Minor,10857910]]'
instance_of:
...
different_from: '[[_Standards/WikiData/WD~Ursa_Minor_Dwarf,32883|WD~Ursa_Minor_Dwarf,32883]]'
area: 256
native_label:
- Little Bear
- Ossa Menor
...
- Mała Niedźwiedzica
- Малая Медведица
locator_map_image: http://commons.wikimedia.org/wiki/Special:FilePath/Ursa%20Minor%20constellation%20map.svg
astronomic_symbol_image: http://commons.wikimedia.org/wiki/Special:FilePath/Ursa%20Minor%20symbol%20%28Moskowitz%2C%20variable%20width%29.svg
image: http://commons.wikimedia.org/wiki/Special:FilePath/UrsaMinorCC.jpg
Hederich_encyclopedia_article: Arctos+[1]
Commons_gallery: Ursa Minor
...
dv_has_:
  name_:
    ...
    hak: Séu-yùng-chho
    he: הדובה הקטנה
    hi: ध्रुवमत्स्य तारामंडल
    hr: Mali medvjed
    hu: Kis Medve csillagkép
    hy: Փոքր Արջ
    id: Ursa Minor
    ig: Ursa Minor
    ik: Paatchuktuurat
    ...
    ja: こぐま座
    jv: Ursa Minor
    ka: პატარა დათვის თანავარსკვლავედი
    kk: Кішіқарақшы
    ko: 작은곰자리
    ku: Termê Nuhê
    kw: Ursa Minor (ranneves)
    ky: Кичи жетиген
    la: Ursa Minor
    la_:
    ...
    ml: ലഘുബാലു
    ms: Beruang Kecil
    my: ခုနှစ်စင်ကြယ် အသေး
    nan: Hîm-á-chō
    nb: Lille bjørn
    nds: Lütt Boor
    nl: Kleine Beer
    nn: Den vesle bjørnen
    oc: Pichona Orsa
    os: Чысыл Арс
    pl: Mała Niedźwiedzica
    pnb: نکا رچھ
    pt: Ursa Minor
    ro: Ursa Mică
    ru: Малая Медведица
    ...
    tl: Ursa Menor
    tr: Ursa Minor
    tt: Кече Җидегән йолдызлыгы
    tyv: Биче Чеди-Хаан деп сылдыстар бөлүү
    udm: Пичи Кобы
    uk: Мала Ведмедиця
    ur: دب اصغر
    uz: Kichik Ayiq
