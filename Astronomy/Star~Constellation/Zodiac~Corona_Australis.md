...
- astro/Zodiac
type: Zodiac
named_after: '[[_Standards/WikiData/WD~crown,170984|WD~crown,170984]]'
described_by_source:
...
topic_has_template:
- '[[_Standards/WikiData/WD~Q10729040,10729040|WD~Q10729040,10729040]]'
- '[[_Standards/WikiData/WD~Template_Stars_of_Corona_Australis,11132896|WD~Template_Stars_of_Corona_Australis,11132896]]'
shares_border_with:
...
astronomic_symbol_image: http://commons.wikimedia.org/wiki/Special:FilePath/Corona%20Australis%20symbol%20%28Moskowitz%2C%20variable%20width%29.svg
Commons_gallery: Corona Australis
...
dv_has_:
  name_:
    af: Suidelike Kroon
    ar: الإكليل الجنوبي
    arz: كورونا اوستراليس
    ast: Corona Australis
    az: Cənub Tacı
    ba: Көньяҡ таж
    be: Паўднёвая Карона
    ...
    ga: Coróin an Deiscirt
    gl: Corona Australis
    gv: Crooin y Jiass
    hak: Nàm-miên-chho
    he: כתר דרומי
    hi: दक्षिणकिरीट तारामंडल
    hr: Južna kruna
    ...
    ja: みなみのかんむり座
    jv: Corona Australis
    ka: სამხრეთის გვირგვინი
    kn: ಕರೋನ ಆಸ್ಟ್ರೇಲಿಸ್
    ko: 남쪽왕관자리
    kw: Corona Australis (ranneves)
    la: Corona Australis
    la_:
    ...
    ml: ദക്ഷിണമകുടം
    ms: Mahkota Selatan
    my: ကိုရိုနာ အော်စထရေးလစ်
    nan: Lâm-koan-chō
    nb: Den sørlige krone
    nds: Süüdlich Kroon
    nl: Zuiderkroon
    nn: Den sørlege krona
    ...
    tl: Corona Australis
    tr: Corona Australis
    tt: Көньяк таҗ йолдызлыгы
    udm: Лымшорпал Корона
    uk: Південна Корона
    ur: تاج جنوبی
    uz: Janubiy Toj
    vec: Corona Austrałe
    vi: Nam Miện
    war: Corona Australis
    wuu: 南冕座
    yue: 南冕座
    zh: 南冕座
    zh_cn: 南冕座
