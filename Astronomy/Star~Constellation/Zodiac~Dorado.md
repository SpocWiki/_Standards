...
image: http://commons.wikimedia.org/wiki/Special:FilePath/Constellation%20Dorado.jpg
...
dv_has_:
  name_:
    ...
    ja: かじき座
    jv: Dorado
    ka: ოქროს თევზის თანავარსკვლავედი
    ko: 황새치자리
    kw: Dorado (ranneves)
    la: Dorado
    la_:
    ...
    ml: സ്രാവ്
    ms: Todak
    my: ဒိုရဒို (ကြယ်စုတန်း)
    nan: Kî-hî-chō
    nb: Gullfisken
    nds: Swertfisch (Steernbild)
    nl: Goudvis
    nn: Gullfisken
    pl: Złota Ryba
    pt: Dorado
