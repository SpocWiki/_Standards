...
named_after:
- '[[_Standards/WikiData/WD~Uridimmu,7900581|WD~Uridimmu,7900581]]'
- '[[_Standards/WikiData/WD~Canis_lupus,18498|WD~Canis_lupus,18498]]'
topic_has_template:
- '[[_Standards/WikiData/WD~Q10729144,10729144|WD~Q10729144,10729144]]'
- '[[_Standards/WikiData/WD~Template_Stars_of_Lupus,10766717|WD~Template_Stars_of_Lupus,10766717]]'
shares_border_with:
...
dv_has_:
  name_:
    ...
    hr: Vuk
    ht: lou
    hu: Farkas csillagkép
    hy: Գայլ
    id: Lupus
    ig: Lupus (ìgwè kpakpando)
    is: Úlfurinn
    it: Lupo
    ja: おおかみ座
    jv: Lupus
    ka: მგლის თანავარსკვლავედი
    kk: Бөрі (шоқжұлдыз)
    kn: ಲೂಪಸ್
    ko: 이리자리
    kw: Lupus (ranneves)
    ...
    mr: वृक
    ms: Serigala
    my: လူးပက်စ် (ကြယ်စုတန်း)
    nan: Chhâi-lông-chō
    nb: Ulven
    nl: Wolf
    nn: Ulven
    os: Бирæгъ (стъалыгуппар)
    pl: Gwiazdozbiór Wilka
    pt: Lupus
    rki: လူးပက်စ်
    ro: Lupul
    ru: Волк
