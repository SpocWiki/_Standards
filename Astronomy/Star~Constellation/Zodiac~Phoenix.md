...
- astro/Zodiac
type: Zodiac
different_from: '[[_Standards/WikiData/WD~Phoenix,105751|WD~Phoenix,105751]]'
...
topic_has_template:
- '[[_Standards/WikiData/WD~Template_Phoenix_(constellation),6504933|WD~Template_Phoenix_(constellation),6504933]]'
- '[[_Standards/WikiData/WD~Q10729019,10729019|WD~Q10729019,10729019]]'
...
area: 469
named_after: '[[_Standards/WikiData/WD~phoenix,48444|WD~phoenix,48444]]'
...
Commons_gallery: Phoenix (constellation)
...
dv_has_:
  name_:
    ...
    fr: Phénix
    frr: Phoenix (stäärbil)
    ga: an Féinics
    gl: Phoenix
    gv: y Veaynushag
    hak: Fung-fòng-chho
    he: עוף החול
    hi: अमरपक्षी तारामंडल
    hr: Feniks
    hu: Főnix csillagkép
    hy: Փյունիկ
    id: Phoenix
    is: Fönix (stjörnumerki)
    it: Fenice
    ja: ほうおう座
    jv: Phoenix
    ka: ფენიქსის თანავარსკვლავედი
    ko: 봉황자리
    kw: Phoenix (ranneves)
    la: Phoenix
    la_:
