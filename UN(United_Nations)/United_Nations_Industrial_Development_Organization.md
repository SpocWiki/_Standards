...
- Industria Garapenerako Nazio Batuen Erakundea
...
- OUNID
- Pertubuhan Pembangunan Industri Pertubuhan Bangsa-Bangsa Bersatu
...
- YUNÏDO
- Арганізацыя Аб’яднаных Нацыяў па прамысловаму разьвіцьцю
- БУУ Өнөр-жайды Өнүктүрүү боюнча Уюму
...
- האומות המאוחדות
- اقوام متحدہ دی صنعتی ترقی دی تنظیم
- منظمة الأمم المتحدة للتنمية الصناعية
- منظمة الامم المتحده للتنميه الصناعيه
- يۋنىيدو
- ڕێکخراوەی گەشەپێدانی پیشەسازیی نەتەوە یەکگرتووەکان
- یونیدو
...
- 26800
- 110760
EU_Corporate_body_code: UNIDO
X_Twitter_username: UNIDO
subject_named_as: UNIDO
inception: 1966-01-01T00:00:00Z
image: http://commons.wikimedia.org/wiki/Special:FilePath/UNIDO-ISEC%20HQ%20in%20Lanzhou%2C%20China%202012.jpg
logo_image: http://commons.wikimedia.org/wiki/Special:FilePath/UNIDO%20Logo.svg
official_website: https://www.unido.org/
ISNI:
- 0000000106405242
- 0000000121646132
- 0000000121935276
P1015: 90057977
Libris_URI: dbqsv3wx52z7dgz
Instagram_username: unido_newsroom
Facebook_username: UNIDO.HQ
Commons_category: United Nations Industrial Development Organization
dv_has_:
  name_:
    ar: منظمة الأمم المتحدة للتنمية الصناعية
    arz: منظمة الامم المتحده للتنميه الصناعيه
    ast: Organización de les Naciones Xuníes pal Desenvolvimientu Industrial
    az: Sənaye inkişafı üzrə Birləşmiş Millətlərin Təşkilatı
    be: ЮНІДА
    be-tarask: Арганізацыя Аб’яднаных Нацыяў па прамысловаму разьвіцьцю
    bg: Организация на ООН за промишлено развитие
    bn: জাতিসংঘ শিল্প উন্নয়ন সংস্থা
    bs: UNIDO
    ca: Organització de les Nacions Unides per al Desenvolupament Industrial
    ckb: ڕێکخراوەی گەشەپێدانی پیشەسازیی نەتەوە یەکگرتووەکان
    cs: Organizace OSN pro průmyslový rozvoj
    da: UNIDO
    de: Organisation der Vereinten Nationen für industrielle Entwicklung
    de-at: Organisation der Vereinten Nationen für industrielle Entwicklung
    en: United Nations Industrial Development Organization
    en-gb: United Nations Industrial Development Organization
    eo: OUNID
    es: Organización de las Naciones Unidas para el Desarrollo Industrial
    eu: Industria Garapenerako Nazio Batuen Erakundea
    fa: یونیدو
    fi: Yhdistyneiden kansakuntien teollistamisjärjestö
    fr: Organisation des Nations unies pour le développement industriel
    gl: Organización das Nacións Unidas para o Desenvolvemento Industrial
    gu: યુનાઇટેડ નેશન્સ ઇન્ડસ્ટ્રીયલ ડેવલપમેન્ટ ઓર્ગેનાઇઝેશન
    he: האומות המאוחדות
    hi: संयुक्त राष्ट्र औद्योगिक विकास संगठन
    hu: Az ENSZ Iparfejlesztési Szervezete
    hy: ՄԱԿ-ի Արդյունաբերական զարգացման կազմակերպություն
    id: Organisasi Pengembangan Industri Perserikatan Bangsa-Bangsa
    is: Iðnþróunarstofnun Sameinuðu þjóðanna
    it: Organizzazione delle Nazioni Unite per lo Sviluppo Industriale
    ja: 国際連合工業開発機関
    kk: ЮНИДО
    kk-arab: يۋنىيدو
    kk-cn: يۋنىيدو
    ...
    kk-tr: YUNÏDO
    ko: 국제 연합 공업 개발 기구
    ky: БУУ Өнөр-жайды Өнүктүрүү боюнча Уюму
    lrc: یونیدو
    lt: Jungtinių Tautų pramonės plėtros organizacija
    mn: United Nations Industrial Development Organization
    ms: Pertubuhan Pembangunan Industri Pertubuhan Bangsa-Bangsa Bersatu
    my: ယူနီဒို
    nb: FNs organisasjon for industriell utvikling
    ne: संयुक्त राष्ट्र औद्योगिक विकास संगठन
    nl: Organisatie van de Verenigde Naties voor Industriële Ontwikkeling
    pa: ਸੰਯੁਕਤ ਰਾਸ਼ਟਰ ਉਦਯੋਗਿਕ ਵਿਕਾਸ ਸੰਸਥਾ
    pl: Organizacja Narodów Zjednoczonych do spraw Rozwoju Przemysłowego
    pnb: اقوام متحدہ دی صنعتی ترقی دی تنظیم
    pt: Organização das Nações Unidas para o Desenvolvimento Industrial
    ru: ЮНИДО
    sh: UNIDO
    sk: Organizácia Spojených národov pre priemyselný rozvoj
    sl: Organizacija Združenih narodov za industrijski razvoj
    so: Ururka Horumarinta Warshedaha Qaramada Midoobay
    sr: Организација Уједињених нација за индустријски развој
    sr-el: unido organizacija
    sv: United Nations Industrial Development Organization
    sw: UNIDO
    th: องค์การพัฒนาอุตสาหกรรมแห่งสหประชาชาติ
    tr: Birleşmiş Milletler Sınai Kalkınma Teşkilatı
    uk: Організація Об'єднаних Націй з промислового розвитку
    uz: Birlashgan millatlar tashkilotining sanoatni rivojlantirish tashkiloti
    vec: Organizasion ONU par el Desviłupo Industriałe
    vi: Tổ chức Phát triển Công nghiệp Liên Hợp Quốc
    yue: 聯合國工業發展組織
    zh: 联合国工业发展组织
---
# [[United_Nations_Industrial_Development_Organization]] 
...
> French/Spanish acronym: ONUDI) is a specialized agency of the United Nations 
> that assists countries in economic and industrial development. 
> 
> It is headquartered at the UN Office in Vienna, Austria, 
> with a permanent presence in over 60 countries. 
> 
> As of October 4,2024, UNIDO comprises 173 member states, 
...
> to promote and accelerate the industrialization of developing countries, 
> which were emerging from decolonization in record numbers 
> and with little to no industrial base. 
> 
> In 1979 it became one of the 15 specialized agencies of the UN, 
> with its new constitution coming into force in 1985. 
> 
> Since its founding, the organization has restructured and reformed several times; 
> the 2013 Lima Declaration expanded its mission to include 
> promoting "inclusive and sustainable industrial development" (ISID), 
> defined as benefiting greater numbers of people while safeguarding the environment. 
> UNIDO is a member of the United Nations Development Group, 
> a coalition of UN entities aimed at fulfilling the Sustainable Development Goals.
>
