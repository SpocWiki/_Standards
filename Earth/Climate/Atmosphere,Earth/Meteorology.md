...
- 氣象學
- 기상학
has_id_wikidata: Q25261
MeSH_tree_code:
- H01.277.687
- H01.671.547
IPTC_NewsCode: mediatopic/20000730
Commons_gallery: Meteorology
Commons_category: Meteorology
short_name:
- meteo
- météo
described_by_source:
...
subreddit: meteorology
Colon_Classification: U28
Dewey_Decimal_Classification: 551.5
Iconclass_notation: 49E6
image: http://commons.wikimedia.org/wiki/Special:FilePath/Windstorm%20Emma.png
...
dv_has_:
  name_:
    ...
    ht: meteyoloji
    hu: meteorológia
    hy: օդերևութաբանություն
    hyw: օդերեւութաբանութիւն
    ia: meteorologia
    id: meteorologi
    ie: meteorologie
    inh: метеорологи
...
#is_/same_as :: [[_Standards/WikiData/WD~Meteorology,25261|WD~Meteorology,25261]] 

## #has_/text_of_/abstract 

> **Meteorology** is the scientific study of the Earth's atmosphere and short-term atmospheric phenomena (i.e., weather), 
> with a focus on [[../Weather|Weather]] forecasting. 
> 
> It has applications in the military, aviation, energy production, transport, agriculture, construction, weather warnings, and disaster management.
>
