...
OmegaWiki_Defined_Meaning: 928775
UMLS_CUI: C0020167
MeSH_tree_code:
- G16.500.275.063.725.310
- G16.500.750.775.310
- N06.230.150.372
...
dv_has_:
  name_:
    ...
    tl: Halumigmig
    tr: nem
    udm: омырлэн мускытлыкез
    uk: вологість повітря
    ur: نمی
    uz: Namlik
    vec: umidità
    vi: Độ ẩm tuyệt đối
...
#is_/same_as :: [[_Standards/WikiData/WD~Humidity,180600|WD~Humidity,180600]] 

## #has_/text_of_/abstract 

> **Humidity** is the concentration of water vapor present in the air. 
> Water vapor, the gaseous state of water, is generally invisible to the naked eye. 
