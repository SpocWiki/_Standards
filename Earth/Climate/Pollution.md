...
- Gurɓacewa
- Ifloslanish
- Image sur l'insalubrité et la dégradation de l'environnement
- incuinamento
- inquinamento
- kaaʹst
- kirlənmə
...
dv_is_:
  same_as:
  - '[[../../WikiData/WD~Pollution,58734|WD~Pollution,58734]]'
...
dv_has_:
  name_:
    ...
    nn: forureining
    oc: pollucion
    om: Faalama Qilleensaa Fi Naannoo
    or: ପ୍ରଦୂଷଣ
    pa: ਪ੍ਰਦੂਸ਼ਣ
    ...
    sh: zagađenje
    si: පරිසර දුශනය
    sk: znečistenie životného prostredia
    sl: onesnaževanje
    smn: nyeskidem
    sms: kaaʹst
    sq: Ndotja
