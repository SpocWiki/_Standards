...
- Temperateness
- tempererat klimat
- tempererejuvvon dálkkádatguovlu
- Tempereret klima
- temperert klima
- Temperéiert Klima
- Temprað belti
...
dv_has_:
  name_:
    ...
    hy: Չափավոր կլիմա
    id: iklim sedang
    ig: Ọnọdụ ihu igwe dị jụụ
    ilo: kalalainganna a klima
    inh: Юккъера Ӏалама лоаттам
    is: Temprað belti
    it: clima temperato
    ja: 温帯
    ...
    sd: ٽيمپريٽ
    se: tempererejuvvon dálkkádatguovlu
    sh: Umjerena klima
    sk: Mierne pásmo
    sl: podnebje zmernega pasu
    sr: Умерена клима
    sv: tempererat klimat
    ta: மிதவெப்பமண்டலம்
    th: ภูมิอากาศแบบอบอุ่น
    tr: Ilıman kuşak iklimleri
    ts: Ku kufumela
    uk: помірний кліматичний пояс
    ur: معتدل آب و ہوا
    uz: moʻʼtadil iqlim
    vec: clima tenperà
    vi: Ôn đới
...
> In geography, the temperate climates of Earth occur in the middle latitudes 
> (approximately 23.5° to 66.5° N/S of the Equator), 
> which span between the tropics and the polar regions of Earth. 
> 
> These zones generally have wider temperature ranges throughout the year 
> and more distinct seasonal changes compared to tropical climates, 
> where such variations are often small; they usually differ only in the amount of precipitation.
>
> In temperate climates, not only do latitudinal positions influence temperature changes, 
> but various sea currents, prevailing wind direction, continentality (how large a landmass is) 
