...
- http://commons.wikimedia.org/wiki/Special:FilePath/Thira%20%28Santorini%29%20-%20Ia-01.jpg
exact_match: http://purl.obolibrary.org/obo/ENVO_00000150
Iconclass_notation: 25K142
UMLS_CUI: C2936266
Commons_category: Coral reefs
MeSH_tree_code:
- G16.500.275.157.130
- N06.230.124.130
...
dv_has_:
  name_:
    ...
    kw: krib gwylar
    la: scopulus curalii
    lld: bariera coralina
    lt: koralinis rifas
    lv: koraļļu rifs
    mg: haran-dranomasina
    min: tarumbu karang
    mk: корален гребен
    ml: പവിഴപ്പുറ്റ്
    mn: шүрэн хад
    ...
    te: ప్రవాళ భిత్తిక
    th: พืดหินปะการัง
    tl: bahura ng mga bulaklak na bato
    tr: mercan resifi
    uk: коралові споруди
    ur: مرجانی جل پتھر
    uz: marjon riflari
    vec: bariera corałina
    vi: rạn san hô
    war: bahura han bagangbang
    wuu: 珊瑚礁
    yue: 珊瑚礁
    zh: 珊瑚礁
    zh_hant: 珊瑚礁
