...
dv_has_:
  name_:
    ...
    la: Cumulonimbus
    lmo: Cumulonemb
    lt: Liūtiniai kamuoliniai debesys
    lv: Gubu lietusmākoņi
    mk: кумулонимбус
    ml: കുമുലോ നിംബസ്
    mr: गर्जन्मेघ
    ms: Awan kumulonimbus
    mul: cumulonimbus
    nb: cumulonimbus
    nl: cumulonimbus
    nn: Cumulonimbus
    ...
    sv: Cumulonimbus
    ta: திரள் கார்முகில்
    te: క్యుములోనింబస్ మేఘం
    th: คิวมูโลนิมบัส
    tr: kümülonimbus
    uk: Купчасто-дощові хмари
    vi: mây vũ tích
    war: Cumulonimbus
    wuu: 积雨云
    yue: 積雨雲
