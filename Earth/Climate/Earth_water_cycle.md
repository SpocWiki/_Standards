...
- Yaku muyuriy
- Zyklus des Wassers
- Çутçанталăри шыв çаврăмĕ
- Ūdens cikls
- κύκλος του νερού
- вулэн инкуазьын бергамез
- Кругазварот вады
...
dv_has_:
  name_:
    af: waterkringloop
    am: የውሃ ኡደት
    an: Ciclo hidrolochico
    ann: Ukana mun̄
    ar: دورة الماء
    ary: ضورة د لما
    ast: Ciclu hidrolóxicu
    awa: जल-चक्र
    az: Su dövranı
    azb: سو دؤورانی
    ...
    br: Kelc'hiad an dour
    bs: hidrološki ciklus
    bxr: Уһанай эрьесэ
    ca: cicle hidrològic
    chr: ᎠᎹ ᎠᏓᏁᏟᏴᏎᎬ
    ckb: سووڕی ئاو
    cs: koloběh vody
    cv: Çутçанталăри шыв çаврăмĕ
    cy: cylchred ddŵr
    da: Vandets kredsløb
    de: Wasserkreislauf
    el: κύκλος του νερού
    ...
    la: Circulus aquae
    li: Waterkringloup
    lmo: Ciclo de l'acqua
    lo: ວົງຈອນນ້ໍາ
    lt: Hidrologinis ciklas
    ltg: Iudiņa cyklys
    lv: Ūdens cikls
    mk: Кружење на водата
    ml: ജലചംക്രമണം
    mn: Усны эргэлт
    mr: जलचक्र
    ms: kitaran air
    ...
    si: ජල චක්රය
    sk: kolobeh vody
    skr: آبی چکر (واٹر سائیکل)
    sl: kroženje vode
    sn: Nhevedzwa dzeMvura
    sq: Cikli i Ujit
    sr: хидролошки циклус
    su: Daur cai
