...
- воштӥськем гурезь извыжыос
- метамарфічныя горныя пароды
- метаморфічні гірські породи
- метаморфик тау токымы
...
- мэтамарфічная горная парода
- Хувирмал чулуулаг
- Ҷинсҳои кӯҳии метаморфи
- Փոխակերպուած քարեր
- փոխակերպված ապար
- סלע מותמר
- تبدیل شدہ چٹان
...
has_cause: '[[_Standards/WikiData/WD~metamorphism,380971|WD~metamorphism,380971]]'
...
studied_by: '[[_Standards/WikiData/WD~metamorphic_petrology,111968621|WD~metamorphic_petrology,111968621]]'
...
EAGLE_id: material/lod/33
Commons_gallery: Metamorphic rock
Commons_category: Metamorphic rocks
dv_is_:
  same_as:
  - '[[../../../../../WikiData/WD~Metamorphic_rock,47069|WD~Metamorphic_rock,47069]]'
  - '[[/_Standards/Earth/Climate/Structure_of_Earth/Lithosphere/Rock(geology)/Metamorphic_Rock|Metamorphic_Rock]]'
  - '[[/_public/Earth/Climate/Structure_of_Earth/Lithosphere/Rock(geology)/Metamorphic_Rock.public|Metamorphic_Rock.public]]'
  - '[[/_internal/Earth/Climate/Structure_of_Earth/Lithosphere/Rock(geology)/Metamorphic_Rock.internal|Metamorphic_Rock.internal]]'
  - '[[/_protect/Earth/Climate/Structure_of_Earth/Lithosphere/Rock(geology)/Metamorphic_Rock.protect|Metamorphic_Rock.protect]]'
  - '[[/_private/Earth/Climate/Structure_of_Earth/Lithosphere/Rock(geology)/Metamorphic_Rock.private|Metamorphic_Rock.private]]'
  - '[[/_personal/Earth/Climate/Structure_of_Earth/Lithosphere/Rock(geology)/Metamorphic_Rock.personal|Metamorphic_Rock.personal]]'
  - '[[/_secret/Earth/Climate/Structure_of_Earth/Lithosphere/Rock(geology)/Metamorphic_Rock.secret|Metamorphic_Rock.secret]]'
dv_is_same_as:
- '[[../../../../../WikiData/WD~Metamorphic_rock,47069|WD~Metamorphic_rock,47069]]'
- '[[/_Standards/Earth/Climate/Structure_of_Earth/Lithosphere/Rock(geology)/Metamorphic_Rock|Metamorphic_Rock]]'
- '[[/_public/Earth/Climate/Structure_of_Earth/Lithosphere/Rock(geology)/Metamorphic_Rock.public|Metamorphic_Rock.public]]'
...
dv_has_:
  name_:
    af: Metamorfe gesteente
    ar: صخر متحول
    ast: roca metamórfica
    ...
    es: roca metamórfica
    et: moondekivim
    eu: Arroka metamorfiko
    fa: سنگ دگرگونی
    fi: metamorfinen kivilaji
    fr: roche métamorphique
    ga: carraig mheiteamorfach
    gd: Clach chruth-atharrachail
    gl: rocha metamórfica
    he: סלע מותמר
    hi: कायांतरित शैल
    hr: metamorfne stijene
    hu: metamorf kőzet
    hy: փոխակերպված ապար
    hyw: Փոխակերպուած քարեր
    id: Batuan metamorf
    io: Metamorfa roko
    is: Umbreytingarberg
    it: roccia metamorfica
    ja: 変成岩
    ka: მეტამორფული ქანები
    kab: azṛu asefludem
    kk: Метаморфтық тау жыныстары
    ko: 변성암
    kw: karrek dreusfurvek
    la: Saxum metamorphicum
    lld: sas metamorfich
    lt: metamorfinė uola
    lv: metamorfais iezis
    mk: метаморфна карпа
    ml: കായാന്തരിതശില
    mn: Хувирмал чулуулаг
    ms: Batuan metamorfosis
    my: အသွင်ပြောင်းကျောက်
    nan: Piàn-sêng-giâm
    nb: metamorf bergart
    nds: Metamorphit
    ne: परिवर्तित चट्टान
    nl: metamorf gesteente
    nn: Metamorf bergart
    oc: Ròca metamorfica
    pa: ਪਰਿਵਰਤਿਤ ਚਟਾਨਾਂ
    ...
    sw: Mwamba metamofia
    ta: உருமாறிய பாறை
    tg: Ҷинсҳои кӯҳии метаморфи
    th: หินแปร
    tl: Banyuhing bato
    tr: Başkalaşım kayaçları
    tt: метаморфик тау токымы
    udm: воштӥськем гурезь извыжыос
    uk: метаморфічні гірські породи
    ur: تبدیل شدہ چٹان
    uz: Metamorfik togʻ jinslari
    vec: ròcia metamòrfega
    vi: Đá biến chất
    wuu: 变质岩
    yue: 變質岩
    zh: 变质岩
...
> 
> The original rock (protolith) is subjected to temperatures greater than 150 to 200 °C (300 to 400 °F) 
> and, often, elevated pressure of 100 megapascals (1,000 bar) or more, 
> causing profound physical or chemical changes. 
> During this process, the rock remains mostly in the solid state, 
> but gradually recrystallizes to a new texture or mineral composition. 
