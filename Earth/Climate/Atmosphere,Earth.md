...
- tawang-panawang bumi
- Tera atmosfero
- Tē-kiû ê tāi-khì-khoan
- Umoyambulunga Womhlaba
- Wayra pacha
- Zemes atmosfēra
- Zemljina atmosfera
- áibmogeardi
...
- Земјина атмосфера
- земљина атмосфера
- Музъемлэн атмосфераез
- Երկրի մթնոլորտ
- אטמוספירת כדור הארץ
- ערד'ס אטמאספער
- اتموسفيرا بومي
- بُتہٕ راتھ ہُنٛد واو مَنڈُل
- تەوشک
- جو زمین
- د ځمکې اتموسپير
- زمين جو موسم
...
dv_has_:
  name_:
    ...
    am: ከባቢ አየር
    ar: غلاف الأرض الجوي
    as: পৃথিৱীৰ বায়ুমণ্ডল
    ast: atmósfera terrestre
    awa: हवा
    az: atmosfer
    azb: هاوا
    ...
    ja: 地球の大気
    jam: atmosfier a Oert
    jv: tawang-panawang bumi
    ka: დედამიწის ატმოსფერო
    kaa: atmosfera
    kk: Жер атмосферасы
    km: ខ្យល់
    kn: ಭೂಮಿಯ ವಾಯುಮಂಡಲ
    ko: 지구 대기권
    ks: بُتہٕ راتھ ہُنٛد واو مَنڈُل
    ky: Жер атмосферасы
    la: Aër
    lb: Atmosphär vun der Äerd
    lmo: atmosfera terrèster
    lo: ບັນຍາກາດຂອງໂລກ
    lt: Žemės atmosfera
    lv: Zemes atmosfēra
    map_bms: atmosfer
    ...
    nn: jordatmosfæren
    oc: atmosfèra
    om: Qilleensaa Nannoo
    or: ପୃଥିବୀର ବାୟୁମଣ୍ଡଳ
    os: Зæххы атмосферæ
    pa: ਹਵਾ
    ...
    ru: атмосфера Земли
    sa: पृथिव्याः वायुमण्डलम्
    sc: atmosfera
    scn: atmusfera dâ Terra
    sco: atmosphere o Yird
    sd: زمين جو موسم
    se: áibmogeardi
    sgs: atmuospėra īr Žemės
    sh: Zemljina atmosfera
    si: පෘථිවි වායුගෝලය
    sk: atmosféra Zeme
    sl: ozračje
    smn: Eennâm áimukerdi
    sms: äimmǩiârd
    sq: atmosfera e Tokës
    sr: земљина атмосфера
    stq: Äid-Atmosphäre
    su: atmosfir
    sv: jordens atmosfär
    sw: angahewa ya dunia
...
| [[Exosphere]]        | Hydrogen, helium, heavier elements like oxygen and carbon         |  1e-7 | transition between Earth's atmosphere and space.                                              |             >2000°C (varies widely) |     600 |
...
> The atmosphere of Earth consists of a layer of mixed gas that is retained by gravity, surrounding the Earth's surface. Known collectively as air, it contains variable quantities of suspended aerosols and particulates that create weather features such as clouds and hazes. The atmosphere serves as a protective buffer between the Earth's surface and outer space. It shields the surface from most meteoroids and ultraviolet solar radiation, reduces diurnal temperature variation – the temperature extremes between day and night, and keeps it warm through heat retention via the greenhouse effect. The atmosphere redistributes heat and moisture among different regions via air currents, and provides the chemical and climate conditions that allow life to exist and evolve on Earth.
>
