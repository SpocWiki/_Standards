...
- calefactio globalis
- Calefaction global
- Calentamentu globale
- calentamiento global
- Calentamientu global
- Canjin yanayi
- Climate change
- cynhesu byd-eang
- dálkkádaga liegganeapmi
- Eadaweamung
- Erderwärmung
- Escalfament global
...
- globālā sasilšana
- Gluobal waamin
- Gluobalėnis atšėlėms
- Guherîna avhewayê
- Heimshlýnun
- Ho'a Adunya
- hèŋhel li ndèè
- Ilma lämmämbäsminek üle ilma
- ilmaston lämpeneminen
- Imihindagurikire y’ibihe
- Jagat nyongkab
- Kalibotanong pagpanginit
- Klimaatopwerming
...
- Pag-init ng daigdig
- Pagbago kan klima
- Pagpaso han kalibutan
- Pamanasan global
- Pamangaluku ning yatu
- Panagpúdot ti lubong
- pemanasan global
- Qlobal istiləşmə
- quecemento global
- Rechofman atmosferik
- rescaldamento globałe
...
contributing_factor_of: '[[_Standards/WikiData/WD~arctic_sea_ice_decline,16243069|WD~arctic_sea_ice_decline,16243069]]'
GitHub_topic: global-warming
has_cause: '[[_Standards/WikiData/WD~greenhouse_gas_emissions,106358009|WD~greenhouse_gas_emissions,106358009]]'
has_characteristic:
- '[[_Standards/WikiData/WD~summer_heat,12888883|WD~summer_heat,12888883]]'
- '[[_Standards/WikiData/WD~global_boiling,120999124|WD~global_boiling,120999124]]'
has_contributing_factor: '[[_Standards/WikiData/WD~coal-fired_power_station,6558431|WD~coal-fired_power_station,6558431]]'
has_effect:
- '[[_Standards/WikiData/WD~wildfire,169950|WD~wildfire,169950]]'
- '[[_Standards/WikiData/WD~heat_wave,215864|WD~heat_wave,215864]]'
- '[[_Standards/WikiData/WD~sea_level_rise,841083|WD~sea_level_rise,841083]]'
- '[[_Standards/WikiData/WD~ocean_acidification,855711|WD~ocean_acidification,855711]]'
- '[[_Standards/WikiData/WD~retreat_of_glaciers_since_1850,903816|WD~retreat_of_glaciers_since_1850,903816]]'
- '[[_Standards/WikiData/WD~extreme_weather,1277161|WD~extreme_weather,1277161]]'
- '[[_Standards/WikiData/WD~environmental_degradation,1334780|WD~environmental_degradation,1334780]]'
- '[[_Standards/WikiData/WD~water_scarcity,5376358|WD~water_scarcity,5376358]]'
- '[[_Standards/WikiData/WD~extinction_risk_from_global_warming,5422084|WD~extinction_risk_from_global_warming,5422084]]'
- '[[_Standards/WikiData/WD~social_inequality,5431887|WD~social_inequality,5431887]]'
- '[[_Standards/WikiData/WD~polar_amplification,7209060|WD~polar_amplification,7209060]]'
- '[[_Standards/WikiData/WD~global_warming_controversy,15278684|WD~global_warming_controversy,15278684]]'
...
instance_of:
- '[[_Standards/WikiData/WD~human_impact_on_the_environment,574376|WD~human_impact_on_the_environment,574376]]'
- '[[_Standards/WikiData/WD~environmental_issue,2144359|WD~environmental_issue,2144359]]'
- '[[_Standards/WikiData/WD~atmospheric_phenomenon,4072190|WD~atmospheric_phenomenon,4072190]]'
...
opposite_of: '[[_Standards/WikiData/WD~global_cooling,1322176|WD~global_cooling,1322176]]'
...
studied_in: '[[_Standards/WikiData/WD~climatology,52139|WD~climatology,52139]]'
subclass_of:
- '[[_Standards/WikiData/WD~climate_change,125928|WD~climate_change,125928]]'
- '[[_Standards/WikiData/WD~external_risk,5422048|WD~external_risk,5422048]]'
UMLS_CUI: C0206217
video:
...
dv_has_:
  name_:
    ...
    anp: विश्वव्यापी तापमान म॑ वृद्धि
    ar: الاحتباس الحراري
    ary: تبدال د لمناخ
    arz: دفا كوكبى
    as: গোলকীয় উষ্ণতা বৃদ্ধি
    ast: Calentamientu global
    az: Qlobal istiləşmə
    azb: ایقلیم دییشیکلیگی
    ba: Глобаль йылыныу
    bar: Eadaweamung
    bas: hèŋhel li ndèè
    ...
    bxr: Дэлхэйн дулааралга
    ca: escalfament global
    ce: Глобалан дохдалар
    ...
    es-419: calentamiento global
    et: globaalne soojenemine
    eu: berotze globala
    fa: تغییر اقلیم
    fi: ilmaston lämpeneminen
    fo: Globala upphitingin
    fr: réchauffement climatique
    frr: globaal apwarmin
    fur: Riscjaldament globâl
    ga: téamh domhanda
    gaa: tsakemɔ ni eha jeŋ edɔ
    gcr: Réchofman klimatik
    gd: atharrachadh na gnàth-shìde
    gl: quecemento global
    gn: Yvy ñembyaku
    gpe: Climate change
    gsw: Globali Erwermig
    gu: વૈશ્વિક આબોહવા પરિવર્તન
    guc: Calentamiento global
    gv: caghlaa emshyragh
    ha: Canjin yanayi
    he: התחממות עולמית
    ...
    kab: Asmeskel anezway
    kk: Ғаламдық жылыну
    kn: ಜಾಗತಿಕ ತಾಪಮಾನ ಏರಿಕೆ
    ko: 지구 온난화
    ku: Guherîna avhewayê
    kw: Tommheans ollvysel
    ky: Глобалдык жылылануусу
    la: calefactio globalis
    lb: Global Erwäermung
    lez: Дуьньядин чими хьун
    lfn: Caldi global
    lg: Olubuguumiriro lw'Enkulungo y'Ensi
    li: Klimaatopwerming
    lld: Sciaudamënt globel
    lmo: Riscaldament glubal
    lo: ການປ່ຽນແປງດິນຟ້າອາກາດ
    lt: visuotinis atšilimas
    lv: globālā sasilšana
    lzh: 天地日暖
    mg: Fihafanan'ny tany
    ...
    nds: Globale Upwärmen
    ne: भूमण्डलीय उष्मीकरण
    ...
    rw: Imihindagurikire y’ibihe
    sah: Аан дойду сылыйыыта
    sc: Calentamentu globale
    scn: Scaudamentu climàticu
    sd: عالمي گرميءَ ۾ واڌ
    se: dálkkádaga liegganeapmi
    sgs: Gluobalėnis atšėlėms
    sh: Globalno zatopljenje
    si: ගෝලීය තාපනය
    sk: globálne otepľovanie
    sl: globalno segrevanje
    smn: šoŋŋâduv lieggânem
    sms: äimmõõzz pakknummuš
    sq: Ngrohja globale
    sr: Глобално загревање
    stq: Globoale Woormenge
    su: Jagat nyongkab
    ...
    ur: عالمی حرارت
    uz: Global isish
    vec: rescaldamento globałe
    vep: Globaline lämšund
    vi: ấm lên toàn cầu
    vro: Ilma lämmämbäsminek üle ilma
    wa: Reschandixhaedje del Daegne
