...
- Empire State Building Tate
- Empire State eraikina
- Empire State-byggingin
- Empire State-gebou
- Empire_State_Building
- Gedhong Empire State
- Gedung Empire State
- Gusaling Empire State
- Imperia-Ŝtata Konstruaĵo
...
- ایمپائر اسٹیٹ بلڈنگ
- ایمپائیر سٹیٹ بلڈنگ
- ایمپایر ایستئیت بیناسی
- اېمپاير سټېټ ودانۍ
- باڵەخانەی ئێمپایەر ستەیت
- ساختمان امپایر استیت
- مبنى إمباير ستيت
- އެމްޕައަރ ސްޓޭޓް ބިލްޑިންގ
- एम्पायर स्टेट इमारत
- एम्पायर स्टेट बिल्डिङ
- एम्पायर स्टेट बिल्डिङ्ग
- एम्पायर स्टेट भवन
- এম্পায়ার স্টেট বিল্ডিং
- এম্পায়াৰ ষ্টেট বিল্ডিং
- ਐਂਪਾਇਰ ਸਟੇਟ ਬਿਲਡਿੰਗ
...
architect: '[[_Standards/WikiData/WD~Shreve,_Lamb_&_Harmon,617190|WD~Shreve,_Lamb_&_Harmon,617190]]'
architectural_style: '[[_Standards/WikiData/WD~Art_Deco_architecture,12720942|WD~Art_Deco_architecture,12720942]]'
area: 2248355
...
CRIS_Unique_Site_Number: 6101.001691
Danbooru_tag: empire_state_building
date_of_official_opening: 1931-05-01
different_from: '[[_Standards/WikiData/WD~Empire_Building,1339295|WD~Empire_Building,1339295]]'
Facebook_username: empirestatebuilding
floors_above_ground: 102
floors_below_ground: 1
has_part_s_:
- '[[_Standards/WikiData/WD~observation_deck,177305|WD~observation_deck,177305]]'
- '[[_Standards/WikiData/WD~transmitter_mast,1068623|WD~transmitter_mast,1068623]]'
- '[[_Standards/WikiData/WD~retail_area,5152545|WD~retail_area,5152545]]'
- '[[_Standards/WikiData/WD~lobby,31948|WD~lobby,31948]]'
...
located_on_street:
- '[[_Standards/WikiData/WD~Fifth_Avenue,109858|WD~Fifth_Avenue,109858]]'
- '[[_Standards/WikiData/WD~34th_Street,110049|WD~34th_Street,110049]]'
location: '[[_Standards/WikiData/WD~Midtown_Manhattan,11249|WD~Midtown_Manhattan,11249]]'
...
named_after: '[[_Standards/WikiData/WD~Empire_State,7102494|WD~Empire_State,7102494]]'
...
owned_by: '[[_Standards/WikiData/WD~Empire_State_Realty_Trust,27146006|WD~Empire_State_Realty_Trust,27146006]]'
page_banner: http://commons.wikimedia.org/wiki/Special:FilePath/Attractions%20Banner.jpg
part_of: '[[_Standards/WikiData/WD~Seven_Wonders_of_the_Modern_World,12800832|WD~Seven_Wonders_of_the_Modern_World,12800832]]'
Pinterest_username: empirestatebldg
postal_code: 10118
significant_event:
- '[[_Standards/WikiData/WD~construction,385378|WD~construction,385378]]'
- '[[_Standards/WikiData/WD~aviation_accident,744913|WD~aviation_accident,744913]]'
- '[[_Standards/WikiData/WD~groundbreaking_ceremony,1068633|WD~groundbreaking_ceremony,1068633]]'
- '[[_Standards/WikiData/WD~opening_ceremony,3010369|WD~opening_ceremony,3010369]]'
social_media_followers:
- 27000
- 267434
structural_engineer: '[[_Standards/WikiData/WD~Homer_G._Balcom,16856049|WD~Homer_G._Balcom,16856049]]'
...
dv_is_:
  same_as:
  - '[[../../../../WikiData/WD~Empire_State_Building,9188|WD~Empire_State_Building,9188]]'
  - '[[/_Standards/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Empire_State_Building|Empire_State_Building]]'
  - '[[/_public/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Empire_State_Building.public|Empire_State_Building.public]]'
  - '[[/_internal/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Empire_State_Building.internal|Empire_State_Building.internal]]'
  - '[[/_protect/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Empire_State_Building.protect|Empire_State_Building.protect]]'
  - '[[/_private/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Empire_State_Building.private|Empire_State_Building.private]]'
  - '[[/_personal/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Empire_State_Building.personal|Empire_State_Building.personal]]'
  - '[[/_secret/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Empire_State_Building.secret|Empire_State_Building.secret]]'
dv_is_same_as:
- '[[../../../../WikiData/WD~Empire_State_Building,9188|WD~Empire_State_Building,9188]]'
- '[[/_Standards/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Empire_State_Building|Empire_State_Building]]'
- '[[/_public/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Empire_State_Building.public|Empire_State_Building.public]]'
...
dv_has_:
  name_:
    ...
    ar: مبنى إمباير ستيت
    arz: امباير ستيت
    as: এম্পায়াৰ ষ্টেট বিল্ডিং
    ast: Empire State Building
    az: Empayr Steyt Bildinq
    azb: ایمپایر ایستئیت بیناسی
    ...
    ce: Эмпайр-стейт-билдинг
    ckb: باڵەخانەی ئێمپایەر ستەیت
    crh: Empayr-steyt-bilding
    ...
    fo: Empire State Building
    fr: Empire State Building
    fy: Empire State Building
    ga: Empire State Building
    gl: Empire State Building
    gn: Empire State Building
    gsw: Empire State Building
    he: בניין אמפייר סטייט
    hi: एम्पायर स्टेट भवन
    hif: Empire State Building
    hr: Empire State Building
    ht: Empire State Building
    hu: Empire State Building
    hy: Էմփայր Սթեյթ Բիլդինգ
    id: Gedung Empire State
    is: Empire State-byggingin
    it: Empire State Building
    ja: エンパイア・ステート・ビルディング
    jv: Gedhong Empire State
    ka: ემპაირ სტეიტ ბილდინგი
    kbp: Ampiiri Siteti Piilidiŋ
    kk: Эмпайр-Стейт-Билдинг
    ko: 엠파이어 스테이트 빌딩
    ...
    lv: Empire State Building
    mai: एम्पायर स्टेट बिल्डिङ
    mk: Емпаер стејт билдинг
    ml: എംപയർ സ്റ്റേറ്റ് ബിൽഡിംഗ്
    mn: Эмпайр-Стейт-Билдинг
    mr: एम्पायर स्टेट इमारत
    ms: Bangunan Empire State
    mul: Empire State Building
    my: အင်ပိုင်ယာစတိတ် အဆောက်အဦး
    nan: Tè-kok Tāi-hā
    nb: Empire State Building
    nds: Empire State Building
    new: एम्पायर स्टेट बिल्डिङ्ग
    nl: Empire State Building
    nn: Empire State Building
    oc: Empire State Building
    pa: ਐਂਪਾਇਰ ਸਟੇਟ ਬਿਲਡਿੰਗ
    pl: Empire State Building
    pms: Empire State Building
    ...
    sh: Empire State Building
    si: එම්පයර් ස්ටේට් ගොඩනැගිල්ල
    ...
    th: ตึกเอ็มไพร์สเตต
    tl: Gusaling Empire State
    tr: Empire State Binası
    tt: Empayr Steyt Bilding
    tw: Empire State Building
    uk: Емпайр-Стейт-Білдінг
    ur: ایمپائر اسٹیٹ بلڈنگ
    uz: Empire State Building
    vep: Empair Steit Bilding
...
![[../../../../assets/Empire_State_Building.png|Empire_State_Building.png]] 
