...
- Aleksandriya pharu
- Aleksandriä mayagı
- Alexandria ê Teng-thah
- Alexandriako itsasargia
- Alexandrijský maják
- Birca Çirayê ya Îskenderiyeyê
- Fanale d'Alissandria
- far d'Alexandria
- Far d'Alexàndria
- Faras Chathair Alastair
- Fari i Aleksandrisë
- Faro de Alejandría
- Faro de Alexandría
- faro di Alessandria
...
Commons_category: Pharos of Alexandria
...
dv_has_:
  name_:
    af: Vuurtoring van Alexandrië
    ar: فنار الإسكندرية
    arz: فنار اسكندريه
    ast: Faru d'Alexandría
    az: İsgəndəriyyə mayakı
    ...
    ca: far d'Alexandria
    ckb: منارەی ئەسکەندەرییە
    co: Fanale d'Alissandria
    cs: Maják na ostrově Faru
    cv: Александри маякĕ
    ...
    et: Pharose tuletorn
    eu: Alexandriako itsasargia
    fa: فانوس اسکندریه
    fi: Faroksen majakka
    fr: phare d'Alexandrie
    ga: Faras Chathair Alastair
    gl: Faro de Alexandría
    he: המגדלור באלכסנדריה
    hi: सिकन्दरिया का प्रकाशस्तंभ
    hr: Aleksandrijski svjetionik
    hu: pharoszi világítótorony
    hy: Ալեքսանդրիայի փարոս
    hyw: Աղեքսանդրիոյ Փարոսը
    id: Mercusuar Iskandariyah
    is: Vitinn í Faros við Alexandríu
    it: faro di Alessandria
    ja: アレクサンドリアの大灯台
    jv: Mercusuar Iskandariyah
    ka: ალექსანდრიის შუქურა
    kk: Александрия шамшырағы
    ko: 알렉산드리아의 등대
    ku: Birca Çirayê ya Îskenderiyeyê
    ky: Александрия маягы
    la: Pharus Alexandrinus
    lad: Fener de Aleksandria
    lt: Aleksandrijos švyturys
    lv: Aleksandrijas bāka
    mk: Александриски светилник
    ml: ഫറോസ് ലൈറ്റ് ഹൗസ്
    mn: Александрын гэрэлт цамхаг
    mr: अलेक्झांड्रियाचे दीपगृह
    ms: Rumah Api Iskandariah
    my: အလက်ဇန်းဒရီးယားရှိ မီးပြတိုက်
    nan: Alexandria ê Teng-thah
    nb: fyrtårnet på Faros ved Alexandria
    ne: एलेक्जेन्ड्रियाको प्रकाशघर
    nl: Pharos van Alexandrië
    oc: Far d'Alexàndria
    ...
    sco: Lichthoose o Alexandria
    sh: Svjetionik u Aleksandriji
    si: ඇලෙක්සැන්ඩ්රියාවේ ප්රදීපාගාරය
    sk: Alexandrijský maják
    ...
    th: ประภาคารฟาโรสแห่งอเล็กซานเดรีย
    tl: Paro ng Alehandriya
    tr: İskenderiye Feneri
    tt: Aleksandriä mayagı
    uk: Александрійський маяк
    ur: اسکندریہ کا روشن مینار
    uz: Aleksandriya mayogʻi
    vi: Hải đăng Alexandria
    war: Parola han Alexandria
    wuu: 亚历山大灯塔
    xmf: ალექსანდრიაშ ოსინთუ
    yue: 亞歷山大燈塔
...
> was a lighthouse built by the Ptolemaic Kingdom of Ancient Egypt, 
> during the reign of Ptolemy II Philadelphus (280–247 BC). 
> 
...
>
> The lighthouse was severely damaged by three earthquakes between 956 and 1303 AD and became an abandoned ruin. It was the third-longest surviving ancient wonder, after the Mausoleum at Halicarnassus and the extant Great Pyramid of Giza, surviving in part until 1480, when the last of its remnant stones were used to build the Citadel of Qaitbay on the site.
>
...
>
> In 2025, portions of the lighthouse's entrance, threshold stones, and foundation paving stones were resurfaced to aid in a digital reconstruction effort.
>
...
### #is_/same_as :: [[/_Standards/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Seven_Wonders_of_the_Ancient_World/Lighthouse_of_Alexandria|Lighthouse_of_Alexandria]] 

### #is_/same_as :: [[/_public/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Seven_Wonders_of_the_Ancient_World/Lighthouse_of_Alexandria.public|Lighthouse_of_Alexandria.public]] 

### #is_/same_as :: [[/_internal/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Seven_Wonders_of_the_Ancient_World/Lighthouse_of_Alexandria.internal|Lighthouse_of_Alexandria.internal]] 

### #is_/same_as :: [[/_protect/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Seven_Wonders_of_the_Ancient_World/Lighthouse_of_Alexandria.protect|Lighthouse_of_Alexandria.protect]] 

### #is_/same_as :: [[/_private/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Seven_Wonders_of_the_Ancient_World/Lighthouse_of_Alexandria.private|Lighthouse_of_Alexandria.private]] 

### #is_/same_as :: [[/_personal/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Seven_Wonders_of_the_Ancient_World/Lighthouse_of_Alexandria.personal|Lighthouse_of_Alexandria.personal]] 

### #is_/same_as :: [[/_secret/Earth/Geography/Place/Landmarks_or_Historical_Buildings/Seven_Wonders_of_the_Ancient_World/Lighthouse_of_Alexandria.secret|Lighthouse_of_Alexandria.secret]] 
