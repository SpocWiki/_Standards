...
dv_has_:
  name_:
    ar: نصب لنكولن التذكاري
    arz: نصب لنكولن التذكارى
    az: Linkoln memorialı
    ba: Линкольн Мемориалы
    be: Мемарыял Лінкальна
    bg: Линкълн Мемориал
    bn: লিংকন মেমোরিয়াল
    ca: Lincoln Memorial
    cs: Lincolnův památník
    cy: Cofeb Lincoln
    da: Lincoln Memorial
    de: Lincoln Memorial
    en: Lincoln Memorial
    eo: Monumento de Lincoln
    es: Monumento a Lincoln
    eu: Lincoln Memorial
    fa: یادبود لینکلن
    fi: Lincolnin muistomerkki
    fr: Lincoln Memorial
    fy: Tinkteken foar Lincoln
    ga: Cuimhneachán Lincoln
    he: אנדרטת לינקולן
    hr: Lincoln Memorial
    hu: Lincoln-emlékmű
    hy: Լինքոլնի հուշակոթող
    id: Memorial Lincoln
    it: Lincoln Memorial
    ja: リンカーン記念館
    ka: ლინკოლნის მემორიალი
    ko: 링컨 기념관
    la: Monumentum Lincolnianum
    lt: Linkolno memorialas
    lv: Linkolna memoriāls
    mk: Линколнов споменик
    mr: लिंकन मेमोरियल
    ms: Tugu Peringatan Lincoln
    nb: Lincolnmonumentet
    nl: Lincoln Memorial
    nn: Lincolnmonumentet
    pl: Pomnik Lincolna
    pnb: لنکن میموریل
    pt: Lincoln Memorial
    ro: Monumentul lui Lincoln
    ru: Мемориал Линкольну
    sco: Lincoln Memorial
    sh: Lincolnov memorijal
    sk: Lincolnov pamätník
    sl: Lincolnov spomenik
    sv: Lincolnmonumentet
    te: లింకన్ మెమోరియల్
    th: อนุสรณ์สถานลินคอล์น
    tr: Lincoln Anıtı
    uk: Меморіал Лінкольна
    ur: لنکن میموریل
    vi: Nhà tưởng niệm Lincoln
