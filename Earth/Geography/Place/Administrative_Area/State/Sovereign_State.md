...
- awanek anayan
- awank ilan abaḍ
- a̱byin ka̱ yong ma̱ sa̱t
- Chú-khoân kok-ka
- Civitas sui iuris
- Daptar nagara badaulat
...
- รัฐเอกราช
- ລັດອະທິປະໄຕ
- အချုပ်အခြာ အာဏာပိုင် နိုင်ငံ
- სუვერენული სახელმწიფო
- სუვერენული სახენწჷფო
- ሉዓላዊ ግዛት
- ᱥᱟᱨᱵᱳᱵᱷᱟᱶᱢ ᱫᱤᱥᱚᱢ
- 主权国家
- 主権国家
...
dv_has_:
  name_:
    ...
    br: stad emveliek
    bs: suverena država
    bxr: Бүрин эрхэтэ улас
    ca: estat sobirà
    ce: Маьрша пачхьалкх
    ceb: soberanong estado
    ckb: دەوڵەتی سەروەر
    co: statu sovranu
    crh-ro: ózgír dewlet
    cs: suverénní stát
    cy: gwladwriaeth sofran
    da: suveræn stat
    dag: maŋsulinsi tiŋgbani
    de: souveräner Staat
    ...
    fa: کشور مستقل
    ff: jeetaare leydi
    fi: itsenäinen valtio
    fo: Fullveldisríki
    fr: État souverain
    frr: suwereen stoot
    fy: soevereine steat
    ga: stát ceannasach
    gd: stàit neo-eisimeileach
    gl: estado soberano
    gn: tetã hekosãsóva
    gsw: Unabhängige Staat
    gu: સાર્વભૌમિત રાજ્ય
    guc: mma mülo'u
    gv: steat kionedeeagh
    ha: ƴantacciyar ƙasa
    he: מדינה ריבונית
    hi: श्रेष्ठ राज्य
    hif: Rajya
    ...
    hsb: suwereny stat
    hu: szuverén állam
    hy: ինքնիշխան պետություն
    hyw: ինքնիշխան պետութիւն
    ia: stato soveran
    id: negara berdaulat
    ilo: Naturay nga estado
    io: suverena stato
    is: Fullvalda ríki
    it: stato sovrano
    ja: 主権国家
    jam: savrin stiet
    ka: სუვერენული სახელმწიფო
    kaa: suveren mámleket
    kab: awanek anayan
    kai: ƴali
    kcg: a̱byin ka̱ yong ma̱ sa̱t
    kk: тәуелсіз мемлекет
    kn: ಸಾರ್ವಭೌಮ ರಾಜ್ಯ
    ko: 주권국
    krj: soberanhën nga estado
    ks: خۄد مۄختیار رِیاسَتھ
    ku: dewleta desthilatdar
    kw: stat sovran
    la: Civitas sui iuris
    lb: souveräne Staat
    lmo: Stat sovran
    lo: ລັດອະທິປະໄຕ
    lt: suvereni valstybė
    lv: suverēna valsts
    mdf: суверенонь кирдемастор
    min: nagara badaulaik
    mk: суверена држава
    ml: പരമാധികാര രാഷ്ട്രം
    mn: Бүрэн эрхт улс
    mni: ꯃꯅꯤꯡ ꯇꯝꯕ ꯂꯩꯄꯥꯛ
    mr: सार्वभौम राष्ट्र
    ms: negara berdaulat
    ...
    mzn: مستقل کشور
    nan: Chú-khoân kok-ka
    nb: uavhengig stat
    nds: Sülvststänniger Staat
    ne: सार्वभौम राष्ट्र
    nl: soevereine staat
    nn: sjølvråden stat
    nqo: ߖߡߊ߬ߣߊ߫ ߡߊ߲߭ߕߎ߬ߙߋ
    nrm: êtat souoveran
    oc: estat sobeiran
    os: суверенон паддзахад
    pa: ਸਿਰਮੌਰ ਰਾਜ
    pam: soberánung estádu
    pap: estado soberano
    pap-aw: estado soberano
    pl: państwo niepodległe
    pnb: خود مختار ریاست
    prg: wālstis
    ps: خپلواک هېواد
    pt: estado soberano
    ...
    wa: Dislaxhî payis
    war: soberano nga estado
    xmf: სუვერენული სახენწჷფო
    yi: סואווערענער שטאט
...
> 
> When referring to a specific polity, 
> the term "country" may also refer to a constituent country, or a dependent territory.
>
> A sovereign state is required to have a permanent population, defined territory, 
> a government not under another, and the capacity to interact with other sovereign states. 
> 
> In actual practice, recognition or non-recognition by other states 
> plays an important role in determining the status of a country. 
> 
> Unrecognized states often 
> have difficulty engaging in diplomatic relations with other sovereign states.
>
