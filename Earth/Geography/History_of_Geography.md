...
- istor an douaroniezh
- istoria geografiei
- Istorija geografije
- istòria de ła zeografia
...
dv_has_:
  name_:
    ...
    bho: भूगोल के इतिहास
    bn: ভূগোলের ইতিহাস
    br: istor an douaroniezh
    ca: història de la geografia
    cs: Dějiny geografie
    de: Geschichte der Geographie
    el: Ιστορία της γεωγραφίας
    en: history of geography
    eo: historio de geografio
    es: historia de la geografía
    eu: Geografiaren historia
    fa: تاریخ جغرافیا
    fi: maantieteen historia
    fr: histoire de la géographie
    gl: historia da xeografía
    hi: भूगोल का इतिहास
    hr: povijest geografije
    hy: աշխարհագրության պատմություն
    it: storia della geografia
    ja: 地理学の歴史
    ka: გეოგრაფიის ისტორია
    kn: ಭೂಗೋಳದ ಇತಿಹಾಸ
    ko: 지리학의 역사
    la: Historia geographiae
    lv: ģeogrāfijas vēsture
    ...
    ps: د جغرافيې تاريخ
    pt: história do pensamento geográfico
    ro: istoria geografiei
    ru: история географии
    sh: Historija geografije
    sk: dejiny geografie
    sl: zgodovina geografije
    sr: Istorija geografije
    sv: geografins historia
    tl: kasaysayan ng heograpiya
    tly: Čoǧrafijə taryx
    tr: coğrafya tarihi
    tt: география тарихы
    ug: جۇغراپىيەنىڭ تارىخى
    uk: історія географії
