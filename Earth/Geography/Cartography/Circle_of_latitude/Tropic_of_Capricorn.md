...
dv_has_:
  name_:
    ...
    an: Tropico de Capricorno
    ar: مدار الجدي
    arz: مدار الجدى
    as: মকৰ ক্ৰান্তি
    ast: Trópicu de Capricorniu
    azb: اوغلاق دؤننجهسی
    ba: Көньяҡ тропик
    ...
    bo: ལྷོའི་ལྡོག་ཐིག
    br: Trovan ar C'havr
    bs: Jarčeva obratnica
    ca: tròpic de Capricorn
    ckb: ھێڵی کارژۆڵە
    cs: Obratník Kozoroha
    cy: Trofan yr Afr
    da: Stenbukkens vendekreds
    de: südlicher Wendekreis
    el: Τροπικός του Αιγόκερω
    eml: Tròpic dal Capricòran
    en: Tropic of Capricorn
    eo: Tropiko de Kaprikorno
    es: Trópico de Capricornio
    et: kaljukitse pöörijoon
    eu: Kaprikornioko tropikoa
    fa: مدار رأسالجدی
    fi: kauriin kääntöpiiri
    fr: tropique du Capricorne
    fy: Stienbokskearkring
    gl: Trópico de Capricornio
    hak: Nàm-fì Kûi-sien
    he: חוג הגדי
    hi: मकर रेखा
    hr: Jarčeva obratnica
    hu: Baktérítő
    hy: Հարավային արևադարձ
    id: Garis balik selatan
    ilo: Tropiko ti Kaprikornio
    io: Tropiko di Kaprikorno
    is: Hvarfbaugur syðri
    it: Tropico del Capricorno
    ja: 南回帰線
    ka: სამხრეთი ტროპიკი
    ko: 남회귀선
    ku: Kelûya Karê
    ...
    lv: Dienvidu tropu loks
    mg: Trôpikan'ny Adijady
    mk: Јужен Повратник
    ml: ദക്ഷിണായനരേഖ
    mn: Матрын зам
    mr: मकरवृत्त
    ms: Garisan Jadi
    my: တောင်ယဉ်စွန်းတန်း
    nb: stenbukkens vendekrets
    nl: Steenbokskeerkring
    nn: Steinbukken sin vendekrins
    oc: Tropic del Capricòrne
    om: Sarara Kaappirikoornii
    or: ମକର କ୍ରାନ୍ତି
    pl: zwrotnik Koziorożca
    pnb: خط جدی
    pt: Trópico de Capricórnio
    ro: Tropicul Capricornului
    ru: Южный тропик
    rue: Зворотник Козорога
    se: ruoiggu jorggihanbirradat
    sh: Jarčeva obratnica
    si: මකර නිවර්තනය
    sk: Obratník Kozorožca
    ...
    ta: மகர ரேகை
    te: మకర రేఖ
    th: ทรอปิกออฟแคปริคอร์น
    tl: Tropiko ng Kaprikorn
    tr: Oğlak Dönencesi
    udm: Лымшор тропик
    uk: Тропік Козерога
    ur: خط جدی
...
#is_/same_as :: [[_Standards/WikiData/WD~Tropic_of_Capricorn,177440|WD~Tropic_of_Capricorn,177440]] 

## #has_/text_of_/abstract 

> The Tropic of Capricorn (or the Southern Tropic) 
> is the circle of latitude that contains the subsolar point at the December (or southern) solstice. 
> 
...
> Its latitude is currently 23°26′09.3″ (or 23.43592°) south of the Equator, 
> but it is very gradually moving northward, currently at the rate of 0.47 arcseconds, or 15 metres, per year.
>
...
### #is_/same_as :: [[/_internal/Earth/Geography/Cartography/Circle_of_latitude/Tropic_of_Capricorn.internal|Tropic_of_Capricorn.internal]] 

### #is_/same_as :: [[/_protect/Earth/Geography/Cartography/Circle_of_latitude/Tropic_of_Capricorn.protect|Tropic_of_Capricorn.protect]] 

### #is_/same_as :: [[/_private/Earth/Geography/Cartography/Circle_of_latitude/Tropic_of_Capricorn.private|Tropic_of_Capricorn.private]] 

### #is_/same_as :: [[/_personal/Earth/Geography/Cartography/Circle_of_latitude/Tropic_of_Capricorn.personal|Tropic_of_Capricorn.personal]] 

### #is_/same_as :: [[/_secret/Earth/Geography/Cartography/Circle_of_latitude/Tropic_of_Capricorn.secret|Tropic_of_Capricorn.secret]] 
