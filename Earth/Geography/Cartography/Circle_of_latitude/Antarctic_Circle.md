...
aliases:
  ...
  - južni tečajnik
  - Južný polárny kruh
  - Kiarkyl yn Antarctagh
  - koło podbiegunowe południowe
  - Lingkar Antarktik
  - Lingkehan Antartika
  - lõunapolaarjoon
  - Mzingo antaktiki
  - máddáápiälááš näpikiärdu
  - Palibot Antartiko
  - Pietų poliaratis
  ...
  - Ανταρκτικός κύκλος
  - Јужен Поларник
  - Антарктички поларни круг
  - көньяҡ поляр түңәрәк
  - Лымшор полярной котрет
  - Південне полярне коло
  - Паўднёвы палярны круг
  - Соҕуруу полюс эргимтэтэ
  - Южен полярен кръг
  - южный полярный круг
  - Өмнөд туйлын цагираг
  - Հարավային բևեռային շրջագիծ
  - החוג האנטארקטי
  - الدائرة القطبية الجنوبية
  - بازنەی جەمسەری باشوور
  - دائرہ قطب جنوبی
  - مدار جنوبگان
  - अंटार्कटिक रेखा
  - अंटार्क्टिक वृत्त
...
instance_of:
  ...
  - "[[_Standards/WikiData/WD~polar_circle,202490|WD~polar_circle,202490]]"
opposite_of: "[[_Standards/WikiData/WD~Arctic_Circle,176609|WD~Arctic_Circle,176609]]"
...
dv_is_:
  same_as:
    ...
    - "[[Antarctic_Circle|Antarctic_Circle]]"
...
dv_has_:
  name_:
    af: Antarktiese Sirkel
    ar: الدائرة القطبية الجنوبية
    ast: Círculu polar antárticu
    az: Cənub Qütb dairəsi
    ba: көньяҡ поляр түңәрәк
    ...
    bn: কুমেরু বৃত্ত
    bs: Antarktički krug
    ca: cercle polar antàrtic
    ckb: بازنەی جەمسەری باشوور
    cs: jižní polární kruh
    ...
    et: lõunapolaarjoon
    eu: Zirkulu Polar Antartikoa
    fa: مدار جنوبگان
    fi: eteläinen napapiiri
    fr: Cercle Antarctique
    fy: Súdpoalsirkel
    ga: An Ciorcal Antartach
    gan: 南極圈
    gan-hans: 南极圈
    gan-hant: 南極圈
    gd: Cearcall na h-Antartaig
    gl: Círculo Polar Antártico
    gv: Kiarkyl yn Antarctagh
    he: החוג האנטארקטי
    hi: अंटार्कटिक रेखा
    hr: Antarktički krug
    hu: déli sarkkör
    hy: Հարավային բևեռային շրջագիծ
    id: Lingkar Antarktik
    ilo: Sirkulo ti Antartiko
    it: Circolo polare antartico
    ja: 南極圏
    ka: სამხრეთ პოლარული წრე
    ko: 남극권
    la: Circulus Antarcticus
    lt: Pietų poliaratis
    lv: Dienvidu polārais loks
    mg: Faribolana antarktika
    mk: Јужен Поларник
    ml: അന്റാർട്ടിക് വൃത്തം
    mn: Өмнөд туйлын цагираг
    mr: अंटार्क्टिक वृत्त
    ms: Garisan Antartik
    my: အန္တာတိတ်စက်ဝိုင်း
    nb: sørlige polarsirkel
    nl: Zuidpoolcirkel
    nn: Den antarktiske polarsirkelen
    oc: Cercle antartic
    ...
    te: అంటార్కిటిక్ వలయం
    th: วงกลมแอนตาร์กติก
    tr: Güney Kutup Dairesi
    udm: Лымшор полярной котрет
    uk: Південне полярне коло
    ur: دائرہ قطب جنوبی
    vi: Vòng Nam Cực
    wa: Ceke polaire antartike
    war: Palibot Antartiko
    wuu: 南極圈
    yue: 南極圈
    zh: 南極圈
    zh_cn: 南极圈
