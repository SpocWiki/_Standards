...
dv_has_:
  name_:
    acm: شبه الجزيرة العربية
    af: Arabiese Skiereiland
    am: አረቢያ
    ang: Arabea
    ar: شبه الجزيرة العربية
    arc: ܐܪܒܝܐ
    arz: شبه الجزيره العربيه
    ast: Arabia
    av: ГӀарабистан
    az: Ərəbistan yarımadası
    azb: عربیستان یاریمآداسی
    ba: Ғәрәп ярымутрауы
    ban: Samenanjung Arab
    ...
    bn: আরব উপদ্বীপ
    br: Arabia
    bs: Arapsko poluostrvo
    ca: Aràbia
    ce: Ӏаьрбийн ахгӀайре
    ckb: نیمچەدوورگەی عەرەبی
    co: penisula araba
    cs: Arabský poloostrov
    cv: Арави çурутравĕ
    cy: Arabia
    da: Arabiske Halvø
    ...
    fo: Arabiska hálvoyggin
    fr: Arabie
    frp: Pèninsula arabica
    frr: Araabisk Hualeweilun
    fy: Arabysk Skiereilân
    ga: An Araib
    gl: Península de Arabia
    gn: Arávia
    gom: अरबस्तानः
    gsw: Arabische Halbinsel
    ha: Yankin Larabawa
    he: חצי האי ערב
    hi: अरबी प्रायद्वीप
    hr: Arapski poluotok
    hsb: Arabska połkupa
    hu: Arab-félsziget
    hy: Արաբական թերակղզի
    hyw: Արաբական թերակղզի
    ia: Peninsula Arabica
    id: Semenanjung Arab
    inh: Iарбий ахгIайре
    io: Arabia
    is: Arabíuskaginn
    ...
    ja: アラビア半島
    jv: Semenanjung Arab
    ka: არაბეთის ნახევარკუნძული
    kab: Tazunegzirt Taɛrabt
    kk: Арабия түбегі
    kn: ಅರೇಬಿಯ
    ko: 아라비아반도
    ks: عرب پَرلانٛکھ
    ...
    ky: Араб жарым аралы
    la: Arabia
    lb: Arabesch Hallefinsel
    lbe: Аьрабусттан
    lfn: Arabia
    li: Arabië
    lij: Arabbia
    lo: ແຫຼມອາຣັບ
    lt: Arabijos pusiasalis
    lv: Arābijas pussala
    mg: Saikanosin'i Arabia
    min: Jazirah Arab
    mk: Арапски Полуостров
    ml: അറേബ്യൻ ഉപദ്വീപ്
    mn: Арабын хойг
    mr: अरबी द्वीपकल्प
    mrj: Арави пел ошмаоты
    ms: Semenanjung Arab
    my: အာရေဗျကျွန်းဆွယ်
    mzn: عربئون جزیره مونا
    nan: A-la-pek
    nb: Den arabiske halvøy
    ne: अरेबियन प्रायःद्वीप
    nl: Arabisch schiereiland
    nn: Den arabiske halvøya
    oc: Arabia
    os: Араббы æрдæгсакъадах
    pa: ਅਰਬੀ ਪਰਾਇਦੀਪ
    pap: Península Árabe
    pap-aw: Peninsula Arabe
    pl: Półwysep Arabski
    pnb: جزیرہ نما عرب
    ...
    sc: Penìsula àraba
    sco: Arabie Peninsula
    sd: عرب جزيري نما
    sh: Arabija
    si: අරාබි අර්ධද්වීපය
    sk: Arabský polostrov
    sl: Arabski polotok
    smn: Arabia njargâeennâm
    sms: Arabia njarggjânnam
    so: Jasiirad Dhuleedka Carabta
    sq: Gadishulli Arabik
    sr: Арабијско полуострво
    su: Semenanjung Arab
    sv: Arabiska halvön
    sw: Bara Arabu
    ta: அராபியத் தீபகற்பம்
    te: అరేబియా ద్వీపకల్పం
    tg: Арабистон (нимҷазира)
    th: คาบสมุทรอาหรับ
    tl: Tangway ng Arabya
    tok: ma palisa Alapi
    tr: Arap Yarımadası
    tt: Гарәбстан ярымутравы
    uk: Аравійський півострів
    ur: جزیرہ نما عرب
    uz: Arabiston yarim oroli
    vi: Bán đảo Ả Rập
    war: Rawis han Arabya
    wo: Arabi
    wuu: 阿拉伯半島
    xmf: არაბეთიშ ჩქონი
...
- Gadishulli Arabik
- Iарбий ахгIайре
- Jasiirad Dhuleedka Carabta
- Jazirah Arab
- ma palisa Alapi
- Nîvgirava Erebistanê
- Peninsula Arabe
- Peninsula Arabica
- Peninsula Arabică
- penisola araba
...
- Араббы æрдæгсакъадах
- Арабијско полуострво
- Арабистон (нимҷазира)
- Арабия түбегі
- Арабски полуостров
- Арабын хойг
- Аравійскі паўвостраў
