...
- Һинд цивилизацияһы
- Ինտուս հովիտին քաղաքակրթութիւնը
...
indigenous_to: '[[_Standards/WikiData/WD~Indus_Valley,10535281|WD~Indus_Valley,10535281]]'
topic_has_template: '[[_Standards/WikiData/WD~Template_Indus_Valley_Civilisation,20646565|WD~Template_Indus_Valley_Civilisation,20646565]]'
start_time: -2999-01-01T00:00:00Z
culture: '[[_Standards/WikiData/WD~South_Asian_culture,122766954|WD~South_Asian_culture,122766954]]'
...
locations: '[[_Standards/WikiData/WD~Indian_subcontinent,60140|WD~Indian_subcontinent,60140]]'
...
dv_has_:
  name_:
    af: Indusvalleibeskawing
    anp: सिन्धु घाटी सभ्यता
    ar: حضارة وادي السند
    as: সিন্ধু সভ্যতা
    ast: civilización del valle del Indo
    az: İnd vadisi mədəniyyəti
    ba: Һинд цивилизацияһы
    bar: Indus Kuitua
    ...
    bn: সিন্ধু সভ্যতা
    bs: Civilizacija doline Inda
    ca: civilització de la vall de l'Indus
    ckb: شارستانیەتی دۆڵی ئیندوس
    ...
    ext: Coltura el Valli el Indu
    fa: تمدن دره سند
    fi: Indus-kulttuuri
    fr: civilisation de la vallée de l'Indus
    fy: Indusbeskaving
    gan: 古印度
    gcr: Sivilizasyon di valé di Indus
    gl: Civilización do val do Indo
    gn: Índo avano'õ
    gu: સિંધુ ખીણની સંસ્કૃતિ
    ha: Wayewar Kwarin Indus
    ...
    hy: Հարապպայի քաղաքակրթություն
    hyw: Ինտուս հովիտին քաղաքակրթութիւնը
    id: Peradaban Lembah Indus
    is: Indusdalsmenningin
    it: civiltà della valle dell'Indo
    ja: インダス文明
    jam: Indus Vali Sivilizieshan
    jv: Kabudayan Lembah Kali Indhus
    ka: ინდის ცივილიზაცია
    kk: Хараппа өркениеті
    kn: ಸಿಂಧೂತಟದ ನಾಗರೀಕತೆ
    ko: 인더스 문명
    la: Civilizatio Vallis Indi
    lfn: Sivilia de la Vale de Indo
    lld: Val dl Indus
    lt: Indo slėnio civilizacija
    lv: Indas ielejas civilizācija
    mag: सिन्धुघाटी सभ्यता
    mai: सिन्धु घाटी सभ्यता
    mk: Индска цивилизација
    ml: സിന്ധു നദീതടസംസ്കാരം
    mn: Энэтхэгийн соёл иргэншил
    mr: हडप्पा संस्कृती
    ...
    nl: Indusbeschaving
    nn: Induskulturen
    oc: Civilizacion de la Vau d'Indus
    or: ହରପ୍ପା ସଭ୍ୟତା
    pa: ਸਿੰਧੂ ਘਾਟੀ ਸੱਭਿਅਤਾ
    pl: Cywilizacja doliny Indusu
    pnb: انڈس تہذیب
    ps: د سیند درې تمدن
    pt: Civilização do Vale do Indo
    ro: Civilizația de pe Valea Indului
    ru: Индская цивилизация
    sa: सिन्धुखातसंस्कृतिः
    sat: ᱥᱤᱱᱫᱷᱩ ᱥᱚᱥᱱᱚᱜ
    sc: Tziviltade de sa badde de s'Indus
    sd: سنڌو ماٿري جي تهذيب
    sh: Civilizacija Doline Inda
    si: ඉන්දු නිම්න ශිෂ්ටාචාරය
    sk: Harappská kultúra
    sl: indska civilizacija
    sq: Qytetërimi i Luginës së Indusit
    sr: Цивилизација долине Инда
    sv: Induskulturen
    sw: Ustaarabu wa Indus
    ...
    uz: Xarappa madaniyati
    vec: siviltà de ła vałe de l'Indo
    vi: Văn minh lưu vực sông Ấn
    vro: Indusõ oro tsivilisats'uun
