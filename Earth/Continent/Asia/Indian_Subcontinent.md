...
- socontinente indiu
- Soscontinent indian
- Sot-continent endien
- sous-continent indien
- South Asia
- Subbenua India
- Subcontinens Indica
- subcontinent indi
- subcontinente indian
- subcontinente indiano
- Subcontinente indianu
- subcontinente indio
- subcontinentul Indian
- Subkontinente han India
- subkontinente Indiano
- Subkontinenteng Indio
- Subkontinenteng Indiyano
- Subkontynent indyjski
- Sucontinenti Indiu
- Suttacuntinenti innianu
- Tiểu lục địa Ấn Độ
- Yndiaaske subkontinint
- Zana-kôntinenta indiana
...
Commons_category: Indian subcontinent
subreddit: subcontinent
dv_has_:
  name_:
    af: Indiese subkontinent
    ar: شبه القارة الهندية
    arz: شبه القاره الهنديه
    as: ভাৰতীয় উপমহাদেশ
    ast: socontinente indiu
    awa: भारतीय उपमहाद्वीप
    az: Hindistan yarımqitəsi
    ba: Һинд субконтиненты
    ...
    bn: ভারতীয় উপমহাদেশ
    br: Iskevandir Indez
    bs: Indijski potkontinent
    ca: subcontinent indi
    ce: ХӀиндин субконтинент
    ceb: Indian Subcontinent
    ckb: نیمچەکیشوەری ھیندی
    ...
    ext: Sucontinenti Indiu
    fa: شبهقاره هند
    fi: Etu-Intia
    fr: sous-continent indien
    frp: Sot-continent endien
    fy: Yndiaaske subkontinint
    ga: fo-ilchríoch na hIndia
    gl: subcontinente indio
    gsw: Dr Indisch Subkontinänt
    gu: ભારતીય ઉપખંડ
    ha: Geology na yankin Indiya
    he: תת-היבשת ההודית
    hi: भारतीय उपमहाद्वीप
    hr: Indijski potkontinent
    hu: Indiai szubkontinens
    hy: Հինդուստան
    hyw: Հինտուստան
    ia: subcontinente indian
    id: anak benua India
    ilo: subkontinente Indiano
    is: Indlandsskagi
    it: subcontinente indiano
    ja: インド亜大陸
    ka: ინდოეთის სუბკონტინენტი
    kab: Azunmenẓaw n Lhend
    kk: Үндістан түбегі
    kn: ಭಾರತೀಯ ಉಪಖಂಡ
    ko: 인도 아대륙
    ks: ہِندوستٲنؠ برِصغیٖر
    la: Subcontinens Indica
    lt: Indijos subkontinentas
    lv: Indijas subkontinents
    mag: भारतीय उपमहाद्वीप
    mai: भारतीय उपमहाद्वीप
    mg: Zana-kôntinenta indiana
    mk: Индиски Потконтинент
    ml: ഇന്ത്യൻ ഉപഭൂഖണ്ഡം
    mr: भारतीय उपखंड
    ms: Subbenua India
    nan: Ìn-tō͘ chhù-tāi-lio̍k
    nb: Det indiske subkontinent
    ne: भारतीय उपमहाद्वीप
    nl: Indiaas subcontinent
    nn: Det indiske subkontinentet
    oc: Soscontinent indian
    or: ଭାରତ ଉପମହାଦେଶ
    os: Индийы субконтинент
    pa: ਭਾਰਤੀ ਉਪਮਹਾਂਦੀਪ
    ...
    sc: Subcontinente indianu
    scn: Suttacuntinenti innianu
    sco: Indie subcontinent
    sd: ننڍو کنڊ
    sh: Indijski potkontinent
    si: ඉන්දීය උප මහාද්වීපය
    sk: Indický subkontinent
    sl: Indijska podcelina
    sq: Nënkontinenti indian
    ...
    te: భారత ఉపఖండము
    th: อนุทวีปอินเดีย
    tl: Subkontinenteng Indiyano
    tr: Hint altkıtası
    tt: Һинд субкыйтгасы
    uk: Індійський субконтинент
    ur: برصغیر پاک و ہند
    vec: subcontinente indian
    vi: Tiểu lục địa Ấn Độ
    war: Subkontinente han India
    wo: Ron-goxu End
    wuu: 印度次大陆
    xmf: ინდოეთიშ სუბკონტინენტი
    yue: 印度次大陸
    zgh: ⴰⴽⵏⵎⵏⵥⴰⵡ ⴰⵀⵉⵏⴷⵉ
    zh: 印度次大陸
    zh_hant: 南亞次大陸
...
> which projects into the Indian Ocean between the Bay of Bengal to the east 
> and the Arabian Sea to the west. 
> 
> It is now divided between Bangladesh, India, and Pakistan. 
> Although the terms "Indian subcontinent" and "South Asia" 
> are often also used interchangeably to denote a wider region which includes, in addition, 
> Bhutan, the Maldives, Nepal and Sri Lanka, 
> the "Indian subcontinent" is more of a geophysical term, 
> whereas "South Asia" is more geopolitical.  
> 
> "South Asia" frequently also includes Afghanistan, 
