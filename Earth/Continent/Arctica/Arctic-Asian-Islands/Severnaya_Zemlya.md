...
has_part_s_: '[[_Standards/WikiData/WD~Komsomolets_Island,248654|WD~Komsomolets_Island,248654]]'
described_by_source:
...
area: 37000
named_after: '[[_Standards/WikiData/WD~Nicholas_II_of_Russia,40787|WD~Nicholas_II_of_Russia,40787]]'
...
dv_has_:
  name_:
    ...
    da: Severnaja Semlja
    de: Sewernaja Semlja
    el: Σεβέρναγια Ζεμλιά
    en: Severnaya Zemlya
    eo: Norda Lando
    es: Tierra del Norte
    et: Severnaja Zemlja
    eu: Iparraldeko Zembla
    fa: سورنایا زملیا
    fi: Severnaja Zemlja
    fr: Terre du Nord
    frr: Sewernaja Semlja
    fy: Noardlân
    ga: Severnaya Zemlya
    gl: Terra do Norte
    he: סברניה זמליה
    hi: सेवेर्नाया ज़ेमल्या
    hif: Severnaya Zemlya
    hr: Severnaja Zemlja
    hu: Szevernaja Zemlja
    hy: Հյուսիսային երկիր
    id: Kepulauan Zemlya Utara
    it: Severnaja Zemlja
    ja: セヴェルナヤ・ゼムリャ諸島
    ka: ჩრდილოეთის მიწა
    kk: Солтүстік Жер
    ko: 세베르나야제믈랴 제도
    ky: Түндүк жер аралдары
    la: Terra Borealis
    lt: Šiaurinė Žemė
    lv: Severnaja Zemļa
    mk: Северна Земја
