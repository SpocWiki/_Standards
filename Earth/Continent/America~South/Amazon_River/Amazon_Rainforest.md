...
- Hutan hujan Amazon
- Lanmanzonni
- Mauran nga kagurangan han Amazon
- Msitu wa Amazon
- Pulan Hujan Amazon
- Pădurea Amazoniană
...
instance_of: '[[_Standards/WikiData/WD~tropical_forest,199403|WD~tropical_forest,199403]]'
location: '[[_Standards/WikiData/WD~Amazonia,2841453|WD~Amazonia,2841453]]'
topic_s_main_Wikimedia_portal: '[[_Standards/WikiData/WD~Portal_Amazon_Rainforest,15584566|WD~Portal_Amazon_Rainforest,15584566]]'
different_from: '[[_Standards/WikiData/WD~Panamazonia,62096465|WD~Panamazonia,62096465]]'
...
dv_has_:
  name_:
    ...
    bs: Amazonija
    ca: selva amazònica
    ckb: دارستانی ئەمازۆن
    co: Furesta amazzonica
    cs: Amazonský prales
    da: Regnskoven i Amazonas
    de: Amazonas-Regenwald
    el: Τροπικό δάσος του Αμαζονίου
    en: Amazon rainforest
    eo: Amazona arbaro
    es: Amazonia
    eu: Amazonia
    fa: جنگل آمازون
    fi: Amazonin sademetsä
    fr: forêt amazonienne
    fy: Amazônewâld
    ga: Foraois bháistí na hAmasóine
    gcr: Lanmanzonni
    gl: selva amazónica
    gn: Amasónia
    ha: Amazon
    he: יער האמזונאס
    hi: अमेज़न वर्षावन
    hr: Amazonska prašuma
    hu: amazóniai esőerdő
    hy: Ամազոնի խոնավ անտառներ
    hyw: Ամազոնի անտառներ
    id: Hutan Amazon
    is: Amasónfrumskógurinn
    it: Amazzonia
    ja: アマゾン熱帯雨林
    ka: ამაზონის ჯუნგლები
    kab: Tiẓgi n Amaẓun
    kge: Pulan Hujan Amazon
    kn: ಅಮೆಜಾನ್ ಮಳೆಕಾಡು
    ko: 아마존 우림
    ky: Гилея
    la: Silvae pluviales Amazoniae
    lfn: Amazonia
    lld: Bosch dl’Amazonia
    lo: ປ່າດົງຕຶບໜາອາມາຊົນ
    lt: Amazonija
    lv: Amazones lietus mežs
    mai: अमेजन रेनफरेस्ट
    mg: Amazônia
    mk: Амазонија
    ml: ആമസോൺ മഴക്കാടുകൾ
    mnw: ဂြိုပ်ဗြဲ အမဇြောန်
    mr: अॅमेझॉन वर्षावन
    ms: Hutan hujan Amazon
    my: အမေဇုန် မိုးသစ်တော
    mzn: آمازون
    nb: Regnskogen i Amazonas
    ne: अमेजन रेनफरेस्ट
    new: अमेजन वा-गुँ
    nl: Amazoneregenwoud
    nn: Regnskogen i Amazonas
    oc: Seuva Amazonica
    pa: ਅਮੇਜ਼ਨ ਵਰਖਾ ਜੰਗਲ
    pl: Amazonia
    pms: Amassònia
    ...
    sat: ᱟᱢᱟᱡᱚᱱ ᱵᱤᱨ
    sgs: Amazuonėjė
    sh: Amazonska prašuma
    si: ඇමසෝන් වැසි වනාන්තරය
    sk: Amazonský prales
    ...
    ta: அமேசான் மழைக்காடு
    te: అమెజాన్ వర్షారణ్యం
    th: ป่าดิบชื้นแอมะซอน
    tl: Amazonia
    tr: Amazon ormanları
    uk: Амазонський дощовий ліс
    ur: ایمیزون برساتی جنگل
    uz: Amazon oʻrmonlari
    vi: rừng mưa Amazon
    war: Mauran nga kagurangan han Amazon
    wuu: 亚马逊雨林
    yue: 亞馬遜雨林
    zh: 亞馬遜雨林
    zh_cn: 亚马孙雨林
