...
dv_has_:
  name_:
    ...
    bn: এটলাস পর্বতমালা
    br: Menezioù Atlas
    ca: serralada de l'Atles
    ceb: Atlas Mountains
    ckb: چیاکانی ئەتلەس
    cs: Atlas
    cy: Mynyddoedd yr Atlas
    da: Atlasbjergene
    de: Atlas
    el: Άτλας
    en: Atlas Mountains
    ...
    la: Atlas
    lb: Atlas
    lld: Atlas (ciadëina de crëps)
    lt: Atlaso kalnai
    lv: Atlass
    mg: Tendrombohitra Atlasy
    mk: Атлас
    ml: അറ്റ്ലസ് പർവ്വതനിര
    mn: Атласын нуруу
    mr: ॲटलास पर्वतरांग
    ms: Gunung Atlas
    nb: Atlasfjellene
