...
- Deştê Ewropa Rocvetışi
- East European Plain
- East_European_Plain
- Ekialdeko Europako ordokia
- Enllanada europea oriental
...
dv_is_:
  same_as:
  - '[[../../../WikiData/WD~East_European_Plain,191862|WD~East_European_Plain,191862]]'
  - '[[/_Standards/Earth/Continent/Europe/East_European_Plain|East_European_Plain]]'
  - '[[/_public/Earth/Continent/Europe/East_European_Plain.public|East_European_Plain.public]]'
  - '[[/_internal/Earth/Continent/Europe/East_European_Plain.internal|East_European_Plain.internal]]'
  - '[[/_protect/Earth/Continent/Europe/East_European_Plain.protect|East_European_Plain.protect]]'
  - '[[/_private/Earth/Continent/Europe/East_European_Plain.private|East_European_Plain.private]]'
  - '[[/_personal/Earth/Continent/Europe/East_European_Plain.personal|East_European_Plain.personal]]'
  - '[[/_secret/Earth/Continent/Europe/East_European_Plain.secret|East_European_Plain.secret]]'
dv_is_same_as:
- '[[../../../WikiData/WD~East_European_Plain,191862|WD~East_European_Plain,191862]]'
- '[[/_Standards/Earth/Continent/Europe/East_European_Plain|East_European_Plain]]'
- '[[/_public/Earth/Continent/Europe/East_European_Plain.public|East_European_Plain.public]]'
...
part_of: '[[_Standards/WikiData/WD~European_Plain,877091|WD~European_Plain,877091]]'
...
locator_map_image: http://commons.wikimedia.org/wiki/Special:FilePath/Karte%20der%20Landschaften%20der%20Osteurop%C3%A4ischen%20Ebene.png
dv_has_:
  name_:
    ar: السهل الأوروبي الشرقي
    ast: Enllanada europea oriental
    ...
    ceb: Vostochno-Yevropeyskaya Ravnina
    cs: Východoevropská rovina
    cv: Тухăç-Европа тӳремĕ
    cy: Gwastatir Gogledd Ewrop
    da: Østeuropæiske Slette
    de: Osteuropäische Ebene
    diq: Deştê Ewropa Rocvetışi
    el: Πεδιάδα της Ανατολικής Ευρώπης
    en: East European Plain
    en-us: East European Plain
    eo: Orienteŭropa ebenaĵo
    es: Llanura europea oriental
    et: Ida-Euroopa lauskmaa
    eu: Ekialdeko Europako ordokia
    fa: دشت اروپای شرقی
    fi: Itä-Euroopan tasanko
    fr: Plaine d'Europe orientale
    gl: Chaira europea oriental
    he: המישור המזרח אירופאי
    hi: पूर्वी यूरोपीय मैदान
    hr: Istočnoeuropska nizina
    hu: Kelet-európai-síkság
    hy: Արևելաեվրոպական հարթավայր
    it: Bassopiano sarmatico
    ja: 東ヨーロッパ平原
    ...
    la: Planities Europaea Orientalis
    lt: Rytų Europos lyguma
    lv: Austrumeiropas līdzenums
    mk: Источноевропска Низина
    ml: കിഴക്കൻ യൂറോപ്യൻ സമതലം
    mn: Дорнод Европын тэгш тал
    nb: Den østeuropeiske slette
    nl: Russisch Laagland
    nn: Den austeuropeiske sletta
    pl: Nizina Wschodnioeuropejska
    pt: Planície europeia oriental
    ro: Câmpia Europei de Est
    ru: Восточно-Европейская равнина
    sco: East European Plain
    ...
    tr: Rusya Ovası
    tt: Көнчыгыш Аурупа тигезлеге
    uk: Східноєвропейська рівнина
    uz: Rossiya tekisligi
    vi: Đồng bằng Đông Âu
    wuu: 东欧平原
...
```leaflet
id: East_European_Plain
zoomFeatures: true 
minZoom: 4 
maxZoom: 18
geojsonFolder: ./East_European_Plain//
markerFolder: ./East_European_Plain/
coordinates: [[East_European_Plain]] 
markerFile: [[East_European_Plain]] 
defaultZoom: 5 
```
