...
- Banca Eoropea de Recostrusion e Desviłupo
...
- Bancu Européu pa la Reconstrucción y el Desenvolvimientu
...
- Europana Banko por Rikonstrukto e Developo
...
- Европа реконcтрукциялоо жана өнүктүрүү банкы
- Европа реконструкция һәм үсеш банкы
...
- Реконструкцийы æмæ тынгады европæйæг банк
...
different_from: '[[_Standards/WikiData/WD~Council_of_Europe_Development_Bank,611107|WD~Council_of_Europe_Development_Bank,611107]]'
instance_of:
...
owner_of:
- '[[_Standards/WikiData/WD~TransContainer,4461999|WD~TransContainer,4461999]]'
- '[[_Standards/WikiData/WD~Grandi_Stazioni_Česká_republika,24352534|WD~Grandi_Stazioni_Česká_republika,24352534]]'
- '[[_Standards/WikiData/WD~Kamaz,30378|WD~Kamaz,30378]]'
chairperson: '[[_Standards/WikiData/WD~Odile_Renaud_Basso,24937938|WD~Odile_Renaud_Basso,24937938]]'
member_of: '[[_Standards/WikiData/WD~Network_for_Greening_the_Financial_System,104872529|WD~Network_for_Greening_the_Financial_System,104872529]]'
industry:
- '[[_Standards/WikiData/WD~international_governmental_or_non_governmental_organizations,107607934|WD~international_governmental_or_non_governmental_organizations,107607934]]'
- '[[_Standards/WikiData/WD~bank,22687|WD~bank,22687]]'
position_held_by_head_of_the_organization: '[[_Standards/WikiData/WD~President_of_the_European_Bank_for_Reconstruction_and_Development,131994204|WD~President_of_the_European_Bank_for_Reconstruction_and_Development,131994204]]'
...
dv_has_:
  name_:
    ar: البنك الأوروبي لإعادة البناء والتنمية
    ...
    da: European Bank for Reconstruction and Development
    de: Europäische Bank für Wiederaufbau und Entwicklung
    el: Ευρωπαϊκή Τράπεζα Ανασυγκρότησης και Ανάπτυξης
    en: European Bank for Reconstruction and Development
    eo: Eŭropa Banko por Rekonstruo kaj Evoluigo
    es: Banco Europeo para la Reconstrucción y el Desarrollo
    et: Euroopa Rekonstruktsiooni- ja Arengupank
    eu: Berreraikuntza eta Garapeneko Europako Bankua
    fa: بانک اروپایی بازسازی و توسعه
    fi: Euroopan jälleenrakennus- ja kehityspankki
    fr: Banque européenne pour la reconstruction et le développement
    he: הבנק האירופי לשיקום ופיתוח
    hr: Europska banka za obnovu i razvitak
    hu: Európai Újjáépítési és Fejlesztési Bank
    hy: Վերակառուցման և զարգացման եվրոպական բանկ
    id: Bank Rekonstruksi dan Pembangunan Eropa
    io: Europana Banko por Rikonstrukto e Developo
    it: Banca Europea per la Ricostruzione e lo Sviluppo
    ja: 欧州復興開発銀行
    ka: ევროპის რეკონსტრუქციისა და განვითარების ბანკი
    kk: Еуропа қайта құру және даму банкі
    ko: 유럽 부흥 개발 은행
    ky: Европа реконcтрукциялоо жана өнүктүрүү банкы
    lb: Banque européenne pour la reconstruction et le développement
    lt: Europos rekonstrukcijos ir plėtros bankas
    lv: Eiropas Rekonstrukcijas un attīstības banka
    mk: Европска банка за обнова и развој
    mn: Европын шинэчлэл хөгжлийн банк
    ms: Bank Eropah untuk Pembinaan Semula dan Pembangunan
    nb: Den europeiske bank for gjenoppbygning og utvikling
    nl: Europese Bank voor Wederopbouw en Ontwikkeling
    os: Реконструкцийы æмæ тынгады европæйæг банк
    pa: ਪੁਨਰ ਨਿਰਮਾਣ ਅਤੇ ਵਿਕਾਸ ਲਈ ਯੂਰਪੀ ਬੈਂਕ
    pl: Europejski Bank Odbudowy i Rozwoju
    pt: Banco Europeu para a Reconstrução e o Desenvolvimento
    ro: Banca Europeană pentru Reconstrucție și Dezvoltare
    ru: Европейский банк реконструкции и развития
    sh: Evropska banka za obnovu i razvoj
    sk: Európska banka pre obnovu a rozvoj
    ...
    tt: Европа реконструкция һәм үсеш банкы
    uk: Європейський банк реконструкції та розвитку
