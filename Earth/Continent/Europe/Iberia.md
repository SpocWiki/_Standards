...
highest_point: '[[_Standards/WikiData/WD~Mulhacén,209528|WD~Mulhacén,209528]]'
has_part_s_:
- '[[_Standards/WikiData/WD~Continental_Portugal,2915956|WD~Continental_Portugal,2915956]]'
- '[[_Standards/WikiData/WD~peninsular_Spain,16390686|WD~peninsular_Spain,16390686]]'
...
studied_by: '[[_Standards/WikiData/WD~Iberian_studies,35832005|WD~Iberian_studies,35832005]]'
country:
- '[[_Standards/WikiData/WD~Gibraltar,1410|WD~Gibraltar,1410]]'
...
- '[[_Standards/WikiData/WD~Bay_of_Biscay,41573|WD~Bay_of_Biscay,41573]]'
connects_with: '[[_Standards/WikiData/WD~Pyrenees,12431|WD~Pyrenees,12431]]'
different_from: '[[_Standards/WikiData/WD~Kingdom_of_Iberia,19083|WD~Kingdom_of_Iberia,19083]]'
...
Dewey_Decimal_Classification: 66
...
page_banner: http://commons.wikimedia.org/wiki/Special:FilePath/Toledo%20banner%20Puerta%20de%20Alfonso%20VI.jpg
Wolfram_Language_entity_code: Entity"Concept", "IberianPeninsula = `=this.dv_"Concept", "IberianPeninsula`
Libris_URI: nl021p7641wmgtn
Colon_Classification: SG--54
dv_"Concept", "IberianPeninsula: 7q7hp"
dv_is_:
  same_as:
  - '[[../../../WikiData/WD~Iberian_Peninsula,12837|WD~Iberian_Peninsula,12837]]'
  - '[[/_Standards/Earth/Continent/Europe/Iberia|Iberia]]'
  - '[[/_public/Earth/Continent/Europe/Iberia.public|Iberia.public]]'
  - '[[/_internal/Earth/Continent/Europe/Iberia.internal|Iberia.internal]]'
  - '[[/_protect/Earth/Continent/Europe/Iberia.protect|Iberia.protect]]'
  - '[[/_private/Earth/Continent/Europe/Iberia.private|Iberia.private]]'
  - '[[/_personal/Earth/Continent/Europe/Iberia.personal|Iberia.personal]]'
  - '[[/_secret/Earth/Continent/Europe/Iberia.secret|Iberia.secret]]'
dv_concept-iberianpeninsula: 7q7hp"
dv_is_same_as:
- '[[../../../WikiData/WD~Iberian_Peninsula,12837|WD~Iberian_Peninsula,12837]]'
- '[[/_Standards/Earth/Continent/Europe/Iberia|Iberia]]'
- '[[/_public/Earth/Continent/Europe/Iberia.public|Iberia.public]]'
...
dv_has_:
  name_:
    af: Iberiese Skiereiland
    am: የኢቤሪያ ልሳነ ምድር
    an: Peninsula Iberica
    ang: Iberia
    ar: شبه الجزيرة الإيبيرية
    ary: إيبيريا
    arz: شبه الجزيره الايبيريه
    ...
    bn: ইবেরীয় উপদ্বীপ
    br: Ledenez iberek
    bs: Pirenejsko poluostrvo
    bxr: Пиренейн хахад арал
    ca: península Ibèrica
    ce: Пиренейн ахгӀайре
    ceb: Penynsula sa Iberia
    ckb: نیمچەدوورگەی ئیبیریا
    co: penisula iberica
    ...
    frr: Ibeerisk Hualeweilun
    fy: Ibearysk Skiereilân
    ga: Leithinis na hIbéire
    gl: Península Ibérica
    gsw: Iberischi Halbinsle
    gv: Lieh-innys ny h-Ibeir
    hak: Iberia Pan-tó
    he: חצי האי האיברי
    hi: इबेरिया प्रायद्वीप
    hr: Pirenejski poluotok
    hsb: Pyrenejska połkupa
    hu: Ibériai-félsziget
    hy: Պիրենեյան թերակղզի
    hyw: Իբերական Թերակղզի
    ia: Peninsula Iberic
    iba: Semenanjung Iberia
    id: Iberia
    ie: Peninsul Iberic
    io: Iberia
    is: Íberíuskaginn
    it: penisola iberica
    ja: イベリア半島
    jam: Aibiirian Peninsiula
    ka: პირენეს ნახევარკუნძული
    kk: Пиреней түбегі
    kn: ಐಬೀರಿಯನ್ ಪರ್ಯಾಯದ್ವೀಪ
    ko: 이베리아반도
    ku: Nîvgirava Îberî
    ky: Пиреней жарым аралы
    la: Iberia
    lad: Peninsola Iberika
    lb: Ibeeresch Hallefinsel
    lez: Пиреней зуростров
    lfn: Iberia
    li: Iberië
    lij: Penîzoa Ibérica
    lo: ຄາບສະໝຸດອີເບລີ
    ...
    ml: ഐബീരിയൻ ഉപദ്വീപ്
    mn: Иберийн хойг
    mr: इबेरियन द्वीपकल्प
    mrj: Пиреней пел ошмаоты
    ms: Semenanjung Iberia
    mwl: Península Eibérica
    my: အိုင်ဘီးရီးယားကျွန်းဆွယ်
    mzn: ایبری
    nan: Iberia Poàn-tó
    ...
    os: Пиренейты æрдæгсакъадах
    pa: ਇਬੇਰੀਆਈ ਪਰਾਇਦੀਪ
    pap: Península Ibériko
    pl: Półwysep Iberyjski
    pms: Penìsola Ibérica
    pnb: جزیرہ نما آئیبیریا
    ...
    sc: Penìsula Ibèrica
    scn: Pinìsula ibbèrica
    sco: Iberie Peninsula
    sd: جزیرو نما آئیبیریا
    sh: Pirinejski poluotok
    si: අයිබීරියානු අර්ධද්වීපය
    sk: Pyrenejský polostrov
    skr: جزیرہ نما آئبیریا
    sl: Iberski polotok
    ...
    th: คาบสมุทรไอบีเรีย
    tk: Pireneý ýarymadasy
    tl: Tangway ng Iberia
    tok: ma Ipelija
    tr: İber Yarımadası
    tt: Пиреней ярымутравы
    uk: Піренейський пів острів
    ur: جزیرہ نما آئبیریا
    uz: Pireney yarim oroli
    vep: Pirenejan pol'sar'
    vi: Bán đảo Iberia
    vls: Iberisch Schiereiland
    war: Rawis han Iberia
    wuu: 伊比利亚半岛
    xmf: პირენეშ ჩქონი
    yi: איבערישער האלבאינזל
    yue: 伊比利半島
    zh: 伊比利亚半岛
---
...
> The Iberian Peninsula (IPA:  eye-BEER-ee-ən), also known as Iberia, 
> is a peninsula in south-western Europe. 
> 
> Mostly separated from the rest of the European landmass by the Pyrenees, 
> it includes the territories of Peninsular Spain and Continental Portugal, 
> comprising most of the region, as well as the tiny adjuncts of Andorra, Gibraltar, 
> and, pursuant to the traditional definition of the Pyrenees as the peninsula's northeastern boundary, 
