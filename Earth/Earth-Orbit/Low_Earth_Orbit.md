...
dv_has_:
  name_:
    af: Lae aardwentelbaan
    an: Orbita baixa terrestre
    ar: مدار أرضي منخفض
    ...
    cs: nízká oběžná dráha Země
    da: Lavt jordkredsløb
    de: niedrige Erdumlaufbahn
    el: χαμηλή περιγήινη τροχιά
    en: low Earth orbit
    eo: malalta Tera orbito
    es: órbita terrestre baja
    et: Maa-lähedane orbiit
    eu: Lurraren orbita baxu
    fa: مدار نزدیک زمین
    fi: Matala Maan kiertorata
    fr: orbite terrestre basse
    ga: fithis íseal dhomhanda
    gl: Órbita baixa terrestre
    he: מסלול לווייני נמוך
    hi: पृथ्वी की निचली कक्षा
    hr: Niska orbita oko Zemlje
    hu: alacsony Föld körüli pálya
    hy: ցածր մերձերկրյա ուղեծիր
    id: orbit bumi rendah
    it: orbita terrestre bassa
    ja: 低軌道
    kn: ಕಡಿಮೆ ಭೂಮಿಯ ಕಕ್ಷೆ
    ko: 지구 저궤도
    lt: Žemoji Žemės orbita
    lv: zemā Zemes orbīta
    mk: нискоземска орбита
    ms: Orbit rendah bumi
    nb: lav jordbane
    ne: पृथ्वीको तल्लो कक्ष
    nl: lage baan om de Aarde
    nn: låg jordbane
    nqo: ߘߎ߱ ߘߎ߲߬ߘߊ ߖߊ߰ߟߋ
    oc: orbita terrestra baisha
    pl: niska orbita okołoziemska
    ps: ټیټ ځمکنی چورلېځ
    pt: órbita terrestre baixa
    ro: Orbita joasă a Pământului
    ru: низкая околоземная орбита
    sa: अकुल पृथिवी अध्वन्
    sh: Niska Zemljina orbita
    si: පහළ පෘථිවි කක්ෂය
    sk: Nízka obežná dráha Zeme
    sl: nizkozemeljska orbita
    sr: Ниска Земљина орбита
    su: Orbit Bumi Handap
    sv: låg omloppsbana
    ta: பூமியின் தாழ் வட்டப்பாதை
    te: భూ నిమ్న కక్ష్య
    tg: мадори пойинии Замин
    th: วงโคจรต่ำของโลก
    tr: Alçak Dünya yörüngesi
    tt: түбән Җир буе орбитасы
    uk: низька навколоземна орбіта
    ur: زیریں زمینی مدار
    vec: òrbita terestre basa
...
#is_/same_as :: [[_Standards/WikiData/WD~Low_Earth_orbit,663611|WD~Low_Earth_orbit,663611]] 
