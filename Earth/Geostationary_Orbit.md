...
dv_has_:
  name_:
    af: geostasionêre wentelbaan
    an: Orbita cheoestacionaria
    ar: المدار الجغرافى الثابت
    ...
    bs: Geostacionarna orbita
    ca: òrbita geostacionària
    cs: geostacionární dráha
    da: geostationære bane
    ...
    eu: Orbita geoestazionario
    fa: مدار زمینایستا
    fi: Geostationaarinen rata
    fr: orbite géostationnaire
    ga: fithis geochobhsaí
    gl: órbita xeoestacionaria
    he: מסלול גאוסטציונרי
    hi: भूस्थिर कक्षा
    hr: Geostacionarni satelit
    hu: geostacionárius pálya
    hy: Գեոհաստատուն ուղեծիր
    id: Orbit geostasioner
    it: orbita geostazionaria
    ja: 静止軌道
    ka: გეოსტაციონარული ორბიტა
    kk: Геостационарлық орбита
    ko: 정지 궤도
    lv: Ģeostacionārā orbīta
    ml: ഭൂസ്ഥിര ഭ്രമണപഥം
    mn: Тогтмол тойрог зам
    ms: Orbit geopegun
    nb: geostasjonær bane
    nl: geostationaire baan
    nn: geostasjonær bane
    oc: Orbita geoestacionària
    ...
    tg: мадори заминисто
    th: วงโคจรค้างฟ้า
    tr: jeostatik yörünge
    uk: геостаціонарна орбіта
    ur: جیوسٹیشنری آربٹ
    vi: quỹ đạo địa tĩnh
    wuu: 地球静止轨道
    yue: 地球靜止軌道
