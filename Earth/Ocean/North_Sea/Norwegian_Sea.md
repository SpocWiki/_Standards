...
vertical_depth: 3970
area: 1383000
SSR_place_name_number: 134842
locator_map_image: http://commons.wikimedia.org/wiki/Special:FilePath/Norwegian%20Sea%20in%20its%20region%20%28IHO%201953%29.svg
image: http://commons.wikimedia.org/wiki/Special:FilePath/V%C3%A5gakaillen%20nattlys.JPG
U_S_National_Archives_Identifier: 10046323
Commons_category: Norwegian Sea
dv_has_:
  name_:
    ab: Анорвег амшын
    af: Noorse See
    ...
    cy: Môr Norwy
    da: Norskehavet
    de: Europäisches Nordmeer
    dsb: Norwegske mórjo
    el: Νορβηγική Θάλασσα
    en: Norwegian Sea
    eo: Norvega Maro
    es: mar de Noruega
    et: Norra meri
    eu: Norvegiako itsasoa
    fa: دریای نروژ
    fi: Norjanmeri
    fo: Norskahavið
    fr: mer de Norvège
    frr: Nuurdeuropeesk Sia
    fy: Noarske See
    ga: Muir na hIorua
    gl: Mar de Noruega
    gv: Yn Vooir Loghlynagh
    he: הים הנורווגי
    hi: नॉर्वेजियन सागर
    hif: Norwegian Samundar
    hr: Norveško more
    hsb: Norwegske morjo
    hu: Norvég-tenger
    hy: Նորվեգական ծով
    ...
    lt: Norvegijos jūra
    lv: Norvēģu jūra
    mg: Ranomasin' i Nôrvezy
    mk: Норвешко Море
    ml: നോർവീജിയൻ കടൽ
    mn: Норвегийн тэнгис
    mr: नॉर्वेजियन समुद्र
    ms: Laut Norway
    mzn: نروژ دریا
    nb: Norskehavet
    nds: Noorsche See
...
#is_/same_as :: [[_Standards/WikiData/WD~Norwegian_Sea,47545|WD~Norwegian_Sea,47545]] 
...
maxZoom: 18
defaultZoom: 2 
coordinates: [[Norwegian_Sea]] 
markerFile: [[Norwegian_Sea]] 
geojsonFolder: ./Norwegian_Sea/
markerFolder: ./Norwegian_Sea/
```


## #has_/text_of_/abstract 

> The Norwegian Sea (Norwegian: Norskehavet; Icelandic: Noregshaf; Faroese: Norskahavið) 
> is a marginal sea, grouped with either the Atlantic Ocean or the Arctic Ocean, 
> northwest of Norway between the North Sea and the Greenland Sea, 
> adjoining the Barents Sea to the northeast. 
> 
