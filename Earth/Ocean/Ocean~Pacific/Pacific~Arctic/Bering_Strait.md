---
aliases:
- Andilan-dranomasin'i Bering
- Bering Boğazı
- Bering bo‘g‘ozi
- Bering Hái-kiap
- Bering Strait
- Bering Strait (agianan)
- Bering Vedil
- Bering-szoros
- Beringa Markolo
- Beringa šauris
...
dv_has_:
  name_:
    af: Beringstraat
    an: Estreito de Bering
    ar: مضيق بيرنغ
    ary: لمضيق د بيرينڭ
    arz: بيرينج
    ast: Estrechu de Bering
    avk: Bering Vedil
    az: Berinq boğazı
    ba: Беринг боғаҙы
    ban: Selat Béring
    ...
    bs: Beringov prolaz
    ca: estret de Bering
    ceb: Bering Strait (agianan)
    ckb: تەنگاوی برینگ
    cs: Beringův průliv
    cv: Беринг тинĕс пырĕ
    cy: Culfor Bering
    da: Beringstrædet
    de: Beringstraße
    de_ch: Beringstrasse
    ...
    lv: Beringa šaurums
    lzh: 白令海峽
    mg: Andilan-dranomasin'i Bering
    mk: Берингов Проток
    ml: ബറിംഗ് കടലിടുക്ക്
    mn: Берингийн хоолой
    mr: बेरिंगची सामुद्रधुनी
    ms: Selat Bering
    mzn: برینگ دریا
    nan: Bering Hái-kiap
    nb: Beringstredet
    ...
    nl: Beringstraat
    nn: Beringsundet
    nov: Strait de Bering
    oc: Estrech de Bering
    os: Беринджы донкъубал
    pa: ਬੇਰਿੰਗ ਪਣਜੋੜ
    pl: Cieśnina Beringa
    pnb: آبنائے بیرنگ
    ...
    sk: Beringov prieliv
    sl: Beringov preliv
    sq: Ngushtica e Beringut
    sr: Берингов мореуз
    sv: Berings sund
    sw: Mlango wa Bering
    szy: salengacay a bayu
    ta: பெரிங் நீரிணை
    te: బేరింగ్ జలసంధి
    tg: Беринг (гулӯгоҳ)
    th: ช่องแคบเบริง
