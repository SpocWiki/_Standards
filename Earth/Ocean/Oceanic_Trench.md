...
dv_has_:
  name_:
    ...
    br: Foz danvorel
    ca: fossa marina
    cs: hlubokomořský příkop
    da: oceangrav
    de: Tiefseerinne
    el: ωκεανική τάφρος
    en: oceanic trench
    eo: profunda submara fosego
    es: fosa oceánica
    et: süvik
    eu: Itsas hobi
    fa: درازگودال
    ...
    ht: Tranche soumaren
    hu: óceáni árok
    hy: խորջրյա անդունդներ
    id: Palung
    it: fossa oceanica
    ja: 海溝
    jbo: condi jorne xamsi
    jv: Palung
    ka: ღრმა ზღვის ღარი
    kk: Шұңғыма
    kk_arab: شۇڭعىما
    ...
    ro: fosă oceanică
    ru: жёлоб
    sk: hlbokomorská priekopa
    sl: oceanski jarek
    sq: Hendeku oqeanik
    sr: Okeanski rov
    su: Palung laut
    sv: djuphavsgrav
    sw: Mfereji wa bahari
    th: ร่องลึกก้นสมุทร
    tr: derin çukur
    udm: океан дырды
    uk: океанічний жолоб
...
#is_/same_as :: [[_Standards/WikiData/WD~Oceanic_trench,119253|WD~Oceanic_trench,119253]] 
