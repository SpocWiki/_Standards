...
different_from: '[[_Standards/WikiData/WD~CNO_cycle,222971|WD~CNO_cycle,222971]]'
subclass_of: '[[_Standards/WikiData/WD~biogeochemical_cycle,846303|WD~biogeochemical_cycle,846303]]'
has_part_s_:
- '[[_Standards/WikiData/WD~carbon_fixation,901921|WD~carbon_fixation,901921]]'
- '[[_Standards/WikiData/WD~carbon_sequestration,15305550|WD~carbon_sequestration,15305550]]'
- '[[_Standards/WikiData/WD~carbon_storage,101953195|WD~carbon_storage,101953195]]'
...
topic_s_main_template: '[[_Standards/WikiData/WD~Template_Carbon_cycle,110250127|WD~Template_Carbon_cycle,110250127]]'
facet_of: '[[_Standards/WikiData/WD~carbon,623|WD~carbon,623]]'
...
dv_has_:
  name_:
    ...
    ht: Sik kabòn
    hu: szénkörforgás
    hy: Ածխածնի շրջանառություն
    id: Siklus karbon
    ig: carbon okirikiri
    is: Hringrás kolefnis
    it: ciclo del carbonio
    ja: 炭素循環
    jv: Siklus karbon
    ka: ნახშირბადის წრებრუნვა
    kk: Көміртек айналымы
    kn: ಇಂಗಾಲದ ಕಣಗಳ ಚಕ್ರ
    ko: 탄소의 순환
    lt: Anglies ciklas
    lv: oglekļa aprite
    mk: јаглероден циклус
    ml: കാർബൺ ചക്രം
    ms: Kitaran karbon
    nb: Karbonkretsløpet
    ne: कार्बन चक्र
    nl: koolstofkringloop
    om: Marsaa kaarboonii
    pa: ਕਾਰਬਨ ਚੱਕਰ
