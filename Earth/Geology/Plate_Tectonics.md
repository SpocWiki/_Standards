...
- levha tektonikası
- Lèmpèng tèktonik
- Mast'a tiktunikukuna
- mba'ekuaarã yvy'ape retepy rehegua
- nannaamráptutektoniik
- Pelat tektonik
- Peleti tektonika
- Plaattektoniek
- pladetektonik
...
- Tetònica a plache
- Yangi global tektonika
- Τεκτονικές πλάκες
- Геотектоника
- Плиталар тектоникаһы
- плитаослэн тектониказы
- Плитасен тектоники
- тектоніка плит
- Тектоник хавтан
...
part_of: '[[_Standards/WikiData/WD~lithosphere,83296|WD~lithosphere,83296]]'
manifestation_of: '[[_Standards/WikiData/WD~tectonic_plate,215680|WD~tectonic_plate,215680]]'
subclass_of: '[[_Standards/WikiData/WD~geotectonics,1863355|WD~geotectonics,1863355]]'
topic_has_template: '[[_Standards/WikiData/WD~Template_Tectonic_plates,10740776|WD~Template_Tectonic_plates,10740776]]'
studied_by:
- '[[_Standards/WikiData/WD~tectonics,78125729|WD~tectonics,78125729]]'
- '[[_Standards/WikiData/WD~geology,1069|WD~geology,1069]]'
instance_of: '[[_Standards/WikiData/WD~theory,17737|WD~theory,17737]]'
...
dv_has_:
  name_:
    ...
    arz: بلات تكتونك
    as: টেক্ট'নিক প্লেট
    ast: tectónica de plaques
    az: Plitələrin tektonikası
    azb: تکتونیک صفحهلر
    ...
    br: Tektonik ar plakennoù
    bs: Tektonika ploča
    ca: tectònica de plaques
    ckb: تێکتۆنیکی پەڕەیی
    crh: levha tektonikası
    cs: desková tektonika
    cv: Плитасен тектоники
    cy: Tectoneg platiau
    da: pladetektonik
    de: Plattentektonik
    diq: Erdlerzo tektonik
    el: Τεκτονικές πλάκες
    en: plate tectonics
    eo: platotektoniko
    ...
    ga: teicteonaic phlátaí
    gcr: Tektonik di sé plak
    gl: Tectónica de placas
    gn: mba'ekuaarã yvy'ape retepy rehegua
    gsw: Plattetektonik
    he: טקטוניקת הלוחות
    hi: प्लेट विवर्तनिकी
    hif: Plate tectonics
    ...
    jam: Pliet tektanix
    jv: Lèmpèng tèktonik
    ka: ახალი გლობალური ტექტონიკა
    kk: Геотектоника
    kn: ಭೂಫಲಕ ಸಿದ್ಧಾಂತ
    ko: 판 구조론
    kw: tektonieth plattys
    la: Tectonica laminarum
    li: Plaattektoniek
    ...
    mn: Тектоник хавтан
    ms: Plat tektonik
    nan: Pán-khoài kò͘-chō
    nb: platetektonikk
    nds: Platentektonik
    new: प्लेट टेक्टोनिक्स
    nl: platentektoniek
    nn: platetektonikk
    oc: Tectonica de las placas
    om: Tectonic plate
    pa: ਪੱਤਰੀ ਘਾੜਤ
    pl: tektonika płyt
    pms: Tetònica a plache
    pnb: پلیٹ ٹیکٹونکس
    ps: د ځمکې د تختو جوړښت
    pt: tectónica de placas
    qu: Mast'a tiktunikukuna
    rm: Tectonica da plattas
    ro: tectonica plăcilor
    ru: тектоника плит
    sco: plate tectonics
    sgs: Pluokštiu tektuonėka
    sh: Tektonika ploča
    si: භූ කාරක තල
    ...
    th: การแปรสัณฐานแผ่นธรณีภาค
    tl: plate tectonics
    tok: tawa ma
    tr: levha hareketleri
    udm: плитаослэн тектониказы
    uk: тектоніка плит
    ur: ساختمانی تختیاں
    uz: Yangi global tektonika
    vi: Kiến tạo mảng
    vls: Ploatntektoniek
    war: Plato tektoniko
    wuu: 板块构造论
