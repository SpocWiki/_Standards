...
- геалягічная фармацыя
- геологічна формація
- геологическая формация
- геолошка образба
- геолошка формација
- երկրաբանական կազմավորում
- תצורה
- تكوين جيولوجي
- سازند زمینشناسی
- भूवैज्ञानिक रचना
...
dv_has_:
  name_:
    ...
    da: formation
    de: Formation
    el: γεωλογικός σχηματισμός
    en: geological formation
    eo: formacio
    es: formación geológica
    et: kihistu
    eu: formazio geologiko
    fa: سازند زمینشناسی
    fi: muodostuma
    fr: formation géologique
    ga: foirmíocht
    gl: Formación xeolóxica
    he: תצורה
    hi: भूवैज्ञानिक रचना
    hr: geološka formacija
    hu: formáció
    hy: երկրաբանական կազմավորում
    id: Formasi geologi
    it: formazione geologica
    ja: 累層
    ka: გეოლოგიური ფორმაცია
    ko: 지질계통
    lb: geologesch Formatioun
    lt: darinys
    lv: ģeoloģiskā formācija
    mk: геолошка образба
    nb: formasjon
    nds: Formatschoon
    nl: formatie
    nn: formasjon
    oc: Formacion geologica
    pl: formacja
    pt: formação geológica
    ru: геологическая формация
    sh: geološka formacija
    sk: Súvrstvie
    sl: formacija
